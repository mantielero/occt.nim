...
#var m  = GC_MakeArcOfCircle.init(aPnt2, aPnt3, aPnt4)
let aArcOfCircle:Handle_Geom_TrimmedCurve  = makeArcOfCircle(aPnt2,aPnt3,aPnt4) 



#let aArcOfCircle:Handle_Geom_TrimmedCurve = makeArcOfCircle(aPnt2,aPnt3,aPnt4)  # cauto^
#[
let 
  aArcOfCircle:Handle_Geom_TrimmedCurve = MakeArcOfCircle(aPntGC_MakeArcOfCircle2,aPnt3,aPnt4)
