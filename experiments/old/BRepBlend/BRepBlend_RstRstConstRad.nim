...
proc `new`*(this: var BRepBlendRstRstConstRad; theSize: csize_t): pointer {.
    importcpp: "BRepBlend_RstRstConstRad::operator new",
    header: "BRepBlend_RstRstConstRad.hxx".}
proc `delete`*(this: var BRepBlendRstRstConstRad; theAddress: pointer) {.
    importcpp: "BRepBlend_RstRstConstRad::operator delete",
    header: "BRepBlend_RstRstConstRad.hxx".}
proc `new[]`*(this: var BRepBlendRstRstConstRad; theSize: csize_t): pointer {.
    importcpp: "BRepBlend_RstRstConstRad::operator new[]",
    header: "BRepBlend_RstRstConstRad.hxx".}
proc `delete[]`*(this: var BRepBlendRstRstConstRad; theAddress: pointer) {.
    importcpp: "BRepBlend_RstRstConstRad::operator delete[]",
    header: "BRepBlend_RstRstConstRad.hxx".}
proc `new`*(this: var BRepBlendRstRstConstRad; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "BRepBlend_RstRstConstRad::operator new",
    header: "BRepBlend_RstRstConstRad.hxx".}
proc `delete`*(this: var BRepBlendRstRstConstRad; a2: pointer; a3: pointer) {.
    importcpp: "BRepBlend_RstRstConstRad::operator delete",
    header: "BRepBlend_RstRstConstRad.hxx".}
...
proc set*(this: var BRepBlendRstRstConstRad; radius: StandardReal; choix: int) {.
    importcpp: "Set", header: "BRepBlend_RstRstConstRad.hxx".}
...
proc section*(this: var BRepBlendRstRstConstRad; p: BlendPoint;
    ...
    importcpp: "Section", header: "BRepBlend_RstRstConstRad.hxx".}
proc resolution*(this: BRepBlendRstRstConstRad; iC2d: int; tol: StandardReal;
