...
proc `new`*(this: var BRepBlendRstRstEvolRad; theSize: csize_t): pointer {.
    importcpp: "BRepBlend_RstRstEvolRad::operator new",
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc `delete`*(this: var BRepBlendRstRstEvolRad; theAddress: pointer) {.
    importcpp: "BRepBlend_RstRstEvolRad::operator delete",
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc `new[]`*(this: var BRepBlendRstRstEvolRad; theSize: csize_t): pointer {.
    importcpp: "BRepBlend_RstRstEvolRad::operator new[]",
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc `delete[]`*(this: var BRepBlendRstRstEvolRad; theAddress: pointer) {.
    importcpp: "BRepBlend_RstRstEvolRad::operator delete[]",
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc `new`*(this: var BRepBlendRstRstEvolRad; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "BRepBlend_RstRstEvolRad::operator new",
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc `delete`*(this: var BRepBlendRstRstEvolRad; a2: pointer; a3: pointer) {.
    importcpp: "BRepBlend_RstRstEvolRad::operator delete",
    header: "BRepBlend_RstRstEvolRad.hxx".}
...
proc centerCircleRst1Rst2*(this: BRepBlendRstRstEvolRad; ptRst1: Pnt; ptRst2: Pnt;
                          np: Vec; center: var Pnt; vdMed: var Vec): StandardBoolean {.
...
proc section*(this: var BRepBlendRstRstEvolRad; p: BlendPoint;
    ...
    importcpp: "Section", header: "BRepBlend_RstRstEvolRad.hxx".}
proc resolution*(this: BRepBlendRstRstEvolRad; iC2d: int; tol: StandardReal;
