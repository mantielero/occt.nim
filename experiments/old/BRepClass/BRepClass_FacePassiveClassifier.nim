...
proc reset*(this: var BRepClassFacePassiveClassifier; L: Lin2d; p: float; tol: float) {.
    importcpp: "Reset", header: "BRepClass_FacePassiveClassifier.hxx".}
...
proc parameter*(this: BRepClassFacePassiveClassifier): float {.noSideEffect,
...
proc closestIntersection*(this: BRepClassFacePassiveClassifier): int {.noSideEffect,
...
proc isHeadOrEnd*(this: BRepClassFacePassiveClassifier): bool {.noSideEffect,
    importcpp: "IsHeadOrEnd", header: "BRepClass_FacePassiveClassifier.hxx".}
