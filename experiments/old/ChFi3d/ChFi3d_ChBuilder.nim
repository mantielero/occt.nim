...
proc `new`*(this: var ChFi3dChBuilder; theSize: csize_t): pointer {.
    importcpp: "ChFi3d_ChBuilder::operator new", header: "ChFi3d_ChBuilder.hxx".}
proc `delete`*(this: var ChFi3dChBuilder; theAddress: pointer) {.
    importcpp: "ChFi3d_ChBuilder::operator delete", header: "ChFi3d_ChBuilder.hxx".}
proc `new[]`*(this: var ChFi3dChBuilder; theSize: csize_t): pointer {.
    importcpp: "ChFi3d_ChBuilder::operator new[]", header: "ChFi3d_ChBuilder.hxx".}
proc `delete[]`*(this: var ChFi3dChBuilder; theAddress: pointer) {.
    importcpp: "ChFi3d_ChBuilder::operator delete[]",
    header: "ChFi3d_ChBuilder.hxx".}
proc `new`*(this: var ChFi3dChBuilder; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "ChFi3d_ChBuilder::operator new", header: "ChFi3d_ChBuilder.hxx".}
proc `delete`*(this: var ChFi3dChBuilder; a2: pointer; a3: pointer) {.
    importcpp: "ChFi3d_ChBuilder::operator delete", header: "ChFi3d_ChBuilder.hxx".}
...
proc setDist*(this: var ChFi3dChBuilder; dis: StandardReal; ic: int; f: TopoDS_Face) {.
    importcpp: "SetDist", header: "ChFi3d_ChBuilder.hxx".}
proc getDist*(this: ChFi3dChBuilder; ic: int; dis: var StandardReal) {.noSideEffect,
...
proc setDists*(this: var ChFi3dChBuilder; dis1: StandardReal; dis2: StandardReal;
              ic: int; f: TopoDS_Face) {.importcpp: "SetDists",
                                     header: "ChFi3d_ChBuilder.hxx".}
proc dists*(this: ChFi3dChBuilder; ic: int; dis1: var StandardReal;
...
proc setDistAngle*(this: var ChFi3dChBuilder; dis: StandardReal; angle: StandardReal;
    ...
    header: "ChFi3d_ChBuilder.hxx".}
proc getDistAngle*(this: ChFi3dChBuilder; ic: int; dis: var StandardReal;
...
proc performSurf*(this: var ChFi3dChBuilder; data: var ChFiDS_SequenceOfSurfData;
                 ...
                 recOnS2: StandardBoolean; soldep: MathVector; intf: var int;
                 intl: var int): StandardBoolean {.importcpp: "PerformSurf",
    header: "ChFi3d_ChBuilder.hxx".}
proc performSurf*(this: var ChFi3dChBuilder; data: var ChFiDS_SequenceOfSurfData;
                 guide: Handle[ChFiDS_HElSpine]; spine: Handle[ChFiDS_Spine];
                 choix: int; s1: Handle[BRepAdaptorHSurface];
