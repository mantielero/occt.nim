...
proc isIdentical*(this: ExprLogOfe; other: Handle[ExprGeneralExpression]): bool {.
    noSideEffect, importcpp: "IsIdentical", header: "Expr_LogOfe.hxx".}
proc isLinear*(this: ExprLogOfe): bool {.noSideEffect, importcpp: "IsLinear",
