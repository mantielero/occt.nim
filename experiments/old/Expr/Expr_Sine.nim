...
proc isIdentical*(this: ExprSine; other: Handle[ExprGeneralExpression]): bool {.
    noSideEffect, importcpp: "IsIdentical", header: "Expr_Sine.hxx".}
proc isLinear*(this: ExprSine): bool {.noSideEffect, importcpp: "IsLinear",
