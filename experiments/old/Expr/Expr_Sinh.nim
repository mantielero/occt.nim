...
proc isIdentical*(this: ExprSinh; other: Handle[ExprGeneralExpression]): bool {.
    noSideEffect, importcpp: "IsIdentical", header: "Expr_Sinh.hxx".}
proc isLinear*(this: ExprSinh): bool {.noSideEffect, importcpp: "IsLinear",
