...
proc deflCurvIntervals*(c: Adaptor2dCurve2d): Handle[TColStdHArray1OfReal] {.
    ...
    header: "Extrema_Curve2dTool.hxx".}
proc isClosed*(c: Adaptor2dCurve2d): bool {.importcpp: "Extrema_Curve2dTool::IsClosed(@)",
                                        header: "Extrema_Curve2dTool.hxx".}
...
proc getType*(c: Adaptor2dCurve2d): GeomAbsCurveType {.
    ...
    header: "Extrema_Curve2dTool.hxx".}
proc line*(c: Adaptor2dCurve2d): Lin2d {.importcpp: "Extrema_Curve2dTool::Line(@)",
                                     header: "Extrema_Curve2dTool.hxx".}
proc circle*(c: Adaptor2dCurve2d): Circ2d {.importcpp: "Extrema_Curve2dTool::Circle(@)",
                                        header: "Extrema_Curve2dTool.hxx".}
