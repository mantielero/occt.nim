...
proc `new`*(this: var GeomIntThePrmPrmSvSurfacesOfWLApprox; theSize: csize_t): pointer {.
    importcpp: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox::operator new",
    header: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox.hxx".}
proc `delete`*(this: var GeomIntThePrmPrmSvSurfacesOfWLApprox; theAddress: pointer) {.
    importcpp: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox::operator delete",
    header: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox.hxx".}
proc `new[]`*(this: var GeomIntThePrmPrmSvSurfacesOfWLApprox; theSize: csize_t): pointer {.
    importcpp: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox::operator new[]",
    header: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox.hxx".}
proc `delete[]`*(this: var GeomIntThePrmPrmSvSurfacesOfWLApprox; theAddress: pointer) {.
    importcpp: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox::operator delete[]",
    header: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox.hxx".}
proc `new`*(this: var GeomIntThePrmPrmSvSurfacesOfWLApprox; a2: csize_t;
           theAddress: pointer): pointer {.importcpp: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox::operator new", header: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox.hxx".}
proc `delete`*(this: var GeomIntThePrmPrmSvSurfacesOfWLApprox; a2: pointer;
              a3: pointer) {.importcpp: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox::operator delete",
                           header: "GeomInt_ThePrmPrmSvSurfacesOfWLApprox.hxx".}
