...
proc constructGraphic3dBufferRange*(theStart: cint; theLength: cint): Graphic3dBufferRange {.
...
proc isEmpty*(this: Graphic3dBufferRange): bool {.noSideEffect, importcpp: "IsEmpty",
    header: "Graphic3d_BufferRange.hxx".}
proc upper*(this: Graphic3dBufferRange): cint {.noSideEffect, importcpp: "Upper",
    header: "Graphic3d_BufferRange.hxx".}
