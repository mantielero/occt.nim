...
## !!!Ignored construct:  # _Graphic3d_TransformPers_HeaderFile [NewLine] # _Graphic3d_TransformPers_HeaderFile [NewLine] # < Aspect_TypeOfTriedronPosition . hxx > [NewLine] # < Bnd_Box . hxx > [NewLine] # < BVH_Box . hxx > [NewLine] # < Graphic3d_Camera . hxx > [NewLine] # < Graphic3d_TransformUtils . hxx > [NewLine] # < Graphic3d_TransModeFlags . hxx > [NewLine] # < Graphic3d_Vec . hxx > [NewLine] # < NCollection_Mat4 . hxx > [NewLine] DEFINE_STANDARD_HANDLE ( Graphic3d_TransformPers , Standard_Transient ) ! Transformation Persistence definition.
## !
...
## !
## ! WARNING: Graphic3d_TMF_None is not permitted for defining instance of this class - NULL handle should be used for this purpose! class Graphic3d_TransformPers : public Standard_Transient { public : typedef Standard_Transient base_type ; static const char * get_type_name ( ) { return Graphic3d_TransformPers ; } static const Handle ( Standard_Type ) & get_type_descriptor ( ) ; virtual const Handle ( Standard_Type ) & DynamicType ( ) const ; public : ! Return true if specified mode is zoom/rotate transformation persistence. static Standard_Boolean IsZoomOrRotate ( Graphic3d_TransModeFlags theMode ) { return ( theMode & ( Graphic3d_TMF_ZoomPers | Graphic3d_TMF_RotatePers ) ) != 0 ; } ! Return true if specified mode is 2d/trihedron transformation persistence. static Standard_Boolean IsTrihedronOr2d ( Graphic3d_TransModeFlags theMode ) { return ( theMode & ( Graphic3d_TMF_TriedronPers | Graphic3d_TMF_2d ) ) != 0 ; } ! Create Graphic3d_TransformPers instance from deprecated parameters set
## ! decoding 2D corner + offset parameters from 3D point. static Handle ( Graphic3d_TransformPers ) FromDeprecatedParams ( Graphic3d_TransModeFlags theFlag , const gp_Pnt & thePoint ) ; public : ! Set transformation persistence. Graphic3d_TransformPers ( const Graphic3d_TransModeFlags theMode ) : myMode ( theMode ) { if ( IsZoomOrRotate ( theMode ) ) { SetPersistence ( theMode , gp_Pnt ( 0.0 , 0.0 , 0.0 ) ) ; } else if ( IsTrihedronOr2d ( theMode ) ) { SetPersistence ( theMode , Aspect_TOTP_LEFT_LOWER , Graphic3d_Vec2i ( 0 , 0 ) ) ; } else { throw Standard_ProgramError ( Graphic3d_TransformPers::SetPersistence(), wrong persistence mode. ) ; } } ! Set Zoom/Rotate transformation persistence with an anchor 3D point.
## ! Anchor point defines the origin of Local Coordinate system within World Coordinate system.
## ! Throws an exception if persistence mode is not Graphic3d_TMF_ZoomPers, Graphic3d_TMF_ZoomRotatePers or Graphic3d_TMF_RotatePers. Graphic3d_TransformPers ( const Graphic3d_TransModeFlags theMode , const gp_Pnt & thePnt ) : myMode ( Graphic3d_TMF_None ) { SetPersistence ( theMode , thePnt ) ; } ! Set 2d/trihedron transformation persistence with a corner and 2D offset.
...
## ! @param theBoundingBox [in/out] the bounding box to transform. template < class T > void Apply ( const Handle ( Graphic3d_Camera ) & theCamera , const NCollection_Mat4 < T > & theProjection , const NCollection_Mat4 < T > & theWorldView , const Standard_Integer theViewportWidth , const Standard_Integer theViewportHeight , Bnd_Box & theBoundingBox ) const ; ! Apply transformation to bounding box of presentation
## ! @param theCamera [in] camera definition
## ! @param theProjection [in] the projection transformation matrix.
## ! @param theWorldView [in] the world view transformation matrix.
## ! @param theViewportWidth [in] the width of viewport (for 2d persistence).
## ! @param theViewportHeight [in] the height of viewport (for 2d persistence).
## ! @param theBoundingBox [in/out] the bounding box to transform. template < class T > void Apply ( const Handle ( Graphic3d_Camera ) & theCamera , const NCollection_Mat4 < T > & theProjection , const NCollection_Mat4 < T > & theWorldView , const Standard_Integer theViewportWidth , const Standard_Integer theViewportHeight , BVH_Box < T , 3 > & theBoundingBox ) const ; ! Compute transformation.
...
## ! @param theViewportWidth [in] the width of viewport (for 2d persistence).
## ! @param theViewportHeight [in] the height of viewport (for 2d persistence).
## ! @return transformation matrix to be applied to model world transformation of an object. template < class T > NCollection_Mat4 < T > Compute ( const Handle ( Graphic3d_Camera ) & theCamera , const NCollection_Mat4 < T > & theProjection , const NCollection_Mat4 < T > & theWorldView , const Standard_Integer theViewportWidth , const Standard_Integer theViewportHeight ) const ; ! Apply transformation persistence on specified matrices.
...
## ! @param theViewportHeight viewport height template < class T > void Apply ( const Handle ( Graphic3d_Camera ) & theCamera , const NCollection_Mat4 < T > & theProjection , NCollection_Mat4 < T > & theWorldView , const Standard_Integer theViewportWidth , const Standard_Integer theViewportHeight ) const ; ! Dumps the content of me into the stream virtual void DumpJson ( Standard_OStream & theOStream , Standard_Integer theDepth = - 1 ) const ; private : ! 3D anchor point for zoom/rotate transformation persistence. struct PersParams3d { Standard_Real PntX ; Standard_Real PntY ; Standard_Real PntZ ; ! Dumps the content of me into the stream void DumpJson ( Standard_OStream & theOStream , Standard_Integer theDepth = - 1 ) const ; } ; ! 2d/trihedron transformation persistence parameters. struct PersParams2d { Standard_Integer OffsetX ; Standard_Integer OffsetY ; Aspect_TypeOfTriedronPosition Corner ; ! Dumps the content of me into the stream void DumpJson ( Standard_OStream & theOStream , Standard_Integer theDepth = - 1 ) const ; } ; private : Graphic3d_TransModeFlags myMode ; !< Transformation persistence mode flags union { PersParams3d Params3d ; PersParams2d Params2d ; } myParams ; } ;
## Error: expected ';'!!!
