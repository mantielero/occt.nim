...
discard "forward decl of IGESDimen_GeneralModule"
type
  HandleC1C1* = Handle[IGESDimenGeneralModule]
...
proc categoryNumber*(this: IGESDimenGeneralModule; cn: cint;
