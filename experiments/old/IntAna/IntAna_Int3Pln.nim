...
proc constructIntAnaInt3Pln*(p1: Pln; p2: Pln; p3: Pln): IntAnaInt3Pln {.constructor,
    importcpp: "IntAna_Int3Pln(@)", header: "IntAna_Int3Pln.hxx".}
proc perform*(this: var IntAnaInt3Pln; p1: Pln; p2: Pln; p3: Pln) {.importcpp: "Perform",
    header: "IntAna_Int3Pln.hxx".}
proc isDone*(this: IntAnaInt3Pln): bool {.noSideEffect, importcpp: "IsDone",
                                      header: "IntAna_Int3Pln.hxx".}
proc isEmpty*(this: IntAnaInt3Pln): bool {.noSideEffect, importcpp: "IsEmpty",
                                       header: "IntAna_Int3Pln.hxx".}
