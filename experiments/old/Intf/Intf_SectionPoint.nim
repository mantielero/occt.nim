...
proc paramOnFirst*(this: IntfSectionPoint): cfloat {.noSideEffect,
    importcpp: "ParamOnFirst", header: "Intf_SectionPoint.hxx".}
proc paramOnSecond*(this: IntfSectionPoint): cfloat {.noSideEffect,
...
proc infoFirst*(this: IntfSectionPoint; dim: var IntfPIType; add1: var cint;
               add2: var cint; param: var cfloat) {.noSideEffect,
    importcpp: "InfoFirst", header: "Intf_SectionPoint.hxx".}
proc infoFirst*(this: IntfSectionPoint; dim: var IntfPIType; `addr`: var cint;
               param: var cfloat) {.noSideEffect, importcpp: "InfoFirst",
                                 header: "Intf_SectionPoint.hxx".}
proc infoSecond*(this: IntfSectionPoint; dim: var IntfPIType; add1: var cint;
                add2: var cint; param: var cfloat) {.noSideEffect,
    importcpp: "InfoSecond", header: "Intf_SectionPoint.hxx".}
proc infoSecond*(this: IntfSectionPoint; dim: var IntfPIType; `addr`: var cint;
                param: var cfloat) {.noSideEffect, importcpp: "InfoSecond",
                                  header: "Intf_SectionPoint.hxx".}
proc incidence*(this: IntfSectionPoint): cfloat {.noSideEffect,
...
proc constructIntfSectionPoint*(where: Pnt; dimeO: IntfPIType; addrO1: cint;
                               addrO2: cint; paramO: cfloat; dimeT: IntfPIType;
                               addrT1: cint; addrT2: cint; paramT: cfloat;
                               incid: cfloat): IntfSectionPoint {.constructor,
    importcpp: "Intf_SectionPoint(@)", header: "Intf_SectionPoint.hxx".}
proc constructIntfSectionPoint*(where: Pnt2d; dimeO: IntfPIType; addrO1: cint;
                               paramO: cfloat; dimeT: IntfPIType; addrT1: cint;
                               paramT: cfloat; incid: cfloat): IntfSectionPoint {.
...
proc dump*(this: IntfSectionPoint; indent: cint) {.noSideEffect, importcpp: "Dump",
    header: "Intf_SectionPoint.hxx".}
