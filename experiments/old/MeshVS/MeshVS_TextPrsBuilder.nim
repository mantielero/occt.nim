...
type
  HandleC1C1* = Handle[MeshVS_TextPrsBuilder]
...
proc constructMeshVS_TextPrsBuilder*(parent: Handle[MeshVS_Mesh]; height: cfloat;
                                    color: QuantityColor; flags: MeshVS_DisplayModeFlags = meshVS_DMF_TextDataPrs;
                                    ds: Handle[MeshVS_DataSource] = 0;
                                    id: cint = -1; priority: MeshVS_BuilderPriority = meshVS_BP_Text): MeshVS_TextPrsBuilder {.
...
proc getText*(this: MeshVS_TextPrsBuilder; isElement: bool; id: cint;
             text: var TCollectionAsciiString): bool {.noSideEffect,
    importcpp: "GetText", header: "MeshVS_TextPrsBuilder.hxx".}
proc setText*(this: var MeshVS_TextPrsBuilder; isElement: bool; id: cint;
