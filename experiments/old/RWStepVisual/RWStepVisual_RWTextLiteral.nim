...
type
  RWStepVisualRWTextLiteral* {.importcpp: "RWStepVisual_RWTextLiteral",
                              header: "RWStepVisual_RWTextLiteral.hxx", bycopy.} = object


proc constructRWStepVisualRWTextLiteral*(): RWStepVisualRWTextLiteral {.
...
proc writeStep*(this: RWStepVisualRWTextLiteral; sw: var StepDataStepWriter;
               ent: Handle[StepVisualTextLiteral]) {.noSideEffect,
