...
proc hasName*(this: StepFEA_SymmetricTensor43dMember): StandardBoolean {.
...
proc setName*(this: var StepFEA_SymmetricTensor43dMember; name: StandardCString): StandardBoolean {.
    importcpp: "SetName", header: "StepFEA_SymmetricTensor43dMember.hxx".}
proc matches*(this: StepFEA_SymmetricTensor43dMember; name: StandardCString): StandardBoolean {.
