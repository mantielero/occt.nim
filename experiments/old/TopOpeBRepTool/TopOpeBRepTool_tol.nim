...
proc fTOL_FaceTolerances*(b1: BndBox; b2: BndBox; myFace1: TopoDS_Face;
                         ...
                         mySurface2: BRepAdaptorSurface; myTol1: var StandardReal;
                         myTol2: var StandardReal; deflection: var StandardReal;
                         maxUV: var StandardReal) {.
...
proc fTOL_FaceTolerances3d*(b1: BndBox; b2: BndBox; myFace1: TopoDS_Face;
                           myFace2: TopoDS_Face; mySurface1: BRepAdaptorSurface;
                           mySurface2: BRepAdaptorSurface;
                           myTol1: var StandardReal; myTol2: var StandardReal;
                           deflection: var StandardReal; maxUV: var StandardReal) {.
    importcpp: "FTOL_FaceTolerances3d(@)", header: "TopOpeBRepTool_tol.hxx".}
