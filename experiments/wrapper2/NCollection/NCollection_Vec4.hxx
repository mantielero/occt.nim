...
public:
  ...
  const NCollection_Vec2<Element_t> xy() const ; 
  const NCollection_Vec2<Element_t> yz() const ;
  const NCollection_Vec2<Element_t> xz() const ; 
  const NCollection_Vec2<Element_t> zx() const ;
  const NCollection_Vec2<Element_t> xw() const ; 
  const NCollection_Vec2<Element_t> wx() const ;
  const NCollection_Vec2<Element_t> yz() const ; 
  const NCollection_Vec2<Element_t> zy() const ;
  const NCollection_Vec2<Element_t> yw() const ; 
  const NCollection_Vec2<Element_t> wy() const ;
  const NCollection_Vec2<Element_t> zw() const ; 
  const NCollection_Vec2<Element_t> wz() const ;
