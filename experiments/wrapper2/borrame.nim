...
type
  Standard* {.bycopy.} = object
    Standard_EXPORT*: DEFINE_STANDARD_ALLOC ## ! Allocates memory blocks
...
proc Free*(this: var Standard; thePtr: Standard_Address)
proc Free*[T](thePtr: ptr T)
proc Reallocate*(this: var Standard; aStorage: Standard_Address;
                aNewSize: Standard_Size): Standard_Address
proc AllocateAligned*(this: var Standard; theSize: Standard_Size;
                     theAlign: Standard_Size): Standard_Address
proc FreeAligned*(this: var Standard; thePtrAligned: Standard_Address)
proc FreeAligned*[T](thePtrAligned: ptr T)
proc Purge*(this: var Standard): Standard_Integer
