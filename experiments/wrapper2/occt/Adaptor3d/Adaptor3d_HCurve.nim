...
proc firstParameter*(this: Adaptor3dHCurve): cfloat {.noSideEffect,
    importcpp: "FirstParameter", header: "Adaptor3d_HCurve.hxx".}
proc lastParameter*(this: Adaptor3dHCurve): cfloat {.noSideEffect,
...
proc period*(this: Adaptor3dHCurve): cfloat {.noSideEffect, importcpp: "Period",
    header: "Adaptor3d_HCurve.hxx".}
proc value*(this: Adaptor3dHCurve; u: cfloat): Pnt {.noSideEffect, importcpp: "Value",
    header: "Adaptor3d_HCurve.hxx".}
proc d0*(this: Adaptor3dHCurve; u: cfloat; p: var Pnt) {.noSideEffect, importcpp: "D0",
    header: "Adaptor3d_HCurve.hxx".}
proc d1*(this: Adaptor3dHCurve; u: cfloat; p: var Pnt; v: var Vec) {.noSideEffect,
...
proc dn*(this: Adaptor3dHCurve; u: cfloat; n: cint): Vec {.noSideEffect, importcpp: "DN",
    header: "Adaptor3d_HCurve.hxx".}
proc resolution*(this: Adaptor3dHCurve; r3d: cfloat): cfloat {.noSideEffect,
...
proc parabola*(this: Adaptor3dHCurve): Parab {.noSideEffect, importcpp: "Parabola",
    header: "Adaptor3d_HCurve.hxx".}
proc degree*(this: Adaptor3dHCurve): cint {.noSideEffect, importcpp: "Degree",
                                        header: "Adaptor3d_HCurve.hxx".}
proc isRational*(this: Adaptor3dHCurve): bool {.noSideEffect,
    importcpp: "IsRational", header: "Adaptor3d_HCurve.hxx".}
proc nbPoles*(this: Adaptor3dHCurve): cint {.noSideEffect, importcpp: "NbPoles",
    header: "Adaptor3d_HCurve.hxx".}
proc nbKnots*(this: Adaptor3dHCurve): cint {.noSideEffect, importcpp: "NbKnots",
    header: "Adaptor3d_HCurve.hxx".}
