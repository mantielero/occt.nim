...
proc firstUParameter*(this: Adaptor3dHSurface): cfloat {.noSideEffect,
    importcpp: "FirstUParameter", header: "Adaptor3d_HSurface.hxx".}
proc lastUParameter*(this: Adaptor3dHSurface): cfloat {.noSideEffect,
    importcpp: "LastUParameter", header: "Adaptor3d_HSurface.hxx".}
proc firstVParameter*(this: Adaptor3dHSurface): cfloat {.noSideEffect,
    importcpp: "FirstVParameter", header: "Adaptor3d_HSurface.hxx".}
proc lastVParameter*(this: Adaptor3dHSurface): cfloat {.noSideEffect,
...
proc uPeriod*(this: Adaptor3dHSurface): cfloat {.noSideEffect, importcpp: "UPeriod",
    header: "Adaptor3d_HSurface.hxx".}
proc isVPeriodic*(this: Adaptor3dHSurface): bool {.noSideEffect,
    importcpp: "IsVPeriodic", header: "Adaptor3d_HSurface.hxx".}
proc vPeriod*(this: Adaptor3dHSurface): cfloat {.noSideEffect, importcpp: "VPeriod",
    header: "Adaptor3d_HSurface.hxx".}
proc value*(this: Adaptor3dHSurface; u: cfloat; v: cfloat): Pnt {.noSideEffect,
    importcpp: "Value", header: "Adaptor3d_HSurface.hxx".}
proc d0*(this: Adaptor3dHSurface; u: cfloat; v: cfloat; p: var Pnt) {.noSideEffect,
...
proc dn*(this: Adaptor3dHSurface; u: cfloat; v: cfloat; nu: cint; nv: cint): Vec {.
    noSideEffect, importcpp: "DN", header: "Adaptor3d_HSurface.hxx".}
proc uResolution*(this: Adaptor3dHSurface; r3d: cfloat): cfloat {.noSideEffect,
    importcpp: "UResolution", header: "Adaptor3d_HSurface.hxx".}
proc vResolution*(this: Adaptor3dHSurface; r3d: cfloat): cfloat {.noSideEffect,
...
proc torus*(this: Adaptor3dHSurface): Torus {.noSideEffect, importcpp: "Torus",
    header: "Adaptor3d_HSurface.hxx".}
proc uDegree*(this: Adaptor3dHSurface): cint {.noSideEffect, importcpp: "UDegree",
    header: "Adaptor3d_HSurface.hxx".}
proc nbUPoles*(this: Adaptor3dHSurface): cint {.noSideEffect, importcpp: "NbUPoles",
    header: "Adaptor3d_HSurface.hxx".}
proc vDegree*(this: Adaptor3dHSurface): cint {.noSideEffect, importcpp: "VDegree",
    header: "Adaptor3d_HSurface.hxx".}
proc nbVPoles*(this: Adaptor3dHSurface): cint {.noSideEffect, importcpp: "NbVPoles",
    header: "Adaptor3d_HSurface.hxx".}
proc nbUKnots*(this: Adaptor3dHSurface): cint {.noSideEffect, importcpp: "NbUKnots",
    header: "Adaptor3d_HSurface.hxx".}
proc nbVKnots*(this: Adaptor3dHSurface): cint {.noSideEffect, importcpp: "NbVKnots",
    header: "Adaptor3d_HSurface.hxx".}
...
proc offsetValue*(this: Adaptor3dHSurface): cfloat {.noSideEffect,
