...
proc firstNotApprox*(this: AdvApp2VarNetwork; index: var int): bool {.noSideEffect,
    importcpp: "FirstNotApprox", header: "AdvApp2Var_Network.hxx".}
proc changePatch*(this: var AdvApp2VarNetwork; index: int): var AdvApp2VarPatch {.
    importcpp: "ChangePatch", header: "AdvApp2Var_Network.hxx".}
proc `()`*(this: var AdvApp2VarNetwork; index: int): var AdvApp2VarPatch {.
    importcpp: "#(@)", header: "AdvApp2Var_Network.hxx".}
proc updateInU*(this: var AdvApp2VarNetwork; cuttingValue: float) {.
    importcpp: "UpdateInU", header: "AdvApp2Var_Network.hxx".}
proc updateInV*(this: var AdvApp2VarNetwork; cuttingValue: float) {.
    importcpp: "UpdateInV", header: "AdvApp2Var_Network.hxx".}
proc sameDegree*(this: var AdvApp2VarNetwork; iu: int; iv: int; ncfu: var int;
                ncfv: var int) {.importcpp: "SameDegree",
                              header: "AdvApp2Var_Network.hxx".}
proc nbPatch*(this: AdvApp2VarNetwork): int {.noSideEffect, importcpp: "NbPatch",
    header: "AdvApp2Var_Network.hxx".}
proc nbPatchInU*(this: AdvApp2VarNetwork): int {.noSideEffect,
    importcpp: "NbPatchInU", header: "AdvApp2Var_Network.hxx".}
proc nbPatchInV*(this: AdvApp2VarNetwork): int {.noSideEffect,
    importcpp: "NbPatchInV", header: "AdvApp2Var_Network.hxx".}
proc uParameter*(this: AdvApp2VarNetwork; index: int): float {.noSideEffect,
    importcpp: "UParameter", header: "AdvApp2Var_Network.hxx".}
proc vParameter*(this: AdvApp2VarNetwork; index: int): float {.noSideEffect,
    importcpp: "VParameter", header: "AdvApp2Var_Network.hxx".}
proc patch*(this: AdvApp2VarNetwork; uIndex: int; vIndex: int): AdvApp2VarPatch {.
    noSideEffect, importcpp: "Patch", header: "AdvApp2Var_Network.hxx".}
proc `()`*(this: AdvApp2VarNetwork; uIndex: int; vIndex: int): AdvApp2VarPatch {.
