...
type
  AppDef_Gradient_BFGSOfTheGradient* {.importcpp: "AppDef_Gradient_BFGSOfTheGradient", header: "AppDef_Gradient_BFGSOfTheGradient.hxx",
                                      bycopy.} = object of math_BFGS


proc constructAppDef_Gradient_BFGSOfTheGradient*(
    ...
    NbIterations: Standard_Integer = 200): AppDef_Gradient_BFGSOfTheGradient {.
    constructor, importcpp: "AppDef_Gradient_BFGSOfTheGradient(@)",
    header: "AppDef_Gradient_BFGSOfTheGradient.hxx".}
proc IsSolutionReached*(this: AppDef_Gradient_BFGSOfTheGradient;
