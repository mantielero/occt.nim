...
proc constructAppParCurvesHArray1OfConstraintCouple*(theLower: int; theUpper: int): AppParCurvesHArray1OfConstraintCouple {.
    constructor, importcpp: "AppParCurves_HArray1OfConstraintCouple(@)",
    header: "AppParCurves_HArray1OfConstraintCouple.hxx".}
proc constructAppParCurvesHArray1OfConstraintCouple*(theLower: int; theUpper: int;
    theValue: ValueType): AppParCurvesHArray1OfConstraintCouple {.constructor,
    importcpp: "AppParCurves_HArray1OfConstraintCouple(@)",
    header: "AppParCurves_HArray1OfConstraintCouple.hxx".}
