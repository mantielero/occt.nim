...
type
  Aspect_TypeOfTriedronPosition* {.size: sizeof(cint),
    ...
    Aspect_TOTP_LEFT_LOWER = Aspect_TOTP_BOTTOM or Aspect_TOTP_LEFT, ## !< at the left lower corner
    Aspect_TOTP_LEFT_UPPER = Aspect_TOTP_TOP or Aspect_TOTP_LEFT, ## !< at the left upper corner
    Aspect_TOTP_RIGHT_LOWER = Aspect_TOTP_BOTTOM or Aspect_TOTP_RIGHT, ## !< at the right lower corner
    Aspect_TOTP_RIGHT_UPPER = Aspect_TOTP_TOP or Aspect_TOTP_RIGHT ## !< at the right upper corner
