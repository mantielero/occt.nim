...
proc setPnt*(this: var BOPDS_Point; thePnt: Pnt) {.importcpp: "SetPnt",
    header: "BOPDS_Point.hxx".}
proc pnt*(this: BOPDS_Point): Pnt {.noSideEffect, importcpp: "Pnt",
                                header: "BOPDS_Point.hxx".}
proc setPnt2D1*(this: var BOPDS_Point; thePnt: Pnt2d) {.importcpp: "SetPnt2D1",
    header: "BOPDS_Point.hxx".}
proc pnt2D1*(this: BOPDS_Point): Pnt2d {.noSideEffect, importcpp: "Pnt2D1",
                                     header: "BOPDS_Point.hxx".}
proc setPnt2D2*(this: var BOPDS_Point; thePnt: Pnt2d) {.importcpp: "SetPnt2D2",
    header: "BOPDS_Point.hxx".}
