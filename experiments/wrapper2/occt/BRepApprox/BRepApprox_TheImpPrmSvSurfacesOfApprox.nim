...
proc constructBRepApproxTheImpPrmSvSurfacesOfApprox*(surf1: IntSurfQuadric;
    ...
    header: "BRepApprox_TheImpPrmSvSurfacesOfApprox.hxx".}
proc compute*(this: var BRepApproxTheImpPrmSvSurfacesOfApprox; u1: var cfloat;
             v1: var cfloat; u2: var cfloat; v2: var cfloat; pt: var Pnt; tg: var Vec;
             tguv1: var Vec2d; tguv2: var Vec2d): bool {.importcpp: "Compute",
    header: "BRepApprox_TheImpPrmSvSurfacesOfApprox.hxx".}
proc pnt*(this: var BRepApproxTheImpPrmSvSurfacesOfApprox; u1: cfloat; v1: cfloat;
         u2: cfloat; v2: cfloat; p: var Pnt) {.importcpp: "Pnt", header: "BRepApprox_TheImpPrmSvSurfacesOfApprox.hxx".}
proc seekPoint*(this: var BRepApproxTheImpPrmSvSurfacesOfApprox; u1: cfloat;
...
proc tangency*(this: var BRepApproxTheImpPrmSvSurfacesOfApprox; u1: cfloat;
              v1: cfloat; u2: cfloat; v2: cfloat; tg: var Vec): bool {.
    importcpp: "Tangency", header: "BRepApprox_TheImpPrmSvSurfacesOfApprox.hxx".}
proc tangencyOnSurf1*(this: var BRepApproxTheImpPrmSvSurfacesOfApprox; u1: cfloat;
                     v1: cfloat; u2: cfloat; v2: cfloat; tg: var Vec2d): bool {.
    importcpp: "TangencyOnSurf1",
    header: "BRepApprox_TheImpPrmSvSurfacesOfApprox.hxx".}
proc tangencyOnSurf2*(this: var BRepApproxTheImpPrmSvSurfacesOfApprox; u1: cfloat;
                     v1: cfloat; u2: cfloat; v2: cfloat; tg: var Vec2d): bool {.
...
proc fillInitialVectorOfSolution*(this: var BRepApproxTheImpPrmSvSurfacesOfApprox;
                                 ...
                                 binfu: cfloat; bsupu: cfloat; binfv: cfloat;
                                 bsupv: cfloat; x: var MathVector;
                                 translationU: var cfloat; translationV: var cfloat): bool {.
