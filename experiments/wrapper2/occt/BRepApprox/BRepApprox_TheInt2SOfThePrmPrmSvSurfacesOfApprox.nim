...
proc constructBRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox*(
    ...
    tolTangency: float): BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox {.
    constructor,
    importcpp: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox(@)",
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
proc constructBRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox*(
    s1: BRepAdaptorSurface; s2: BRepAdaptorSurface; tolTangency: float): BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox {.
    constructor,
    importcpp: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox(@)",
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
...
proc perform*(this: var BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox;
    ...
    importcpp: "Perform",
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
proc isDone*(this: BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox): bool {.
    noSideEffect, importcpp: "IsDone",
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
proc isEmpty*(this: BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox): bool {.
...
proc point*(this: BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox): IntSurfPntOn2S {.
    ...
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
proc isTangent*(this: BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox): bool {.
    noSideEffect, importcpp: "IsTangent",
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
proc direction*(this: BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox): Dir {.
    noSideEffect, importcpp: "Direction",
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
proc directionOnS1*(this: BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox): Dir2d {.
    noSideEffect, importcpp: "DirectionOnS1",
    header: "BRepApprox_TheInt2SOfThePrmPrmSvSurfacesOfApprox.hxx".}
proc directionOnS2*(this: BRepApproxTheInt2SOfThePrmPrmSvSurfacesOfApprox): Dir2d {.
