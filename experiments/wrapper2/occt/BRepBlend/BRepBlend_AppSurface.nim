...
proc `new`*(this: var BRepBlendAppSurface; theSize: csize_t): pointer {.
    importcpp: "BRepBlend_AppSurface::operator new",
    header: "BRepBlend_AppSurface.hxx".}
proc `delete`*(this: var BRepBlendAppSurface; theAddress: pointer) {.
    importcpp: "BRepBlend_AppSurface::operator delete",
    header: "BRepBlend_AppSurface.hxx".}
proc `new[]`*(this: var BRepBlendAppSurface; theSize: csize_t): pointer {.
    importcpp: "BRepBlend_AppSurface::operator new[]",
    header: "BRepBlend_AppSurface.hxx".}
proc `delete[]`*(this: var BRepBlendAppSurface; theAddress: pointer) {.
    importcpp: "BRepBlend_AppSurface::operator delete[]",
    header: "BRepBlend_AppSurface.hxx".}
proc `new`*(this: var BRepBlendAppSurface; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "BRepBlend_AppSurface::operator new",
    header: "BRepBlend_AppSurface.hxx".}
proc `delete`*(this: var BRepBlendAppSurface; a2: pointer; a3: pointer) {.
    importcpp: "BRepBlend_AppSurface::operator delete",
    header: "BRepBlend_AppSurface.hxx".}
...
proc tolReached*(this: BRepBlendAppSurface; tol3d: var StandardReal;
                tol2d: var StandardReal) {.noSideEffect, importcpp: "TolReached",
                                        header: "BRepBlend_AppSurface.hxx".}
proc max2dError*(this: BRepBlendAppSurface; index: int): StandardReal {.noSideEffect,
    importcpp: "Max2dError", header: "BRepBlend_AppSurface.hxx".}
proc tolCurveOnSurf*(this: BRepBlendAppSurface; index: int): StandardReal {.
