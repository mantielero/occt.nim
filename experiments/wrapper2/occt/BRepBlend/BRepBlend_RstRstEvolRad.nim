...
proc nbVariables*(this: BRepBlendRstRstEvolRad): int {.noSideEffect,
    importcpp: "NbVariables", header: "BRepBlend_RstRstEvolRad.hxx".}
proc nbEquations*(this: BRepBlendRstRstEvolRad): int {.noSideEffect,
...
proc set*(this: var BRepBlendRstRstEvolRad; surfRef1: Handle[Adaptor3dHSurface];
    ...
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc set*(this: var BRepBlendRstRstEvolRad; param: float) {.importcpp: "Set",
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc set*(this: var BRepBlendRstRstEvolRad; first: float; last: float) {.
    importcpp: "Set", header: "BRepBlend_RstRstEvolRad.hxx".}
proc getTolerance*(this: BRepBlendRstRstEvolRad; tolerance: var MathVector; tol: float) {.
...
proc getBounds*(this: BRepBlendRstRstEvolRad; infBound: var MathVector;
               supBound: var MathVector) {.noSideEffect, importcpp: "GetBounds",
                                        header: "BRepBlend_RstRstEvolRad.hxx".}
proc isSolution*(this: var BRepBlendRstRstEvolRad; sol: MathVector; tol: float): bool {.
    importcpp: "IsSolution", header: "BRepBlend_RstRstEvolRad.hxx".}
proc getMinimalDistance*(this: BRepBlendRstRstEvolRad): float {.noSideEffect,
...
proc parameterOnRst1*(this: BRepBlendRstRstEvolRad): float {.noSideEffect,
    importcpp: "ParameterOnRst1", header: "BRepBlend_RstRstEvolRad.hxx".}
proc parameterOnRst2*(this: BRepBlendRstRstEvolRad): float {.noSideEffect,
...
proc set*(this: var BRepBlendRstRstEvolRad; choix: int) {.importcpp: "Set",
    header: "BRepBlend_RstRstEvolRad.hxx".}
...
proc section*(this: var BRepBlendRstRstEvolRad; param: float; u: float; v: float;
...
proc getSectionSize*(this: BRepBlendRstRstEvolRad): float {.noSideEffect,
...
proc nbIntervals*(this: BRepBlendRstRstEvolRad; s: GeomAbsShape): int {.noSideEffect,
...
proc intervals*(this: BRepBlendRstRstEvolRad; t: var TColStdArray1OfReal;
               s: GeomAbsShape) {.noSideEffect, importcpp: "Intervals",
                                header: "BRepBlend_RstRstEvolRad.hxx".}
proc getShape*(this: var BRepBlendRstRstEvolRad; nbPoles: var int; nbKnots: var int;
              degree: var int; nbPoles2d: var int) {.importcpp: "GetShape",
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc getTolerance*(this: BRepBlendRstRstEvolRad; boundTol: float; surfTol: float;
...
proc section*(this: var BRepBlendRstRstEvolRad; p: BlendPoint;
    ...
    header: "BRepBlend_RstRstEvolRad.hxx".}
proc resolution*(this: BRepBlendRstRstEvolRad; iC2d: int; tol: float; tolU: var float;
