...
proc constructBRepFillNSections*(s: TopToolsSequenceOfShape;
                                ...
                                p: TColStdSequenceOfReal; vf: float; vl: float;
...
proc continuity*(this: BRepFillNSections; index: int; tolAngular: float): GeomAbsShape {.
    noSideEffect, importcpp: "Continuity", header: "BRepFill_NSections.hxx".}
proc vertexTol*(this: BRepFillNSections; index: int; param: float): float {.
    noSideEffect, importcpp: "VertexTol", header: "BRepFill_NSections.hxx".}
proc vertex*(this: BRepFillNSections; index: int; param: float): TopoDS_Vertex {.
    noSideEffect, importcpp: "Vertex", header: "BRepFill_NSections.hxx".}
proc d0*(this: var BRepFillNSections; param: float; s: var TopoDS_Shape) {.
