...
proc vIntegrationOrder*(this: BRepGPropFace): cint {.noSideEffect,
...
proc getFace*(this: BRepGPropFace): TopoDS_Face {.noSideEffect, importcpp: "GetFace",
    header: "BRepGProp_Face.hxx".}
proc value2d*(this: BRepGPropFace; u: cfloat): Pnt2d {.noSideEffect,
    importcpp: "Value2d", header: "BRepGProp_Face.hxx".}
proc sIntOrder*(this: BRepGPropFace; eps: cfloat): cint {.noSideEffect,
    importcpp: "SIntOrder", header: "BRepGProp_Face.hxx".}
proc sVIntSubs*(this: BRepGPropFace): cint {.noSideEffect, importcpp: "SVIntSubs",
    header: "BRepGProp_Face.hxx".}
proc sUIntSubs*(this: BRepGPropFace): cint {.noSideEffect, importcpp: "SUIntSubs",
    header: "BRepGProp_Face.hxx".}
...
proc lIntOrder*(this: BRepGPropFace; eps: cfloat): cint {.noSideEffect,
    importcpp: "LIntOrder", header: "BRepGProp_Face.hxx".}
proc lIntSubs*(this: BRepGPropFace): cint {.noSideEffect, importcpp: "LIntSubs",
                                        header: "BRepGProp_Face.hxx".}
proc lKnots*(this: BRepGPropFace; knots: var TColStdArray1OfReal) {.noSideEffect,
    importcpp: "LKnots", header: "BRepGProp_Face.hxx".}
proc uIntegrationOrder*(this: BRepGPropFace): cint {.noSideEffect,
    importcpp: "UIntegrationOrder", header: "BRepGProp_Face.hxx".}
proc bounds*(this: BRepGPropFace; u1: var cfloat; u2: var cfloat; v1: var cfloat;
            v2: var cfloat) {.noSideEffect, importcpp: "Bounds",
                           header: "BRepGProp_Face.hxx".}
proc normal*(this: BRepGPropFace; u: cfloat; v: cfloat; p: var Pnt; vNor: var Vec) {.
...
proc load*(this: var BRepGPropFace; e: TopoDS_Edge): bool {.importcpp: "Load",
    header: "BRepGProp_Face.hxx".}
proc firstParameter*(this: BRepGPropFace): cfloat {.noSideEffect,
    importcpp: "FirstParameter", header: "BRepGProp_Face.hxx".}
proc lastParameter*(this: BRepGPropFace): cfloat {.noSideEffect,
    importcpp: "LastParameter", header: "BRepGProp_Face.hxx".}
proc integrationOrder*(this: BRepGPropFace): cint {.noSideEffect,
    importcpp: "IntegrationOrder", header: "BRepGProp_Face.hxx".}
proc d12d*(this: BRepGPropFace; u: cfloat; p: var Pnt2d; v1: var Vec2d) {.noSideEffect,
...
proc getUKnots*(this: BRepGPropFace; theUMin: cfloat; theUMax: cfloat;
               theUKnots: var Handle[TColStdHArray1OfReal]) {.noSideEffect,
    importcpp: "GetUKnots", header: "BRepGProp_Face.hxx".}
proc getTKnots*(this: BRepGPropFace; theTMin: cfloat; theTMax: cfloat;
