...
include BRepTools
include BRepTools_DataMapIteratorOfMapOfVertexPnt2d
include BRepTools_GTrsfModification
include BRepTools_History
include BRepTools_MapOfVertexPnt2d
include BRepTools_Modification
