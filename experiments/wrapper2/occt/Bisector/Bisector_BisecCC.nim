...
discard "forward decl of Bisector_BisecCC"
type
  HandleC1C1* = Handle[BisectorBisecCC]
...
proc constructBisectorBisecCC*(cu1: Handle[Geom2dCurve]; cu2: Handle[Geom2dCurve];
                              side1: cfloat; side2: cfloat; origin: Pnt2d;
                              distMax: cfloat = 500): BisectorBisecCC {.constructor,
    importcpp: "Bisector_BisecCC(@)", header: "Bisector_BisecCC.hxx".}
proc perform*(this: var BisectorBisecCC; cu1: Handle[Geom2dCurve];
             cu2: Handle[Geom2dCurve]; side1: cfloat; side2: cfloat; origin: Pnt2d;
             distMax: cfloat = 500) {.importcpp: "Perform",
...
proc reverse*(this: var BisectorBisecCC) {.importcpp: "Reverse",
                                       header: "Bisector_BisecCC.hxx".}
proc reversedParameter*(this: BisectorBisecCC; u: cfloat): cfloat {.noSideEffect,
    importcpp: "ReversedParameter", header: "Bisector_BisecCC.hxx".}
proc isCN*(this: BisectorBisecCC; n: cint): bool {.noSideEffect, importcpp: "IsCN",
    header: "Bisector_BisecCC.hxx".}
...
proc transform*(this: var BisectorBisecCC; t: Trsf2d) {.importcpp: "Transform",
    header: "Bisector_BisecCC.hxx".}
proc firstParameter*(this: BisectorBisecCC): cfloat {.noSideEffect,
    importcpp: "FirstParameter", header: "Bisector_BisecCC.hxx".}
proc lastParameter*(this: BisectorBisecCC): cfloat {.noSideEffect,
...
proc nbIntervals*(this: BisectorBisecCC): cint {.noSideEffect,
    importcpp: "NbIntervals", header: "Bisector_BisecCC.hxx".}
proc intervalFirst*(this: BisectorBisecCC; index: cint): cfloat {.noSideEffect,
    importcpp: "IntervalFirst", header: "Bisector_BisecCC.hxx".}
proc intervalLast*(this: BisectorBisecCC; index: cint): cfloat {.noSideEffect,
...
proc valueAndDist*(this: BisectorBisecCC; u: cfloat; u1: var cfloat; u2: var cfloat;
                  distance: var cfloat): Pnt2d {.noSideEffect,
    importcpp: "ValueAndDist", header: "Bisector_BisecCC.hxx".}
proc valueByInt*(this: BisectorBisecCC; u: cfloat; u1: var cfloat; u2: var cfloat;
                distance: var cfloat): Pnt2d {.noSideEffect, importcpp: "ValueByInt",
    header: "Bisector_BisecCC.hxx".}
proc d0*(this: BisectorBisecCC; u: cfloat; p: var Pnt2d) {.noSideEffect, importcpp: "D0",
    header: "Bisector_BisecCC.hxx".}
proc d1*(this: BisectorBisecCC; u: cfloat; p: var Pnt2d; v: var Vec2d) {.noSideEffect,
    importcpp: "D1", header: "Bisector_BisecCC.hxx".}
proc d2*(this: BisectorBisecCC; u: cfloat; p: var Pnt2d; v1: var Vec2d; v2: var Vec2d) {.
    noSideEffect, importcpp: "D2", header: "Bisector_BisecCC.hxx".}
proc d3*(this: BisectorBisecCC; u: cfloat; p: var Pnt2d; v1: var Vec2d; v2: var Vec2d;
        v3: var Vec2d) {.noSideEffect, importcpp: "D3", header: "Bisector_BisecCC.hxx".}
proc dn*(this: BisectorBisecCC; u: cfloat; n: cint): Vec2d {.noSideEffect,
    importcpp: "DN", header: "Bisector_BisecCC.hxx".}
proc isEmpty*(this: BisectorBisecCC): bool {.noSideEffect, importcpp: "IsEmpty",
    header: "Bisector_BisecCC.hxx".}
proc linkBisCurve*(this: BisectorBisecCC; u: cfloat): cfloat {.noSideEffect,
    importcpp: "LinkBisCurve", header: "Bisector_BisecCC.hxx".}
proc linkCurveBis*(this: BisectorBisecCC; u: cfloat): cfloat {.noSideEffect,
    importcpp: "LinkCurveBis", header: "Bisector_BisecCC.hxx".}
proc parameter*(this: BisectorBisecCC; p: Pnt2d): cfloat {.noSideEffect,
    importcpp: "Parameter", header: "Bisector_BisecCC.hxx".}
proc curve*(this: BisectorBisecCC; indCurve: cint): Handle[Geom2dCurve] {.
...
proc dump*(this: BisectorBisecCC; deep: cint = 0; offset: cint = 0) {.noSideEffect,
