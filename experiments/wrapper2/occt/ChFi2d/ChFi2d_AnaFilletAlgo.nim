...
proc constructChFi2dAnaFilletAlgo*(theWire: TopoDS_Wire; thePlane: Pln): ChFi2dAnaFilletAlgo {.
...
proc constructChFi2dAnaFilletAlgo*(theEdge1: TopoDS_Edge; theEdge2: TopoDS_Edge;
                                  thePlane: Pln): ChFi2dAnaFilletAlgo {.
    constructor, importcpp: "ChFi2d_AnaFilletAlgo(@)",
    header: "ChFi2d_AnaFilletAlgo.hxx".}
proc init*(this: var ChFi2dAnaFilletAlgo; theWire: TopoDS_Wire; thePlane: Pln) {.
...
proc init*(this: var ChFi2dAnaFilletAlgo; theEdge1: TopoDS_Edge;
    ...
    header: "ChFi2d_AnaFilletAlgo.hxx".}
proc perform*(this: var ChFi2dAnaFilletAlgo; radius: float): bool {.
