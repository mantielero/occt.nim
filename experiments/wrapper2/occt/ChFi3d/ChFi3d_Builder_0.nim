...
proc chFi3dBoite*(p1: Pnt2d; p2: Pnt2d; mu: var cfloat; mu: var cfloat; mv: var cfloat;
                 mv: var cfloat) {.importcpp: "ChFi3d_Boite(@)",
                                header: "ChFi3d_Builder_0.hxx".}
proc chFi3dBoite*(p1: Pnt2d; p2: Pnt2d; p3: Pnt2d; p4: Pnt2d; du: var cfloat;
                 dv: var cfloat; mu: var cfloat; mu: var cfloat; mv: var cfloat;
                 mv: var cfloat) {.importcpp: "ChFi3d_Boite(@)",
                                header: "ChFi3d_Builder_0.hxx".}
proc chFi3dSetPointTolerance*(dStr: var TopOpeBRepDS_DataStructure; box: BndBox;
                             ip: cint) {.importcpp: "ChFi3d_SetPointTolerance(@)",
                                       header: "ChFi3d_Builder_0.hxx".}
...
proc chFi3dEnlargeBox*(s: Handle[Adaptor3dHSurface]; pc: Handle[Geom2dCurve];
                      wd: cfloat; wf: cfloat; box1: var BndBox; box2: var BndBox) {.
...
proc chFi3dKParticular*(spine: Handle[ChFiDS_Spine]; ie: cint;
                       s1: BRepAdaptorSurface; s2: BRepAdaptorSurface): bool {.
...
proc chFi3dExtrSpineCarac*(dStr: TopOpeBRepDS_DataStructure;
                          ...
                          sens: cint; p: var Pnt; v: var Vec; r: var cfloat) {.
...
proc chFi3dSameParameter*(c3d: Handle[GeomCurve]; pcurv: var Handle[Geom2dCurve];
                         ...
                         tol3d: cfloat; tolreached: var cfloat): bool {.
    importcpp: "ChFi3d_SameParameter(@)", header: "ChFi3d_Builder_0.hxx".}
proc chFi3dComputePCurv*(c3d: Handle[GeomCurve]; uv1: Pnt2d; uv2: Pnt2d;
                        ...
                        tolreached: var cfloat; reverse: bool = false) {.
...
proc chFi3dComputePCurv*(uv1: Pnt2d; uv2: Pnt2d; pcurv: var Handle[Geom2dCurve];
                        pardeb: cfloat; parfin: cfloat; reverse: bool = false) {.
    importcpp: "ChFi3d_ComputePCurv(@)", header: "ChFi3d_Builder_0.hxx".}
proc chFi3dIntTraces*(fd1: Handle[ChFiDS_SurfData]; pref1: cfloat; p1: var cfloat;
                     ...
                     enlarge: bool = false): bool {.importcpp: "ChFi3d_IntTraces(@)",
    header: "ChFi3d_Builder_0.hxx".}
...
proc chFi3dComputeArete*(p1: ChFiDS_CommonPoint; uv1: Pnt2d; p2: ChFiDS_CommonPoint;
                        ...
                        tol2d: cfloat; tolreached: var cfloat; iFlag: cint) {.
...
proc chFi3dComputeCurves*(s1: Handle[Adaptor3dHSurface];
                         ...
                         tolreached: var cfloat; wholeCurv: bool = true): bool {.
...
proc chFi3dIntCS*(s: Handle[Adaptor3dHSurface]; c: Handle[Adaptor3dHCurve];
                 p2dS: var Pnt2d; wc: var cfloat): bool {.importcpp: "ChFi3d_IntCS(@)",
    header: "ChFi3d_Builder_0.hxx".}
proc chFi3dComputesIntPC*(fi1: ChFiDS_FaceInterference;
                         ...
                         uInt2: var cfloat) {.importcpp: "ChFi3d_ComputesIntPC(@)",
    header: "ChFi3d_Builder_0.hxx".}
proc chFi3dComputesIntPC*(fi1: ChFiDS_FaceInterference;
                         fi2: ChFiDS_FaceInterference;
                         hs1: Handle[GeomAdaptorHSurface];
                         hs2: Handle[GeomAdaptorHSurface]; uInt1: var cfloat;
                         uInt2: var cfloat; p: var Pnt) {.
...
proc chFi3dSearchFD*(dStr: var TopOpeBRepDS_DataStructure;
                    ...
                    sameside: var bool; jf1: var cint; jf2: var cint): bool {.
...
proc chFi3dNbface*(mapVF: TopToolsListOfShape): cint {.
...
proc chFi3dNumberOfEdges*(vtx: TopoDS_Vertex; vEMap: ChFiDS_Map): cint {.
