...
proc constructContapThePathPointOfTheSearch*(): ContapThePathPointOfTheSearch {.
    ...
    header: "Contap_ThePathPointOfTheSearch.hxx".}
proc constructContapThePathPointOfTheSearch*(p: Pnt; tol: float;
    v: Handle[Adaptor3dHVertex]; a: Handle[Adaptor2dHCurve2d]; parameter: float): ContapThePathPointOfTheSearch {.
    constructor, importcpp: "Contap_ThePathPointOfTheSearch(@)",
    header: "Contap_ThePathPointOfTheSearch.hxx".}
proc constructContapThePathPointOfTheSearch*(p: Pnt; tol: float;
    a: Handle[Adaptor2dHCurve2d]; parameter: float): ContapThePathPointOfTheSearch {.
    constructor, importcpp: "Contap_ThePathPointOfTheSearch(@)",
    header: "Contap_ThePathPointOfTheSearch.hxx".}
proc setValue*(this: var ContapThePathPointOfTheSearch; p: Pnt; tol: float;
              v: Handle[Adaptor3dHVertex]; a: Handle[Adaptor2dHCurve2d];
              parameter: float) {.importcpp: "SetValue",
                                header: "Contap_ThePathPointOfTheSearch.hxx".}
proc setValue*(this: var ContapThePathPointOfTheSearch; p: Pnt; tol: float;
