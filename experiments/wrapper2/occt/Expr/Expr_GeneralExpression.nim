...
proc containsUnknowns*(this: ExprGeneralExpression): bool {.noSideEffect,
    importcpp: "ContainsUnknowns", header: "Expr_GeneralExpression.hxx".}
proc contains*(this: ExprGeneralExpression; exp: Handle[ExprGeneralExpression]): bool {.
    noSideEffect, importcpp: "Contains", header: "Expr_GeneralExpression.hxx".}
proc isLinear*(this: ExprGeneralExpression): bool {.noSideEffect,
    importcpp: "IsLinear", header: "Expr_GeneralExpression.hxx".}
proc isShareable*(this: ExprGeneralExpression): bool {.noSideEffect,
    importcpp: "IsShareable", header: "Expr_GeneralExpression.hxx".}
proc isIdentical*(this: ExprGeneralExpression; other: Handle[ExprGeneralExpression]): bool {.
