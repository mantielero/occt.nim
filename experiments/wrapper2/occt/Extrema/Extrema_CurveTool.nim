...
proc firstParameter*(c: Adaptor3dCurve): float {.
    importcpp: "Extrema_CurveTool::FirstParameter(@)",
    header: "Extrema_CurveTool.hxx".}
proc lastParameter*(c: Adaptor3dCurve): float {.
...
proc nbIntervals*(c: var Adaptor3dCurve; s: GeomAbsShape): int {.
...
proc isPeriodic*(c: Adaptor3dCurve): bool {.importcpp: "Extrema_CurveTool::IsPeriodic(@)",
                                        header: "Extrema_CurveTool.hxx".}
proc period*(c: Adaptor3dCurve): float {.importcpp: "Extrema_CurveTool::Period(@)",
                                     header: "Extrema_CurveTool.hxx".}
proc resolution*(c: Adaptor3dCurve; r3d: float): float {.
...
proc value*(c: Adaptor3dCurve; u: float): Pnt {.
    importcpp: "Extrema_CurveTool::Value(@)", header: "Extrema_CurveTool.hxx".}
proc d0*(c: Adaptor3dCurve; u: float; p: var Pnt) {.
    importcpp: "Extrema_CurveTool::D0(@)", header: "Extrema_CurveTool.hxx".}
proc d1*(c: Adaptor3dCurve; u: float; p: var Pnt; v: var Vec) {.
    importcpp: "Extrema_CurveTool::D1(@)", header: "Extrema_CurveTool.hxx".}
proc d2*(c: Adaptor3dCurve; u: float; p: var Pnt; v1: var Vec; v2: var Vec) {.
    importcpp: "Extrema_CurveTool::D2(@)", header: "Extrema_CurveTool.hxx".}
proc d3*(c: Adaptor3dCurve; u: float; p: var Pnt; v1: var Vec; v2: var Vec; v3: var Vec) {.
    importcpp: "Extrema_CurveTool::D3(@)", header: "Extrema_CurveTool.hxx".}
proc dn*(c: Adaptor3dCurve; u: float; n: int): Vec {.
...
proc parabola*(c: Adaptor3dCurve): Parab {.importcpp: "Extrema_CurveTool::Parabola(@)",
                                       header: "Extrema_CurveTool.hxx".}
proc degree*(c: Adaptor3dCurve): int {.importcpp: "Extrema_CurveTool::Degree(@)",
                                   header: "Extrema_CurveTool.hxx".}
proc isRational*(c: Adaptor3dCurve): bool {.importcpp: "Extrema_CurveTool::IsRational(@)",
                                        header: "Extrema_CurveTool.hxx".}
proc nbPoles*(c: Adaptor3dCurve): int {.importcpp: "Extrema_CurveTool::NbPoles(@)",
                                    header: "Extrema_CurveTool.hxx".}
proc nbKnots*(c: Adaptor3dCurve): int {.importcpp: "Extrema_CurveTool::NbKnots(@)",
                                    header: "Extrema_CurveTool.hxx".}
