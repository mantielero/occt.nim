...
proc constructExtremaExtCC2d*(c1: Adaptor2dCurve2d; c2: Adaptor2dCurve2d; u1: cfloat;
                             u2: cfloat; v1: cfloat; v2: cfloat;
                             tolC1: cfloat = 1.0e-10; tolC2: cfloat = 1.0e-10): ExtremaExtCC2d {.
    constructor, importcpp: "Extrema_ExtCC2d(@)", header: "Extrema_ExtCC2d.hxx".}
proc initialize*(this: var ExtremaExtCC2d; c2: Adaptor2dCurve2d; v1: cfloat; v2: cfloat;
                tolC1: cfloat = 1.0e-10; tolC2: cfloat = 1.0e-10) {.
...
proc nbExt*(this: ExtremaExtCC2d): cint {.noSideEffect, importcpp: "NbExt",
                                      header: "Extrema_ExtCC2d.hxx".}
proc isParallel*(this: ExtremaExtCC2d): bool {.noSideEffect, importcpp: "IsParallel",
    header: "Extrema_ExtCC2d.hxx".}
proc squareDistance*(this: ExtremaExtCC2d; n: cint = 1): cfloat {.noSideEffect,
