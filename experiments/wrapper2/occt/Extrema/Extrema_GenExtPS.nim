...
proc constructExtremaGenExtPS*(p: Pnt; s: Adaptor3dSurface; nbU: int; nbV: int;
                              tolU: float; tolV: float;
...
proc constructExtremaGenExtPS*(p: Pnt; s: Adaptor3dSurface; nbU: int; nbV: int;
                              ...
                              a: ExtremaExtAlgo = extremaExtAlgoGrad): ExtremaGenExtPS {.
    constructor, importcpp: "Extrema_GenExtPS(@)", header: "Extrema_GenExtPS.hxx".}
proc initialize*(this: var ExtremaGenExtPS; s: Adaptor3dSurface; nbU: int; nbV: int;
                tolU: float; tolV: float) {.importcpp: "Initialize",
                                        header: "Extrema_GenExtPS.hxx".}
proc initialize*(this: var ExtremaGenExtPS; s: Adaptor3dSurface; nbU: int; nbV: int;
                umin: float; usup: float; vmin: float; vsup: float; tolU: float;
                tolV: float) {.importcpp: "Initialize",
                             header: "Extrema_GenExtPS.hxx".}
...
proc isDone*(this: ExtremaGenExtPS): bool {.noSideEffect, importcpp: "IsDone",
                                        header: "Extrema_GenExtPS.hxx".}
proc nbExt*(this: ExtremaGenExtPS): int {.noSideEffect, importcpp: "NbExt",
                                      header: "Extrema_GenExtPS.hxx".}
proc squareDistance*(this: ExtremaGenExtPS; n: int): float {.noSideEffect,
    importcpp: "SquareDistance", header: "Extrema_GenExtPS.hxx".}
proc point*(this: ExtremaGenExtPS; n: int): ExtremaPOnSurf {.noSideEffect,
