...
proc value*(this: var ExtremaPCFOfEPCOfELPCOfLocateExtPC; u: float; f: var float): bool {.
    importcpp: "Value", header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc derivative*(this: var ExtremaPCFOfEPCOfELPCOfLocateExtPC; u: float; df: var float): bool {.
    importcpp: "Derivative", header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc values*(this: var ExtremaPCFOfEPCOfELPCOfLocateExtPC; u: float; f: var float;
            df: var float): bool {.importcpp: "Values", header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc getStateNumber*(this: var ExtremaPCFOfEPCOfELPCOfLocateExtPC): int {.
    importcpp: "GetStateNumber", header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc nbExt*(this: ExtremaPCFOfEPCOfELPCOfLocateExtPC): int {.noSideEffect,
    importcpp: "NbExt", header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc squareDistance*(this: ExtremaPCFOfEPCOfELPCOfLocateExtPC; n: int): float {.
    noSideEffect, importcpp: "SquareDistance",
    header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc isMin*(this: ExtremaPCFOfEPCOfELPCOfLocateExtPC; n: int): bool {.noSideEffect,
    importcpp: "IsMin", header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc point*(this: ExtremaPCFOfEPCOfELPCOfLocateExtPC; n: int): ExtremaPOnCurv {.
...
proc subIntervalInitialize*(this: var ExtremaPCFOfEPCOfELPCOfLocateExtPC;
    ...
    header: "Extrema_PCFOfEPCOfELPCOfLocateExtPC.hxx".}
proc searchOfTolerance*(this: var ExtremaPCFOfEPCOfELPCOfLocateExtPC): float {.
