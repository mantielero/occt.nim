...
#[ proc constructGeomBSplineSurface*(poles: TColgpArray2OfPnt;
                                 ...
                                 vDegree: int; uPeriodic: StandardBoolean = false;
                                 vPeriodic: StandardBoolean = false): GeomBSplineSurface {.
...
#[ proc insertUKnots*(this: var GeomBSplineSurface; knots: TColStdArray1OfReal;
                  ...
                  add: StandardBoolean = true) {.importcpp: "InsertUKnots",
    header: "Geom_BSplineSurface.hxx".}
proc insertVKnots*(this: var GeomBSplineSurface; knots: TColStdArray1OfReal;
                  mults: TColStdArray1OfInteger;
                  parametricTolerance: StandardReal = 0.0;
                  add: StandardBoolean = true) {.importcpp: "InsertVKnots",
    header: "Geom_BSplineSurface.hxx".}
proc removeUKnot*(this: var GeomBSplineSurface; index: int; m: int;
                 tolerance: StandardReal): StandardBoolean {.
    importcpp: "RemoveUKnot", header: "Geom_BSplineSurface.hxx".}
proc removeVKnot*(this: var GeomBSplineSurface; index: int; m: int;
                 tolerance: StandardReal): StandardBoolean {.
...
proc incrementVMultiplicity*(this: var GeomBSplineSurface; fromI1: int; toI2: int;
                            step: int) {.importcpp: "IncrementVMultiplicity",
                                       header: "Geom_BSplineSurface.hxx".}
proc insertUKnot*(this: var GeomBSplineSurface; u: StandardReal; m: int;
                 parametricTolerance: StandardReal; add: StandardBoolean = true) {.
    importcpp: "InsertUKnot", header: "Geom_BSplineSurface.hxx".}
proc insertVKnot*(this: var GeomBSplineSurface; v: StandardReal; m: int;
                 parametricTolerance: StandardReal; add: StandardBoolean = true) {.
...
proc setUKnot*(this: var GeomBSplineSurface; uIndex: int; k: StandardReal) {.
...
proc setUKnot*(this: var GeomBSplineSurface; uIndex: int; k: StandardReal; m: int) {.
    importcpp: "SetUKnot", header: "Geom_BSplineSurface.hxx".}
proc setVKnot*(this: var GeomBSplineSurface; vIndex: int; k: StandardReal) {.
...
proc setVKnot*(this: var GeomBSplineSurface; vIndex: int; k: StandardReal; m: int) {.
    importcpp: "SetVKnot", header: "Geom_BSplineSurface.hxx".}
...
proc setWeight*(this: var GeomBSplineSurface; uIndex: int; vIndex: int;
...
proc setWeightRow*(this: var GeomBSplineSurface; uIndex: int;
    ...
    header: "Geom_BSplineSurface.hxx".}
proc movePoint*(this: var GeomBSplineSurface; u: StandardReal; v: StandardReal; p: Pnt;
               uIndex1: int; uIndex2: int; vIndex1: int; vIndex2: int;
               uFirstIndex: var int; uLastIndex: var int; vFirstIndex: var int;
               vLastIndex: var int) {.importcpp: "MovePoint",
                                   header: "Geom_BSplineSurface.hxx".}
...
proc isCNu*(this: GeomBSplineSurface; n: int): StandardBoolean {.noSideEffect,
    importcpp: "IsCNu", header: "Geom_BSplineSurface.hxx".}
proc isCNv*(this: GeomBSplineSurface; n: int): StandardBoolean {.noSideEffect,
...
proc uDegree*(this: GeomBSplineSurface): int {.noSideEffect, importcpp: "UDegree",
    header: "Geom_BSplineSurface.hxx".}
proc uKnot*(this: GeomBSplineSurface; uIndex: int): StandardReal {.noSideEffect,
...
proc vDegree*(this: GeomBSplineSurface): int {.noSideEffect, importcpp: "VDegree",
    header: "Geom_BSplineSurface.hxx".}
proc vKnot*(this: GeomBSplineSurface; vIndex: int): StandardReal {.noSideEffect,
...
proc vMultiplicities*(this: GeomBSplineSurface): TColStdArray1OfInteger {.
    noSideEffect, importcpp: "VMultiplicities", header: "Geom_BSplineSurface.hxx".}
proc weight*(this: GeomBSplineSurface; uIndex: int; vIndex: int): StandardReal {.
    noSideEffect, importcpp: "Weight", header: "Geom_BSplineSurface.hxx".}
...
proc weights*(this: GeomBSplineSurface): ptr TColStdArray2OfReal {.noSideEffect,
    importcpp: "Weights", header: "Geom_BSplineSurface.hxx".}
proc d0*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; p: var Pnt) {.
    noSideEffect, importcpp: "D0", header: "Geom_BSplineSurface.hxx".}
proc d1*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; p: var Pnt;
        d1u: var Vec; d1v: var Vec) {.noSideEffect, importcpp: "D1",
                                header: "Geom_BSplineSurface.hxx".}
proc d2*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; p: var Pnt;
        d1u: var Vec; d1v: var Vec; d2u: var Vec; d2v: var Vec; d2uv: var Vec) {.noSideEffect,
    importcpp: "D2", header: "Geom_BSplineSurface.hxx".}
proc d3*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; p: var Pnt;
    ...
    header: "Geom_BSplineSurface.hxx".}
proc dn*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; nu: int; nv: int): Vec {.
    noSideEffect, importcpp: "DN", header: "Geom_BSplineSurface.hxx".}
proc localD0*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; fromUK1: int;
             toUK2: int; fromVK1: int; toVK2: int; p: var Pnt) {.noSideEffect,
    importcpp: "LocalD0", header: "Geom_BSplineSurface.hxx".}
proc localD1*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; fromUK1: int;
             toUK2: int; fromVK1: int; toVK2: int; p: var Pnt; d1u: var Vec; d1v: var Vec) {.
    noSideEffect, importcpp: "LocalD1", header: "Geom_BSplineSurface.hxx".}
proc localD2*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; fromUK1: int;
             toUK2: int; fromVK1: int; toVK2: int; p: var Pnt; d1u: var Vec; d1v: var Vec;
             d2u: var Vec; d2v: var Vec; d2uv: var Vec) {.noSideEffect,
    importcpp: "LocalD2", header: "Geom_BSplineSurface.hxx".}
proc localD3*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; fromUK1: int;
             toUK2: int; fromVK1: int; toVK2: int; p: var Pnt; d1u: var Vec; d1v: var Vec;
             d2u: var Vec; d2v: var Vec; d2uv: var Vec; d3u: var Vec; d3v: var Vec;
             d3uuv: var Vec; d3uvv: var Vec) {.noSideEffect, importcpp: "LocalD3",
    header: "Geom_BSplineSurface.hxx".}
proc localDN*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal; fromUK1: int;
             toUK2: int; fromVK1: int; toVK2: int; nu: int; nv: int): Vec {.noSideEffect,
    importcpp: "LocalDN", header: "Geom_BSplineSurface.hxx".}
proc localValue*(this: GeomBSplineSurface; u: StandardReal; v: StandardReal;
                fromUK1: int; toUK2: int; fromVK1: int; toVK2: int): Pnt {.noSideEffect,
