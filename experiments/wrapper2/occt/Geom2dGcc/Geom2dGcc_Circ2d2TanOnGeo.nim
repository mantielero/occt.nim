...
proc constructGeom2dGccCirc2d2TanOnGeo*(qualified1: GccEntQualifiedCirc;
                                       ...
                                       tolerance: float): Geom2dGccCirc2d2TanOnGeo {.
...
proc constructGeom2dGccCirc2d2TanOnGeo*(point1: Pnt2d; point2: Pnt2d;
    ...
    constructor, importcpp: "Geom2dGcc_Circ2d2TanOnGeo(@)",
    header: "Geom2dGcc_Circ2d2TanOnGeo.hxx".}
proc isDone*(this: Geom2dGccCirc2d2TanOnGeo): bool {.noSideEffect,
...
proc whichQualifier*(this: Geom2dGccCirc2d2TanOnGeo; index: int;
    ...
    header: "Geom2dGcc_Circ2d2TanOnGeo.hxx".}
proc tangency1*(this: Geom2dGccCirc2d2TanOnGeo; index: int; parSol: var float;
               parArg: var float; pntSol: var Pnt2d) {.noSideEffect,
    importcpp: "Tangency1", header: "Geom2dGcc_Circ2d2TanOnGeo.hxx".}
proc tangency2*(this: Geom2dGccCirc2d2TanOnGeo; index: int; parSol: var float;
               parArg: var float; pntSol: var Pnt2d) {.noSideEffect,
    importcpp: "Tangency2", header: "Geom2dGcc_Circ2d2TanOnGeo.hxx".}
proc centerOn3*(this: Geom2dGccCirc2d2TanOnGeo; index: int; parArg: var float;
               pntSol: var Pnt2d) {.noSideEffect, importcpp: "CenterOn3",
                                 header: "Geom2dGcc_Circ2d2TanOnGeo.hxx".}
proc isTheSame1*(this: Geom2dGccCirc2d2TanOnGeo; index: int): bool {.noSideEffect,
    importcpp: "IsTheSame1", header: "Geom2dGcc_Circ2d2TanOnGeo.hxx".}
proc isTheSame2*(this: Geom2dGccCirc2d2TanOnGeo; index: int): bool {.noSideEffect,
    importcpp: "IsTheSame2", header: "Geom2dGcc_Circ2d2TanOnGeo.hxx".}
