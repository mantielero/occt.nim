...
proc constructGeom2dGccCirc2d3Tan*(qualified1: Geom2dGccQualifiedCurve;
                                  ...
                                  tolerance: float; param1: float; param2: float;
                                  param3: float): Geom2dGccCirc2d3Tan {.
    constructor, importcpp: "Geom2dGcc_Circ2d3Tan(@)",
    header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc constructGeom2dGccCirc2d3Tan*(qualified1: Geom2dGccQualifiedCurve;
                                  qualified2: Geom2dGccQualifiedCurve;
                                  point: Handle[Geom2dPoint]; tolerance: float;
                                  param1: float; param2: float): Geom2dGccCirc2d3Tan {.
    constructor, importcpp: "Geom2dGcc_Circ2d3Tan(@)",
    header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc constructGeom2dGccCirc2d3Tan*(qualified1: Geom2dGccQualifiedCurve;
                                  point1: Handle[Geom2dPoint];
                                  point2: Handle[Geom2dPoint]; tolerance: float;
                                  param1: float): Geom2dGccCirc2d3Tan {.
    constructor, importcpp: "Geom2dGcc_Circ2d3Tan(@)",
    header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc constructGeom2dGccCirc2d3Tan*(point1: Handle[Geom2dPoint];
                                  point2: Handle[Geom2dPoint];
                                  point3: Handle[Geom2dPoint]; tolerance: float): Geom2dGccCirc2d3Tan {.
    constructor, importcpp: "Geom2dGcc_Circ2d3Tan(@)",
    header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc results*(this: var Geom2dGccCirc2d3Tan; circ: GccAnaCirc2d3Tan; rank1: int;
             rank2: int; rank3: int) {.importcpp: "Results",
                                   header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc isDone*(this: Geom2dGccCirc2d3Tan): bool {.noSideEffect, importcpp: "IsDone",
    header: "Geom2dGcc_Circ2d3Tan.hxx".}
...
proc tangency1*(this: Geom2dGccCirc2d3Tan; index: int; parSol: var float;
               parArg: var float; pntSol: var Pnt2d) {.noSideEffect,
    importcpp: "Tangency1", header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc tangency2*(this: Geom2dGccCirc2d3Tan; index: int; parSol: var float;
               parArg: var float; pntSol: var Pnt2d) {.noSideEffect,
    importcpp: "Tangency2", header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc tangency3*(this: Geom2dGccCirc2d3Tan; index: int; parSol: var float;
               parArg: var float; pntSol: var Pnt2d) {.noSideEffect,
    importcpp: "Tangency3", header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc isTheSame1*(this: Geom2dGccCirc2d3Tan; index: int): bool {.noSideEffect,
    importcpp: "IsTheSame1", header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc isTheSame2*(this: Geom2dGccCirc2d3Tan; index: int): bool {.noSideEffect,
    importcpp: "IsTheSame2", header: "Geom2dGcc_Circ2d3Tan.hxx".}
proc isTheSame3*(this: Geom2dGccCirc2d3Tan; index: int): bool {.noSideEffect,
    importcpp: "IsTheSame3", header: "Geom2dGcc_Circ2d3Tan.hxx".}
