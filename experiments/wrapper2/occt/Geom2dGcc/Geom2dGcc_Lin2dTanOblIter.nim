...
proc constructGeom2dGccLin2dTanOblIter*(qualified1: Geom2dGccQCurve; theLin: Lin2d;
                                       param1: float; tolAng: float;
                                       angle: float = 0): Geom2dGccLin2dTanOblIter {.
    constructor, importcpp: "Geom2dGcc_Lin2dTanOblIter(@)",
    header: "Geom2dGcc_Lin2dTanOblIter.hxx".}
proc isDone*(this: Geom2dGccLin2dTanOblIter): bool {.noSideEffect,
...
proc whichQualifier*(this: Geom2dGccLin2dTanOblIter; qualif1: var GccEntPosition) {.
    ...
    header: "Geom2dGcc_Lin2dTanOblIter.hxx".}
proc tangency1*(this: Geom2dGccLin2dTanOblIter; parSol: var float; parArg: var float;
               pntSol: var Pnt2d) {.noSideEffect, importcpp: "Tangency1",
                                 header: "Geom2dGcc_Lin2dTanOblIter.hxx".}
proc intersection2*(this: Geom2dGccLin2dTanOblIter; parSol: var float;
                   parArg: var float; pntSol: var Pnt2d) {.noSideEffect,
    importcpp: "Intersection2", header: "Geom2dGcc_Lin2dTanOblIter.hxx".}
proc isParallel2*(this: Geom2dGccLin2dTanOblIter): bool {.noSideEffect,
