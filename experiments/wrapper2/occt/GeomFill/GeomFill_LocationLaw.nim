...
discard "forward decl of GeomFill_LocationLaw"
type
  HandleC1C1* = Handle[GeomFillLocationLaw]
...
proc d0*(this: var GeomFillLocationLaw; param: StandardReal; m: var Mat; v: var Vec): StandardBoolean {.
    importcpp: "D0", header: "GeomFill_LocationLaw.hxx".}
proc d0*(this: var GeomFillLocationLaw; param: StandardReal; m: var Mat; v: var Vec;
        poles2d: var TColgpArray1OfPnt2d): StandardBoolean {.importcpp: "D0",
    header: "GeomFill_LocationLaw.hxx".}
proc d1*(this: var GeomFillLocationLaw; param: StandardReal; m: var Mat; v: var Vec;
        dm: var Mat; dv: var Vec; poles2d: var TColgpArray1OfPnt2d;
        dPoles2d: var TColgpArray1OfVec2d): StandardBoolean {.importcpp: "D1",
    header: "GeomFill_LocationLaw.hxx".}
proc d2*(this: var GeomFillLocationLaw; param: StandardReal; m: var Mat; v: var Vec;
...
proc getDomain*(this: GeomFillLocationLaw; first: var StandardReal;
               last: var StandardReal) {.noSideEffect, importcpp: "GetDomain",
                                      header: "GeomFill_LocationLaw.hxx".}
proc resolution*(this: GeomFillLocationLaw; index: int; tol: StandardReal;
                tolU: var StandardReal; tolV: var StandardReal) {.noSideEffect,
    importcpp: "Resolution", header: "GeomFill_LocationLaw.hxx".}
