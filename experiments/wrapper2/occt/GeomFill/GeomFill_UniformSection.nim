...
proc constructGeomFillUniformSection*(c: Handle[GeomCurve];
                                     firstParameter: float = 0.0;
                                     lastParameter: float = 1.0): GeomFillUniformSection {.
    constructor, importcpp: "GeomFill_UniformSection(@)",
    header: "GeomFill_UniformSection.hxx".}
proc d0*(this: var GeomFillUniformSection; param: float; poles: var TColgpArray1OfPnt;
        weigths: var TColStdArray1OfReal): bool {.importcpp: "D0",
    header: "GeomFill_UniformSection.hxx".}
proc d1*(this: var GeomFillUniformSection; param: float; poles: var TColgpArray1OfPnt;
        dPoles: var TColgpArray1OfVec; weigths: var TColStdArray1OfReal;
        dWeigths: var TColStdArray1OfReal): bool {.importcpp: "D1",
    header: "GeomFill_UniformSection.hxx".}
proc d2*(this: var GeomFillUniformSection; param: float; poles: var TColgpArray1OfPnt;
...
proc bSplineSurface*(this: GeomFillUniformSection): Handle[GeomBSplineSurface] {.
    ...
    header: "GeomFill_UniformSection.hxx".}
proc sectionShape*(this: GeomFillUniformSection; nbPoles: var int; nbKnots: var int;
...
proc isRational*(this: GeomFillUniformSection): bool {.noSideEffect,
    importcpp: "IsRational", header: "GeomFill_UniformSection.hxx".}
proc isUPeriodic*(this: GeomFillUniformSection): bool {.noSideEffect,
    importcpp: "IsUPeriodic", header: "GeomFill_UniformSection.hxx".}
proc isVPeriodic*(this: GeomFillUniformSection): bool {.noSideEffect,
    importcpp: "IsVPeriodic", header: "GeomFill_UniformSection.hxx".}
proc nbIntervals*(this: GeomFillUniformSection; s: GeomAbsShape): int {.noSideEffect,
    importcpp: "NbIntervals", header: "GeomFill_UniformSection.hxx".}
proc intervals*(this: GeomFillUniformSection; t: var TColStdArray1OfReal;
               s: GeomAbsShape) {.noSideEffect, importcpp: "Intervals",
                                header: "GeomFill_UniformSection.hxx".}
proc setInterval*(this: var GeomFillUniformSection; first: float; last: float) {.
    importcpp: "SetInterval", header: "GeomFill_UniformSection.hxx".}
proc getInterval*(this: GeomFillUniformSection; first: var float; last: var float) {.
    noSideEffect, importcpp: "GetInterval", header: "GeomFill_UniformSection.hxx".}
proc getDomain*(this: GeomFillUniformSection; first: var float; last: var float) {.
    noSideEffect, importcpp: "GetDomain", header: "GeomFill_UniformSection.hxx".}
proc getTolerance*(this: GeomFillUniformSection; boundTol: float; surfTol: float;
                  angleTol: float; tol3d: var TColStdArray1OfReal) {.noSideEffect,
    importcpp: "GetTolerance", header: "GeomFill_UniformSection.hxx".}
proc barycentreOfSurf*(this: GeomFillUniformSection): Pnt {.noSideEffect,
    importcpp: "BarycentreOfSurf", header: "GeomFill_UniformSection.hxx".}
proc maximalSection*(this: GeomFillUniformSection): float {.noSideEffect,
...
proc isConstant*(this: GeomFillUniformSection; error: var float): bool {.noSideEffect,
    importcpp: "IsConstant", header: "GeomFill_UniformSection.hxx".}
