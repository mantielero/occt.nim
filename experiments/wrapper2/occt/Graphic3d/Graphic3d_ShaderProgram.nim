...
proc destroyGraphic3dShaderProgram*(this: var Graphic3dShaderProgram) {.
    ...
    header: "Graphic3d_ShaderProgram.hxx".}
proc isDone*(this: Graphic3dShaderProgram): bool {.noSideEffect, importcpp: "IsDone",
    header: "Graphic3d_ShaderProgram.hxx".}
...
proc setAlphaTest*(this: var Graphic3dShaderProgram; theAlphaTest: bool) {.
    importcpp: "SetAlphaTest", header: "Graphic3d_ShaderProgram.hxx".}
proc hasDefaultSampler*(this: Graphic3dShaderProgram): bool {.noSideEffect,
...
proc hasWeightOitOutput*(this: Graphic3dShaderProgram): bool {.noSideEffect,
    importcpp: "HasWeightOitOutput", header: "Graphic3d_ShaderProgram.hxx".}
proc setWeightOitOutput*(this: var Graphic3dShaderProgram; theOutput: bool) {.
    importcpp: "SetWeightOitOutput", header: "Graphic3d_ShaderProgram.hxx".}
proc isPBR*(this: Graphic3dShaderProgram): bool {.noSideEffect, importcpp: "IsPBR",
    header: "Graphic3d_ShaderProgram.hxx".}
...
proc pushVariableInt*(this: var Graphic3dShaderProgram;
                     theName: TCollectionAsciiString; theValue: cint): bool {.
