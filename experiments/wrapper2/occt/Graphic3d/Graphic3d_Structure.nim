...
proc constructGraphic3dStructure*(theManager: Handle[Graphic3dStructureManager];
    ...
    header: "Graphic3d_Structure.hxx".}
proc clear*(this: var Graphic3dStructure; withDestruction: bool = true) {.
...
proc display*(this: var Graphic3dStructure) {.importcpp: "Display",
    header: "Graphic3d_Structure.hxx".}
proc displayPriority*(this: Graphic3dStructure): int {.noSideEffect,
...
proc highlight*(this: var Graphic3dStructure;
               ...
               theToUpdateMgr: bool = true) {.importcpp: "Highlight",
    header: "Graphic3d_Structure.hxx".}
...
proc setInfiniteState*(this: var Graphic3dStructure; theToSet: bool) {.
    importcpp: "SetInfiniteState", header: "Graphic3d_Structure.hxx".}
proc setDisplayPriority*(this: var Graphic3dStructure; priority: int) {.
...
proc setVisible*(this: var Graphic3dStructure; aValue: bool) {.
...
proc setZoomLimit*(this: var Graphic3dStructure; limitInf: float; limitSup: float) {.
    importcpp: "SetZoomLimit", header: "Graphic3d_Structure.hxx".}
proc setIsForHighlight*(this: var Graphic3dStructure; isForHighlight: bool) {.
...
proc containsFacet*(this: Graphic3dStructure): bool {.noSideEffect,
...
proc numberOfGroups*(this: Graphic3dStructure): int {.noSideEffect,
...
proc highlightStyle*(this: Graphic3dStructure): Handle[
    Graphic3dPresentationAttributes] {.noSideEffect, importcpp: "HighlightStyle",
                                      header: "Graphic3d_Structure.hxx".}
proc isDeleted*(this: Graphic3dStructure): bool {.noSideEffect,
    importcpp: "IsDeleted", header: "Graphic3d_Structure.hxx".}
proc isDisplayed*(this: Graphic3dStructure): bool {.noSideEffect,
    importcpp: "IsDisplayed", header: "Graphic3d_Structure.hxx".}
proc isEmpty*(this: Graphic3dStructure): bool {.noSideEffect, importcpp: "IsEmpty",
    header: "Graphic3d_Structure.hxx".}
proc isInfinite*(this: Graphic3dStructure): bool {.noSideEffect,
    importcpp: "IsInfinite", header: "Graphic3d_Structure.hxx".}
proc isHighlighted*(this: Graphic3dStructure): bool {.noSideEffect,
    importcpp: "IsHighlighted", header: "Graphic3d_Structure.hxx".}
proc isTransformed*(this: Graphic3dStructure): bool {.noSideEffect,
    importcpp: "IsTransformed", header: "Graphic3d_Structure.hxx".}
proc isVisible*(this: Graphic3dStructure): bool {.noSideEffect,
...
proc acceptConnection*(theStructure1: ptr Graphic3dStructure;
                      ...
                      theType: Graphic3dTypeOfConnection): bool {.
...
proc connect*(this: var Graphic3dStructure; theStructure: ptr Graphic3dStructure;
             theType: Graphic3dTypeOfConnection; theWithCheck: bool = false) {.
...
proc setHLRValidation*(this: var Graphic3dStructure; theFlag: bool) {.
    importcpp: "SetHLRValidation", header: "Graphic3d_Structure.hxx".}
proc hLRValidation*(this: Graphic3dStructure): bool {.noSideEffect,
...
proc transformPersistence*(this: Graphic3dStructure): Handle[Graphic3dTransformPers] {.
    ...
    header: "Graphic3d_Structure.hxx".}
proc setMutable*(this: var Graphic3dStructure; theIsMutable: bool) {.
    importcpp: "SetMutable", header: "Graphic3d_Structure.hxx".}
proc isMutable*(this: Graphic3dStructure): bool {.noSideEffect,
...
proc graphicClear*(this: var Graphic3dStructure; withDestruction: bool) {.
...
proc identification*(this: Graphic3dStructure): int {.noSideEffect,
...
proc transforms*(theTrsf: Trsf; theX: float; theY: float; theZ: float;
                theNewX: var float; theNewY: var float; theNewZ: var float) {.
