...
proc isPeriodic*(c: BRepAdaptorCurve): bool {.
    ...
    header: "HLRBRep_BCurveTool.hxx".}
proc period*(c: BRepAdaptorCurve): float {.importcpp: "HLRBRep_BCurveTool::Period(@)",
                                       header: "HLRBRep_BCurveTool.hxx".}
proc value*(c: BRepAdaptorCurve; u: float): Pnt {.
    importcpp: "HLRBRep_BCurveTool::Value(@)", header: "HLRBRep_BCurveTool.hxx".}
proc d0*(c: BRepAdaptorCurve; u: float; p: var Pnt) {.
    importcpp: "HLRBRep_BCurveTool::D0(@)", header: "HLRBRep_BCurveTool.hxx".}
proc d1*(c: BRepAdaptorCurve; u: float; p: var Pnt; v: var Vec) {.
...
proc dn*(c: BRepAdaptorCurve; u: float; n: int): Vec {.
    importcpp: "HLRBRep_BCurveTool::DN(@)", header: "HLRBRep_BCurveTool.hxx".}
proc resolution*(c: BRepAdaptorCurve; r3d: float): float {.
...
proc degree*(c: BRepAdaptorCurve): int {.importcpp: "HLRBRep_BCurveTool::Degree(@)",
                                     header: "HLRBRep_BCurveTool.hxx".}
proc isRational*(c: BRepAdaptorCurve): bool {.
    importcpp: "HLRBRep_BCurveTool::IsRational(@)",
    header: "HLRBRep_BCurveTool.hxx".}
proc nbPoles*(c: BRepAdaptorCurve): int {.importcpp: "HLRBRep_BCurveTool::NbPoles(@)",
                                      header: "HLRBRep_BCurveTool.hxx".}
proc nbKnots*(c: BRepAdaptorCurve): int {.importcpp: "HLRBRep_BCurveTool::NbKnots(@)",
                                      header: "HLRBRep_BCurveTool.hxx".}
...
proc polesAndWeights*(c: BRepAdaptorCurve; t: var TColgpArray1OfPnt;
    ...
    header: "HLRBRep_BCurveTool.hxx".}
proc nbSamples*(c: BRepAdaptorCurve; u0: float; u1: float): int {.
