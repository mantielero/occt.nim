...
proc setCurve*(this: var HLRBRepCLProps; c: ptr HLRBRepCurve) {.importcpp: "SetCurve",
    header: "HLRBRep_CLProps.hxx".}
proc value*(this: HLRBRepCLProps): Pnt2d {.noSideEffect, importcpp: "Value",
                                       header: "HLRBRep_CLProps.hxx".}
proc d1*(this: var HLRBRepCLProps): Vec2d {.importcpp: "D1",
                                       header: "HLRBRep_CLProps.hxx".}
proc d2*(this: var HLRBRepCLProps): Vec2d {.importcpp: "D2",
                                       header: "HLRBRep_CLProps.hxx".}
proc d3*(this: var HLRBRepCLProps): Vec2d {.importcpp: "D3",
                                       header: "HLRBRep_CLProps.hxx".}
proc isTangentDefined*(this: var HLRBRepCLProps): bool {.
