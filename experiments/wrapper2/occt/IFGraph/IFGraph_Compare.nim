...
proc getFromEntity*(this: var IFGraphCompare; ent: Handle[StandardTransient];
                   first: bool) {.importcpp: "GetFromEntity",
                                header: "IFGraph_Compare.hxx".}
proc getFromIter*(this: var IFGraphCompare; iter: InterfaceEntityIterator; first: bool) {.
    importcpp: "GetFromIter", header: "IFGraph_Compare.hxx".}
