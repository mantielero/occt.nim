...
proc clearLines*(this: var IFSelectSessionFile) {.importcpp: "ClearLines",
    header: "IFSelect_SessionFile.hxx".}
proc nbLines*(this: IFSelectSessionFile): cint {.noSideEffect, importcpp: "NbLines",
    header: "IFSelect_SessionFile.hxx".}
...
proc write*(this: var IFSelectSessionFile; filename: StandardCString): cint {.
    importcpp: "Write", header: "IFSelect_SessionFile.hxx".}
proc read*(this: var IFSelectSessionFile; filename: StandardCString): cint {.
    importcpp: "Read", header: "IFSelect_SessionFile.hxx".}
proc writeSession*(this: var IFSelectSessionFile): cint {.importcpp: "WriteSession",
    header: "IFSelect_SessionFile.hxx".}
proc writeEnd*(this: var IFSelectSessionFile): cint {.importcpp: "WriteEnd",
    header: "IFSelect_SessionFile.hxx".}
...
proc readSession*(this: var IFSelectSessionFile): cint {.importcpp: "ReadSession",
    header: "IFSelect_SessionFile.hxx".}
proc readEnd*(this: var IFSelectSessionFile): cint {.importcpp: "ReadEnd",
    header: "IFSelect_SessionFile.hxx".}
...
proc setLastGeneral*(this: var IFSelectSessionFile; lastgen: cint) {.
    importcpp: "SetLastGeneral", header: "IFSelect_SessionFile.hxx".}
proc nbParams*(this: IFSelectSessionFile): cint {.noSideEffect,
    importcpp: "NbParams", header: "IFSelect_SessionFile.hxx".}
proc isVoid*(this: IFSelectSessionFile; num: cint): bool {.noSideEffect,
    importcpp: "IsVoid", header: "IFSelect_SessionFile.hxx".}
proc isText*(this: IFSelectSessionFile; num: cint): bool {.noSideEffect,
