...
discard "forward decl of IGESAppli_GeneralModule"
type
  HandleC1C1* = Handle[IGESAppliGeneralModule]
...
proc categoryNumber*(this: IGESAppliGeneralModule; cn: cint;
