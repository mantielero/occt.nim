...
discard "forward decl of IGESDimen_GeneralModule"
type
  Handle_IGESDimen_GeneralModule* = handle[IGESDimen_GeneralModule]

## ! Definition of General Services for IGESDimen (specific part)
## ! This Services comprise : Shared & Implied Lists, Copy, Check

type
  IGESDimen_GeneralModule* {.importcpp: "IGESDimen_GeneralModule",
                            header: "IGESDimen_GeneralModule.hxx", bycopy.} = object of IGESData_GeneralModule ##
                                                                                                        ## !
                                                                                                        ## Creates
                                                                                                        ## a
                                                                                                        ## GeneralModule
...
proc NewVoid*(this: IGESDimen_GeneralModule; CN: Standard_Integer;
             entto: var handle[Standard_Transient]): Standard_Boolean {.
    noSideEffect, importcpp: "NewVoid", header: "IGESDimen_GeneralModule.hxx".}
proc OwnCopyCase*(this: IGESDimen_GeneralModule; CN: Standard_Integer;
...
proc CategoryNumber*(this: IGESDimen_GeneralModule; CN: Standard_Integer;
...
type
  IGESDimen_GeneralModulebase_type* = IGESData_GeneralModule

proc get_type_name*(): cstring {.importcpp: "IGESDimen_GeneralModule::get_type_name(@)",
                              header: "IGESDimen_GeneralModule.hxx".}
proc get_type_descriptor*(): handle[Standard_Type] {.
    importcpp: "IGESDimen_GeneralModule::get_type_descriptor(@)",
    header: "IGESDimen_GeneralModule.hxx".}
proc DynamicType*(this: IGESDimen_GeneralModule): handle[Standard_Type] {.
