...
proc constructIGESGeomHArray1OfBoundary*(theLower: int; theUpper: int): IGESGeomHArray1OfBoundary {.
    constructor, importcpp: "IGESGeom_HArray1OfBoundary(@)",
    header: "IGESGeom_HArray1OfBoundary.hxx".}
proc constructIGESGeomHArray1OfBoundary*(theLower: int; theUpper: int;
