...
proc nbSamplesV*(s: Handle[Adaptor3dHSurface]; v1: cfloat; v2: cfloat): cint {.
    ...
    header: "IntPatch_HInterTool.hxx".}
proc nbSamplePoints*(this: var IntPatchHInterTool; s: Handle[Adaptor3dHSurface]): cint {.
...
proc samplePoint*(this: IntPatchHInterTool; s: Handle[Adaptor3dHSurface];
                 index: cint; u: var cfloat; v: var cfloat) {.noSideEffect,
    importcpp: "SamplePoint", header: "IntPatch_HInterTool.hxx".}
...
proc value*(c: Handle[Adaptor2dHCurve2d]; index: cint; pt: var Pnt; tol: var cfloat;
           u: var cfloat) {.importcpp: "IntPatch_HInterTool::Value(@)",
                         header: "IntPatch_HInterTool.hxx".}
