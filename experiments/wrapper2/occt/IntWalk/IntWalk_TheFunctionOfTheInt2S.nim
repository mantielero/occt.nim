...
proc nbEquations*(this: IntWalkTheFunctionOfTheInt2S): int {.noSideEffect,
    importcpp: "NbEquations", header: "IntWalk_TheFunctionOfTheInt2S.hxx".}
proc value*(this: var IntWalkTheFunctionOfTheInt2S; x: MathVector; f: var MathVector): bool {.
...
proc derivatives*(this: var IntWalkTheFunctionOfTheInt2S; x: MathVector;
                 d: var MathMatrix): bool {.importcpp: "Derivatives", header: "IntWalk_TheFunctionOfTheInt2S.hxx".}
...
proc computeParameters*(this: var IntWalkTheFunctionOfTheInt2S;
    ...
    header: "IntWalk_TheFunctionOfTheInt2S.hxx".}
proc root*(this: IntWalkTheFunctionOfTheInt2S): float {.noSideEffect,
    importcpp: "Root", header: "IntWalk_TheFunctionOfTheInt2S.hxx".}
proc point*(this: IntWalkTheFunctionOfTheInt2S): Pnt {.noSideEffect,
...
proc direction*(this: IntWalkTheFunctionOfTheInt2S): Dir {.noSideEffect,
    importcpp: "Direction", header: "IntWalk_TheFunctionOfTheInt2S.hxx".}
proc directionOnS1*(this: IntWalkTheFunctionOfTheInt2S): Dir2d {.noSideEffect,
