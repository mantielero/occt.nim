...
proc `==`*(this: IntfTangentZone; other: IntfTangentZone): bool {.noSideEffect,
...
proc hasCommonRange*(this: IntfTangentZone; other: IntfTangentZone): bool {.
...
proc append*(this: var IntfTangentZone; tzi: IntfTangentZone) {.importcpp: "Append",
    header: "Intf_TangentZone.hxx".}
proc insert*(this: var IntfTangentZone; pi: IntfSectionPoint): bool {.
