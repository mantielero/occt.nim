...
proc computeAnalysis*(this: var LocalAnalysisSurfaceContinuity;
    ...
    header: "LocalAnalysis_SurfaceContinuity.hxx".}
proc isDone*(this: LocalAnalysisSurfaceContinuity): bool {.noSideEffect,
...
proc isC1*(this: LocalAnalysisSurfaceContinuity): bool {.noSideEffect,
    importcpp: "IsC1", header: "LocalAnalysis_SurfaceContinuity.hxx".}
proc isC2*(this: LocalAnalysisSurfaceContinuity): bool {.noSideEffect,
    importcpp: "IsC2", header: "LocalAnalysis_SurfaceContinuity.hxx".}
proc isG1*(this: LocalAnalysisSurfaceContinuity): bool {.noSideEffect,
