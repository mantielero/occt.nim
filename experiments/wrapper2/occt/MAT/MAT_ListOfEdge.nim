...
proc previous*(this: var MAT_ListOfEdge) {.importcpp: "Previous",
                                       header: "MAT_ListOfEdge.hxx".}
proc more*(this: MAT_ListOfEdge): bool {.noSideEffect, importcpp: "More",
                                     header: "MAT_ListOfEdge.hxx".}
...
proc number*(this: MAT_ListOfEdge): int {.noSideEffect, importcpp: "Number",
                                      header: "MAT_ListOfEdge.hxx".}
proc index*(this: MAT_ListOfEdge): int {.noSideEffect, importcpp: "Index",
                                     header: "MAT_ListOfEdge.hxx".}
proc brackets*(this: var MAT_ListOfEdge; anindex: int): Handle[MAT_Edge] {.
    importcpp: "Brackets", header: "MAT_ListOfEdge.hxx".}
proc `()`*(this: var MAT_ListOfEdge; anindex: int): Handle[MAT_Edge] {.
...
proc loop*(this: MAT_ListOfEdge) {.noSideEffect, importcpp: "Loop",
                                header: "MAT_ListOfEdge.hxx".}
proc isEmpty*(this: MAT_ListOfEdge): bool {.noSideEffect, importcpp: "IsEmpty",
                                        header: "MAT_ListOfEdge.hxx".}
proc dump*(this: var MAT_ListOfEdge; ashift: int; alevel: int) {.importcpp: "Dump",
    header: "MAT_ListOfEdge.hxx".}
type
