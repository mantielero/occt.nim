...
proc getColor1*(this: MeshVS_ElementalColorPrsBuilder; id: int;
               theColor: var QuantityColor): bool {.noSideEffect,
    importcpp: "GetColor1", header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc setColor1*(this: var MeshVS_ElementalColorPrsBuilder; id: int;
...
proc getColor2*(this: MeshVS_ElementalColorPrsBuilder; id: int;
...
proc getColor2*(this: MeshVS_ElementalColorPrsBuilder; id: int;
    ...
    header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc setColor2*(this: var MeshVS_ElementalColorPrsBuilder; id: int;
