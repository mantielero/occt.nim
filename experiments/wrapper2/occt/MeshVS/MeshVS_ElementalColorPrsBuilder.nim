...
discard "forward decl of MeshVS_ElementalColorPrsBuilder"
type
  HandleC1C1* = Handle[MeshVS_ElementalColorPrsBuilder]
...
proc setColors1*(this: var MeshVS_ElementalColorPrsBuilder;
    ...
    header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc hasColors1*(this: MeshVS_ElementalColorPrsBuilder): bool {.noSideEffect,
    importcpp: "HasColors1", header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc getColor1*(this: MeshVS_ElementalColorPrsBuilder; id: cint;
               theColor: var QuantityColor): bool {.noSideEffect,
    importcpp: "GetColor1", header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc setColor1*(this: var MeshVS_ElementalColorPrsBuilder; id: cint;
...
proc setColors2*(this: var MeshVS_ElementalColorPrsBuilder;
    ...
    header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc hasColors2*(this: MeshVS_ElementalColorPrsBuilder): bool {.noSideEffect,
    importcpp: "HasColors2", header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc getColor2*(this: MeshVS_ElementalColorPrsBuilder; id: cint;
               theColor: var MeshVS_TwoColors): bool {.noSideEffect,
    importcpp: "GetColor2", header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc getColor2*(this: MeshVS_ElementalColorPrsBuilder; id: cint;
               theColor1: var QuantityColor; theColor2: var QuantityColor): bool {.
    noSideEffect, importcpp: "GetColor2",
    header: "MeshVS_ElementalColorPrsBuilder.hxx".}
proc setColor2*(this: var MeshVS_ElementalColorPrsBuilder; id: cint;
