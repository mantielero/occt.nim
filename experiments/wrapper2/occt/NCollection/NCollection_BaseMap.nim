...
type
  NCollection_BaseMap* {.importcpp: "NCollection_BaseMap",
                        header: "NCollection_BaseMap.hxx", bycopy.} = object of RootObj ## public:
                                                                        ## ! Memory allocation
...
proc NbBuckets*(this: NCollection_BaseMap): int {.noSideEffect,
    importcpp: "NbBuckets", header: "NCollection_BaseMap.hxx".}
proc Extent*(this: NCollection_BaseMap): int {.noSideEffect, importcpp: "Extent",
    header: "NCollection_BaseMap.hxx".}
