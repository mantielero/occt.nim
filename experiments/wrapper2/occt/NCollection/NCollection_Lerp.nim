...
proc constructNCollectionLerp*[T](): NCollectionLerp[T] {.constructor,
    importcpp: "NCollection_Lerp<\'*0>(@)", header: "NCollection_Lerp.hxx".}
proc constructNCollectionLerp*[T](theStart: T; theEnd: T): NCollectionLerp[T] {.
    constructor, importcpp: "NCollection_Lerp<\'*0>(@)",
    header: "NCollection_Lerp.hxx".}
proc init*[T](this: var NCollectionLerp[T]; theStart: T; theEnd: T) {.importcpp: "Init",
    header: "NCollection_Lerp.hxx".}
