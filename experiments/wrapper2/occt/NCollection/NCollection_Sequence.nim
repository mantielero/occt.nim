...
proc constructNCollectionSequenceIterator*[TheItemType](
    theSeq: NCollectionSequence; isStart: bool = true): NCollectionSequenceIterator[
    TheItemType] {.constructor,
                  importcpp: "NCollection_Sequence<\'*0>::Iterator(@)",
                  header: "NCollection_Sequence.hxx".}
...
proc constructNCollectionSequence*[TheItemType](theOther: NCollectionSequence): NCollectionSequence[
    TheItemType] {.constructor, importcpp: "NCollection_Sequence<\'*0>(@)",
                  header: "NCollection_Sequence.hxx".}
proc size*[TheItemType](this: NCollectionSequence[TheItemType]): int {.noSideEffect,
    importcpp: "Size", header: "NCollection_Sequence.hxx".}
proc length*[TheItemType](this: NCollectionSequence[TheItemType]): int {.
    noSideEffect, importcpp: "Length", header: "NCollection_Sequence.hxx".}
proc lower*[TheItemType](this: NCollectionSequence[TheItemType]): int {.
    noSideEffect, importcpp: "Lower", header: "NCollection_Sequence.hxx".}
proc upper*[TheItemType](this: NCollectionSequence[TheItemType]): int {.
...
proc exchange*[TheItemType](this: var NCollectionSequence[TheItemType]; i: int; j: int) {.
...
proc remove*[TheItemType](this: var NCollectionSequence[TheItemType]; theIndex: int) {.
    importcpp: "Remove", header: "NCollection_Sequence.hxx".}
proc remove*[TheItemType](this: var NCollectionSequence[TheItemType];
                         theFromIndex: int; theToIndex: int) {.importcpp: "Remove",
    header: "NCollection_Sequence.hxx".}
...
proc insertBefore*[TheItemType](this: var NCollectionSequence[TheItemType];
                               theIndex: int; theItem: TheItemType) {.
    importcpp: "InsertBefore", header: "NCollection_Sequence.hxx".}
proc insertBefore*[TheItemType](this: var NCollectionSequence[TheItemType];
                               theIndex: int; theSeq: var NCollectionSequence) {.
    importcpp: "InsertBefore", header: "NCollection_Sequence.hxx".}
...
proc insertAfter*[TheItemType](this: var NCollectionSequence[TheItemType];
                              theIndex: int; theItem: TheItemType) {.
    importcpp: "InsertAfter", header: "NCollection_Sequence.hxx".}
proc split*[TheItemType](this: var NCollectionSequence[TheItemType]; theIndex: int;
                        theSeq: var NCollectionSequence) {.importcpp: "Split",
    header: "NCollection_Sequence.hxx".}
...
proc value*[TheItemType](this: NCollectionSequence[TheItemType]; theIndex: int): TheItemType {.
    noSideEffect, importcpp: "Value", header: "NCollection_Sequence.hxx".}
proc `()`*[TheItemType](this: NCollectionSequence[TheItemType]; theIndex: int): TheItemType {.
    noSideEffect, importcpp: "#(@)", header: "NCollection_Sequence.hxx".}
proc changeValue*[TheItemType](this: var NCollectionSequence[TheItemType];
                              theIndex: int): var TheItemType {.
    importcpp: "ChangeValue", header: "NCollection_Sequence.hxx".}
proc `()`*[TheItemType](this: var NCollectionSequence[TheItemType]; theIndex: int): var TheItemType {.
