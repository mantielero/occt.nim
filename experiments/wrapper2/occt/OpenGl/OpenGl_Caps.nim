...
type
  OpenGl_Caps* {.importcpp: "OpenGl_Caps", header: "OpenGl_Caps.hxx", bycopy.} = object of Standard_Transient ##
                                                                                                    ## !
                                                                                                    ## @name
                                                                                                    ## flags
                                                                                                    ## to
                                                                                                    ...
                                                                                                    ## Not
                                                                                                    ## implemented
    sRGBDisable* {.importc: "sRGBDisable".}: Standard_Boolean ## !< Disables sRGB rendering (OFF by default)
    compressedTexturesDisable* {.importc: "compressedTexturesDisable".}: Standard_Boolean ## !< Disables uploading of compressed texture formats native to GPU (OFF by default)
    vboDisable* {.importc: "vboDisable".}: Standard_Boolean ## !< disallow VBO usage for debugging purposes (OFF by default)
    pntSpritesDisable* {.importc: "pntSpritesDisable".}: Standard_Boolean ## !< flag permits Point Sprites usage, will significantly affect performance (OFF by default)
    keepArrayData* {.importc: "keepArrayData".}: Standard_Boolean ## !< Disables freeing CPU memory after building VBOs (OFF by default)
    ffpEnable* {.importc: "ffpEnable".}: Standard_Boolean ## !< Enables FFP (fixed-function pipeline), do not use built-in GLSL programs (OFF by default)
    usePolygonMode* {.importc: "usePolygonMode".}: Standard_Boolean ## !< Enables Polygon Mode instead of built-in GLSL programs (OFF by default; unsupported on OpenGL ES)
    useSystemBuffer* {.importc: "useSystemBuffer".}: Standard_Boolean ## !< Enables usage of system backbuffer for blitting (OFF by default on desktop OpenGL and ON on OpenGL ES for testing)
    swapInterval* {.importc: "swapInterval".}: Standard_Integer ## !< controls swap interval - 0 for VSync off and 1 for VSync on, 1 by default
    buffersNoSwap* {.importc: "buffersNoSwap".}: Standard_Boolean ## *
                                                              ##  Request stereoscopic context (with Quad Buffer). This flag requires support in OpenGL driver.
                                                              ##
                                                              ##  OFF by default.
                                                              ##
    contextStereo* {.importc: "contextStereo".}: Standard_Boolean ## *
                                                              ...
                                                              ##  OFF by default.
                                                              ##
    contextDebug* {.importc: "contextDebug".}: Standard_Boolean ## *
                                                            ...
                                                            ##  OFF by default.
                                                            ##
    contextSyncDebug* {.importc: "contextSyncDebug".}: Standard_Boolean ## *
                                                                    ...
                                                                    ##
    contextNoAccel* {.importc: "contextNoAccel".}: Standard_Boolean ## *
                                                                ...
                                                                ##  ON by default.
                                                                ##
    contextCompatible* {.importc: "contextCompatible".}: Standard_Boolean ## *
                                                                      ##  Disallow using OpenGL extensions.
                                                                      ##  Should be used for debugging purposes only!
                                                                      ##
                                                                      ##  OFF by default.
                                                                      ##
    contextNoExtensions* {.importc: "contextNoExtensions".}: Standard_Boolean ## *
                                                                          ##  Synthetically restrict upper version of OpenGL functionality to be used.
                                                                          ##  Should be used for debugging purposes only!
                                                                          ##
                                                                          ##  (-1, -1) by default, which means no restriction.
                                                                          ##
    contextMajorVersionUpper* {.importc: "contextMajorVersionUpper".}: Standard_Integer
    contextMinorVersionUpper* {.importc: "contextMinorVersionUpper".}: Standard_Integer ## *
                                                                                    ...
                                                                                    ##
    isTopDownTextureUV* {.importc: "isTopDownTextureUV".}: Standard_Boolean
    glslWarnings* {.importc: "glslWarnings".}: Standard_Boolean ## ! Suppress redundant messages from debug GL context. ON by default.
    suppressExtraMsg* {.importc: "suppressExtraMsg".}: Standard_Boolean ## ! Print GLSL program source code. OFF by default.
    glslDumpLevel* {.importc: "glslDumpLevel".}: OpenGl_ShaderProgramDumpLevel


proc constructOpenGl_Caps*(): OpenGl_Caps {.constructor,
    importcpp: "OpenGl_Caps(@)", header: "OpenGl_Caps.hxx".}
proc destroyOpenGl_Caps*(this: var OpenGl_Caps) {.importcpp: "#.~OpenGl_Caps()",
    header: "OpenGl_Caps.hxx".}
type
  OpenGl_Capsbase_type* = Standard_Transient

proc get_type_name*(): cstring {.importcpp: "OpenGl_Caps::get_type_name(@)",
                              header: "OpenGl_Caps.hxx".}
proc get_type_descriptor*(): handle[Standard_Type] {.
    importcpp: "OpenGl_Caps::get_type_descriptor(@)", header: "OpenGl_Caps.hxx".}
proc DynamicType*(this: OpenGl_Caps): handle[Standard_Type] {.noSideEffect,
    importcpp: "DynamicType", header: "OpenGl_Caps.hxx".}
discard "forward decl of OpenGl_Caps"
type
  Handle_OpenGl_Caps* = handle[OpenGl_Caps]
