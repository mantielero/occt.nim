...
proc constructPlateGtoCConstraint*(point2d: Xy; d1s: PlateD1; d1t: PlateD1): PlateGtoCConstraint {.
    constructor, importcpp: "Plate_GtoCConstraint(@)",
    header: "Plate_GtoCConstraint.hxx".}
proc constructPlateGtoCConstraint*(point2d: Xy; d1s: PlateD1; d1t: PlateD1; nP: Xyz): PlateGtoCConstraint {.
    constructor, importcpp: "Plate_GtoCConstraint(@)",
    header: "Plate_GtoCConstraint.hxx".}
proc constructPlateGtoCConstraint*(point2d: Xy; d1s: PlateD1; d1t: PlateD1;
                                  d2s: PlateD2; d2t: PlateD2): PlateGtoCConstraint {.
    constructor, importcpp: "Plate_GtoCConstraint(@)",
    header: "Plate_GtoCConstraint.hxx".}
proc constructPlateGtoCConstraint*(point2d: Xy; d1s: PlateD1; d1t: PlateD1;
                                  d2s: PlateD2; d2t: PlateD2; nP: Xyz): PlateGtoCConstraint {.
    constructor, importcpp: "Plate_GtoCConstraint(@)",
    header: "Plate_GtoCConstraint.hxx".}
proc constructPlateGtoCConstraint*(point2d: Xy; d1s: PlateD1; d1t: PlateD1;
