...
proc constructPrs3dPointAspect*(theType: AspectTypeOfMarker;
                               theColor: QuantityColor; theScale: cfloat): Prs3dPointAspect {.
    constructor, importcpp: "Prs3d_PointAspect(@)", header: "Prs3d_PointAspect.hxx".}
proc constructPrs3dPointAspect*(theColor: QuantityColor; theWidth: cint;
                               theHeight: cint;
...
proc setScale*(this: var Prs3dPointAspect; theScale: cfloat) {.importcpp: "SetScale",
    header: "Prs3d_PointAspect.hxx".}
...
type
  HandleC1C1* = Handle[Prs3dPointAspect]
