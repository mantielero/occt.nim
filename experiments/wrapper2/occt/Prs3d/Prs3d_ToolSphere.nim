...
proc constructPrs3dToolSphere*(theRadius: cfloat; theNbSlices: cint;
                              theNbStacks: cint): Prs3dToolSphere {.constructor,
    importcpp: "Prs3d_ToolSphere(@)", header: "Prs3d_ToolSphere.hxx".}
