...
proc constructRWStepAP214_RWAutoDesignDateAndPersonAssignment*(): RWStepAP214_RWAutoDesignDateAndPersonAssignment {.
...
proc ReadStep*(this: RWStepAP214_RWAutoDesignDateAndPersonAssignment;
              data: handle[StepData_StepReaderData]; num: Standard_Integer;
              ach: var handle[Interface_Check];
              ent: handle[StepAP214_AutoDesignDateAndPersonAssignment]) {.
    noSideEffect, importcpp: "ReadStep",
    header: "RWStepAP214_RWAutoDesignDateAndPersonAssignment.hxx".}
proc WriteStep*(this: RWStepAP214_RWAutoDesignDateAndPersonAssignment;
               SW: var StepData_StepWriter;
               ent: handle[StepAP214_AutoDesignDateAndPersonAssignment]) {.
    noSideEffect, importcpp: "WriteStep",
    header: "RWStepAP214_RWAutoDesignDateAndPersonAssignment.hxx".}
proc Share*(this: RWStepAP214_RWAutoDesignDateAndPersonAssignment;
           ent: handle[StepAP214_AutoDesignDateAndPersonAssignment];
