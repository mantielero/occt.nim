...
proc constructRWStepBasic_RWIdentificationAssignment*(): RWStepBasic_RWIdentificationAssignment {.
    constructor, importcpp: "RWStepBasic_RWIdentificationAssignment(@)",
    header: "RWStepBasic_RWIdentificationAssignment.hxx".}
proc ReadStep*(this: RWStepBasic_RWIdentificationAssignment;
              data: handle[StepData_StepReaderData]; num: Standard_Integer;
              ach: var handle[Interface_Check];
              ent: handle[StepBasic_IdentificationAssignment]) {.noSideEffect,
    importcpp: "ReadStep", header: "RWStepBasic_RWIdentificationAssignment.hxx".}
proc WriteStep*(this: RWStepBasic_RWIdentificationAssignment;
               SW: var StepData_StepWriter;
               ent: handle[StepBasic_IdentificationAssignment]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepBasic_RWIdentificationAssignment.hxx".}
proc Share*(this: RWStepBasic_RWIdentificationAssignment;
           ent: handle[StepBasic_IdentificationAssignment];
