...
type
  RWStepFEA_RWFeaMaterialPropertyRepresentationItem* {.
      ...
      header: "RWStepFEA_RWFeaMaterialPropertyRepresentationItem.hxx", bycopy.} = object ##
                                                                                    ## !
                                                                                    ## Empty
                                                                                    ## constructor


proc constructRWStepFEA_RWFeaMaterialPropertyRepresentationItem*(): RWStepFEA_RWFeaMaterialPropertyRepresentationItem {.
    constructor,
    importcpp: "RWStepFEA_RWFeaMaterialPropertyRepresentationItem(@)",
...
proc readStep*(this: RWStepFEA_RWFeaMaterialPropertyRepresentationItem;
    ...
    header: "RWStepFEA_RWFeaMaterialPropertyRepresentationItem.hxx".}
proc writeStep*(this: RWStepFEA_RWFeaMaterialPropertyRepresentationItem;
               sw: var StepDataStepWriter;
               ent: Handle[StepFEA_FeaMaterialPropertyRepresentationItem]) {.
    noSideEffect, importcpp: "WriteStep",
    header: "RWStepFEA_RWFeaMaterialPropertyRepresentationItem.hxx".}
proc share*(this: RWStepFEA_RWFeaMaterialPropertyRepresentationItem;
           ent: Handle[StepFEA_FeaMaterialPropertyRepresentationItem];
