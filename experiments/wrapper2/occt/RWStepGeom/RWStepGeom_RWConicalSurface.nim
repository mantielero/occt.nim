...
type
  RWStepGeomRWConicalSurface* {.importcpp: "RWStepGeom_RWConicalSurface",
                               header: "RWStepGeom_RWConicalSurface.hxx", bycopy.} = object


proc constructRWStepGeomRWConicalSurface*(): RWStepGeomRWConicalSurface {.
...
proc writeStep*(this: RWStepGeomRWConicalSurface; sw: var StepDataStepWriter;
               ent: Handle[StepGeomConicalSurface]) {.noSideEffect,
