...
type
  RWStepGeomRWRationalBSplineCurve* {.importcpp: "RWStepGeom_RWRationalBSplineCurve", header: "RWStepGeom_RWRationalBSplineCurve.hxx",
                                     bycopy.} = object


proc constructRWStepGeomRWRationalBSplineCurve*(): RWStepGeomRWRationalBSplineCurve {.
...
proc writeStep*(this: RWStepGeomRWRationalBSplineCurve; sw: var StepDataStepWriter;
               ent: Handle[StepGeomRationalBSplineCurve]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepGeom_RWRationalBSplineCurve.hxx".}
proc share*(this: RWStepGeomRWRationalBSplineCurve;
           ent: Handle[StepGeomRationalBSplineCurve];
           iter: var InterfaceEntityIterator) {.noSideEffect, importcpp: "Share",
    header: "RWStepGeom_RWRationalBSplineCurve.hxx".}
proc check*(this: RWStepGeomRWRationalBSplineCurve;
