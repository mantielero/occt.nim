...
proc constructRWStepGeom_RWRectangularTrimmedSurface*(): RWStepGeom_RWRectangularTrimmedSurface {.
    constructor, importcpp: "RWStepGeom_RWRectangularTrimmedSurface(@)",
    header: "RWStepGeom_RWRectangularTrimmedSurface.hxx".}
proc ReadStep*(this: RWStepGeom_RWRectangularTrimmedSurface;
              data: handle[StepData_StepReaderData]; num: Standard_Integer;
              ach: var handle[Interface_Check];
              ent: handle[StepGeom_RectangularTrimmedSurface]) {.noSideEffect,
    importcpp: "ReadStep", header: "RWStepGeom_RWRectangularTrimmedSurface.hxx".}
proc WriteStep*(this: RWStepGeom_RWRectangularTrimmedSurface;
               SW: var StepData_StepWriter;
               ent: handle[StepGeom_RectangularTrimmedSurface]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepGeom_RWRectangularTrimmedSurface.hxx".}
proc Share*(this: RWStepGeom_RWRectangularTrimmedSurface;
           ent: handle[StepGeom_RectangularTrimmedSurface];
