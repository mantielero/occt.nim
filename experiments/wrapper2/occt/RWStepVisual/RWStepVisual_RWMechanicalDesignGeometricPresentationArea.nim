...
type
  RWStepVisualRWMechanicalDesignGeometricPresentationArea* {.
...
proc constructRWStepVisualRWMechanicalDesignGeometricPresentationArea*(): RWStepVisualRWMechanicalDesignGeometricPresentationArea {.
    constructor,
    importcpp: "RWStepVisual_RWMechanicalDesignGeometricPresentationArea(@)",
    header: "RWStepVisual_RWMechanicalDesignGeometricPresentationArea.hxx".}
proc readStep*(this: RWStepVisualRWMechanicalDesignGeometricPresentationArea;
    ...
    header: "RWStepVisual_RWMechanicalDesignGeometricPresentationArea.hxx".}
proc writeStep*(this: RWStepVisualRWMechanicalDesignGeometricPresentationArea;
               sw: var StepDataStepWriter;
               ent: Handle[StepVisualMechanicalDesignGeometricPresentationArea]) {.
    noSideEffect, importcpp: "WriteStep",
    header: "RWStepVisual_RWMechanicalDesignGeometricPresentationArea.hxx".}
proc share*(this: RWStepVisualRWMechanicalDesignGeometricPresentationArea;
           ent: Handle[StepVisualMechanicalDesignGeometricPresentationArea];
