...
proc constructSelect3D_SensitiveSegment*(theOwnerId: Handle[SelectMgrEntityOwner];
                                        theFirstPnt: Pnt; theLastPnt: Pnt): Select3D_SensitiveSegment {.
    constructor, importcpp: "Select3D_SensitiveSegment(@)",
    header: "Select3D_SensitiveSegment.hxx".}
proc setStartPoint*(this: var Select3D_SensitiveSegment; thePnt: Pnt) {.
    importcpp: "SetStartPoint", header: "Select3D_SensitiveSegment.hxx".}
proc setEndPoint*(this: var Select3D_SensitiveSegment; thePnt: Pnt) {.
    importcpp: "SetEndPoint", header: "Select3D_SensitiveSegment.hxx".}
proc startPoint*(this: Select3D_SensitiveSegment): Pnt {.noSideEffect,
...
proc centerOfGeometry*(this: Select3D_SensitiveSegment): Pnt {.noSideEffect,
...
proc toBuildBVH*(this: Select3D_SensitiveSegment): bool {.noSideEffect,
    importcpp: "ToBuildBVH", header: "Select3D_SensitiveSegment.hxx".}
proc startPoint*(this: var Select3D_SensitiveSegment; thePnt: Pnt) {.
    importcpp: "StartPoint", header: "Select3D_SensitiveSegment.hxx".}
