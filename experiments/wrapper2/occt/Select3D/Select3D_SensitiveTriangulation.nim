...
proc constructSelect3D_SensitiveTriangulation*(
    ...
    theInitLoc: TopLocLocation; theIsInterior: bool = true): Select3D_SensitiveTriangulation {.
...
proc centerOfGeometry*(this: Select3D_SensitiveTriangulation): Pnt {.noSideEffect,
    importcpp: "CenterOfGeometry", header: "Select3D_SensitiveTriangulation.hxx".}
proc hasInitLocation*(this: Select3D_SensitiveTriangulation): bool {.noSideEffect,
    importcpp: "HasInitLocation", header: "Select3D_SensitiveTriangulation.hxx".}
proc invInitLocation*(this: Select3D_SensitiveTriangulation): GTrsf {.noSideEffect,
    importcpp: "InvInitLocation", header: "Select3D_SensitiveTriangulation.hxx".}
