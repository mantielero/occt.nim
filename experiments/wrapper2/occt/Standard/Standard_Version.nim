...
## !!!Ignored construct:  # _Standard_Version_HeaderFile [NewLine] # _Standard_Version_HeaderFile [NewLine]  Primary definitions # OCC_VERSION_MAJOR 7 [NewLine] # OCC_VERSION_MINOR 5 [NewLine] # OCC_VERSION_MAINTENANCE 2 [NewLine] ! This macro must be commented in official release, and set to non-empty
