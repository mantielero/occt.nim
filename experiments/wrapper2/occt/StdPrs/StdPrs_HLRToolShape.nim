...
proc nbEdges*(this: StdPrsHLRToolShape): cint {.noSideEffect, importcpp: "NbEdges",
    header: "StdPrs_HLRToolShape.hxx".}
proc initVisible*(this: var StdPrsHLRToolShape; edgeNumber: cint) {.
...
proc visible*(this: var StdPrsHLRToolShape; theEdge: var BRepAdaptorCurve;
             u1: var cfloat; u2: var cfloat) {.importcpp: "Visible",
    header: "StdPrs_HLRToolShape.hxx".}
proc initHidden*(this: var StdPrsHLRToolShape; edgeNumber: cint) {.
...
proc hidden*(this: var StdPrsHLRToolShape; theEdge: var BRepAdaptorCurve;
            u1: var cfloat; u2: var cfloat) {.importcpp: "Hidden",
                                        header: "StdPrs_HLRToolShape.hxx".}
