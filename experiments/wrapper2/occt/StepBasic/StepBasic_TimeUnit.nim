...
proc constructStepBasicTimeUnit*(): StepBasicTimeUnit {.constructor,
    importcpp: "StepBasic_TimeUnit(@)", header: "StepBasic_TimeUnit.hxx".}
type
  StepBasicTimeUnitbaseType* = StepBasicNamedUnit

proc getTypeName*(): cstring {.importcpp: "StepBasic_TimeUnit::get_type_name(@)",
