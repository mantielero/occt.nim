...
discard "forward decl of StepGeom_OffsetCurve3d"
type
  HandleStepGeomOffsetCurve3d* = Handle[StepGeomOffsetCurve3d]
...
proc init*(this: var StepGeomOffsetCurve3d; aName: Handle[TCollectionHAsciiString];
          aBasisCurve: Handle[StepGeomCurve]; aDistance: float;
...
proc setDistance*(this: var StepGeomOffsetCurve3d; aDistance: float) {.
    importcpp: "SetDistance", header: "StepGeom_OffsetCurve3d.hxx".}
proc distance*(this: StepGeomOffsetCurve3d): float {.noSideEffect,
