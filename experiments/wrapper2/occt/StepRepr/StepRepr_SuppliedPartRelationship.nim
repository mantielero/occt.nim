...
proc constructStepReprSuppliedPartRelationship*(): StepReprSuppliedPartRelationship {.
    constructor, importcpp: "StepRepr_SuppliedPartRelationship(@)",
    header: "StepRepr_SuppliedPartRelationship.hxx".}
type
  StepReprSuppliedPartRelationshipbaseType* = StepBasicProductDefinitionRelationship

proc getTypeName*(): cstring {.importcpp: "StepRepr_SuppliedPartRelationship::get_type_name(@)",
                            header: "StepRepr_SuppliedPartRelationship.hxx".}
