...
## !!!Ignored construct:  # _TDF_DerivedAttribute_HeaderFile [NewLine] # _TDF_DerivedAttribute_HeaderFile [NewLine] # < NCollection_List . hxx > [NewLine] # < TDF_Attribute . hxx > [NewLine] class TCollection_AsciiString ;
