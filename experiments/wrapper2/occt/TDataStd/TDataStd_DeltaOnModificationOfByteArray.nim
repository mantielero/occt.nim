...
proc constructTDataStdDeltaOnModificationOfByteArray*(
    arr: Handle[TDataStdByteArray]): TDataStdDeltaOnModificationOfByteArray {.
    constructor, importcpp: "TDataStd_DeltaOnModificationOfByteArray(@)",
    header: "TDataStd_DeltaOnModificationOfByteArray.hxx".}
proc apply*(this: var TDataStdDeltaOnModificationOfByteArray) {.importcpp: "Apply",
    header: "TDataStd_DeltaOnModificationOfByteArray.hxx".}
type
  TDataStdDeltaOnModificationOfByteArraybaseType* = TDF_DeltaOnModification

proc getTypeName*(): cstring {.importcpp: "TDataStd_DeltaOnModificationOfByteArray::get_type_name(@)", header: "TDataStd_DeltaOnModificationOfByteArray.hxx".}
proc getTypeDescriptor*(): Handle[StandardType] {.importcpp: "TDataStd_DeltaOnModificationOfByteArray::get_type_descriptor(@)",
    header: "TDataStd_DeltaOnModificationOfByteArray.hxx".}
