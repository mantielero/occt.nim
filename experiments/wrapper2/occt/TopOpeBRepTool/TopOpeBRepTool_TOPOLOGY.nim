...
proc fUN_toolTolUV*(f: TopoDS_Face; tolu: var cfloat; tolv: var cfloat) {.
...
proc fUN_toolPinC*(p: Pnt; bac: BRepAdaptorCurve; tol: cfloat): bool {.
    importcpp: "FUN_tool_PinC(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
##  ----------------------------------------------------------------------

proc fUN_toolValue*(par: cfloat; e: TopoDS_Edge; p: var Pnt): bool {.
    importcpp: "FUN_tool_value(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_toolValue*(uv: Pnt2d; f: TopoDS_Face; p: var Pnt): bool {.
    importcpp: "FUN_tool_value(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_toolStaPinE*(p: Pnt; e: TopoDS_Edge; tol: cfloat): TopAbsState {.
...
proc fUN_toolOrientVinE*(v: TopoDS_Vertex; e: TopoDS_Edge): cint {.
...
proc fUN_toolGetgeomxx*(fi: TopoDS_Face; ei: TopoDS_Edge; parOnEi: cfloat): Vec {.
    importcpp: "FUN_tool_getgeomxx(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_nearestISO*(f: TopoDS_Face; xpar: cfloat; isoU: bool; xinf: var cfloat;
                    xsup: var cfloat): bool {.importcpp: "FUN_nearestISO(@)",
    header: "TopOpeBRepTool_TOPOLOGY.hxx".}
...
proc fUN_toolEitangenttoFe*(ngFe: Dir; ei: TopoDS_Edge; parOnEi: cfloat): bool {.
...
proc fUN_toolParVonE*(v: TopoDS_Vertex; e: TopoDS_Edge; par: var cfloat): bool {.
...
proc fUN_toolParE*(e0: TopoDS_Edge; par0: cfloat; e: TopoDS_Edge; par: var cfloat;
                  tol: cfloat): bool {.importcpp: "FUN_tool_parE(@)",
                                    header: "TopOpeBRepTool_TOPOLOGY.hxx".}
...
proc fUN_toolParonEF*(e: TopoDS_Edge; par: cfloat; f: TopoDS_Face; uv: var Pnt2d;
                     tol: cfloat): bool {.importcpp: "FUN_tool_paronEF(@)",
                                       header: "TopOpeBRepTool_TOPOLOGY.hxx".}
...
proc fUN_toolParF*(e: TopoDS_Edge; par: cfloat; f: TopoDS_Face; uv: var Pnt2d): bool {.
    importcpp: "FUN_tool_parF(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_toolDirC*(par: cfloat; bac: BRepAdaptorCurve): Dir {.
    importcpp: "FUN_tool_dirC(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_toolTggeomE*(paronE: cfloat; e: TopoDS_Edge): Vec {.
...
proc fUN_toolFindparinBAC*(bac: BRepAdaptorCurve; par: var cfloat): bool {.
    importcpp: "FUN_tool_findparinBAC(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_toolFindparinE*(e: TopoDS_Shape; par: var cfloat): bool {.
    importcpp: "FUN_tool_findparinE(@)", header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_toolFindPinE*(e: TopoDS_Shape; p: var Pnt; par: var cfloat): bool {.
...
proc fUN_toolMaxtol*(s: TopoDS_Shape): cfloat {.importcpp: "FUN_tool_maxtol(@)",
    header: "TopOpeBRepTool_TOPOLOGY.hxx".}
proc fUN_toolNbshapes*(s: TopoDS_Shape; typ: TopAbsShapeEnum): cint {.
...
proc fUN_toolComparebndkole*(sh1: TopoDS_Shape; sh2: TopoDS_Shape): cint {.
...
proc fUN_dsParameter*(e: TopoDS_Shape; v: TopoDS_Shape; p: cfloat) {.
