...
proc constructGceMakePln*(a2: Ax2): GceMakePln {.constructor,
...
proc constructGceMakePln*(p1: Pnt; p2: Pnt; p3: Pnt): GceMakePln {.constructor,
    importcpp: "gce_MakePln(@)", header: "gce_MakePln.hxx".}
proc constructGceMakePln*(p1: Pnt; p2: Pnt): GceMakePln {.constructor,
    importcpp: "gce_MakePln(@)", header: "gce_MakePln.hxx".}
proc constructGceMakePln*(axis: Ax1): GceMakePln {.constructor,
    importcpp: "gce_MakePln(@)", header: "gce_MakePln.hxx".}
proc value*(this: GceMakePln): Pln {.noSideEffect, importcpp: "Value",
                                 header: "gce_MakePln.hxx".}
proc operator*(this: GceMakePln): Pln {.noSideEffect, importcpp: "Operator",
                                    header: "gce_MakePln.hxx".}
