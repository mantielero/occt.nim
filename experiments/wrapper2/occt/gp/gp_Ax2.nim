...
type
  Ax2* {.importcpp: "gp_Ax2", header: "gp_Ax2.hxx", bycopy.} = object


proc `new`*(this: var Ax2; theSize: csize_t): pointer {.
    importcpp: "gp_Ax2::operator new", header: "gp_Ax2.hxx".}
proc `delete`*(this: var Ax2; theAddress: pointer) {.
    importcpp: "gp_Ax2::operator delete", header: "gp_Ax2.hxx".}
proc `new[]`*(this: var Ax2; theSize: csize_t): pointer {.
    importcpp: "gp_Ax2::operator new[]", header: "gp_Ax2.hxx".}
proc `delete[]`*(this: var Ax2; theAddress: pointer) {.
    importcpp: "gp_Ax2::operator delete[]", header: "gp_Ax2.hxx".}
proc `new`*(this: var Ax2; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "gp_Ax2::operator new", header: "gp_Ax2.hxx".}
...
proc setYDirection*(this: var Ax2; vy: Dir) {.importcpp: "SetYDirection",
                                        header: "gp_Ax2.hxx".}
proc angle*(this: Ax2; other: Ax2): StandardReal {.noSideEffect, importcpp: "Angle",
    header: "gp_Ax2.hxx".}
...
proc yDirection*(this: Ax2): Dir {.noSideEffect, importcpp: "YDirection",
                               header: "gp_Ax2.hxx".}
proc isCoplanar*(this: Ax2; other: Ax2; linearTolerance: StandardReal;
                angularTolerance: StandardReal): StandardBoolean {.noSideEffect,
    importcpp: "IsCoplanar", header: "gp_Ax2.hxx".}
proc isCoplanar*(this: Ax2; a1: Ax1; linearTolerance: StandardReal;
                angularTolerance: StandardReal): StandardBoolean {.noSideEffect,
    importcpp: "IsCoplanar", header: "gp_Ax2.hxx".}
...
proc mirrored*(this: Ax2; a2: Ax2): Ax2 {.noSideEffect, importcpp: "Mirrored",
                                    header: "gp_Ax2.hxx".}
proc rotate*(this: var Ax2; a1: Ax1; ang: StandardReal) {.importcpp: "Rotate",
    header: "gp_Ax2.hxx".}
proc rotated*(this: Ax2; a1: Ax1; ang: StandardReal): Ax2 {.noSideEffect,
    importcpp: "Rotated", header: "gp_Ax2.hxx".}
proc scale*(this: var Ax2; p: Pnt; s: StandardReal) {.importcpp: "Scale",
    header: "gp_Ax2.hxx".}
proc scaled*(this: Ax2; p: Pnt; s: StandardReal): Ax2 {.noSideEffect,
...
proc initFromJson*(this: var Ax2; theSStream: StandardSStream; theStreamPos: var int): StandardBoolean {.
