...
proc setYDirection*(this: var Ax3; vy: Dir) {.importcpp: "SetYDirection",
                                        header: "gp_Ax3.hxx".}
proc angle*(this: Ax3; other: Ax3): float {.noSideEffect, importcpp: "Angle",
                                      header: "gp_Ax3.hxx".}
...
proc yDirection*(this: Ax3): Dir {.noSideEffect, importcpp: "YDirection",
                               header: "gp_Ax3.hxx".}
proc direct*(this: Ax3): bool {.noSideEffect, importcpp: "Direct", header: "gp_Ax3.hxx".}
proc isCoplanar*(this: Ax3; other: Ax3; linearTolerance: float; angularTolerance: float): bool {.
    noSideEffect, importcpp: "IsCoplanar", header: "gp_Ax3.hxx".}
proc isCoplanar*(this: Ax3; a1: Ax1; linearTolerance: float; angularTolerance: float): bool {.
    noSideEffect, importcpp: "IsCoplanar", header: "gp_Ax3.hxx".}
...
proc mirrored*(this: Ax3; a2: Ax2): Ax3 {.noSideEffect, importcpp: "Mirrored",
                                    header: "gp_Ax3.hxx".}
proc rotate*(this: var Ax3; a1: Ax1; ang: float) {.importcpp: "Rotate",
    header: "gp_Ax3.hxx".}
proc rotated*(this: Ax3; a1: Ax1; ang: float): Ax3 {.noSideEffect, importcpp: "Rotated",
    header: "gp_Ax3.hxx".}
proc scale*(this: var Ax3; p: Pnt; s: float) {.importcpp: "Scale", header: "gp_Ax3.hxx".}
proc scaled*(this: Ax3; p: Pnt; s: float): Ax3 {.noSideEffect, importcpp: "Scaled",
    header: "gp_Ax3.hxx".}
...
proc initFromJson*(this: var Ax3; theSStream: StandardSStream; theStreamPos: var int): bool {.
