...
proc constructMat*(a11: float; a12: float; a13: float; a21: float; a22: float; a23: float;
                  a31: float; a32: float; a33: float): Mat {.constructor,
...
proc setDiagonal*(this: var Mat; x1: float; x2: float; x3: float) {.
...
proc setRotation*(this: var Mat; axis: Xyz; ang: float) {.importcpp: "SetRotation",
    header: "gp_Mat.hxx".}
...
proc setRows*(this: var Mat; row1: Xyz; row2: Xyz; row3: Xyz) {.importcpp: "SetRows",
    header: "gp_Mat.hxx".}
proc setScale*(this: var Mat; s: float) {.importcpp: "SetScale", header: "gp_Mat.hxx".}
proc setValue*(this: var Mat; row: int; col: int; value: float) {.importcpp: "SetValue",
    header: "gp_Mat.hxx".}
proc column*(this: Mat; col: int): Xyz {.noSideEffect, importcpp: "Column",
                                   header: "gp_Mat.hxx".}
proc determinant*(this: Mat): float {.noSideEffect, importcpp: "Determinant",
                                  header: "gp_Mat.hxx".}
proc diagonal*(this: Mat): Xyz {.noSideEffect, importcpp: "Diagonal",
                             header: "gp_Mat.hxx".}
proc row*(this: Mat; row: int): Xyz {.noSideEffect, importcpp: "Row",
                                header: "gp_Mat.hxx".}
proc value*(this: Mat; row: int; col: int): float {.noSideEffect, importcpp: "Value",
    header: "gp_Mat.hxx".}
proc `()`*(this: Mat; row: int; col: int): float {.noSideEffect, importcpp: "#(@)",
    header: "gp_Mat.hxx".}
proc changeValue*(this: var Mat; row: int; col: int): var float {.
    importcpp: "ChangeValue", header: "gp_Mat.hxx".}
proc `()`*(this: var Mat; row: int; col: int): var float {.importcpp: "#(@)",
    header: "gp_Mat.hxx".}
proc isSingular*(this: Mat): bool {.noSideEffect, importcpp: "IsSingular",
                                header: "gp_Mat.hxx".}
...
proc `+`*(this: Mat; other: Mat): Mat {.noSideEffect, importcpp: "(# + #)",
                                  header: "gp_Mat.hxx".}
proc divide*(this: var Mat; scalar: float) {.importcpp: "Divide", header: "gp_Mat.hxx".}
proc `/=`*(this: var Mat; scalar: float) {.importcpp: "(# /= #)", header: "gp_Mat.hxx".}
proc divided*(this: Mat; scalar: float): Mat {.noSideEffect, importcpp: "Divided",
    header: "gp_Mat.hxx".}
proc `/`*(this: Mat; scalar: float): Mat {.noSideEffect, importcpp: "(# / #)",
                                     header: "gp_Mat.hxx".}
...
proc preMultiply*(this: var Mat; other: Mat) {.importcpp: "PreMultiply",
    header: "gp_Mat.hxx".}
proc multiplied*(this: Mat; scalar: float): Mat {.noSideEffect,
    importcpp: "Multiplied", header: "gp_Mat.hxx".}
proc `*`*(this: Mat; scalar: float): Mat {.noSideEffect, importcpp: "(# * #)",
                                     header: "gp_Mat.hxx".}
proc multiply*(this: var Mat; scalar: float) {.importcpp: "Multiply",
    header: "gp_Mat.hxx".}
proc `*=`*(this: var Mat; scalar: float) {.importcpp: "(# *= #)", header: "gp_Mat.hxx".}
