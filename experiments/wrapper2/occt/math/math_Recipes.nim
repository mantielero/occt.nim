...
import
  ...
  ../Standard/Standard_Real, ../Standard/Standard_Handle,
  ../Message/Message_ProgressRange

discard "forward decl of math_IntegerVector"
discard "forward decl of math_Vector"
discard "forward decl of math_Matrix"
var math_Status_UserAborted* {.importcpp: "math_Status_UserAborted",
                             header: "math_Recipes.hxx".}: Standard_Integer

var math_Status_OK* {.importcpp: "math_Status_OK", header: "math_Recipes.hxx".}: Standard_Integer

var math_Status_SingularMatrix* {.importcpp: "math_Status_SingularMatrix",
                                header: "math_Recipes.hxx".}: Standard_Integer

var math_Status_ArgumentError* {.importcpp: "math_Status_ArgumentError",
                               header: "math_Recipes.hxx".}: Standard_Integer

var math_Status_NoConvergence* {.importcpp: "math_Status_NoConvergence",
                               header: "math_Recipes.hxx".}: Standard_Integer

proc LU_Decompose*(a: var math_Matrix; indx: var math_IntegerVector;
                  d: var Standard_Real; TINY: Standard_Real = 1.0e-20;
...
proc LU_Decompose*(a: var math_Matrix; indx: var math_IntegerVector;
                  d: var Standard_Real; vv: var math_Vector;
                  TINY: Standard_Real = 1.0e-30;
                  theProgress: Message_ProgressRange = Message_ProgressRange()): Standard_Integer {.
    importcpp: "LU_Decompose(@)", header: "math_Recipes.hxx".}
##  Idem to the previous LU_Decompose function. But the input Vector vv(1..n) is
##  used internally as a scratch area.

proc LU_Solve*(a: math_Matrix; indx: math_IntegerVector; b: var math_Vector) {.
...
proc LU_Invert*(a: var math_Matrix): Standard_Integer {.importcpp: "LU_Invert(@)",
    header: "math_Recipes.hxx".}
##  Given a matrix a(1..n, 1..n) this routine computes its inverse. The matrix
##  a is replaced by its inverse.

proc SVD_Decompose*(a: var math_Matrix; w: var math_Vector; v: var math_Matrix): Standard_Integer {.
...
proc SVD_Decompose*(a: var math_Matrix; w: var math_Vector; v: var math_Matrix;
                   rv1: var math_Vector): Standard_Integer {.
    importcpp: "SVD_Decompose(@)", header: "math_Recipes.hxx".}
...
proc SVD_Solve*(u: math_Matrix; w: math_Vector; v: math_Matrix; b: math_Vector;
               x: var math_Vector) {.importcpp: "SVD_Solve(@)",
                                  header: "math_Recipes.hxx".}
...
proc DACTCL_Decompose*(a: var math_Vector; indx: math_IntegerVector;
                      MinPivot: Standard_Real = 1.e-20): Standard_Integer {.
...
proc DACTCL_Solve*(a: math_Vector; b: var math_Vector; indx: math_IntegerVector;
                  MinPivot: Standard_Real = 1.e-20): Standard_Integer {.
...
proc Jacobi*(a: var math_Matrix; d: var math_Vector; v: var math_Matrix;
            nrot: var Standard_Integer): Standard_Integer {.importcpp: "Jacobi(@)",
    header: "math_Recipes.hxx".}
