...
genFiles("TCollection_AsciiString",
  comment = @[(113, 120)] 
)
pp("tcollection_asciistring.nim",
  replaceAll = @[("replaceNonAscii: cchar = 0", "replaceNonAscii: cchar = cchar(0)")]
)

genFiles("TCollection_BaseSequence")
genFiles("TCollection_BasicMap")
pp("tcollection_basicmap.nim",
  replaceAll = @[("""header: "TCollection_BasicMap.hxx", bycopy.} = object""", """header: "TCollection_BasicMap.hxx", bycopy.} = object of RootObj""")]
)
genFiles("TCollection_BasicMapIterator")
pp("tcollection_basicmapiterator.nim",
  replaceAll = @[(""""TCollection_BasicMapIterator.hxx", bycopy.} = object""", """"TCollection_BasicMapIterator.hxx", bycopy.} = object of RootObj""")]
)

genFiles("TCollection_ExtendedString",
  remove = @[(76, 83)],
  removeFuncBody = @[(350,352)]
)
genFiles("TCollection_HAsciiString")
genFiles("TCollection_HExtendedString")
genFiles("TCollection")
genFiles("TCollection_MapNode")
genFiles("TCollection_MapNodePtr")
genFiles("TCollection_SeqNode")
genFiles("TCollection_SeqNodePtr")
genFiles("TCollection_Side")
