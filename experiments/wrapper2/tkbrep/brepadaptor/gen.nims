...
# ls /usr/include/opencascade/BRepAdaptor*.hxx | cut -c 26-

genFiles("BRepAdaptor_Array1OfCurve")
genFiles("BRepAdaptor_CompCurve")
genFiles("BRepAdaptor_Curve2d")
genFiles("BRepAdaptor_Curve")
genFiles("BRepAdaptor_HArray1OfCurve")
genFiles("BRepAdaptor_HCompCurve",
  comment = @[(80, 92)]
)

genFiles("BRepAdaptor_HCurve2d",
  comment = @[(76, 88)]
)
genFiles("BRepAdaptor_HCurve",
  comment = @[(80, 92)]
)

genFiles("BRepAdaptor_HSurface",
  comment = @[(76, 88)]
)
genFiles("BRepAdaptor_Surface")
