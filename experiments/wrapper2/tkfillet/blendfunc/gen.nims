...
# ls /usr/include/opencascade/BlendFunc*.hxx | cut -c 26-



genFiles("BlendFunc_Chamfer")
genFiles("BlendFunc_ChamfInv")
genFiles("BlendFunc_ChAsym")
genFiles("BlendFunc_ChAsymInv")
genFiles("BlendFunc_ConstRad")
genFiles("BlendFunc_ConstRadInv")
genFiles("BlendFunc_ConstThroat")
genFiles("BlendFunc_ConstThroatInv")
genFiles("BlendFunc_ConstThroatWithPenetration")
genFiles("BlendFunc_ConstThroatWithPenetrationInv")
genFiles("BlendFunc_Corde")
genFiles("BlendFunc_CSCircular")
genFiles("BlendFunc_CSConstRad")
genFiles("BlendFunc_EvolRad")
genFiles("BlendFunc_EvolRadInv")
genFiles("BlendFunc_GenChamfer")
genFiles("BlendFunc_GenChamfInv")
genFiles("BlendFunc")
genFiles("BlendFunc_Ruled")
genFiles("BlendFunc_RuledInv")
genFiles("BlendFunc_SectionShape")
genFiles("BlendFunc_Tensor")
