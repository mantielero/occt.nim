...
proc newGeom2dOffsetCurve*(c: Handle[Geom2dCurve]; offset: cfloat;
    ...
    constructor, importcpp: "Geom2d_OffsetCurve(@)", dynlib: tkernel.}
proc reverse*(this: var Geom2dOffsetCurve) {.cdecl, importcpp: "Reverse",
    dynlib: tkernel.}
...
proc offset*(this: Geom2dOffsetCurve): cfloat {.noSideEffect, cdecl,
    importcpp: "Offset", dynlib: tkernel.}
...
proc getBasisCurveContinuity*(this: Geom2dOffsetCurve): GeomAbsShape {.noSideEffect,
    cdecl, importcpp: "GetBasisCurveContinuity", dynlib: tkernel.}
