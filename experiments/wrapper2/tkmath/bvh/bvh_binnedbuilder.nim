...
when defined(win32) and defined(max):
  discard
...
proc splitPrimitives*[T; N: static[cint]](theSet: ptr BVH_Set[T, N];
                                       theBox: BVH_Box[T, N]; theBeg: cint;
                                       theEnd: cint; theBin: cint; theAxis: cint;
...
type
  ...
  BVH_AxisSelectorBVH_VecNt*[T; N] = Type[T, N]
