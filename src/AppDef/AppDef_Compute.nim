...
proc constructAppDefCompute*(line: AppDefMultiLine; degreemin: cint = 4;
                            degreemax: cint = 8; tolerance3d: cfloat = 1.0e-3;
                            tolerance2d: cfloat = 1.0e-6; nbIterations: cint = 5;
...
proc constructAppDefCompute*(line: AppDefMultiLine; parameters: MathVector;
                            ...
                            tolerance2d: cfloat = 1.0e-06; nbIterations: cint = 5;
                            cutting: bool = true; squares: bool = false): AppDefCompute {.
    constructor, importcpp: "AppDef_Compute(@)", header: "AppDef_Compute.hxx".}
proc constructAppDefCompute*(parameters: MathVector; degreemin: cint = 4;
                            degreemax: cint = 8; tolerance3d: cfloat = 1.0e-03;
                            tolerance2d: cfloat = 1.0e-06; nbIterations: cint = 5;
                            cutting: bool = true; squares: bool = false): AppDefCompute {.
    constructor, importcpp: "AppDef_Compute(@)", header: "AppDef_Compute.hxx".}
proc constructAppDefCompute*(degreemin: cint = 4; degreemax: cint = 8;
                            tolerance3d: cfloat = 1.0e-03;
                            tolerance2d: cfloat = 1.0e-06; nbIterations: cint = 5;
                            cutting: bool = true; parametrization: ApproxParametrizationType = approxChordLength;
                            squares: bool = false): AppDefCompute {.constructor,
    importcpp: "AppDef_Compute(@)", header: "AppDef_Compute.hxx".}
proc init*(this: var AppDefCompute; degreemin: cint = 4; degreemax: cint = 8;
...
proc setDegrees*(this: var AppDefCompute; degreemin: cint; degreemax: cint) {.
    importcpp: "SetDegrees", header: "AppDef_Compute.hxx".}
proc setTolerances*(this: var AppDefCompute; tolerance3d: cfloat; tolerance2d: cfloat) {.
...
proc error*(this: AppDefCompute; index: cint; tol3d: var cfloat; tol2d: var cfloat) {.
    noSideEffect, importcpp: "Error", header: "AppDef_Compute.hxx".}
proc nbMultiCurves*(this: AppDefCompute): cint {.noSideEffect,
    importcpp: "NbMultiCurves", header: "AppDef_Compute.hxx".}
proc value*(this: AppDefCompute; index: cint = 1): AppParCurvesMultiCurve {.
    noSideEffect, importcpp: "Value", header: "AppDef_Compute.hxx".}
proc changeValue*(this: var AppDefCompute; index: cint = 1): var AppParCurvesMultiCurve {.
...
proc parameters*(this: AppDefCompute; index: cint = 1): TColStdArray1OfReal {.
