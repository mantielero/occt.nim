...
proc uDegree*(this: ApproxSweepApproximation): cint {.noSideEffect,
    importcpp: "UDegree", header: "Approx_SweepApproximation.hxx".}
proc vDegree*(this: ApproxSweepApproximation): cint {.noSideEffect,
...
proc maxErrorOnSurf*(this: ApproxSweepApproximation): cfloat {.noSideEffect,
...
proc nbCurves2d*(this: ApproxSweepApproximation): cint {.noSideEffect,
...
proc curves2dShape*(this: ApproxSweepApproximation; degree: var cint;
                   nbPoles: var cint; nbKnots: var cint) {.noSideEffect,
...
proc curves2dDegree*(this: ApproxSweepApproximation): cint {.noSideEffect,
