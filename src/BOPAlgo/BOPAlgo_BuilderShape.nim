...
proc isDeleted*(this: var BOPAlgoBuilderShape; theS: TopoDS_Shape): bool {.
    importcpp: "IsDeleted", header: "BOPAlgo_BuilderShape.hxx".}
proc hasModified*(this: BOPAlgoBuilderShape): bool {.noSideEffect,
    importcpp: "HasModified", header: "BOPAlgo_BuilderShape.hxx".}
proc hasGenerated*(this: BOPAlgoBuilderShape): bool {.noSideEffect,
    importcpp: "HasGenerated", header: "BOPAlgo_BuilderShape.hxx".}
proc hasDeleted*(this: BOPAlgoBuilderShape): bool {.noSideEffect,
...
proc setToFillHistory*(this: var BOPAlgoBuilderShape; theHistFlag: bool) {.
