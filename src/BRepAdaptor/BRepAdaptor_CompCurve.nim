...
proc `new`*(this: var BRepAdaptorCompCurve; theSize: csize_t): pointer {.
    importcpp: "BRepAdaptor_CompCurve::operator new",
    header: "BRepAdaptor_CompCurve.hxx".}
proc `delete`*(this: var BRepAdaptorCompCurve; theAddress: pointer) {.
    importcpp: "BRepAdaptor_CompCurve::operator delete",
    header: "BRepAdaptor_CompCurve.hxx".}
proc `new[]`*(this: var BRepAdaptorCompCurve; theSize: csize_t): pointer {.
    importcpp: "BRepAdaptor_CompCurve::operator new[]",
    header: "BRepAdaptor_CompCurve.hxx".}
proc `delete[]`*(this: var BRepAdaptorCompCurve; theAddress: pointer) {.
    importcpp: "BRepAdaptor_CompCurve::operator delete[]",
    header: "BRepAdaptor_CompCurve.hxx".}
proc `new`*(this: var BRepAdaptorCompCurve; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "BRepAdaptor_CompCurve::operator new",
    header: "BRepAdaptor_CompCurve.hxx".}
proc `delete`*(this: var BRepAdaptorCompCurve; a2: pointer; a3: pointer) {.
    importcpp: "BRepAdaptor_CompCurve::operator delete",
    header: "BRepAdaptor_CompCurve.hxx".}
...
proc constructBRepAdaptorCompCurve*(w: TopoDS_Wire; knotByCurvilinearAbcissa: StandardBoolean = false): BRepAdaptorCompCurve {.
...
proc value*(this: BRepAdaptorCompCurve; u: StandardReal): Pnt {.noSideEffect,
    importcpp: "Value", header: "BRepAdaptor_CompCurve.hxx".}
proc d0*(this: BRepAdaptorCompCurve; u: StandardReal; p: var Pnt) {.noSideEffect,
    importcpp: "D0", header: "BRepAdaptor_CompCurve.hxx".}
proc d1*(this: BRepAdaptorCompCurve; u: StandardReal; p: var Pnt; v: var Vec) {.
    noSideEffect, importcpp: "D1", header: "BRepAdaptor_CompCurve.hxx".}
proc d2*(this: BRepAdaptorCompCurve; u: StandardReal; p: var Pnt; v1: var Vec; v2: var Vec) {.
    noSideEffect, importcpp: "D2", header: "BRepAdaptor_CompCurve.hxx".}
proc d3*(this: BRepAdaptorCompCurve; u: StandardReal; p: var Pnt; v1: var Vec; v2: var Vec;
        v3: var Vec) {.noSideEffect, importcpp: "D3",
                    header: "BRepAdaptor_CompCurve.hxx".}
proc dn*(this: BRepAdaptorCompCurve; u: StandardReal; n: int): Vec {.noSideEffect,
