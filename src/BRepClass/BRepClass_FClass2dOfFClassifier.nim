...
proc reset*(this: var BRepClassFClass2dOfFClassifier; L: Lin2d; p: float; tol: float) {.
    importcpp: "Reset", header: "BRepClass_FClass2dOfFClassifier.hxx".}
...
proc parameter*(this: BRepClassFClass2dOfFClassifier): float {.noSideEffect,
...
proc closestIntersection*(this: BRepClassFClass2dOfFClassifier): int {.noSideEffect,
    importcpp: "ClosestIntersection",
    header: "BRepClass_FClass2dOfFClassifier.hxx".}
...
proc isHeadOrEnd*(this: BRepClassFClass2dOfFClassifier): bool {.noSideEffect,
    importcpp: "IsHeadOrEnd", header: "BRepClass_FClass2dOfFClassifier.hxx".}
