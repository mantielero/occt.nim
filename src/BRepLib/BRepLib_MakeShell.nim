...
proc `new`*(this: var BRepLibMakeShell; theSize: csize_t): pointer {.
    importcpp: "BRepLib_MakeShell::operator new", header: "BRepLib_MakeShell.hxx".}
proc `delete`*(this: var BRepLibMakeShell; theAddress: pointer) {.
    importcpp: "BRepLib_MakeShell::operator delete",
    header: "BRepLib_MakeShell.hxx".}
proc `new[]`*(this: var BRepLibMakeShell; theSize: csize_t): pointer {.
    importcpp: "BRepLib_MakeShell::operator new[]",
    header: "BRepLib_MakeShell.hxx".}
proc `delete[]`*(this: var BRepLibMakeShell; theAddress: pointer) {.
    importcpp: "BRepLib_MakeShell::operator delete[]",
    header: "BRepLib_MakeShell.hxx".}
proc `new`*(this: var BRepLibMakeShell; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "BRepLib_MakeShell::operator new", header: "BRepLib_MakeShell.hxx".}
proc `delete`*(this: var BRepLibMakeShell; a2: pointer; a3: pointer) {.
    importcpp: "BRepLib_MakeShell::operator delete",
    header: "BRepLib_MakeShell.hxx".}
...
proc constructBRepLibMakeShell*(s: Handle[GeomSurface];
                               segment: StandardBoolean = false): BRepLibMakeShell {.
...
proc init*(this: var BRepLibMakeShell; s: Handle[GeomSurface]; uMin: StandardReal;
          ...
          segment: StandardBoolean = false) {.importcpp: "Init",
    header: "BRepLib_MakeShell.hxx".}
