...
proc `new`*(this: var ChFi2dBuilder; theSize: csize_t): pointer {.
    importcpp: "ChFi2d_Builder::operator new", header: "ChFi2d_Builder.hxx".}
proc `delete`*(this: var ChFi2dBuilder; theAddress: pointer) {.
    importcpp: "ChFi2d_Builder::operator delete", header: "ChFi2d_Builder.hxx".}
proc `new[]`*(this: var ChFi2dBuilder; theSize: csize_t): pointer {.
    importcpp: "ChFi2d_Builder::operator new[]", header: "ChFi2d_Builder.hxx".}
proc `delete[]`*(this: var ChFi2dBuilder; theAddress: pointer) {.
    importcpp: "ChFi2d_Builder::operator delete[]", header: "ChFi2d_Builder.hxx".}
proc `new`*(this: var ChFi2dBuilder; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "ChFi2d_Builder::operator new", header: "ChFi2d_Builder.hxx".}
proc `delete`*(this: var ChFi2dBuilder; a2: pointer; a3: pointer) {.
    importcpp: "ChFi2d_Builder::operator delete", header: "ChFi2d_Builder.hxx".}
...
proc addFillet*(this: var ChFi2dBuilder; v: TopoDS_Vertex; radius: StandardReal): TopoDS_Edge {.
    importcpp: "AddFillet", header: "ChFi2d_Builder.hxx".}
proc modifyFillet*(this: var ChFi2dBuilder; fillet: TopoDS_Edge; radius: StandardReal): TopoDS_Edge {.
...
proc addChamfer*(this: var ChFi2dBuilder; e1: TopoDS_Edge; e2: TopoDS_Edge;
                d1: StandardReal; d2: StandardReal): TopoDS_Edge {.
    importcpp: "AddChamfer", header: "ChFi2d_Builder.hxx".}
proc addChamfer*(this: var ChFi2dBuilder; e: TopoDS_Edge; v: TopoDS_Vertex;
                d: StandardReal; ang: StandardReal): TopoDS_Edge {.
    importcpp: "AddChamfer", header: "ChFi2d_Builder.hxx".}
...
proc result*(this: ChFi2dBuilder): TopoDS_Face {.noSideEffect, importcpp: "Result",
    header: "ChFi2d_Builder.hxx".}
proc isModified*(this: ChFi2dBuilder; e: TopoDS_Edge): StandardBoolean {.noSideEffect,
...
proc nbChamfer*(this: ChFi2dBuilder): int {.noSideEffect, importcpp: "NbChamfer",
                                        header: "ChFi2d_Builder.hxx".}
proc hasDescendant*(this: ChFi2dBuilder; e: TopoDS_Edge): StandardBoolean {.
