...
proc curve*(this: ChFiDS_Stripe; first: StandardBoolean): int {.noSideEffect,
    importcpp: "Curve", header: "ChFiDS_Stripe.hxx".}
proc setCurve*(this: var ChFiDS_Stripe; index: int; first: StandardBoolean) {.
...
proc setOrientation*(this: var ChFiDS_Stripe; `or`: TopAbsOrientation;
    ...
    header: "ChFiDS_Stripe.hxx".}
proc indexPoint*(this: ChFiDS_Stripe; first: StandardBoolean; onS: int): int {.
    noSideEffect, importcpp: "IndexPoint", header: "ChFiDS_Stripe.hxx".}
proc setIndexPoint*(this: var ChFiDS_Stripe; index: int; first: StandardBoolean;
                   onS: int) {.importcpp: "SetIndexPoint",
                             header: "ChFiDS_Stripe.hxx".}
...
proc setSolidIndex*(this: var ChFiDS_Stripe; index: int) {.importcpp: "SetSolidIndex",
    header: "ChFiDS_Stripe.hxx".}
proc inDS*(this: var ChFiDS_Stripe; first: StandardBoolean; nb: int = 1) {.
    importcpp: "InDS", header: "ChFiDS_Stripe.hxx".}
proc isInDS*(this: ChFiDS_Stripe; first: StandardBoolean): int {.noSideEffect,
