...
proc isIdentical*(this: ExprArgCosh; other: Handle[ExprGeneralExpression]): bool {.
    noSideEffect, importcpp: "IsIdentical", header: "Expr_ArgCosh.hxx".}
proc isLinear*(this: ExprArgCosh): bool {.noSideEffect, importcpp: "IsLinear",
