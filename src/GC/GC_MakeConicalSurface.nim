...
proc constructor_GC_MakeConicalSurface*(A2: gp_Ax2, Ang: cdouble, Radius: cdouble): GC_MakeConicalSurface {.constructor,importcpp: "GC_MakeConicalSurface(@)".}
...
proc constructor_GC_MakeConicalSurface*(P1: gp_Pnt, P2: gp_Pnt, R1: cdouble, R2: cdouble): GC_MakeConicalSurface {.constructor,importcpp: "GC_MakeConicalSurface(@)".}
