...
proc constructor_GC_MakeRotation*(Line: gp_Lin, Angle: cdouble): GC_MakeRotation {.constructor,importcpp: "GC_MakeRotation(@)".}
  ## Constructs a rotation through angle Angle about the axis defined by
  ## the line Line.

proc constructor_GC_MakeRotation*(Axis: gp_Ax1, Angle: cdouble): GC_MakeRotation {.constructor,importcpp: "GC_MakeRotation(@)".}
  ## Constructs a rotation through angle Angle about the axis defined by
  ## the axis Axis.

proc constructor_GC_MakeRotation*(Point: gp_Pnt, Direc: gp_Dir, Angle: cdouble): GC_MakeRotation {.constructor,importcpp: "GC_MakeRotation(@)".}
  ## Constructs a rotation through angle Angle about the axis defined by
