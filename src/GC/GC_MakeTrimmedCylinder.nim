...
proc constructor_GC_MakeTrimmedCylinder*(Circ: gp_Circ, Height: cdouble): GC_MakeTrimmedCylinder {.constructor,importcpp: "GC_MakeTrimmedCylinder(@)".}
...
proc constructor_GC_MakeTrimmedCylinder*(A1: gp_Ax1, Radius: cdouble, Height: cdouble): GC_MakeTrimmedCylinder {.constructor,importcpp: "GC_MakeTrimmedCylinder(@)".}
