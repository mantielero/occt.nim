...
proc constructGccAnaPnt2dBisec*(point1: Pnt2d; point2: Pnt2d): GccAnaPnt2dBisec {.
    constructor, importcpp: "GccAna_Pnt2dBisec(@)", header: "GccAna_Pnt2dBisec.hxx".}
proc isDone*(this: GccAnaPnt2dBisec): bool {.noSideEffect, importcpp: "IsDone",
    header: "GccAna_Pnt2dBisec.hxx".}
proc hasSolution*(this: GccAnaPnt2dBisec): bool {.noSideEffect,
