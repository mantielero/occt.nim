...
proc constructGccEntQualifiedLin*(qualified: Lin2d; qualifier: GccEntPosition): GccEntQualifiedLin {.
    constructor, importcpp: "GccEnt_QualifiedLin(@)",
    header: "GccEnt_QualifiedLin.hxx".}
proc qualified*(this: GccEntQualifiedLin): Lin2d {.noSideEffect,
...
proc isUnqualified*(this: GccEntQualifiedLin): bool {.noSideEffect,
    importcpp: "IsUnqualified", header: "GccEnt_QualifiedLin.hxx".}
proc isEnclosed*(this: GccEntQualifiedLin): bool {.noSideEffect,
