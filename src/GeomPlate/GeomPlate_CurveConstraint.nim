...
proc order*(this: GeomPlateCurveConstraint): int {.noSideEffect, importcpp: "Order",
    header: "GeomPlate_CurveConstraint.hxx".}
proc nbPoints*(this: GeomPlateCurveConstraint): int {.noSideEffect,
    importcpp: "NbPoints", header: "GeomPlate_CurveConstraint.hxx".}
proc setNbPoints*(this: var GeomPlateCurveConstraint; newNb: int) {.
