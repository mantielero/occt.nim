...
## !
## ! Contains the shape geometry information as vtkPolyData. class IVtkVTK_ShapeData : public IVtk_IShapeData { public : static const char * ARRNAME_SUBSHAPE_IDS ( ) { return SUBSHAPE_IDS ; } static const char * ARRNAME_MESH_TYPES ( ) { return MESH_TYPES ; } typedef Handle ( IVtkVTK_ShapeData ) Handle ; ! Constructor IVtkVTK_ShapeData ( ) ; ! Destructor ~ IVtkVTK_ShapeData ( ) ; public : typedef IVtk_IShapeData base_type ; static const char * get_type_name ( ) { return IVtkVTK_ShapeData ; } static const Handle ( Standard_Type ) & get_type_descriptor ( ) ; virtual const Handle ( Standard_Type ) & DynamicType ( ) const ; ! Insert a coordinate
## ! @param [in] theX X coordinate
## ! @param [in] theY Y coordinate
## ! @param [in] theZ Z coordinate
## ! @return id of added point virtual IVtk_PointId InsertCoordinate ( double theX , double theY , double theZ ) ; ! Insert a vertex.
...
## ! @param [in] theMeshType mesh type of the subshape (MT_Undefined by default) virtual void InsertVertex ( const IVtk_IdType theShapeID , const IVtk_PointId thePointId , const IVtk_MeshType theMeshType ) ; ! Insert a line.
...
## ! @param [in] theMeshType mesh type of the subshape (MT_Undefined by default) virtual void InsertLine ( const IVtk_IdType theShapeID , const IVtk_PointId thePointId1 , const IVtk_PointId thePointId2 , const IVtk_MeshType theMeshType ) ; ! Insert a poly-line.
## ! @param [in] theShapeID id of the subshape to which the polyline belongs.
## ! @param [in] thePointIds vector of point ids
## ! @param [in] theMeshType mesh type of the subshape (MT_Undefined by default) virtual void InsertLine ( const IVtk_IdType theShapeID , const IVtk_PointIdList * thePointIds , const IVtk_MeshType theMeshType ) ; ! Insert a triangle
## ! @param [in] theShapeID id of the subshape to which the triangle belongs.
## ! @param [in] thePointId1 id of the first point
## ! @param [in] thePointId2 id of the second point
## ! @param [in] thePointId3 id of the third point
## ! @param [in] theMeshType mesh type of the subshape (MT_Undefined by default) virtual void InsertTriangle ( const IVtk_IdType theShapeID , const IVtk_PointId thePointId1 , const IVtk_PointId thePointId2 , const IVtk_PointId thePointId3 , const IVtk_MeshType theMeshType ) ; public : ! @name Specific methods ! Get VTK PolyData.
