...
proc userBreak*(this: MessageProgressRange): bool {.noSideEffect,
    importcpp: "UserBreak", header: "Message_ProgressRange.hxx".}
proc more*(this: MessageProgressRange): bool {.noSideEffect, importcpp: "More",
    header: "Message_ProgressRange.hxx".}
proc isActive*(this: MessageProgressRange): bool {.noSideEffect,
