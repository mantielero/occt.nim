...
proc constructTopoDS_Shape*(): TopoDS_Shape {.constructor,importcpp: "TopoDS_Shape::TopoDS_Shape".}
...
proc ` new`*(this: var TopoDS_Shape, a00: cint, theAddress: pointer)  {.importcpp: "#  new #".}

proc ` delete`*(this: var TopoDS_Shape, a00: pointer, a01: pointer)  {.importcpp: "#  delete #".}

proc isNull*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "IsNull".}
...
proc free*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Free".}
    ## Returns the free flag.

proc free*(this: var TopoDS_Shape, theIsFree: Standard_Boolean)  {.importcpp: "Free".}
    ## Sets the free flag.

proc locked*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Locked".}
    ## Returns the locked flag.

proc locked*(this: var TopoDS_Shape, theIsLocked: Standard_Boolean)  {.importcpp: "Locked".}
    ## Sets the locked flag.

proc modified*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Modified".}
    ## Returns the modification flag.

proc modified*(this: var TopoDS_Shape, theIsModified: Standard_Boolean)  {.importcpp: "Modified".}
    ## Sets the modification flag.

proc checked*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Checked".}
    ## Returns the checked flag.

proc checked*(this: var TopoDS_Shape, theIsChecked: Standard_Boolean)  {.importcpp: "Checked".}
    ## Sets the checked flag.

proc orientable*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Orientable".}
    ## Returns the orientability flag.

proc orientable*(this: var TopoDS_Shape, theIsOrientable: Standard_Boolean)  {.importcpp: "Orientable".}
    ## Sets the orientability flag.

proc closed*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Closed".}
    ## Returns the closedness flag.

proc closed*(this: var TopoDS_Shape, theIsClosed: Standard_Boolean)  {.importcpp: "Closed".}
    ## Sets the closedness flag.

proc infinite*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Infinite".}
    ## Returns the infinity flag.

proc infinite*(this: var TopoDS_Shape, theIsInfinite: Standard_Boolean)  {.importcpp: "Infinite".}
    ## Sets the infinity flag.

proc convex*(this: TopoDS_Shape): Standard_Boolean  {.importcpp: "Convex".}
    ## Returns the convexness flag.

proc convex*(this: var TopoDS_Shape, theIsConvex: Standard_Boolean)  {.importcpp: "Convex".}
...
proc nbChildren*(this: TopoDS_Shape): Standard_Integer  {.importcpp: "NbChildren".}
    ## Returns the number of direct sub-shapes (children).

proc isPartner*(this: TopoDS_Shape, theOther: TopoDS_Shape): Standard_Boolean  {.importcpp: "IsPartner".}
    ## Returns True if two shapes are partners, i.e. if they share the same
    ## TShape. Locations and Orientations may differ.

proc isSame*(this: TopoDS_Shape, theOther: TopoDS_Shape): Standard_Boolean  {.importcpp: "IsSame".}
    ## Returns True if two shapes are same, i.e. if they share the same
    ## TShape with the same Locations. Orientations may differ.

proc isEqual*(this: TopoDS_Shape, theOther: TopoDS_Shape): Standard_Boolean  {.importcpp: "IsEqual".}
    ## Returns True if two shapes are equal, i.e. if they share the same
    ## TShape with the same Locations and Orientations.

proc `==`*(this: TopoDS_Shape, theOther: TopoDS_Shape): Standard_Boolean  {.importcpp: "# == #".}

proc isNotEqual*(this: TopoDS_Shape, theOther: TopoDS_Shape): Standard_Boolean  {.importcpp: "IsNotEqual".}
    ## Negation of the IsEqual method.

proc `!=`*(this: TopoDS_Shape, theOther: TopoDS_Shape): Standard_Boolean  {.importcpp: "# != #".}

proc hashCode*(this: TopoDS_Shape, theUpperBound: Standard_Integer): Standard_Integer  {.importcpp: "HashCode".}
...
proc dumpJson*(this: TopoDS_Shape, theOStream: var Standard_OStream, theDepth: Standard_Integer = 1)  {.importcpp: "DumpJson".}
