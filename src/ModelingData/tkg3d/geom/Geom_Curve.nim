...
proc reversedParameter*(this: Geom_Curve, U: Standard_Real): Standard_Real  {.importcpp: "ReversedParameter".}
    ## Returns the parameter on the reversed curve for the point of parameter
    ## U on <me>.

proc transformedParameter*(this: Geom_Curve, U: Standard_Real, T: gp_Trsf): Standard_Real  {.importcpp: "TransformedParameter".}
    ## Returns the parameter on the transformed curve for the transform of
    ## the point of parameter U on <me>.

proc parametricTransformation*(this: Geom_Curve, T: gp_Trsf): Standard_Real  {.importcpp: "ParametricTransformation".}
...
proc isPeriodic*(this: Geom_Curve): Standard_Boolean  {.importcpp: "IsPeriodic".}
...
proc period*(this: Geom_Curve): Standard_Real  {.importcpp: "Period".}
...
proc isCN*(this: Geom_Curve, N: Standard_Integer): Standard_Boolean  {.importcpp: "IsCN".}
    ## Returns true if the degree of continuity of this curve is at least N.
    ## Exceptions - Standard_RangeError if N is less than 0.

proc d0*(this: Geom_Curve, U: Standard_Real, P: var gp_Pnt)  {.importcpp: "D0".}
...
proc d1*(this: Geom_Curve, U: Standard_Real, P: var gp_Pnt, V1: var gp_Vec)  {.importcpp: "D1".}
    ## Returns the point P of parameter U and the first derivative V1. Raised
    ## if the continuity of the curve is not C1.

proc d2*(this: Geom_Curve, U: Standard_Real, P: var gp_Pnt, V1: var gp_Vec, V2: var gp_Vec)  {.importcpp: "D2".}
...
proc d3*(this: Geom_Curve, U: Standard_Real, P: var gp_Pnt, V1: var gp_Vec, V2: var gp_Vec, V3: var gp_Vec)  {.importcpp: "D3".}
...
proc dN*(this: Geom_Curve, U: Standard_Real, N: Standard_Integer): gp_Vec  {.importcpp: "DN".}
...
proc value*(this: Geom_Curve, U: Standard_Real): gp_Pnt  {.importcpp: "Value".}
...
proc dumpJson*(this: Geom_Curve, theOStream: var Standard_OStream, theDepth: Standard_Integer = 1)  {.importcpp: "DumpJson".}
