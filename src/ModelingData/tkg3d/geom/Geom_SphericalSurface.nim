...
proc constructGeom_SphericalSurface*(A3: gp_Ax3, Radius: Standard_Real): Geom_SphericalSurface {.constructor,importcpp: "Geom_SphericalSurface::Geom_SphericalSurface(@)".}
...
proc setRadius*(this: var Geom_SphericalSurface, R: Standard_Real)  {.importcpp: "SetRadius".}
...
proc uReversedParameter*(this: Geom_SphericalSurface, U: Standard_Real): Standard_Real  {.importcpp: "UReversedParameter".}
...
proc vReversedParameter*(this: Geom_SphericalSurface, V: Standard_Real): Standard_Real  {.importcpp: "VReversedParameter".}
...
proc area*(this: Geom_SphericalSurface): Standard_Real  {.importcpp: "Area".}
    ## Computes the aera of the spherical surface.

proc bounds*(this: Geom_SphericalSurface, U1: var Standard_Real, U2: var Standard_Real, V1: var Standard_Real, V2: var Standard_Real)  {.importcpp: "Bounds".}
    ## Returns the parametric bounds U1, U2, V1 and V2 of this sphere. For a
    ## sphere: U1 = 0, U2 = 2*PI, V1 = -PI/2, V2 = PI/2.

proc coefficients*(this: Geom_SphericalSurface, A1: var Standard_Real, A2: var Standard_Real, A3: var Standard_Real, B1: var Standard_Real, B2: var Standard_Real, B3: var Standard_Real, C1: var Standard_Real, C2: var Standard_Real, C3: var Standard_Real, D: var Standard_Real)  {.importcpp: "Coefficients".}
...
proc radius*(this: Geom_SphericalSurface): Standard_Real  {.importcpp: "Radius".}
...
proc volume*(this: Geom_SphericalSurface): Standard_Real  {.importcpp: "Volume".}
    ## Computes the volume of the spherical surface.

proc isUClosed*(this: Geom_SphericalSurface): Standard_Boolean  {.importcpp: "IsUClosed".}
    ## Returns True.

proc isVClosed*(this: Geom_SphericalSurface): Standard_Boolean  {.importcpp: "IsVClosed".}
    ## Returns False.

proc isUPeriodic*(this: Geom_SphericalSurface): Standard_Boolean  {.importcpp: "IsUPeriodic".}
    ## Returns True.

proc isVPeriodic*(this: Geom_SphericalSurface): Standard_Boolean  {.importcpp: "IsVPeriodic".}
    ## Returns False.

proc uIso*(this: Geom_SphericalSurface, U: Standard_Real): handle[Geom_Curve]  {.importcpp: "UIso".}
...
proc vIso*(this: Geom_SphericalSurface, V: Standard_Real): handle[Geom_Curve]  {.importcpp: "VIso".}
...
proc d0*(this: Geom_SphericalSurface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt)  {.importcpp: "D0".}
...
proc d1*(this: Geom_SphericalSurface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt, D1U: var gp_Vec, D1V: var gp_Vec)  {.importcpp: "D1".}
    ## Computes the current point and the first derivatives in the directions
    ## U and V.

proc d2*(this: Geom_SphericalSurface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt, D1U: var gp_Vec, D1V: var gp_Vec, D2U: var gp_Vec, D2V: var gp_Vec, D2UV: var gp_Vec)  {.importcpp: "D2".}
    ## Computes the current point, the first and the second derivatives in
    ## the directions U and V.

proc d3*(this: Geom_SphericalSurface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt, D1U: var gp_Vec, D1V: var gp_Vec, D2U: var gp_Vec, D2V: var gp_Vec, D2UV: var gp_Vec, D3U: var gp_Vec, D3V: var gp_Vec, D3UUV: var gp_Vec, D3UVV: var gp_Vec)  {.importcpp: "D3".}
    ## Computes the current point, the first,the second and the third
    ## derivatives in the directions U and V.

proc dN*(this: Geom_SphericalSurface, U: Standard_Real, V: Standard_Real, Nu: Standard_Integer, Nv: Standard_Integer): gp_Vec  {.importcpp: "DN".}
...
proc dumpJson*(this: Geom_SphericalSurface, theOStream: var Standard_OStream, theDepth: Standard_Integer = 1)  {.importcpp: "DumpJson".}
