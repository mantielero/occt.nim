...
proc uReversedParameter*(this: Geom_Surface, U: Standard_Real): Standard_Real  {.importcpp: "UReversedParameter".}
...
proc vReversedParameter*(this: Geom_Surface, V: Standard_Real): Standard_Real  {.importcpp: "VReversedParameter".}
    ## Returns the parameter on the Vreversed surface for the point of
    ## parameter V on <me>.

proc transformParameters*(this: Geom_Surface, U: var Standard_Real, V: var Standard_Real, T: gp_Trsf)  {.importcpp: "TransformParameters".}
...
proc bounds*(this: Geom_Surface, U1: var Standard_Real, U2: var Standard_Real, V1: var Standard_Real, V2: var Standard_Real)  {.importcpp: "Bounds".}
    ...
    ## Precision::Infinite: instead of Standard_Real::LastReal.

proc isUClosed*(this: Geom_Surface): Standard_Boolean  {.importcpp: "IsUClosed".}
...
proc isVClosed*(this: Geom_Surface): Standard_Boolean  {.importcpp: "IsVClosed".}
    ## Checks whether this surface is closed in the u parametric direction.
...
proc isUPeriodic*(this: Geom_Surface): Standard_Boolean  {.importcpp: "IsUPeriodic".}
...
proc uPeriod*(this: Geom_Surface): Standard_Real  {.importcpp: "UPeriod".}
    ## Returns the period of this surface in the u parametric direction.
    ## raises if the surface is not uperiodic.

proc isVPeriodic*(this: Geom_Surface): Standard_Boolean  {.importcpp: "IsVPeriodic".}
...
proc vPeriod*(this: Geom_Surface): Standard_Real  {.importcpp: "VPeriod".}
    ## Returns the period of this surface in the v parametric direction.
    ## raises if the surface is not vperiodic.

proc uIso*(this: Geom_Surface, U: Standard_Real): handle[Geom_Curve]  {.importcpp: "UIso".}
    ## Computes the U isoparametric curve.

proc vIso*(this: Geom_Surface, V: Standard_Real): handle[Geom_Curve]  {.importcpp: "VIso".}
...
proc isCNu*(this: Geom_Surface, N: Standard_Integer): Standard_Boolean  {.importcpp: "IsCNu".}
    ## Returns the order of continuity of the surface in the U parametric
    ## direction. Raised if N < 0.

proc isCNv*(this: Geom_Surface, N: Standard_Integer): Standard_Boolean  {.importcpp: "IsCNv".}
    ## Returns the order of continuity of the surface in the V parametric
    ## direction. Raised if N < 0.

proc d0*(this: Geom_Surface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt)  {.importcpp: "D0".}
    ## Computes the point of parameter U,V on the surface.

proc d1*(this: Geom_Surface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt, D1U: var gp_Vec, D1V: var gp_Vec)  {.importcpp: "D1".}
...
proc d2*(this: Geom_Surface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt, D1U: var gp_Vec, D1V: var gp_Vec, D2U: var gp_Vec, D2V: var gp_Vec, D2UV: var gp_Vec)  {.importcpp: "D2".}
...
proc d3*(this: Geom_Surface, U: Standard_Real, V: Standard_Real, P: var gp_Pnt, D1U: var gp_Vec, D1V: var gp_Vec, D2U: var gp_Vec, D2V: var gp_Vec, D2UV: var gp_Vec, D3U: var gp_Vec, D3V: var gp_Vec, D3UUV: var gp_Vec, D3UVV: var gp_Vec)  {.importcpp: "D3".}
...
proc dN*(this: Geom_Surface, U: Standard_Real, V: Standard_Real, Nu: Standard_Integer, Nv: Standard_Integer): gp_Vec  {.importcpp: "DN".}
    ## ---Purpose ; Computes the derivative of order Nu in the direction U
    ## and Nv in the direction V at the point P(U, V).

proc value*(this: Geom_Surface, U: Standard_Real, V: Standard_Real): gp_Pnt  {.importcpp: "Value".}
    ## Computes the point of parameter U on the surface.

proc dumpJson*(this: Geom_Surface, theOStream: var Standard_OStream, theDepth: Standard_Integer = 1)  {.importcpp: "DumpJson".}
