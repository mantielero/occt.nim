...
proc constructGeom_TrimmedCurve*(C: handle[Geom_Curve], U1: Standard_Real, U2: Standard_Real, Sense: Standard_Boolean, theAdjustPeriodic: Standard_Boolean): Geom_TrimmedCurve {.constructor,importcpp: "Geom_TrimmedCurve::Geom_TrimmedCurve(@)".}
...
proc reversedParameter*(this: Geom_TrimmedCurve, U: Standard_Real): Standard_Real  {.importcpp: "ReversedParameter".}
    ## Computes the parameter on the reversed curve for the point of
    ## parameter U on this trimmed curve.

proc setTrim*(this: var Geom_TrimmedCurve, U1: Standard_Real, U2: Standard_Real, Sense: Standard_Boolean, theAdjustPeriodic: Standard_Boolean)  {.importcpp: "SetTrim".}
...
proc isCN*(this: Geom_TrimmedCurve, N: Standard_Integer): Standard_Boolean  {.importcpp: "IsCN".}
...
proc firstParameter*(this: Geom_TrimmedCurve): Standard_Real  {.importcpp: "FirstParameter".}
...
proc isClosed*(this: Geom_TrimmedCurve): Standard_Boolean  {.importcpp: "IsClosed".}
    ## Returns True if the distance between the StartPoint and the EndPoint
    ## is lower or equal to Resolution from package gp.

proc isPeriodic*(this: Geom_TrimmedCurve): Standard_Boolean  {.importcpp: "IsPeriodic".}
    ## Always returns FALSE (independently of the type of basis curve).

proc period*(this: Geom_TrimmedCurve): Standard_Real  {.importcpp: "Period".}
...
proc lastParameter*(this: Geom_TrimmedCurve): Standard_Real  {.importcpp: "LastParameter".}
...
proc d0*(this: Geom_TrimmedCurve, U: Standard_Real, P: var gp_Pnt)  {.importcpp: "D0".}
    ## Returns in P the point of parameter U.

proc d1*(this: Geom_TrimmedCurve, U: Standard_Real, P: var gp_Pnt, V1: var gp_Vec)  {.importcpp: "D1".}
    ## Raised if the continuity of the curve is not C1.

proc d2*(this: Geom_TrimmedCurve, U: Standard_Real, P: var gp_Pnt, V1: var gp_Vec, V2: var gp_Vec)  {.importcpp: "D2".}
    ## Raised if the continuity of the curve is not C2.

proc d3*(this: Geom_TrimmedCurve, U: Standard_Real, P: var gp_Pnt, V1: var gp_Vec, V2: var gp_Vec, V3: var gp_Vec)  {.importcpp: "D3".}
    ## Raised if the continuity of the curve is not C3.

proc dN*(this: Geom_TrimmedCurve, U: Standard_Real, N: Standard_Integer): gp_Vec  {.importcpp: "DN".}
...
proc transformedParameter*(this: Geom_TrimmedCurve, U: Standard_Real, T: gp_Trsf): Standard_Real  {.importcpp: "TransformedParameter".}
    ## Returns the parameter on the transformed curve for the transform of
    ## the point of parameter U on <me>.

proc parametricTransformation*(this: Geom_TrimmedCurve, T: gp_Trsf): Standard_Real  {.importcpp: "ParametricTransformation".}
...
proc dumpJson*(this: Geom_TrimmedCurve, theOStream: var Standard_OStream, theDepth: Standard_Integer = 1)  {.importcpp: "DumpJson".}
