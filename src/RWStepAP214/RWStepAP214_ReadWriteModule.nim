...
discard "forward decl of RWStepAP214_ReadWriteModule"
type
  HandleC1C1* = Handle[RWStepAP214ReadWriteModule]
...
proc writeStep*(this: RWStepAP214ReadWriteModule; cn: cint;
