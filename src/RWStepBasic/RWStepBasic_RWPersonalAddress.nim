...
type
  RWStepBasicRWPersonalAddress* {.importcpp: "RWStepBasic_RWPersonalAddress",
                                 header: "RWStepBasic_RWPersonalAddress.hxx",
                                 bycopy.} = object


proc constructRWStepBasicRWPersonalAddress*(): RWStepBasicRWPersonalAddress {.
...
proc writeStep*(this: RWStepBasicRWPersonalAddress; sw: var StepDataStepWriter;
               ent: Handle[StepBasicPersonalAddress]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepBasic_RWPersonalAddress.hxx".}
proc share*(this: RWStepBasicRWPersonalAddress;
