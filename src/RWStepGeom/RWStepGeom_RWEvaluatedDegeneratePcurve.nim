...
type
  RWStepGeomRWEvaluatedDegeneratePcurve* {.
      importcpp: "RWStepGeom_RWEvaluatedDegeneratePcurve",
      header: "RWStepGeom_RWEvaluatedDegeneratePcurve.hxx", bycopy.} = object


proc constructRWStepGeomRWEvaluatedDegeneratePcurve*(): RWStepGeomRWEvaluatedDegeneratePcurve {.
    constructor, importcpp: "RWStepGeom_RWEvaluatedDegeneratePcurve(@)",
    header: "RWStepGeom_RWEvaluatedDegeneratePcurve.hxx".}
proc readStep*(this: RWStepGeomRWEvaluatedDegeneratePcurve;
              data: Handle[StepDataStepReaderData]; num: cint;
              ach: var Handle[InterfaceCheck];
              ent: Handle[StepGeomEvaluatedDegeneratePcurve]) {.noSideEffect,
    importcpp: "ReadStep", header: "RWStepGeom_RWEvaluatedDegeneratePcurve.hxx".}
proc writeStep*(this: RWStepGeomRWEvaluatedDegeneratePcurve;
               sw: var StepDataStepWriter;
               ent: Handle[StepGeomEvaluatedDegeneratePcurve]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepGeom_RWEvaluatedDegeneratePcurve.hxx".}
proc share*(this: RWStepGeomRWEvaluatedDegeneratePcurve;
           ent: Handle[StepGeomEvaluatedDegeneratePcurve];
