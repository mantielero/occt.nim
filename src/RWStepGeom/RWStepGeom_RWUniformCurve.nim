...
type
  RWStepGeomRWUniformCurve* {.importcpp: "RWStepGeom_RWUniformCurve",
                             header: "RWStepGeom_RWUniformCurve.hxx", bycopy.} = object


proc constructRWStepGeomRWUniformCurve*(): RWStepGeomRWUniformCurve {.constructor,
...
proc writeStep*(this: RWStepGeomRWUniformCurve; sw: var StepDataStepWriter;
               ent: Handle[StepGeomUniformCurve]) {.noSideEffect,
