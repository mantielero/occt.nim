...
type
  RWStepReprRWRepresentationRelationship* {.
      importcpp: "RWStepRepr_RWRepresentationRelationship",
      header: "RWStepRepr_RWRepresentationRelationship.hxx", bycopy.} = object


proc constructRWStepReprRWRepresentationRelationship*(): RWStepReprRWRepresentationRelationship {.
    constructor, importcpp: "RWStepRepr_RWRepresentationRelationship(@)",
    header: "RWStepRepr_RWRepresentationRelationship.hxx".}
proc readStep*(this: RWStepReprRWRepresentationRelationship;
              data: Handle[StepDataStepReaderData]; num: cint;
              ach: var Handle[InterfaceCheck];
              ent: Handle[StepReprRepresentationRelationship]) {.noSideEffect,
    importcpp: "ReadStep", header: "RWStepRepr_RWRepresentationRelationship.hxx".}
proc writeStep*(this: RWStepReprRWRepresentationRelationship;
               sw: var StepDataStepWriter;
               ent: Handle[StepReprRepresentationRelationship]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepRepr_RWRepresentationRelationship.hxx".}
proc share*(this: RWStepReprRWRepresentationRelationship;
           ent: Handle[StepReprRepresentationRelationship];
