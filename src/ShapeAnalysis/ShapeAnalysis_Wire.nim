...
discard "forward decl of ShapeAnalysis_Wire"
type
  HandleC1C1* = Handle[ShapeAnalysisWire]
...
proc constructShapeAnalysisWire*(wire: TopoDS_Wire; face: TopoDS_Face;
                                precision: cfloat): ShapeAnalysisWire {.
...
proc constructShapeAnalysisWire*(sbwd: Handle[ShapeExtendWireData];
                                face: TopoDS_Face; precision: cfloat): ShapeAnalysisWire {.
    constructor, importcpp: "ShapeAnalysis_Wire(@)",
    header: "ShapeAnalysis_Wire.hxx".}
proc init*(this: var ShapeAnalysisWire; wire: TopoDS_Wire; face: TopoDS_Face;
          precision: cfloat) {.importcpp: "Init", header: "ShapeAnalysis_Wire.hxx".}
proc init*(this: var ShapeAnalysisWire; sbwd: Handle[ShapeExtendWireData];
          face: TopoDS_Face; precision: cfloat) {.importcpp: "Init",
    header: "ShapeAnalysis_Wire.hxx".}
...
proc setSurface*(this: var ShapeAnalysisWire; surface: Handle[GeomSurface];
    ...
    header: "ShapeAnalysis_Wire.hxx".}
proc setPrecision*(this: var ShapeAnalysisWire; precision: cfloat) {.
...
proc isReady*(this: ShapeAnalysisWire): bool {.noSideEffect, importcpp: "IsReady",
    header: "ShapeAnalysis_Wire.hxx".}
proc precision*(this: ShapeAnalysisWire): cfloat {.noSideEffect,
...
proc nbEdges*(this: ShapeAnalysisWire): cint {.noSideEffect, importcpp: "NbEdges",
    header: "ShapeAnalysis_Wire.hxx".}
...
proc checkConnected*(this: var ShapeAnalysisWire; prec: cfloat = 0.0): bool {.
    importcpp: "CheckConnected", header: "ShapeAnalysis_Wire.hxx".}
proc checkSmall*(this: var ShapeAnalysisWire; precsmall: cfloat = 0.0): bool {.
...
proc checkClosed*(this: var ShapeAnalysisWire; prec: cfloat = 0.0): bool {.
...
proc checkOrder*(this: var ShapeAnalysisWire; sawo: var ShapeAnalysisWireOrder;
    ...
    importcpp: "CheckOrder", header: "ShapeAnalysis_Wire.hxx".}
proc checkConnected*(this: var ShapeAnalysisWire; num: cint; prec: cfloat = 0.0): bool {.
    importcpp: "CheckConnected", header: "ShapeAnalysis_Wire.hxx".}
proc checkSmall*(this: var ShapeAnalysisWire; num: cint; precsmall: cfloat = 0.0): bool {.
    importcpp: "CheckSmall", header: "ShapeAnalysis_Wire.hxx".}
proc checkSeam*(this: var ShapeAnalysisWire; num: cint; c1: var Handle[Geom2dCurve];
               c2: var Handle[Geom2dCurve]; cf: var cfloat; cl: var cfloat): bool {.
    importcpp: "CheckSeam", header: "ShapeAnalysis_Wire.hxx".}
proc checkSeam*(this: var ShapeAnalysisWire; num: cint): bool {.importcpp: "CheckSeam",
    header: "ShapeAnalysis_Wire.hxx".}
proc checkDegenerated*(this: var ShapeAnalysisWire; num: cint; dgnr1: var Pnt2d;
                      dgnr2: var Pnt2d): bool {.importcpp: "CheckDegenerated",
    header: "ShapeAnalysis_Wire.hxx".}
proc checkDegenerated*(this: var ShapeAnalysisWire; num: cint): bool {.
    importcpp: "CheckDegenerated", header: "ShapeAnalysis_Wire.hxx".}
proc checkGap3d*(this: var ShapeAnalysisWire; num: cint = 0): bool {.
    importcpp: "CheckGap3d", header: "ShapeAnalysis_Wire.hxx".}
proc checkGap2d*(this: var ShapeAnalysisWire; num: cint = 0): bool {.
    importcpp: "CheckGap2d", header: "ShapeAnalysis_Wire.hxx".}
proc checkCurveGap*(this: var ShapeAnalysisWire; num: cint = 0): bool {.
    importcpp: "CheckCurveGap", header: "ShapeAnalysis_Wire.hxx".}
proc checkSelfIntersectingEdge*(this: var ShapeAnalysisWire; num: cint; points2d: var IntRes2dSequenceOfIntersectionPoint;
                               points3d: var TColgpSequenceOfPnt): bool {.
    importcpp: "CheckSelfIntersectingEdge", header: "ShapeAnalysis_Wire.hxx".}
proc checkSelfIntersectingEdge*(this: var ShapeAnalysisWire; num: cint): bool {.
    importcpp: "CheckSelfIntersectingEdge", header: "ShapeAnalysis_Wire.hxx".}
proc checkIntersectingEdges*(this: var ShapeAnalysisWire; num: cint;
...
proc checkIntersectingEdges*(this: var ShapeAnalysisWire; num: cint): bool {.
    importcpp: "CheckIntersectingEdges", header: "ShapeAnalysis_Wire.hxx".}
proc checkIntersectingEdges*(this: var ShapeAnalysisWire; num1: cint; num2: cint;
                            points2d: var IntRes2dSequenceOfIntersectionPoint;
                            points3d: var TColgpSequenceOfPnt;
                            errors: var TColStdSequenceOfReal): bool {.
    importcpp: "CheckIntersectingEdges", header: "ShapeAnalysis_Wire.hxx".}
proc checkIntersectingEdges*(this: var ShapeAnalysisWire; num1: cint; num2: cint): bool {.
    importcpp: "CheckIntersectingEdges", header: "ShapeAnalysis_Wire.hxx".}
proc checkLacking*(this: var ShapeAnalysisWire; num: cint; tolerance: cfloat;
                  p2d1: var Pnt2d; p2d2: var Pnt2d): bool {.importcpp: "CheckLacking",
    header: "ShapeAnalysis_Wire.hxx".}
proc checkLacking*(this: var ShapeAnalysisWire; num: cint; tolerance: cfloat = 0.0): bool {.
...
proc checkNotchedEdges*(this: var ShapeAnalysisWire; num: cint; shortNum: var cint;
                       param: var cfloat; tolerance: cfloat = 0.0): bool {.
...
proc checkShapeConnect*(this: var ShapeAnalysisWire; shape: TopoDS_Shape;
                       prec: cfloat = 0.0): bool {.importcpp: "CheckShapeConnect",
    header: "ShapeAnalysis_Wire.hxx".}
proc checkShapeConnect*(this: var ShapeAnalysisWire; tailhead: var cfloat;
                       tailtail: var cfloat; headtail: var cfloat;
                       headhead: var cfloat; shape: TopoDS_Shape; prec: cfloat = 0.0): bool {.
...
proc checkTail*(this: var ShapeAnalysisWire; theEdge1: TopoDS_Edge;
               theEdge2: TopoDS_Edge; theMaxSine: cfloat; theMaxWidth: cfloat;
               theMaxTolerance: cfloat; theEdge11: var TopoDS_Edge;
...
proc minDistance3d*(this: ShapeAnalysisWire): cfloat {.noSideEffect,
    importcpp: "MinDistance3d", header: "ShapeAnalysis_Wire.hxx".}
proc minDistance2d*(this: ShapeAnalysisWire): cfloat {.noSideEffect,
    importcpp: "MinDistance2d", header: "ShapeAnalysis_Wire.hxx".}
proc maxDistance3d*(this: ShapeAnalysisWire): cfloat {.noSideEffect,
    importcpp: "MaxDistance3d", header: "ShapeAnalysis_Wire.hxx".}
proc maxDistance2d*(this: ShapeAnalysisWire): cfloat {.noSideEffect,
