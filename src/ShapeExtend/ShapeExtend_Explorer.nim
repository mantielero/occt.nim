...
proc seqFromCompound*(this: ShapeExtendExplorer; comp: TopoDS_Shape; expcomp: bool): Handle[
    TopToolsHSequenceOfShape] {.noSideEffect, importcpp: "SeqFromCompound",
                               header: "ShapeExtend_Explorer.hxx".}
proc listFromSeq*(this: ShapeExtendExplorer;
                 seqval: Handle[TopToolsHSequenceOfShape];
                 lisval: var TopToolsListOfShape; clear: bool = true) {.noSideEffect,
...
proc seqFromList*(this: ShapeExtendExplorer; lisval: TopToolsListOfShape): Handle[
    TopToolsHSequenceOfShape] {.noSideEffect, importcpp: "SeqFromList",
                               header: "ShapeExtend_Explorer.hxx".}
proc shapeType*(this: ShapeExtendExplorer; shape: TopoDS_Shape; compound: bool): TopAbsShapeEnum {.
    noSideEffect, importcpp: "ShapeType", header: "ShapeExtend_Explorer.hxx".}
proc sortedCompound*(this: ShapeExtendExplorer; shape: TopoDS_Shape;
    ...
    noSideEffect, importcpp: "SortedCompound", header: "ShapeExtend_Explorer.hxx".}
