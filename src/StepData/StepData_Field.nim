...
proc `new`*(this: var StepDataField; theSize: csize_t): pointer {.
    importcpp: "StepData_Field::operator new", header: "StepData_Field.hxx".}
proc `delete`*(this: var StepDataField; theAddress: pointer) {.
    importcpp: "StepData_Field::operator delete", header: "StepData_Field.hxx".}
proc `new[]`*(this: var StepDataField; theSize: csize_t): pointer {.
    importcpp: "StepData_Field::operator new[]", header: "StepData_Field.hxx".}
proc `delete[]`*(this: var StepDataField; theAddress: pointer) {.
    importcpp: "StepData_Field::operator delete[]", header: "StepData_Field.hxx".}
proc `new`*(this: var StepDataField; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "StepData_Field::operator new", header: "StepData_Field.hxx".}
proc `delete`*(this: var StepDataField; a2: pointer; a3: pointer) {.
    importcpp: "StepData_Field::operator delete", header: "StepData_Field.hxx".}
proc constructStepDataField*(): StepDataField {.constructor,
    importcpp: "StepData_Field(@)", header: "StepData_Field.hxx".}
proc constructStepDataField*(other: StepDataField; copy: StandardBoolean = false): StepDataField {.
...
proc setInteger*(this: var StepDataField; val: int = 0) {.importcpp: "SetInteger",
    header: "StepData_Field.hxx".}
proc setBoolean*(this: var StepDataField; val: StandardBoolean = false) {.
...
proc setReal*(this: var StepDataField; val: StandardReal = 0.0) {.importcpp: "SetReal",
    header: "StepData_Field.hxx".}
...
proc setInteger*(this: var StepDataField; num: int; val: int) {.importcpp: "SetInteger",
    header: "StepData_Field.hxx".}
proc setBoolean*(this: var StepDataField; num: int; val: StandardBoolean) {.
    importcpp: "SetBoolean", header: "StepData_Field.hxx".}
...
proc setEnum*(this: var StepDataField; num: int; val: int; text: StandardCString = "") {.
    importcpp: "SetEnum", header: "StepData_Field.hxx".}
proc setReal*(this: var StepDataField; num: int; val: StandardReal) {.
...
proc setEntity*(this: var StepDataField; num: int; val: Handle[StandardTransient]) {.
    importcpp: "SetEntity", header: "StepData_Field.hxx".}
proc isSet*(this: StepDataField; n1: int = 1; n2: int = 1): StandardBoolean {.noSideEffect,
...
proc kind*(this: StepDataField; `type`: StandardBoolean = true): int {.noSideEffect,
...
proc boolean*(this: StepDataField; n1: int = 1; n2: int = 1): StandardBoolean {.
...
proc real*(this: StepDataField; n1: int = 1; n2: int = 1): StandardReal {.noSideEffect,
