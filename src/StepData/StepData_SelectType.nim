...
proc caseNum*(this: StepDataSelectType; ent: Handle[StandardTransient]): cint {.
...
proc caseNumber*(this: StepDataSelectType): cint {.noSideEffect,
...
proc caseMem*(this: StepDataSelectType; ent: Handle[StepDataSelectMember]): cint {.
    noSideEffect, importcpp: "CaseMem", header: "StepData_SelectType.hxx".}
proc caseMember*(this: StepDataSelectType): cint {.noSideEffect,
...
proc int*(this: StepDataSelectType): cint {.noSideEffect, importcpp: "Int",
                                        header: "StepData_SelectType.hxx".}
proc setInt*(this: var StepDataSelectType; val: cint) {.importcpp: "SetInt",
    header: "StepData_SelectType.hxx".}
proc integer*(this: StepDataSelectType): cint {.noSideEffect, importcpp: "Integer",
    header: "StepData_SelectType.hxx".}
proc setInteger*(this: var StepDataSelectType; val: cint; name: StandardCString = "") {.
...
proc setLogical*(this: var StepDataSelectType; val: StepDataLogical;
    ...
    header: "StepData_SelectType.hxx".}
proc real*(this: StepDataSelectType): cfloat {.noSideEffect, importcpp: "Real",
    header: "StepData_SelectType.hxx".}
proc setReal*(this: var StepDataSelectType; val: cfloat; name: StandardCString = "") {.
