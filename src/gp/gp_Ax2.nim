...
proc Ax2*(): gp_Ax2 {.constructor,importcpp: "gp_Ax2".}
  ## Creates an object corresponding to the reference coordinate system
  ## (OXYZ).

proc Ax2*(P: gp_Pnt, N: gp_Dir, Vx: gp_Dir): gp_Ax2 {.constructor,importcpp: "gp_Ax2(@)".}
...
proc Ax2*(P: gp_Pnt, V: gp_Dir): gp_Ax2 {.constructor,importcpp: "gp_Ax2(@)".}
