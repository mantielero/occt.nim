...
type
  Circ* {.importcpp: "gp_Circ", header: "gp_Circ.hxx", bycopy.} = object


proc `new`*(this: var Circ; theSize: csize_t): pointer {.
    importcpp: "gp_Circ::operator new", header: "gp_Circ.hxx".}
proc `delete`*(this: var Circ; theAddress: pointer) {.
    importcpp: "gp_Circ::operator delete", header: "gp_Circ.hxx".}
proc `new[]`*(this: var Circ; theSize: csize_t): pointer {.
    importcpp: "gp_Circ::operator new[]", header: "gp_Circ.hxx".}
proc `delete[]`*(this: var Circ; theAddress: pointer) {.
    importcpp: "gp_Circ::operator delete[]", header: "gp_Circ.hxx".}
proc `new`*(this: var Circ; a2: csize_t; theAddress: pointer): pointer {.
    importcpp: "gp_Circ::operator new", header: "gp_Circ.hxx".}
proc `delete`*(this: var Circ; a2: pointer; a3: pointer) {.
    importcpp: "gp_Circ::operator delete", header: "gp_Circ.hxx".}
proc constructCirc*(): Circ {.constructor, importcpp: "gp_Circ(@)",
                           header: "gp_Circ.hxx".}
proc constructCirc*(a2: Ax2; radius: StandardReal): Circ {.constructor,
...
proc setPosition*(this: var Circ; a2: Ax2) {.importcpp: "SetPosition",
                                       header: "gp_Circ.hxx".}
proc setRadius*(this: var Circ; radius: StandardReal) {.importcpp: "SetRadius",
    header: "gp_Circ.hxx".}
proc area*(this: Circ): StandardReal {.noSideEffect, importcpp: "Area",
                                   header: "gp_Circ.hxx".}
proc axis*(this: Circ): Ax1 {.noSideEffect, importcpp: "Axis", header: "gp_Circ.hxx".}
proc length*(this: Circ): StandardReal {.noSideEffect, importcpp: "Length",
                                     header: "gp_Circ.hxx".}
proc location*(this: Circ): Pnt {.noSideEffect, importcpp: "Location",
                              header: "gp_Circ.hxx".}
proc position*(this: Circ): Ax2 {.noSideEffect, importcpp: "Position",
                              header: "gp_Circ.hxx".}
proc radius*(this: Circ): StandardReal {.noSideEffect, importcpp: "Radius",
                                     header: "gp_Circ.hxx".}
...
proc distance*(this: Circ; p: Pnt): StandardReal {.noSideEffect, importcpp: "Distance",
    header: "gp_Circ.hxx".}
proc squareDistance*(this: Circ; p: Pnt): StandardReal {.noSideEffect,
    importcpp: "SquareDistance", header: "gp_Circ.hxx".}
proc contains*(this: Circ; p: Pnt; linearTolerance: StandardReal): StandardBoolean {.
...
proc mirrored*(this: Circ; a2: Ax2): Circ {.noSideEffect, importcpp: "Mirrored",
                                      header: "gp_Circ.hxx".}
proc rotate*(this: var Circ; a1: Ax1; ang: StandardReal) {.importcpp: "Rotate",
    header: "gp_Circ.hxx".}
proc rotated*(this: Circ; a1: Ax1; ang: StandardReal): Circ {.noSideEffect,
    importcpp: "Rotated", header: "gp_Circ.hxx".}
proc scale*(this: var Circ; p: Pnt; s: StandardReal) {.importcpp: "Scale",
    header: "gp_Circ.hxx".}
proc scaled*(this: Circ; p: Pnt; s: StandardReal): Circ {.noSideEffect,
