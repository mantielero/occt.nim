...
proc MakeSegment*(P1: gp_Pnt, P2: gp_Pnt): Handle_Geom_TrimmedCurve {.constructor,importcpp: "GC_MakeSegment(@)".}
  ## Make a segment of Line from the 2 points <P1> and <P2>. It returns
  ## NullObject if <P1> and <P2> are confused.

proc MakeSegment*(Line: gp_Lin, U1: cdouble, U2: cdouble): Handle_Geom_TrimmedCurve {.constructor,importcpp: "GC_MakeSegment(@)".}
...
proc MakeSegment*(Line: gp_Lin, P1: gp_Pnt, P2: gp_Pnt): Handle_Geom_TrimmedCurve {.constructor,importcpp: "GC_MakeSegment(@)".}
