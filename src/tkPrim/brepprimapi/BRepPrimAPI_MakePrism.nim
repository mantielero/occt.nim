...
proc MakePrism*(S: TopoDS_Shape, V: gp_Vec, Copy: bool, Canonize: bool): BRepPrimAPI_MakePrism {.constructor,importcpp: "BRepPrimAPI_MakePrism(@)".}
...
proc MakePrism*(S: TopoDS_Shape, D: gp_Dir, Inf: bool, Copy: bool, Canonize: bool): BRepPrimAPI_MakePrism {.constructor,importcpp: "BRepPrimAPI_MakePrism(@)".}
