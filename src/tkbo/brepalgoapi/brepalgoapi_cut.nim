...
proc cut*(): CutObj {.cdecl, constructor,
    importcpp: "BRepAlgoAPI_Cut(@)", header: "BRepAlgoAPI_Cut.hxx".}
proc destroyBRepAlgoAPI_Cut*(this: var CutObj) {.cdecl,
    importcpp: "#.~BRepAlgoAPI_Cut()", header: "BRepAlgoAPI_Cut.hxx".}
proc cut*(pf: BOPAlgoPaveFiller): CutObj {.cdecl,
    constructor, importcpp: "BRepAlgoAPI_Cut(@)", header: "BRepAlgoAPI_Cut.hxx".}
proc cut*(s1: TopoDS_Shape; s2: TopoDS_Shape): CutObj {.cdecl,
    constructor, importcpp: "BRepAlgoAPI_Cut(@)", header: "BRepAlgoAPI_Cut.hxx".}
proc cut*(s1: TopoDS_Shape; s2: TopoDS_Shape; aDSF: BOPAlgoPaveFiller;
                        bFWD: bool = true): CutObj {.cdecl, constructor,
    importcpp: "BRepAlgoAPI_Cut(@)", header: "BRepAlgoAPI_Cut.hxx".}