...
proc newTrsf*(): TrsfObj {.cdecl, constructor, importcpp: "gp_Trsf(@)", header: "gp_Trsf.hxx".}
proc newTrsf*(t: Trsf2dObj): TrsfObj {.cdecl, constructor, importcpp: "gp_Trsf(@)",
                             header: "gp_Trsf.hxx".}
...
proc setRotation*(this: var TrsfObj; r: Quaternion) {.cdecl, importcpp: "SetRotation",
    header: "gp_Trsf.hxx".}
proc setRotationPart*(this: var TrsfObj; r: Quaternion) {.cdecl,
...
proc setTransformation*(this: var TrsfObj; toSystem: Ax3Obj) {.cdecl,
    importcpp: "SetTransformation", header: "gp_Trsf.hxx".}
proc setTransformation*(this: var TrsfObj; r: Quaternion; t: VecObj) {.cdecl,
    importcpp: "SetTransformation", header: "gp_Trsf.hxx".}
...
proc setScaleFactor*(this: var TrsfObj; s: cfloat) {.cdecl, importcpp: "SetScaleFactor",
    header: "gp_Trsf.hxx".}
proc setForm*(this: var TrsfObj; p: TrsfForm) {.cdecl, importcpp: "SetForm", header: "gp_Trsf.hxx".}
...
proc isNegative*(this: TrsfObj): bool {.noSideEffect, cdecl, importcpp: "IsNegative",
                                 header: "gp_Trsf.hxx".}
proc form*(this: TrsfObj): TrsfForm {.noSideEffect, cdecl, importcpp: "Form",
                               header: "gp_Trsf.hxx".}
...
proc getRotation*(this: TrsfObj): Quaternion {.noSideEffect, cdecl,
                                        importcpp: "GetRotation", header: "gp_Trsf.hxx".}
proc vectorialPart*(this: TrsfObj): Mat {.noSideEffect, cdecl,
                                   importcpp: "VectorialPart", header: "gp_Trsf.hxx".}
proc hVectorialPart*(this: TrsfObj): Mat {.noSideEffect, cdecl,
