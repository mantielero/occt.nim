...
proc `*=`*(this: var XyzObj; other: XyzObj) {.cdecl, importcpp: "(# *= #)", header: "gp_XYZ.hxx".}
#proc multiply*(this: var XyzObj; matrix: Mat) {.cdecl, importcpp: "Multiply", header: "gp_XYZ.hxx".}
#proc `*=`*(this: var XyzObj; matrix: Mat) {.cdecl, importcpp: "(# *= #)", header: "gp_XYZ.hxx".}
...
proc multiplied*(this: XyzObj; other: XyzObj): XyzObj {.noSideEffect, cdecl,
    importcpp: "Multiplied", header: "gp_XYZ.hxx".}
#proc multiplied*(this: XyzObj; matrix: Mat): XyzObj {.noSideEffect, cdecl,
#    importcpp: "Multiplied", header: "gp_XYZ.hxx".}
#proc `*`*(this: XyzObj; matrix: Mat): XyzObj {.noSideEffect, cdecl, importcpp: "(# * #)",
#                                   header: "gp_XYZ.hxx".}
