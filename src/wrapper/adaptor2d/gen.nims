...
# ls /usr/include/opencascade/Adaptor2d*.hxx | cut -c 26-

genFiles("Adaptor2d_Curve2d")
pp("adaptor2d_curve2d.nim",
  replaceAll = @[("= object", "= object of RootObj")]
)
genFiles("Adaptor2d_HCurve2d")
genFiles("Adaptor2d_HLine2d",
  comment = @[(76,88)]
)
genFiles("Adaptor2d_HOffsetCurve",
  comment = @[(76,88)]
)
genFiles("Adaptor2d_Line2d")
genFiles("Adaptor2d_OffsetCurve")
