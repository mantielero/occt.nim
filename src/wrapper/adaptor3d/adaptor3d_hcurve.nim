...
proc value*(this: Adaptor3dHCurve; u: cfloat): gp_Pnt {.noSideEffect, cdecl,
    importcpp: "Value", header: "Adaptor3d_HCurve.hxx".}
proc d0*(this: Adaptor3dHCurve; u: cfloat; p: var gp_Pnt) {.noSideEffect, cdecl,
    importcpp: "D0", header: "Adaptor3d_HCurve.hxx".}
proc d1*(this: Adaptor3dHCurve; u: cfloat; p: var gp_Pnt; v: var gp_Vec) {.noSideEffect, cdecl,
    importcpp: "D1", header: "Adaptor3d_HCurve.hxx".}
proc d2*(this: Adaptor3dHCurve; u: cfloat; p: var gp_Pnt; v1: var gp_Vec; v2: var gp_Vec) {.
    noSideEffect, cdecl, importcpp: "D2", header: "Adaptor3d_HCurve.hxx".}
proc d3*(this: Adaptor3dHCurve; u: cfloat; p: var gp_Pnt; v1: var gp_Vec; v2: var gp_Vec; v3: var gp_Vec) {.
    noSideEffect, cdecl, importcpp: "D3", header: "Adaptor3d_HCurve.hxx".}
proc dn*(this: Adaptor3dHCurve; u: cfloat; n: cint): gp_Vec {.noSideEffect, cdecl,
...
proc line*(this: Adaptor3dHCurve): gp_Lin {.noSideEffect, cdecl, importcpp: "Line",
                                     header: "Adaptor3d_HCurve.hxx".}
proc circle*(this: Adaptor3dHCurve): gp_Circ {.noSideEffect, cdecl, importcpp: "Circle",
                                        header: "Adaptor3d_HCurve.hxx".}
proc ellipse*(this: Adaptor3dHCurve): gp_Elips {.noSideEffect, cdecl,
    importcpp: "Ellipse", header: "Adaptor3d_HCurve.hxx".}
proc hyperbola*(this: Adaptor3dHCurve): gp_Hypr {.noSideEffect, cdecl,
    importcpp: "Hyperbola", header: "Adaptor3d_HCurve.hxx".}
proc parabola*(this: Adaptor3dHCurve): gp_Parab {.noSideEffect, cdecl,
