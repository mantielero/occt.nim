...
proc d1*(this: Adaptor3dHSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var VecObj;
        d1v: var VecObj) {.noSideEffect, cdecl, importcpp: "D1", header: "Adaptor3d_HSurface.hxx".}
proc d2*(this: Adaptor3dHSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var VecObj;
...
proc d3*(this: Adaptor3dHSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var VecObj;
