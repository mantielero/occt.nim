...
# ls /usr/include/opencascade/Adaptor3d*.hxx | cut -c 26-

genFiles("Adaptor3d_Curve")
pp("adaptor3d_curve.nim",
  replaceAll = @[("""Adaptor3dCurve* {.importcpp: "Adaptor3d_Curve", header: "Adaptor3d_Curve.hxx",
                   bycopy.} = object""",
                  """Adaptor3dCurve* {.importcpp: "Adaptor3d_Curve", header: "Adaptor3d_Curve.hxx",
                   bycopy.} = object of RootObj""")]  
)
genFiles("Adaptor3d_CurveOnSurface")
genFiles("Adaptor3d_CurveOnSurfacePtr")
genFiles("Adaptor3d_CurvePtr")
genFiles("Adaptor3d_HCurve")
genFiles("Adaptor3d_HCurveOnSurface",
  comment = @[(80, 92)]
)
genFiles("Adaptor3d_HIsoCurve",
  comment = @[(80, 92)]
)
genFiles("Adaptor3d_HSurface")
genFiles("Adaptor3d_HSurfaceTool")
genFiles("Adaptor3d_HVertex")
genFiles("Adaptor3d_InterFunc")
genFiles("Adaptor3d_IsoCurve")
genFiles("Adaptor3d_Surface")
pp("adaptor3d_surface.nim",
  replaceAll = @[("= object", "= object of RootObj")]
)
genFiles("Adaptor3d_SurfacePtr")
genFiles("Adaptor3d_TopolTool")
