...
# ls /usr/include/opencascade/AppParCurves*.hxx | cut -c 26-


genFiles("AppParCurves_Array1OfConstraintCouple")
genFiles("AppParCurves_Array1OfMultiBSpCurve")
genFiles("AppParCurves_Array1OfMultiCurve")
genFiles("AppParCurves_Array1OfMultiPoint")
genFiles("AppParCurves_ConstraintCouple")
genFiles("AppParCurves_Constraint")
pp("appparcurves_constraint.nim",
  replaceAll = @[("""AppParCurvesNoConstraint, AppParCurvesPassPoint, AppParCurvesTangencyPoint,
    AppParCurvesCurvaturePoint""",
    """appParCurvesNoConstraint, appParCurvesPassPoint, appParCurvesTangencyPoint,
    appParCurvesCurvaturePoint""")]
)
genFiles("AppParCurves_HArray1OfConstraintCouple")
genFiles("AppParCurves_HArray1OfMultiBSpCurve")
genFiles("AppParCurves_HArray1OfMultiCurve")
genFiles("AppParCurves_HArray1OfMultiPoint")
genFiles("AppParCurves")
genFiles("AppParCurves_MultiBSpCurve")
genFiles("AppParCurves_MultiCurve")
pp("appparcurves_multicurve.nim",
  replaceAll = @[("= object", "= object of RootObj")]
)
genFiles("AppParCurves_MultiPoint")
genFiles("AppParCurves_SequenceOfMultiBSpCurve")
genFiles("AppParCurves_SequenceOfMultiCurve")
