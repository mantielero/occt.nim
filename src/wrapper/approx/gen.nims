...
# ls /usr/include/opencascade/Approx*.hxx | cut -c 26-

genFiles("Approx_Array1OfAdHSurface")
genFiles("Approx_Array1OfGTrsf2d")
genFiles("Approx_Curve2d")
genFiles("Approx_Curve3d")
genFiles("Approx_CurveOnSurface")
genFiles("Approx_CurvilinearParameter")
genFiles("Approx_CurvlinFunc")
genFiles("Approx_FitAndDivide2d")
genFiles("Approx_FitAndDivide")
genFiles("Approx_HArray1OfAdHSurface")
genFiles("Approx_HArray1OfGTrsf2d")
genFiles("ApproxInt_KnotTools")
pp("approxint_knottools.nim",
  commentRange = @[(14,17)]
)
genFiles("ApproxInt_SvSurfaces")
genFiles("Approx_MCurvesToBSpCurve")
genFiles("Approx_ParametrizationType")
genFiles("Approx_SameParameter")
genFiles("Approx_SequenceOfHArray1OfReal")
genFiles("Approx_Status")
genFiles("Approx_SweepApproximation")
genFiles("Approx_SweepFunction")
