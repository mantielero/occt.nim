...
proc newBlendPoint*(pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; tg1: gp_Vec; tg2: gp_Vec; tg12d: gp_Vec2d; tg22d: gp_Vec2d): BlendPoint {.
...
proc newBlendPoint*(pts: gp_Pnt; ptc: gp_Pnt; param: cfloat; u: cfloat; v: cfloat; w: cfloat;
                   tgs: gp_Vec; tgc: gp_Vec; tg2d: gp_Vec2d): BlendPoint {.cdecl, constructor,
    importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pts: gp_Pnt; ptc: gp_Pnt; param: cfloat; u: cfloat; v: cfloat; w: cfloat): BlendPoint {.
    cdecl, constructor, importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; pc: cfloat; tg1: gp_Vec; tg2: gp_Vec; tg12d: gp_Vec2d; tg22d: gp_Vec2d): BlendPoint {.
    cdecl, constructor, importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; pc: cfloat): BlendPoint {.cdecl, constructor,
    importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; pc1: cfloat; pc2: cfloat; tg1: gp_Vec; tg2: gp_Vec; tg12d: gp_Vec2d;
                   tg22d: gp_Vec2d): BlendPoint {.cdecl, constructor,
    importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
...
proc setValue*(this: var BlendPoint; pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat;
              v1: cfloat; u2: cfloat; v2: cfloat; tg1: gp_Vec; tg2: gp_Vec; tg12d: gp_Vec2d;
              tg22d: gp_Vec2d) {.cdecl, importcpp: "SetValue", header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat;
...
proc setValue*(this: var BlendPoint; pts: gp_Pnt; ptc: gp_Pnt; param: cfloat; u: cfloat;
              v: cfloat; w: cfloat; tgs: gp_Vec; tgc: gp_Vec; tg2d: gp_Vec2d) {.cdecl,
...
proc setValue*(this: var BlendPoint; pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat;
              ...
              tg12d: gp_Vec2d; tg22d: gp_Vec2d) {.cdecl, importcpp: "SetValue",
                                        header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat;
...
proc setValue*(this: var BlendPoint; pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat;
              ...
              tg2: gp_Vec; tg12d: gp_Vec2d; tg22d: gp_Vec2d) {.cdecl, importcpp: "SetValue",
    header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: gp_Pnt; pt2: gp_Pnt; param: cfloat; u1: cfloat;
...
proc tangent2dOnS1*(this: BlendPoint): gp_Vec2d {.noSideEffect, cdecl,
    importcpp: "Tangent2dOnS1", header: "Blend_Point.hxx".}
proc tangent2dOnS2*(this: BlendPoint): gp_Vec2d {.noSideEffect, cdecl,
...
proc tangent2d*(this: BlendPoint): gp_Vec2d {.noSideEffect, cdecl,
