...
# ls /usr/include/opencascade/Blend*.hxx | cut -c 26-



genFiles("Blend_AppFunction")
genFiles("Blend_CSFunction")
genFiles("Blend_CurvPointFuncInv")
genFiles("Blend_DecrochStatus")
genFiles("Blend_FuncInv")
genFiles("Blend_Function")
genFiles("Blend_Point")
genFiles("Blend_RstRstFunction")
genFiles("Blend_SequenceOfPoint")
genFiles("Blend_Status")
genFiles("Blend_SurfCurvFuncInv")
genFiles("Blend_SurfPointFuncInv")
genFiles("Blend_SurfRstFunction")
