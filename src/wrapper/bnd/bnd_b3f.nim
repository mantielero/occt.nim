...
proc newBndB3f*(theCenter: gp_Xyz; theHSize: gp_Xyz): BndB3f {.cdecl, constructor,
...
proc add*(this: var BndB3f; thePnt: gp_Xyz) {.cdecl, importcpp: "Add", header: "Bnd_B3f.hxx".}
...
proc cornerMin*(this: BndB3f): gp_Xyz {.noSideEffect, cdecl, importcpp: "CornerMin",
                                 header: "Bnd_B3f.hxx".}
proc cornerMax*(this: BndB3f): gp_Xyz {.noSideEffect, cdecl, importcpp: "CornerMax",
                                 header: "Bnd_B3f.hxx".}
...
proc isOut*(this: BndB3f; thePnt: gp_Xyz): bool {.noSideEffect, cdecl, importcpp: "IsOut",
    header: "Bnd_B3f.hxx".}
proc isOut*(this: BndB3f; theCenter: gp_Xyz; theRadius: cfloat;
...
proc isOut*(this: BndB3f; theLine: gp_Ax1; isRay: bool = false;
           theOverthickness: cfloat = 0.0): bool {.noSideEffect, cdecl,
    importcpp: "IsOut", header: "Bnd_B3f.hxx".}
proc isOut*(this: BndB3f; thePlane: gp_Ax3): bool {.noSideEffect, cdecl,
    importcpp: "IsOut", header: "Bnd_B3f.hxx".}
...
proc setCenter*(this: var BndB3f; theCenter: gp_Xyz) {.cdecl, importcpp: "SetCenter",
    header: "Bnd_B3f.hxx".}
proc setHSize*(this: var BndB3f; theHSize: gp_Xyz) {.cdecl, importcpp: "SetHSize",
    header: "Bnd_B3f.hxx".}
