...
proc setUVPoints2*(this: var BRepCurveOnClosedSurface; p1: gp_Pnt2d; p2: gp_Pnt2d) {.cdecl,
    importcpp: "SetUVPoints2", header: "BRep_CurveOnClosedSurface.hxx".}
proc uVPoints2*(this: BRepCurveOnClosedSurface; p1: var gp_Pnt2d; p2: var gp_Pnt2d) {.
