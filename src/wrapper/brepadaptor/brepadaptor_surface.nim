...
proc d1*(this: BRepAdaptorSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
        d1v: var gp_Vec) {.noSideEffect, cdecl, importcpp: "D1", header: "BRepAdaptor_Surface.hxx".}
proc d2*(this: BRepAdaptorSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
...
proc d3*(this: BRepAdaptorSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
        ...
        d3uuv: var gp_Vec; d3uvv: var gp_Vec) {.noSideEffect, cdecl, importcpp: "D3",
                                    header: "BRepAdaptor_Surface.hxx".}
proc dn*(this: BRepAdaptorSurface; u: cfloat; v: cfloat; nu: cint; nv: cint): gp_Vec {.
...
proc plane*(this: BRepAdaptorSurface): gp_Pln {.noSideEffect, cdecl, importcpp: "Plane",
    header: "BRepAdaptor_Surface.hxx".}
...
proc axeOfRevolution*(this: BRepAdaptorSurface): gp_Ax1 {.noSideEffect, cdecl,
    importcpp: "AxeOfRevolution", header: "BRepAdaptor_Surface.hxx".}
proc direction*(this: BRepAdaptorSurface): gp_Dir {.noSideEffect, cdecl,
