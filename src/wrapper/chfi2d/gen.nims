...
# ls /usr/include/opencascade/ChFi2d*.hxx | cut -c 26-

genFiles("ChFi2d_AnaFilletAlgo")
genFiles("ChFi2d_Builder")
genFiles("ChFi2d_ChamferAPI")
genFiles("ChFi2d_ConstructionError")
genFiles("ChFi2d_FilletAlgo")
genFiles("ChFi2d_FilletAPI")
genFiles("ChFi2d")
