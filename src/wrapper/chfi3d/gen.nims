...
# ls /usr/include/opencascade/ChFi3d*.hxx | cut -c 26-

genFiles("ChFi3d_Builder_0")
pp("chfi3d_builder_0.nim",
  replaceAll = @[("mu: var cfloat; mu: var cfloat; mv: var cfloat;", "mu1: var cfloat; mu2: var cfloat; mv3: var cfloat;"),
    ("mv: var cfloat)", "mv2: var cfloat)"),
    ("p: var Pnt; v: var Vec; r: var cfloat)", "p2: var Pnt; v: var Vec; r: var cfloat)")
  ]
)

genFiles("ChFi3d_Builder")
pp("chfi3d_builder.nim",
  replaceAll = @[("= object", "= object of RootObj")]
)
genFiles("ChFi3d_ChBuilder")
genFiles("ChFi3d_FilBuilder")
genFiles("ChFi3d_FilletShape")
pp("chfi3d_filletshape.nim",
  replaceAll = @[("ChFi3dRational, ChFi3dQuasiAngular, ChFi3dPolynomial", "chFi3dRational, chFi3dQuasiAngular, chFi3dPolynomial")]
)
genFiles("ChFi3d")
#pp("chfi3d.nim",
#  replaceAll = @[("geomAbsG1", "GeomAbsG1")]
#)
genFiles("ChFi3d_SearchSing")
