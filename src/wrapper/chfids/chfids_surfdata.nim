...
proc resetSimul*(this: var ChFiDS_SurfData) {.cdecl, importcpp: "ResetSimul",
    header: "ChFiDS_SurfData.hxx".}
proc get2dPoints*(this: ChFiDS_SurfData; first: bool; onS: cint): gp_Pnt2d {.noSideEffect,
...
proc get2dPoints*(this: ChFiDS_SurfData; p2df1: var gp_Pnt2d; p2dl1: var gp_Pnt2d;
                 p2df2: var gp_Pnt2d; p2dl2: var gp_Pnt2d) {.noSideEffect, cdecl,
    importcpp: "Get2dPoints", header: "ChFiDS_SurfData.hxx".}
proc set2dPoints*(this: var ChFiDS_SurfData; p2df1: gp_Pnt2d; p2dl1: gp_Pnt2d; p2df2: gp_Pnt2d;
                 p2dl2: gp_Pnt2d) {.cdecl, importcpp: "Set2dPoints", header: "ChFiDS_SurfData.hxx".}
