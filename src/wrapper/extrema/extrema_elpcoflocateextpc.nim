...
proc newExtrema_ELPCOfLocateExtPC*(P: gp_Pnt; C: Adaptor3d_Curve; Uinf: cfloat;
                                  Usup: cfloat; TolF: cfloat = 1.0e-10): Extrema_ELPCOfLocateExtPC {.
    cdecl, constructor, importcpp: "Extrema_ELPCOfLocateExtPC(@)",
    header: "Extrema_ELPCOfLocateExtPC.hxx".}
proc newExtrema_ELPCOfLocateExtPC*(P: gp_Pnt; C: Adaptor3d_Curve;
...
proc Perform*(this: var Extrema_ELPCOfLocateExtPC; P: gp_Pnt) {.cdecl,
