...
proc newExtrema_LocEPCOfLocateExtPC2d*(P: Pnt2dObj; C: Adaptor2d_Curve2d; U0: cfloat;
...
proc Perform*(this: var Extrema_LocEPCOfLocateExtPC2d; P: Pnt2dObj; U0: cfloat) {.cdecl,
