...
proc newExtrema_PCLocFOfLocEPCOfLocateExtPC2d*(P: Pnt2dObj; C: Adaptor2d_Curve2d): Extrema_PCLocFOfLocEPCOfLocateExtPC2d {.
    cdecl, constructor, importcpp: "Extrema_PCLocFOfLocEPCOfLocateExtPC2d(@)",
    header: "Extrema_PCLocFOfLocEPCOfLocateExtPC2d.hxx".}
...
proc SetPoint*(this: var Extrema_PCLocFOfLocEPCOfLocateExtPC2d; P: Pnt2dObj) {.cdecl,
