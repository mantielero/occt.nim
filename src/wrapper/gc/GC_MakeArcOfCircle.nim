...
proc constructor_GC_MakeArcOfCircle*(Circ: gp_Circ, Alpha1: Standard_Real, Alpha2: Standard_Real, Sense: Standard_Boolean): GC_MakeArcOfCircle {.constructor,importcpp: "GC_MakeArcOfCircle(@)".}
  ## Make an arc of circle (TrimmedCurve from Geom) from a circle between
  ## two angles Alpha1 and Alpha2 given in radiians.

proc constructor_GC_MakeArcOfCircle*(Circ: gp_Circ, P: gp_Pnt, Alpha: Standard_Real, Sense: Standard_Boolean): GC_MakeArcOfCircle {.constructor,importcpp: "GC_MakeArcOfCircle(@)".}
  ## Make an arc of circle (TrimmedCurve from Geom) from a circle between
  ## point <P> and the angle Alpha given in radians.

proc constructor_GC_MakeArcOfCircle*(Circ: gp_Circ, P1: gp_Pnt, P2: gp_Pnt, Sense: Standard_Boolean): GC_MakeArcOfCircle {.constructor,importcpp: "GC_MakeArcOfCircle(@)".}
  ## Make an arc of circle (TrimmedCurve from Geom) from a circle between
  ## two points P1 and P2.

proc constructor_GC_MakeArcOfCircle*(P1: gp_Pnt, P2: gp_Pnt, P3: gp_Pnt): GC_MakeArcOfCircle {.constructor,importcpp: "GC_MakeArcOfCircle(@)".}
  ## Make an arc of circle (TrimmedCurve from Geom) from three points
  ## P1,P2,P3 between two points P1 and P2.

proc constructor_GC_MakeArcOfCircle*(P1: gp_Pnt, V: gp_Vec, P2: gp_Pnt): GC_MakeArcOfCircle {.constructor,importcpp: "GC_MakeArcOfCircle(@)".}
