...
proc constructor_GC_MakeArcOfEllipse*(Elips: gp_Elips, Alpha1: Standard_Real, Alpha2: Standard_Real, Sense: Standard_Boolean): GC_MakeArcOfEllipse {.constructor,importcpp: "GC_MakeArcOfEllipse(@)".}
  ## Constructs an arc of Ellipse (TrimmedCurve from Geom) from a Ellipse
  ## between two parameters Alpha1 and Alpha2.

proc constructor_GC_MakeArcOfEllipse*(Elips: gp_Elips, P: gp_Pnt, Alpha: Standard_Real, Sense: Standard_Boolean): GC_MakeArcOfEllipse {.constructor,importcpp: "GC_MakeArcOfEllipse(@)".}
  ## Constructs an arc of Ellipse (TrimmedCurve from Geom) from a Ellipse
  ## between point <P> and the angle Alpha given in radians.

proc constructor_GC_MakeArcOfEllipse*(Elips: gp_Elips, P1: gp_Pnt, P2: gp_Pnt, Sense: Standard_Boolean): GC_MakeArcOfEllipse {.constructor,importcpp: "GC_MakeArcOfEllipse(@)".}
  ## Constructs an arc of Ellipse (TrimmedCurve from Geom) from a Ellipse
