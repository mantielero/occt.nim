...
proc constructor_GC_MakeArcOfHyperbola*(Hypr: gp_Hypr, Alpha1: Standard_Real, Alpha2: Standard_Real, Sense: Standard_Boolean): GC_MakeArcOfHyperbola {.constructor,importcpp: "GC_MakeArcOfHyperbola(@)".}
...
proc constructor_GC_MakeArcOfHyperbola*(Hypr: gp_Hypr, P: gp_Pnt, Alpha: Standard_Real, Sense: Standard_Boolean): GC_MakeArcOfHyperbola {.constructor,importcpp: "GC_MakeArcOfHyperbola(@)".}
  ## Creates an arc of Hyperbola (TrimmedCurve from Geom) from a Hyperbola
  ## between point <P> and the parameter Alpha (given in radians).

proc constructor_GC_MakeArcOfHyperbola*(Hypr: gp_Hypr, P1: gp_Pnt, P2: gp_Pnt, Sense: Standard_Boolean): GC_MakeArcOfHyperbola {.constructor,importcpp: "GC_MakeArcOfHyperbola(@)".}
  ## Creates an arc of Hyperbola (TrimmedCurve from Geom) from a Hyperbola
