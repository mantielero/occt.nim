...
proc constructor_GC_MakeCylindricalSurface*(A2: gp_Ax2, Radius: Standard_Real): GC_MakeCylindricalSurface {.constructor,importcpp: "GC_MakeCylindricalSurface(@)".}
...
proc constructor_GC_MakeCylindricalSurface*(Cyl: gp_Cylinder, Dist: Standard_Real): GC_MakeCylindricalSurface {.constructor,importcpp: "GC_MakeCylindricalSurface(@)".}
  ## Make a CylindricalSurface from Geom <TheCylinder> parallel to another
...
proc constructor_GC_MakeCylindricalSurface*(Axis: gp_Ax1, Radius: Standard_Real): GC_MakeCylindricalSurface {.constructor,importcpp: "GC_MakeCylindricalSurface(@)".}
