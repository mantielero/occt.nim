...
proc constructor_GC_MakeHyperbola*(A2: gp_Ax2, MajorRadius: Standard_Real, MinorRadius: Standard_Real): GC_MakeHyperbola {.constructor,importcpp: "GC_MakeHyperbola(@)".}
