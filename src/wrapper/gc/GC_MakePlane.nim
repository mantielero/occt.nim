...
proc constructor_GC_MakePlane*(A: Standard_Real, B: Standard_Real, C: Standard_Real, D: Standard_Real): GC_MakePlane {.constructor,importcpp: "GC_MakePlane(@)".}
...
proc constructor_GC_MakePlane*(Pln: gp_Pln, Dist: Standard_Real): GC_MakePlane {.constructor,importcpp: "GC_MakePlane(@)".}
