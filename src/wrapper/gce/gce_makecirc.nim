...
proc newGceMakeCirc*(a2: gp_Ax2; radius: cfloat): GceMakeCirc {.cdecl, constructor,
...
proc newGceMakeCirc*(p1: gp_Pnt; p2: gp_Pnt; p3: gp_Pnt): GceMakeCirc {.cdecl, constructor,
    importcpp: "gce_MakeCirc(@)", header: "gce_MakeCirc.hxx".}
proc newGceMakeCirc*(center: gp_Pnt; norm: gp_Dir; radius: cfloat): GceMakeCirc {.cdecl,
    constructor, importcpp: "gce_MakeCirc(@)", header: "gce_MakeCirc.hxx".}
proc newGceMakeCirc*(center: gp_Pnt; plane: gp_Pln; radius: cfloat): GceMakeCirc {.cdecl,
    constructor, importcpp: "gce_MakeCirc(@)", header: "gce_MakeCirc.hxx".}
proc newGceMakeCirc*(center: gp_Pnt; ptaxis: gp_Pnt; radius: cfloat): GceMakeCirc {.cdecl,
    constructor, importcpp: "gce_MakeCirc(@)", header: "gce_MakeCirc.hxx".}
proc newGceMakeCirc*(axis: gp_Ax1; radius: cfloat): GceMakeCirc {.cdecl, constructor,
    importcpp: "gce_MakeCirc(@)", header: "gce_MakeCirc.hxx".}
