...
proc d1*(this: GeomBezierSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
        d1v: var gp_Vec) {.noSideEffect, cdecl, importcpp: "D1", header: "Geom_BezierSurface.hxx".}
proc d2*(this: GeomBezierSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
...
proc d3*(this: GeomBezierSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
        ...
        d3uuv: var gp_Vec; d3uvv: var gp_Vec) {.noSideEffect, cdecl, importcpp: "D3",
                                    header: "Geom_BezierSurface.hxx".}
proc dn*(this: GeomBezierSurface; u: cfloat; v: cfloat; nu: cint; nv: cint): gp_Vec {.
