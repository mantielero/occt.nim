...
proc setPole*(this: var GeomBSplineCurve; index: cint; p: gp_Pnt) {.cdecl,
    importcpp: "SetPole", header: "Geom_BSplineCurve.hxx".}
proc setPole*(this: var GeomBSplineCurve; index: cint; p: gp_Pnt; weight: cfloat) {.cdecl,
    importcpp: "SetPole", header: "Geom_BSplineCurve.hxx".}
...
proc pole*(this: GeomBSplineCurve; index: cint): gp_Pnt {.noSideEffect, cdecl,
...
proc poles*(this: GeomBSplineCurve): TColgpArray1OfPnt {.noSideEffect, cdecl,
    importcpp: "Poles", header: "Geom_BSplineCurve.hxx".}
proc startPoint*(this: GeomBSplineCurve): gp_Pnt {.noSideEffect, cdecl,
