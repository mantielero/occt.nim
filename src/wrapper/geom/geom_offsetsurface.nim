...
proc d1*(this: GeomOffsetSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
        d1v: var gp_Vec) {.noSideEffect, cdecl, importcpp: "D1", header: "Geom_OffsetSurface.hxx".}
proc d2*(this: GeomOffsetSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
...
proc d3*(this: GeomOffsetSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var gp_Vec;
