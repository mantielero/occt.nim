...
proc d1*(this: GeomSphericalSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var VecObj;
        d1v: var VecObj) {.noSideEffect, cdecl, importcpp: "D1", header: "Geom_SphericalSurface.hxx".}
proc d2*(this: GeomSphericalSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var VecObj;
...
proc d3*(this: GeomSphericalSurface; u: cfloat; v: cfloat; p: var gp_Pnt; d1u: var VecObj;
