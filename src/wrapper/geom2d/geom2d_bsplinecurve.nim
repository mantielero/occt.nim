...
proc insertPoleAfter*(this: var Geom2dBSplineCurve; index: cint; p: gp_Pnt2d;
                     weight: cfloat = 1.0) {.cdecl, importcpp: "InsertPoleAfter",
    header: "Geom2d_BSplineCurve.hxx".}
proc insertPoleBefore*(this: var Geom2dBSplineCurve; index: cint; p: gp_Pnt2d;
...
proc setPole*(this: var Geom2dBSplineCurve; index: cint; p: gp_Pnt2d) {.cdecl,
    importcpp: "SetPole", header: "Geom2d_BSplineCurve.hxx".}
proc setPole*(this: var Geom2dBSplineCurve; index: cint; p: gp_Pnt2d; weight: cfloat) {.
...
proc movePoint*(this: var Geom2dBSplineCurve; u: cfloat; p: gp_Pnt2d; index1: cint;
               index2: cint; firstModifiedPole: var cint; lastModifiedPole: var cint) {.
    cdecl, importcpp: "MovePoint", header: "Geom2d_BSplineCurve.hxx".}
proc movePointAndTangent*(this: var Geom2dBSplineCurve; u: cfloat; p: gp_Pnt2d;
                         tangent: gp_Vec2d; tolerance: cfloat; startingCondition: cint;
...
proc d0*(this: Geom2dBSplineCurve; u: cfloat; p: var gp_Pnt2d) {.noSideEffect, cdecl,
    importcpp: "D0", header: "Geom2d_BSplineCurve.hxx".}
proc d1*(this: Geom2dBSplineCurve; u: cfloat; p: var gp_Pnt2d; v1: var gp_Vec2d) {.noSideEffect,
    cdecl, importcpp: "D1", header: "Geom2d_BSplineCurve.hxx".}
proc d2*(this: Geom2dBSplineCurve; u: cfloat; p: var gp_Pnt2d; v1: var gp_Vec2d; v2: var gp_Vec2d) {.
    noSideEffect, cdecl, importcpp: "D2", header: "Geom2d_BSplineCurve.hxx".}
proc d3*(this: Geom2dBSplineCurve; u: cfloat; p: var gp_Pnt2d; v1: var gp_Vec2d; v2: var gp_Vec2d;
        v3: var gp_Vec2d) {.noSideEffect, cdecl, importcpp: "D3", header: "Geom2d_BSplineCurve.hxx".}
proc dn*(this: Geom2dBSplineCurve; u: cfloat; n: cint): gp_Vec2d {.noSideEffect, cdecl,
    importcpp: "DN", header: "Geom2d_BSplineCurve.hxx".}
proc localValue*(this: Geom2dBSplineCurve; u: cfloat; fromK1: cint; toK2: cint): gp_Pnt2d {.
    noSideEffect, cdecl, importcpp: "LocalValue", header: "Geom2d_BSplineCurve.hxx".}
proc localD0*(this: Geom2dBSplineCurve; u: cfloat; fromK1: cint; toK2: cint; p: var gp_Pnt2d) {.
...
proc localD1*(this: Geom2dBSplineCurve; u: cfloat; fromK1: cint; toK2: cint;
             p: var gp_Pnt2d; v1: var gp_Vec2d) {.noSideEffect, cdecl, importcpp: "LocalD1",
                                      header: "Geom2d_BSplineCurve.hxx".}
proc localD2*(this: Geom2dBSplineCurve; u: cfloat; fromK1: cint; toK2: cint;
             p: var gp_Pnt2d; v1: var gp_Vec2d; v2: var gp_Vec2d) {.noSideEffect, cdecl,
    importcpp: "LocalD2", header: "Geom2d_BSplineCurve.hxx".}
proc localD3*(this: Geom2dBSplineCurve; u: cfloat; fromK1: cint; toK2: cint;
             p: var gp_Pnt2d; v1: var gp_Vec2d; v2: var gp_Vec2d; v3: var gp_Vec2d) {.noSideEffect,
    cdecl, importcpp: "LocalD3", header: "Geom2d_BSplineCurve.hxx".}
proc localDN*(this: Geom2dBSplineCurve; u: cfloat; fromK1: cint; toK2: cint; n: cint): gp_Vec2d {.
    noSideEffect, cdecl, importcpp: "LocalDN", header: "Geom2d_BSplineCurve.hxx".}
proc endPoint*(this: Geom2dBSplineCurve): gp_Pnt2d {.noSideEffect, cdecl,
...
proc pole*(this: Geom2dBSplineCurve; index: cint): gp_Pnt2d {.noSideEffect, cdecl,
...
proc startPoint*(this: Geom2dBSplineCurve): gp_Pnt2d {.noSideEffect, cdecl,
