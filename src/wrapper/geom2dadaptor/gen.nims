...
# ls /usr/include/opencascade/Geom2dAdaptor*.hxx | cut -c 26-


genFiles("Geom2dAdaptor_Curve")
genFiles("Geom2dAdaptor_GHCurve",
  comment = @[(76, 88)]
)
genFiles("Geom2dAdaptor_HCurve")
genFiles("Geom2dAdaptor")
