...
proc value*(this: Geom2dAdaptorCurve; u: cfloat): gp_Pnt2d {.noSideEffect, cdecl,
    importcpp: "Value", header: "Geom2dAdaptor_Curve.hxx".}
proc d0*(this: Geom2dAdaptorCurve; u: cfloat; p: var gp_Pnt2d) {.noSideEffect, cdecl,
    importcpp: "D0", header: "Geom2dAdaptor_Curve.hxx".}
proc d1*(this: Geom2dAdaptorCurve; u: cfloat; p: var gp_Pnt2d; v: var gp_Vec2d) {.noSideEffect,
    cdecl, importcpp: "D1", header: "Geom2dAdaptor_Curve.hxx".}
proc d2*(this: Geom2dAdaptorCurve; u: cfloat; p: var gp_Pnt2d; v1: var gp_Vec2d; v2: var gp_Vec2d) {.
    noSideEffect, cdecl, importcpp: "D2", header: "Geom2dAdaptor_Curve.hxx".}
proc d3*(this: Geom2dAdaptorCurve; u: cfloat; p: var gp_Pnt2d; v1: var gp_Vec2d; v2: var gp_Vec2d;
        v3: var gp_Vec2d) {.noSideEffect, cdecl, importcpp: "D3", header: "Geom2dAdaptor_Curve.hxx".}
proc dn*(this: Geom2dAdaptorCurve; u: cfloat; n: cint): gp_Vec2d {.noSideEffect, cdecl,
...
proc line*(this: Geom2dAdaptorCurve): gp_Lin2d {.noSideEffect, cdecl, importcpp: "Line",
    header: "Geom2dAdaptor_Curve.hxx".}
proc circle*(this: Geom2dAdaptorCurve): gp_Circ2d {.noSideEffect, cdecl,
    importcpp: "Circle", header: "Geom2dAdaptor_Curve.hxx".}
proc ellipse*(this: Geom2dAdaptorCurve): gp_Elips2d {.noSideEffect, cdecl,
    importcpp: "Ellipse", header: "Geom2dAdaptor_Curve.hxx".}
proc hyperbola*(this: Geom2dAdaptorCurve): gp_Hypr2d {.noSideEffect, cdecl,
    importcpp: "Hyperbola", header: "Geom2dAdaptor_Curve.hxx".}
proc parabola*(this: Geom2dAdaptorCurve): gp_Parab2d {.noSideEffect, cdecl,
