...
# ls /usr/include/opencascade/GeomAdaptor*.hxx | cut -c 26-

genFiles("GeomAdaptor_Curve")
genFiles("GeomAdaptor_GHCurve",
  comment = @[(80, 92)]
)
genFiles("GeomAdaptor_GHSurface",
  comment = @[(76, 88)]
)
genFiles("GeomAdaptor_HCurve")
genFiles("GeomAdaptor_HSurface")
genFiles("GeomAdaptor_HSurfaceOfLinearExtrusion",
  comment = @[(76, 88)]
)
genFiles("GeomAdaptor_HSurfaceOfRevolution",
  comment = @[(76, 88)]
)
genFiles("GeomAdaptor")
genFiles("GeomAdaptor_Surface")
genFiles("GeomAdaptor_SurfaceOfLinearExtrusion")
genFiles("GeomAdaptor_SurfaceOfRevolution")
