...
proc setParam*(this: var GeomFillFunctionGuide; param: cfloat; centre: gp_Pnt; dir: gp_Xyz;
              xDir: gp_Xyz) {.cdecl, importcpp: "SetParam", header: "GeomFill_FunctionGuide.hxx".}
...
proc derivT*(this: var GeomFillFunctionGuide; x: MathVector; dCentre: gp_Xyz; dDir: gp_Xyz;
            dfdt: var MathVector): bool {.cdecl, importcpp: "DerivT",
                                      header: "GeomFill_FunctionGuide.hxx".}
proc deriv2T*(this: var GeomFillFunctionGuide; dCentre: gp_Xyz; dDir: gp_Xyz;
