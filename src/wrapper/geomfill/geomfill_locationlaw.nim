...
proc setTrsf*(this: var GeomFillLocationLaw; transfo: gp_Mat) {.cdecl,
...
proc d0*(this: var GeomFillLocationLaw; param: cfloat; m: var gp_Mat; v: var gp_Vec): bool {.cdecl,
    importcpp: "D0", header: "GeomFill_LocationLaw.hxx".}
proc d0*(this: var GeomFillLocationLaw; param: cfloat; m: var gp_Mat; v: var gp_Vec;
        poles2d: var TColgpArray1OfPnt2d): bool {.cdecl, importcpp: "D0",
    header: "GeomFill_LocationLaw.hxx".}
proc d1*(this: var GeomFillLocationLaw; param: cfloat; m: var gp_Mat; v: var gp_Vec; dm: var gp_Mat;
        dv: var gp_Vec; poles2d: var TColgpArray1OfPnt2d;
        dPoles2d: var TColgpArray1OfVec2d): bool {.cdecl, importcpp: "D1",
    header: "GeomFill_LocationLaw.hxx".}
proc d2*(this: var GeomFillLocationLaw; param: cfloat; m: var gp_Mat; v: var gp_Vec; dm: var gp_Mat;
        dv: var gp_Vec; d2m: var gp_Mat; d2v: var gp_Vec; poles2d: var TColgpArray1OfPnt2d;
...
proc getAverageLaw*(this: var GeomFillLocationLaw; am: var gp_Mat; av: var gp_Vec) {.cdecl,
