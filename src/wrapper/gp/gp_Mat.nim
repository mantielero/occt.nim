...
proc SetCol*(this: var gp_Mat, Col: Standard_Integer, Value: gp_XYZ)  {.importcpp: "SetCol".}
...
proc SetDiagonal*(this: var gp_Mat, X1: Standard_Real, X2: Standard_Real, X3: Standard_Real)  {.importcpp: "SetDiagonal".}
...
proc SetRotation*(this: var gp_Mat, Axis: gp_XYZ, Ang: Standard_Real)  {.importcpp: "SetRotation".}
...
proc SetRow*(this: var gp_Mat, Row: Standard_Integer, Value: gp_XYZ)  {.importcpp: "SetRow".}
...
proc SetValue*(this: var gp_Mat, Row: Standard_Integer, Col: Standard_Integer, Value: Standard_Real)  {.importcpp: "SetValue".}
...
proc Value*(this: gp_Mat, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "Value".}
  ## Returns the coefficient of range (Row, Col) Raises OutOfRange if Row <
  ## 1 or Row > 3 or Col < 1 or Col > 3

proc `()`*(this: gp_Mat, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "`()`".}

proc ChangeValue*(this: var gp_Mat, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "ChangeValue".}
  ## Returns the coefficient of range (Row, Col) Raises OutOfRange if Row <
  ## 1 or Row > 3 or Col < 1 or Col > 3

proc `()`*(this: var gp_Mat, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "`()`".}
...
proc Divide*(this: var gp_Mat, Scalar: Standard_Real)  {.importcpp: "Divide".}
...
proc `/`*(this: gp_Mat, Scalar: Standard_Real): gp_Mat  {.importcpp: "`/`".}
...
proc Multiply*(this: var gp_Mat, Scalar: Standard_Real)  {.importcpp: "Multiply".}
...
proc DumpJson*(this: gp_Mat, theOStream: var Standard_OStream, theDepth: Standard_Integer)  {.importcpp: "DumpJson".}
