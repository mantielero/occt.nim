...
proc SetCol*(this: var gp_Mat2d, Col: Standard_Integer, Value: gp_XY)  {.importcpp: "SetCol".}
...
proc SetDiagonal*(this: var gp_Mat2d, X1: Standard_Real, X2: Standard_Real)  {.importcpp: "SetDiagonal".}
...
proc SetRow*(this: var gp_Mat2d, Row: Standard_Integer, Value: gp_XY)  {.importcpp: "SetRow".}
...
proc SetValue*(this: var gp_Mat2d, Row: Standard_Integer, Col: Standard_Integer, Value: Standard_Real)  {.importcpp: "SetValue".}
...
proc Value*(this: gp_Mat2d, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "Value".}
  ## Returns the coefficient of range (Row, Col) Raises OutOfRange if Row <
  ## 1 or Row > 2 or Col < 1 or Col > 2

proc `()`*(this: gp_Mat2d, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "`()`".}

proc ChangeValue*(this: var gp_Mat2d, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "ChangeValue".}
  ## Returns the coefficient of range (Row, Col) Raises OutOfRange if Row <
  ## 1 or Row > 2 or Col < 1 or Col > 2

proc `()`*(this: var gp_Mat2d, Row: Standard_Integer, Col: Standard_Integer): Standard_Real  {.importcpp: "`()`".}
...
proc Divide*(this: var gp_Mat2d, Scalar: Standard_Real)  {.importcpp: "Divide".}
...
proc `/`*(this: gp_Mat2d, Scalar: Standard_Real): gp_Mat2d  {.importcpp: "`/`".}
...
proc Multiply*(this: var gp_Mat2d, Scalar: Standard_Real)  {.importcpp: "Multiply".}
