...
proc Interpolate*(this: var gp_QuaternionSLerp, theQStart: gp_Quaternion, theQEnd: gp_Quaternion, theT: cdouble): gp_Quaternion  {.importcpp: "Interpolate".}
...
proc Interpolate*(this: gp_QuaternionSLerp, theT: cdouble, theResultQ: var gp_Quaternion)  {.importcpp: "Interpolate".}
