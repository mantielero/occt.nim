...
proc circ*(a2: gp_Ax2; radius: cfloat): gp_Circ {.cdecl, constructor,
    importcpp: "gp_Circ(@)", header: "gp_Circ.hxx".}
proc setAxis*(this: var gp_Circ; a1: gp_Ax1) {.cdecl, importcpp: "SetAxis", header: "gp_Circ.hxx".}
proc setLocation*(this: var gp_Circ; p: gp_Pnt) {.cdecl, importcpp: "SetLocation",
                                      header: "gp_Circ.hxx".}
proc setPosition*(this: var gp_Circ; a2: gp_Ax2) {.cdecl, importcpp: "SetPosition",
                                       header: "gp_Circ.hxx".}
...
proc axis*(this: gp_Circ): gp_Ax1 {.noSideEffect, cdecl, importcpp: "Axis", header: "gp_Circ.hxx".}
...
proc location*(this: gp_Circ): gp_Pnt {.noSideEffect, cdecl, importcpp: "Location",
                              header: "gp_Circ.hxx".}
proc position*(this: gp_Circ): gp_Ax2 {.noSideEffect, cdecl, importcpp: "Position",
                              header: "gp_Circ.hxx".}
proc radius*(this: gp_Circ): cfloat {.noSideEffect, cdecl, importcpp: "Radius",
                               header: "gp_Circ.hxx".}
proc xAxis*(this: gp_Circ): gp_Ax1 {.noSideEffect, cdecl, importcpp: "XAxis", header: "gp_Circ.hxx".}
proc yAxis*(this: gp_Circ): gp_Ax1 {.noSideEffect, cdecl, importcpp: "YAxis", header: "gp_Circ.hxx".}
...
proc mirrored*(this: gp_Circ; p: gp_Pnt): gp_Circ {.noSideEffect, cdecl, importcpp: "Mirrored",
                                     header: "gp_Circ.hxx".}
proc mirror*(this: var gp_Circ; a1: gp_Ax1) {.cdecl, importcpp: "Mirror", header: "gp_Circ.hxx".}
proc mirrored*(this: gp_Circ; a1: gp_Ax1): gp_Circ {.noSideEffect, cdecl, importcpp: "Mirrored",
                                      header: "gp_Circ.hxx".}
proc mirror*(this: var gp_Circ; a2: gp_Ax2) {.cdecl, importcpp: "Mirror", header: "gp_Circ.hxx".}
proc mirrored*(this: gp_Circ; a2: gp_Ax2): gp_Circ {.noSideEffect, cdecl, importcpp: "Mirrored",
                                      header: "gp_Circ.hxx".}
proc rotate*(this: var gp_Circ; a1: gp_Ax1; ang: cfloat) {.cdecl, importcpp: "Rotate",
    header: "gp_Circ.hxx".}
proc rotated*(this: gp_Circ; a1: gp_Ax1; ang: cfloat): gp_Circ {.noSideEffect, cdecl,
...
proc transform*(this: var gp_Circ; t: gp_Trsf) {.cdecl, importcpp: "Transform", header: "gp_Circ.hxx".}
proc transformed*(this: gp_Circ; t: gp_Trsf): gp_Circ {.noSideEffect, cdecl,
