...
proc elips2d*(majorAxis: gp_Ax2d; majorRadius: cfloat; minorRadius: cfloat;
                sense: bool = true): gp_Elips2d {.cdecl, constructor,
    importcpp: "gp_Elips2d(@)", header: "gp_Elips2d.hxx".}
proc elips2d*(a: gp_Ax22d; majorRadius: cfloat; minorRadius: cfloat): gp_Elips2d {.cdecl,
...
proc setAxis*(this: var gp_Elips2d; a: gp_Ax22d) {.cdecl, importcpp: "SetAxis", header: "gp_Elips2d.hxx".}
proc setXAxis*(this: var gp_Elips2d; a: gp_Ax2d) {.cdecl, importcpp: "SetXAxis", header: "gp_Elips2d.hxx".}
proc setYAxis*(this: var gp_Elips2d; a: gp_Ax2d) {.cdecl, importcpp: "SetYAxis", header: "gp_Elips2d.hxx".}
...
proc directrix1*(this: gp_Elips2d): gp_Ax2d {.noSideEffect, cdecl, importcpp: "Directrix1",
                                    header: "gp_Elips2d.hxx".}
proc directrix2*(this: gp_Elips2d): gp_Ax2d {.noSideEffect, cdecl, importcpp: "Directrix2",
                                    header: "gp_Elips2d.hxx".}
...
proc parameter*(this: gp_Elips2d): cfloat {.noSideEffect, cdecl, importcpp: "Parameter",
                                     header: "gp_Elips2d.hxx".}
proc axis*(this: gp_Elips2d): gp_Ax22d {.noSideEffect, cdecl, importcpp: "Axis",
                               header: "gp_Elips2d.hxx".}
proc xAxis*(this: gp_Elips2d): gp_Ax2d {.noSideEffect, cdecl, importcpp: "XAxis",
                               header: "gp_Elips2d.hxx".}
proc yAxis*(this: gp_Elips2d): gp_Ax2d {.noSideEffect, cdecl, importcpp: "YAxis",
                               header: "gp_Elips2d.hxx".}
...
proc mirror*(this: var gp_Elips2d; a: gp_Ax2d) {.cdecl, importcpp: "Mirror", header: "gp_Elips2d.hxx".}
proc mirrored*(this: gp_Elips2d; a: gp_Ax2d): gp_Elips2d {.noSideEffect, cdecl,
    importcpp: "Mirrored", header: "gp_Elips2d.hxx".}
...
proc transform*(this: var gp_Elips2d; t: gp_Trsf2d) {.cdecl, importcpp: "Transform",
    header: "gp_Elips2d.hxx".}
proc transformed*(this: gp_Elips2d; t: gp_Trsf2d): gp_Elips2d {.noSideEffect, cdecl,
