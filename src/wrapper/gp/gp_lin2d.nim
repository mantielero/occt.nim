...
proc lin2d*(a: gp_Ax2d): gp_Lin2d {.cdecl, constructor, importcpp: "gp_Lin2d(@)",
                             header: "gp_Lin2d.hxx".}
proc lin2d*(p: gp_Pnt2d; v: gp_Dir2d): gp_Lin2d {.cdecl, constructor,
...
proc reversed*(this: gp_Lin2d): gp_Lin2d {.noSideEffect, cdecl, importcpp: "Reversed",
                                 header: "gp_Lin2d.hxx".}
proc setDirection*(this: var gp_Lin2d; v: gp_Dir2d) {.cdecl, importcpp: "SetDirection",
    header: "gp_Lin2d.hxx".}
proc setLocation*(this: var gp_Lin2d; p: gp_Pnt2d) {.cdecl, importcpp: "SetLocation",
    header: "gp_Lin2d.hxx".}
proc setPosition*(this: var gp_Lin2d; a: gp_Ax2d) {.cdecl, importcpp: "SetPosition",
                                        header: "gp_Lin2d.hxx".}
...
proc direction*(this: gp_Lin2d): gp_Dir2d {.noSideEffect, cdecl, importcpp: "Direction",
                                  header: "gp_Lin2d.hxx".}
proc location*(this: gp_Lin2d): gp_Pnt2d {.noSideEffect, cdecl, importcpp: "Location",
                                 header: "gp_Lin2d.hxx".}
proc position*(this: gp_Lin2d): gp_Ax2d {.noSideEffect, cdecl, importcpp: "Position",
                                header: "gp_Lin2d.hxx".}
...
proc mirror*(this: var gp_Lin2d; a: gp_Ax2d) {.cdecl, importcpp: "Mirror", header: "gp_Lin2d.hxx".}
proc mirrored*(this: gp_Lin2d; a: gp_Ax2d): gp_Lin2d {.noSideEffect, cdecl,
                                        importcpp: "Mirrored", header: "gp_Lin2d.hxx".}
...
proc transform*(this: var gp_Lin2d; t: gp_Trsf2d) {.cdecl, importcpp: "Transform",
                                        header: "gp_Lin2d.hxx".}
proc transformed*(this: gp_Lin2d; t: gp_Trsf2d): gp_Lin2d {.noSideEffect, cdecl,
