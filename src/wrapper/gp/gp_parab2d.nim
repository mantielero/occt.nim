...
proc parab2d*(theMirrorAxis: Ax2dObj; theFocalLength: cfloat; theSense: bool = true): gp_Parab2d {.
    cdecl, constructor, importcpp: "gp_Parab2d(@)", header: "gp_Parab2d.hxx".}
proc parab2d*(theAxes: Ax22dObj; theFocalLength: cfloat): gp_Parab2d {.cdecl, constructor,
    importcpp: "gp_Parab2d(@)", header: "gp_Parab2d.hxx".}
proc parab2d*(theDirectrix: Ax2dObj; theFocus: gp_Pnt2d; theSense: bool = true): gp_Parab2d {.
    cdecl, constructor, importcpp: "gp_Parab2d(@)", header: "gp_Parab2d.hxx".}
...
proc setLocation*(this: var gp_Parab2d; p: gp_Pnt2d) {.cdecl, importcpp: "SetLocation",
    header: "gp_Parab2d.hxx".}
proc setMirrorAxis*(this: var gp_Parab2d; a: Ax2dObj) {.cdecl, importcpp: "SetMirrorAxis",
    header: "gp_Parab2d.hxx".}
proc setAxis*(this: var gp_Parab2d; a: Ax22dObj) {.cdecl, importcpp: "SetAxis", header: "gp_Parab2d.hxx".}
...
proc directrix*(this: gp_Parab2d): Ax2dObj {.noSideEffect, cdecl, importcpp: "Directrix",
                                   header: "gp_Parab2d.hxx".}
...
proc location*(this: gp_Parab2d): gp_Pnt2d {.noSideEffect, cdecl, importcpp: "Location",
                                   header: "gp_Parab2d.hxx".}
proc mirrorAxis*(this: gp_Parab2d): Ax2dObj {.noSideEffect, cdecl, importcpp: "MirrorAxis",
                                    header: "gp_Parab2d.hxx".}
proc axis*(this: gp_Parab2d): Ax22dObj {.noSideEffect, cdecl, importcpp: "Axis",
                               header: "gp_Parab2d.hxx".}
...
proc mirror*(this: var gp_Parab2d; a: Ax2dObj) {.cdecl, importcpp: "Mirror", header: "gp_Parab2d.hxx".}
proc mirrored*(this: gp_Parab2d; a: Ax2dObj): gp_Parab2d {.noSideEffect, cdecl,
    importcpp: "Mirrored", header: "gp_Parab2d.hxx".}
...
proc transform*(this: var gp_Parab2d; t: Trsf2dObj) {.cdecl, importcpp: "Transform",
    header: "gp_Parab2d.hxx".}
proc transformed*(this: gp_Parab2d; t: Trsf2dObj): gp_Parab2d {.noSideEffect, cdecl,
