...
# ls /usr/include/opencascade/PrsMgr*.hxx | cut -c 26-


genFiles("PrsMgr_ListOfPresentableObjects")
pp("prsmgr_listofpresentableobjects.nim",
  replaceAll = @[("""PrsMgrListOfPresentableObjectsIter* = Iterator[Handle[PrsMgrPresentableObject]]""",
...
genFiles("PrsMgr_ListOfPresentations")
genFiles("PrsMgr_PresentableObject")
pp("prsmgr_presentableobject.nim",
  replaceAll = @[
  ("pnt(0.0, 0.0, 0.0)", "newPnt(0.0, 0.0, 0.0)")]
)
genFiles("PrsMgr_Presentation3d")
genFiles("PrsMgr_Presentation")
genFiles("PrsMgr_PresentationManager3d")
pp("prsmgr_presentationmanager3d.nim",
  commentRange = @[(18,18)]
)
genFiles("PrsMgr_PresentationManager")
pp("prsmgr_presentationmanager.nim",
  commentRange = @[(18,19)],
  replaceAll = @[("Handle[PrsMgrPresentableObject] = nil", "Handle[PrsMgrPresentableObject] = cast[Handle[PrsMgrPresentableObject]](nil)")]
)
genFiles("PrsMgr_Presentations")
genFiles("PrsMgr_TypeOfPresentation3d")
pp("prsmgr_typeofpresentation3d.nim",
  replaceAll = @[("PrsMgrTOP_", "prsMgrTOP_")]
)
