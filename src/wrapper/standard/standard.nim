...
type
  ...
  Standard_Byte* {.header: "Standard_TypeDef.hxx", importcpp: "Standard_Byte".} = unsigned char
  ...
  Standard_Utf8UChar* {.header: "Standard_TypeDef.hxx", importcpp: "Standard_Utf8UChar".} = unsigned char
