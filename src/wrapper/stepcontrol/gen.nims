...
# ls /usr/include/opencascade/STEPControl*.hxx | cut -c 26-

genFiles("STEPControl_ActorRead")
pp("stepcontrol_actorread.nim",
  replaceAll = @[("messageProgressRange()", "newMessageProgressRange()")]
)
genFiles("STEPControl_ActorWrite")
pp("stepcontrol_actorwrite.nim",
  replaceAll = @[("messageProgressRange()", "newMessageProgressRange()"),
    ("Handle[TopToolsHSequenceOfShape] = nil", "Handle[TopToolsHSequenceOfShape] = cast[Handle[TopToolsHSequenceOfShape]](nil)")
  ]
)
genFiles("STEPControl_Controller")
pp("stepcontrol_controller.nim",
  replaceAll = @[("messageProgressRange()", "newMessageProgressRange()")]
)
genFiles("STEPControl_Reader")
pp("stepcontrol_reader.nim",
  replaceAll = @[("messageProgressRange()", "newMessageProgressRange()")]
)
genFiles("STEPControl_StepModelType")
genFiles("STEPControl_Writer")
pp("stepcontrol_writer.nim",
  replaceAll = @[("messageProgressRange()", "newMessageProgressRange()")]
)
