...
proc newTDataStdHDataMapOfStringInteger*(nbBuckets: cint = 1): TDataStdHDataMapOfStringInteger {.
    cdecl, constructor, importcpp: "TDataStd_HDataMapOfStringInteger(@)",
    header: "TDataStd_HDataMapOfStringInteger.hxx".}
proc newTDataStdHDataMapOfStringInteger*(theOther: TColStdDataMapOfStringInteger): TDataStdHDataMapOfStringInteger {.
    cdecl, constructor, importcpp: "TDataStd_HDataMapOfStringInteger(@)",
    header: "TDataStd_HDataMapOfStringInteger.hxx".}
