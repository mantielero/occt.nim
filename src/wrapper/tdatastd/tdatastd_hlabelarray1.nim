...
proc newTDataStdHLabelArray1*(theLower: cint; theUpper: cint): TDataStdHLabelArray1 {.
    cdecl, constructor, importcpp: "TDataStd_HLabelArray1(@)",
    header: "TDataStd_HLabelArray1.hxx".}
proc newTDataStdHLabelArray1*(theLower: cint; theUpper: cint; theValue: ValueType): TDataStdHLabelArray1 {.
    cdecl, constructor, importcpp: "TDataStd_HLabelArray1(@)",
    header: "TDataStd_HLabelArray1.hxx".}
proc newTDataStdHLabelArray1*(theOther: TDataStdLabelArray1): TDataStdHLabelArray1 {.
    cdecl, constructor, importcpp: "TDataStd_HLabelArray1(@)",
    header: "TDataStd_HLabelArray1.hxx".}
