...
proc set*(label: TDF_Label): Handle[TDataStdTick] {.cdecl,
    importcpp: "TDataStd_Tick::Set(@)", header: "TDataStd_Tick.hxx".}
proc newTDataStdTick*(): TDataStdTick {.cdecl, constructor,
                                     importcpp: "TDataStd_Tick(@)",
                                     header: "TDataStd_Tick.hxx".}
proc id*(this: TDataStdTick): StandardGUID {.noSideEffect, cdecl, importcpp: "ID",
    header: "TDataStd_Tick.hxx".}
