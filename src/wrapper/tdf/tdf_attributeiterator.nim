...
proc newTDF_AttributeIterator*(): TDF_AttributeIterator {.cdecl, constructor,
    importcpp: "TDF_AttributeIterator(@)", header: "TDF_AttributeIterator.hxx".}
proc newTDF_AttributeIterator*(aLabel: TDF_Label; withoutForgotten: bool = true): TDF_AttributeIterator {.
    cdecl, constructor, importcpp: "TDF_AttributeIterator(@)",
    header: "TDF_AttributeIterator.hxx".}
proc newTDF_AttributeIterator*(aLabelNode: TDF_LabelNodePtr;
                              withoutForgotten: bool = true): TDF_AttributeIterator {.
    cdecl, constructor, importcpp: "TDF_AttributeIterator(@)",
    header: "TDF_AttributeIterator.hxx".}
proc initialize*(this: var TDF_AttributeIterator; aLabel: TDF_Label;
                withoutForgotten: bool = true) {.cdecl, importcpp: "Initialize",
    header: "TDF_AttributeIterator.hxx".}
proc more*(this: TDF_AttributeIterator): bool {.noSideEffect, cdecl,
    importcpp: "More", header: "TDF_AttributeIterator.hxx".}
proc next*(this: var TDF_AttributeIterator) {.cdecl, importcpp: "Next",
    header: "TDF_AttributeIterator.hxx".}
proc value*(this: TDF_AttributeIterator): Handle[TDF_Attribute] {.noSideEffect,
    cdecl, importcpp: "Value", header: "TDF_AttributeIterator.hxx".}
proc ptrValue*(this: TDF_AttributeIterator): ptr TDF_Attribute {.noSideEffect, cdecl,
