...
proc newTDocStdApplicationDelta*(): TDocStdApplicationDelta {.cdecl, constructor,
...
proc getDocuments*(this: var TDocStdApplicationDelta): var TDocStdSequenceOfDocument {.
    cdecl, importcpp: "GetDocuments", header: "TDocStd_ApplicationDelta.hxx".}
...
proc setName*(this: var TDocStdApplicationDelta; theName: TCollectionExtendedString) {.
    cdecl, importcpp: "SetName", header: "TDocStd_ApplicationDelta.hxx".}
proc dump*(this: TDocStdApplicationDelta; anOS: var StandardOStream) {.noSideEffect,
    cdecl, importcpp: "Dump", header: "TDocStd_ApplicationDelta.hxx".}
