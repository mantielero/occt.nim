...
proc newTDocStdContext*(): TDocStdContext {.cdecl, constructor,
    importcpp: "TDocStd_Context(@)", header: "TDocStd_Context.hxx".}
proc setModifiedReferences*(this: var TDocStdContext; `mod`: bool) {.cdecl,
    importcpp: "SetModifiedReferences", header: "TDocStd_Context.hxx".}
proc modifiedReferences*(this: TDocStdContext): bool {.noSideEffect, cdecl,
