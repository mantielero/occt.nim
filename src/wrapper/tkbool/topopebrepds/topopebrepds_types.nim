# PROVIDES: TopOpeBRepDS TopOpeBRepDS_BuildTool HandleTopOpeBRepDS_Check TopOpeBRepDS_Curve TopOpeBRepDS_CurveExplorer HandleTopOpeBRepDS_CurvePointInterference TopOpeBRepDS_DataStructure TopOpeBRepDS_Dumper TopOpeBRepDS_Edge3dInterferenceTool TopOpeBRepDS_EdgeInterferenceTool HandleTopOpeBRepDS_EdgeVertexInterference TopOpeBRepDS_EIR TopOpeBRepDS_Explorer HandleTopOpeBRepDS_FaceEdgeInterference TopOpeBRepDS_FaceInterferenceTool TopOpeBRepDS_Filter TopOpeBRepDS_FIR TopOpeBRepDS_GapFiller TopOpeBRepDS_GeometryData HandleTopOpeBRepDS_Interference TopOpeBRepDS_InterferenceIterator TopOpeBRepDS_InterferenceTool TopOpeBRepDS_ListOfShapeOn1State TopOpeBRepDS_Point TopOpeBRepDS_PointExplorer TopOpeBRepDS_Reducer TopOpeBRepDS_ShapeData HandleTopOpeBRepDS_ShapeShapeInterference TopOpeBRepDS_ShapeWithState HandleTopOpeBRepDS_SolidSurfaceInterference TopOpeBRepDS_Surface HandleTopOpeBRepDS_SurfaceCurveInterference TopOpeBRepDS_SurfaceExplorer TopOpeBRepDS_TKI TopOpeBRepDS_TOOL TopOpeBRepDS_Transition TopOpeBRepDS_CurveData TopOpeBRepDS_CurveIterator TopOpeBRepDS_PointData TopOpeBRepDS_PointIterator TopOpeBRepDS_SurfaceData TopOpeBRepDS_SurfaceIterator
# DEPENDS: StandardTransient StandardTransient TopOpeBRepDS_Interference TopOpeBRepDS_ShapeShapeInterference TopOpeBRepDS_ShapeShapeInterference StandardTransient TopOpeBRepDS_Array1OfDataMapOfIntegerListOfInterference StandardTransient StandardTransient StandardTransient TopOpeBRepDS_Interference TopOpeBRepDS_Interference TopOpeBRepDS_Interference
