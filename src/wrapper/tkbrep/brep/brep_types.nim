# PROVIDES: HandleBRepCurve3D HandleBRepCurveOn2Surfaces HandleBRepCurveOnClosedSurface HandleBRepCurveOnSurface HandleBRepCurveRepresentation HandleBRepGCurve HandleBRepPointOnCurve HandleBRepPointOnCurveOnSurface HandleBRepPointOnSurface HandleBRepPointRepresentation HandleBRepPointsOnSurface HandleBRepPolygon3D HandleBRepPolygonOnClosedSurface HandleBRepPolygonOnClosedTriangulation HandleBRepPolygonOnSurface HandleBRepPolygonOnTriangulation HandleBRepTEdge HandleBRepTFace BRepTool HandleBRepTVertex
# DEPENDS: TopoDS_Builder BRepGCurve BRepCurveRepresentation BRepCurveOnSurface BRepGCurve StandardTransient BRepCurveRepresentation BRepPointRepresentation BRepPointsOnSurface BRepPointsOnSurface StandardTransient BRepPointRepresentation BRepCurveRepresentation BRepPolygonOnSurface BRepPolygonOnTriangulation BRepCurveRepresentation BRepCurveRepresentation TopoDS_TEdge TopoDS_TFace TopoDS_TVertex
