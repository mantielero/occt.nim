# PROVIDES: TopoDS TopoDS_Builder TopoDS_Iterator TopoDS_Shape
# DEPENDS: TopoDS_Shape TopoDS_Shape TopoDS_Shape TopoDS_Shape TopoDS_Shape TopoDS_Shape TopoDS_Shape TopoDS_Shape  Handle[TopoDS_FrozenShape]  Handle[TopoDS_HShape]  Handle[TopoDS_LockedShape]  Handle[TopoDS_TCompound]  Handle[TopoDS_TCompSolid]  Handle[TopoDS_TEdge]  Handle[TopoDS_TFace]  Handle[TopoDS_TShell]  Handle[TopoDS_TSolid]  Handle[TopoDS_TVertex]  Handle[TopoDS_TWire]  Handle[TopoDS_UnCompatibleShapes] MessageAttributeStream MessageAlert StandardTransient TopoDS_TShape TopoDS_TShape TopoDS_TShape TopoDS_TShape StandardTransient TopoDS_TShape TopoDS_TShape TopoDS_TShape TopoDS_TShape
