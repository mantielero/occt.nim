# PROVIDES: Message HandleMessageAlert HandleMessageAlgorithm HandleMessageAttribute MessageExecStatus MessageExecStatusStatusRange MessageLevel HandleMessageMessenger MessageMsg MessageMsgFile HandleMessagePrinter HandleMessagePrinterOStream HandleMessagePrinterSystemLog HandleMessageProgressIndicator MessageProgressRange MessageProgressScope HandleMessageReport MessageProgressSentry
# DEPENDS: StandardTransient MessageAlert StandardTransient StandardTransient MessageAttribute MessageAttribute MessageAttribute StandardTransient StandardTransient StandardTransient MessagePrinter MessagePrinter MessagePrinter StandardTransient StandardTransient
