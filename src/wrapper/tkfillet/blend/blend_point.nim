...
proc newBlendPoint*(pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; tg1: VecObj; tg2: VecObj; tg12d: Vec2dObj; tg22d: Vec2dObj): BlendPoint {.
...
proc newBlendPoint*(pts: PntObj; ptc: PntObj; param: cfloat; u: cfloat; v: cfloat; w: cfloat;
                   tgs: VecObj; tgc: VecObj; tg2d: Vec2dObj): BlendPoint {.cdecl, constructor,
    importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pts: PntObj; ptc: PntObj; param: cfloat; u: cfloat; v: cfloat; w: cfloat): BlendPoint {.
    cdecl, constructor, importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; pc: cfloat; tg1: VecObj; tg2: VecObj; tg12d: Vec2dObj; tg22d: Vec2dObj): BlendPoint {.
    cdecl, constructor, importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; pc: cfloat): BlendPoint {.cdecl, constructor,
    importcpp: "Blend_Point(@)", header: "Blend_Point.hxx".}
proc newBlendPoint*(pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat; v1: cfloat; u2: cfloat;
                   v2: cfloat; pc1: cfloat; pc2: cfloat; tg1: VecObj; tg2: VecObj; tg12d: Vec2dObj;
...
proc setValue*(this: var BlendPoint; pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat;
              v1: cfloat; u2: cfloat; v2: cfloat; tg1: VecObj; tg2: VecObj; tg12d: Vec2dObj;
              tg22d: Vec2dObj) {.cdecl, importcpp: "SetValue", header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat;
              v1: cfloat; u2: cfloat; v2: cfloat) {.cdecl, importcpp: "SetValue",
    header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pts: PntObj; ptc: PntObj; param: cfloat; u: cfloat;
              v: cfloat; w: cfloat; tgs: VecObj; tgc: VecObj; tg2d: Vec2dObj) {.cdecl,
    importcpp: "SetValue", header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pts: PntObj; ptc: PntObj; param: cfloat; u: cfloat;
              v: cfloat; w: cfloat) {.cdecl, importcpp: "SetValue", header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat;
              v1: cfloat; u2: cfloat; v2: cfloat; pc: cfloat; tg1: VecObj; tg2: VecObj;
...
proc setValue*(this: var BlendPoint; pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat;
    ...
    importcpp: "SetValue", header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat;
              v1: cfloat; u2: cfloat; v2: cfloat; pc1: cfloat; pc2: cfloat; tg1: VecObj;
              tg2: VecObj; tg12d: Vec2dObj; tg22d: Vec2dObj) {.cdecl, importcpp: "SetValue",
    header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: PntObj; pt2: PntObj; param: cfloat; u1: cfloat;
              v1: cfloat; u2: cfloat; v2: cfloat; pc1: cfloat; pc2: cfloat) {.cdecl,
    importcpp: "SetValue", header: "Blend_Point.hxx".}
proc setValue*(this: var BlendPoint; pt1: PntObj; pt2: PntObj; param: cfloat; pc1: cfloat;
...
proc pointOnS1*(this: BlendPoint): PntObj {.noSideEffect, cdecl, importcpp: "PointOnS1",
                                     header: "Blend_Point.hxx".}
proc pointOnS2*(this: BlendPoint): PntObj {.noSideEffect, cdecl, importcpp: "PointOnS2",
                                     header: "Blend_Point.hxx".}
...
proc tangentOnS1*(this: BlendPoint): VecObj {.noSideEffect, cdecl,
                                       importcpp: "TangentOnS1", header: "Blend_Point.hxx".}
proc tangentOnS2*(this: BlendPoint): VecObj {.noSideEffect, cdecl,
...
proc pointOnS*(this: BlendPoint): PntObj {.noSideEffect, cdecl, importcpp: "PointOnS",
                                    header: "Blend_Point.hxx".}
proc pointOnC*(this: BlendPoint): PntObj {.noSideEffect, cdecl, importcpp: "PointOnC",
                                    header: "Blend_Point.hxx".}
...
proc tangentOnS*(this: BlendPoint): VecObj {.noSideEffect, cdecl,
                                      importcpp: "TangentOnS", header: "Blend_Point.hxx".}
proc tangentOnC*(this: BlendPoint): VecObj {.noSideEffect, cdecl,
...
proc pointOnC1*(this: BlendPoint): PntObj {.noSideEffect, cdecl, importcpp: "PointOnC1",
                                     header: "Blend_Point.hxx".}
proc pointOnC2*(this: BlendPoint): PntObj {.noSideEffect, cdecl, importcpp: "PointOnC2",
                                     header: "Blend_Point.hxx".}
...
proc tangentOnC1*(this: BlendPoint): VecObj {.noSideEffect, cdecl,
