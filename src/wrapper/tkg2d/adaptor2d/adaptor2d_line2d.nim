...
proc newAdaptor2dLine2d*(p: Pnt2dObj; d: Dir2dObj; uFirst: cfloat; uLast: cfloat): Adaptor2dLine2d {.
    cdecl, constructor, importcpp: "Adaptor2d_Line2d(@)", header: "Adaptor2d_Line2d.hxx".}
proc load*(this: var Adaptor2dLine2d; L: Lin2dObj) {.cdecl, importcpp: "Load", header: "Adaptor2d_Line2d.hxx".}
proc load*(this: var Adaptor2dLine2d; L: Lin2dObj; uFirst: cfloat; uLast: cfloat) {.cdecl,
...
proc value*(this: Adaptor2dLine2d; x: cfloat): Pnt2dObj {.noSideEffect, cdecl,
    importcpp: "Value", header: "Adaptor2d_Line2d.hxx".}
proc d0*(this: Adaptor2dLine2d; x: cfloat; p: var Pnt2dObj) {.noSideEffect, cdecl,
    importcpp: "D0", header: "Adaptor2d_Line2d.hxx".}
proc d1*(this: Adaptor2dLine2d; x: cfloat; p: var Pnt2dObj; v: var Vec2dObj) {.noSideEffect,
    cdecl, importcpp: "D1", header: "Adaptor2d_Line2d.hxx".}
proc d2*(this: Adaptor2dLine2d; x: cfloat; p: var Pnt2dObj; v1: var Vec2dObj; v2: var Vec2dObj) {.
    noSideEffect, cdecl, importcpp: "D2", header: "Adaptor2d_Line2d.hxx".}
proc d3*(this: Adaptor2dLine2d; x: cfloat; p: var Pnt2dObj; v1: var Vec2dObj; v2: var Vec2dObj;
        v3: var Vec2dObj) {.noSideEffect, cdecl, importcpp: "D3", header: "Adaptor2d_Line2d.hxx".}
proc dn*(this: Adaptor2dLine2d; u: cfloat; n: cint): Vec2dObj {.noSideEffect, cdecl,
...
proc line*(this: Adaptor2dLine2d): Lin2dObj {.noSideEffect, cdecl, importcpp: "Line",
                                       header: "Adaptor2d_Line2d.hxx".}
proc circle*(this: Adaptor2dLine2d): Circ2dObj {.noSideEffect, cdecl,
    importcpp: "Circle", header: "Adaptor2d_Line2d.hxx".}
proc ellipse*(this: Adaptor2dLine2d): Elips2dObj {.noSideEffect, cdecl,
    importcpp: "Ellipse", header: "Adaptor2d_Line2d.hxx".}
proc hyperbola*(this: Adaptor2dLine2d): Hypr2dObj {.noSideEffect, cdecl,
    importcpp: "Hyperbola", header: "Adaptor2d_Line2d.hxx".}
proc parabola*(this: Adaptor2dLine2d): Parab2dObj {.noSideEffect, cdecl,
