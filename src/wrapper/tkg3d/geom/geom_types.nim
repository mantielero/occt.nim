# PROVIDES: HandleGeomAxis1Placement HandleGeomAxis2Placement HandleGeomAxisPlacement HandleGeomBezierCurve HandleGeomBezierSurface HandleGeomBoundedCurve HandleGeomBoundedSurface HandleGeomBSplineCurve HandleGeomBSplineSurface HandleGeomCartesianPoint HandleGeomCircle HandleGeomConic HandleGeomConicalSurface HandleGeomCurve HandleGeomCylindricalSurface HandleGeomDirection HandleGeomElementarySurface HandleGeomEllipse HandleGeomGeometry HandleGeomHyperbola HandleGeomLine HandleGeomOffsetCurve HandleGeomOffsetSurface HandleGeomParabola HandleGeomPlane HandleGeomPoint HandleGeomRectangularTrimmedSurface HandleGeomSphericalSurface HandleGeomSurface HandleGeomSurfaceOfLinearExtrusion HandleGeomSurfaceOfRevolution HandleGeomSweptSurface HandleGeomToroidalSurface HandleGeomTransformation HandleGeomUndefinedDerivative HandleGeomUndefinedValue HandleGeomVector HandleGeomVectorWithMagnitude HandleGeomTrimmedCurve
# DEPENDS: GeomAxisPlacement GeomAxisPlacement GeomGeometry GeomBoundedCurve GeomBoundedSurface GeomCurve GeomBoundedCurve GeomBoundedSurface GeomPoint GeomConic GeomCurve GeomElementarySurface GeomGeometry GeomElementarySurface GeomVector GeomSurface GeomConic StandardTransient GeomSequenceOfBSplineSurface GeomConic GeomCurve GeomCurve GeomSurface StandardTransient GeomConic GeomElementarySurface GeomGeometry GeomBoundedSurface GeomElementarySurface GeomGeometry GeomSweptSurface GeomSweptSurface GeomSurface GeomElementarySurface StandardTransient GeomBoundedCurve GeomGeometry GeomVector
