...
# ls /usr/include/opencascade/IntSurf*.hxx | cut -c 26-



genFiles("IntSurf_Allocator")
genFiles("IntSurf_Couple")
genFiles("IntSurf")
...
genFiles("IntSurf_Quadric")
genFiles("IntSurf_QuadricTool")
genFiles("IntSurf_SequenceOfCouple")
genFiles("IntSurf_SequenceOfInteriorPoint")
genFiles("IntSurf_SequenceOfPathPoint")
genFiles("IntSurf_SequenceOfPntOn2S")
genFiles("IntSurf_Situation")
genFiles("IntSurf_Transition")
genFiles("IntSurf_TypeTrans")
