...
# ls /usr/include/opencascade/AppCont*.hxx | cut -c 26-


genFiles("AppCont_ContMatrices")
genFiles("AppCont_Function")
genFiles("AppCont_LeastSquare")
