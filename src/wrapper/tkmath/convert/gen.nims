...
# ls /usr/include/opencascade/Convert*.hxx | cut -c 26-

genFiles("Convert_CircleToBSplineCurve")
genFiles("Convert_CompBezierCurves2dToBSplineCurve2d")
genFiles("Convert_CompBezierCurvesToBSplineCurve")
genFiles("Convert_CompPolynomialToPoles")
genFiles("Convert_ConeToBSplineSurface")
genFiles("Convert_ConicToBSplineCurve")
pp("convert_conictobsplinecurve.nim",
  replaceAll = @[("= object", "= object of RootObj")]
)
genFiles("Convert_CosAndSinEvalFunction")
genFiles("Convert_CylinderToBSplineSurface")
genFiles("Convert_ElementarySurfaceToBSplineSurface")
pp("convert_elementarysurfacetobsplinesurface.nim",
  replaceAll = @[("= object", "= object of RootObj")]
)
genFiles("Convert_EllipseToBSplineCurve")
genFiles("Convert_GridPolynomialToPoles")
genFiles("Convert_HyperbolaToBSplineCurve")
genFiles("Convert_ParabolaToBSplineCurve")
genFiles("Convert_ParameterisationType")
pp("convert_parameterisationtype.nim",
  replaceAll = @[("""    ConvertTgtThetaOver2, ConvertTgtThetaOver21, ConvertTgtThetaOver22,
...
genFiles("Convert_PolynomialCosAndSin")
genFiles("Convert_SequenceOfArray1OfPoles2d")
genFiles("Convert_SequenceOfArray1OfPoles")
genFiles("Convert_SphereToBSplineSurface")
genFiles("Convert_TorusToBSplineSurface")
