...
proc newPnt2d*(): Pnt2d {.cdecl, constructor, importcpp: "gp_Pnt2d(@)", header: "gp_Pnt2d.hxx".}
...
proc setCoord*(this: var Pnt2d; xp: cfloat; yp: cfloat) {.cdecl, importcpp: "SetCoord",
    header: "gp_Pnt2d.hxx".}
proc setX*(this: var Pnt2d; x: cfloat) {.cdecl, importcpp: "SetX", header: "gp_Pnt2d.hxx".}
proc setY*(this: var Pnt2d; y: cfloat) {.cdecl, importcpp: "SetY", header: "gp_Pnt2d.hxx".}
proc setXY*(this: var Pnt2d; coord: Xy) {.cdecl, importcpp: "SetXY", header: "gp_Pnt2d.hxx".}
...
proc x*(this: Pnt2d): cfloat {.noSideEffect, cdecl, importcpp: "X", header: "gp_Pnt2d.hxx".}
proc y*(this: Pnt2d): cfloat {.noSideEffect, cdecl, importcpp: "Y", header: "gp_Pnt2d.hxx".}
proc xy*(this: Pnt2d): Xy {.noSideEffect, cdecl, importcpp: "XY", header: "gp_Pnt2d.hxx".}
proc coord*(this: Pnt2d): Xy {.noSideEffect, cdecl, importcpp: "Coord", header: "gp_Pnt2d.hxx".}
...
proc mirror*(this: var Pnt2d; p: Pnt2d) {.cdecl, importcpp: "Mirror", header: "gp_Pnt2d.hxx".}
proc mirrored*(this: Pnt2d; p: Pnt2d): Pnt2d {.noSideEffect, cdecl,
    importcpp: "Mirrored", header: "gp_Pnt2d.hxx".}
proc mirror*(this: var Pnt2d; a: Ax2d) {.cdecl, importcpp: "Mirror", header: "gp_Pnt2d.hxx".}
