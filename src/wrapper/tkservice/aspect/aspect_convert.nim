...
proc round*(theValue: cfloat): cint {.cdecl.} =
  discard
...
proc convertCoordinates*(theParentPxSizeX: cint; theParentPxSizeY: cint;
                        ...
                        thePxSizeX: var cint; thePxSizeY: var cint) {.cdecl.} =
  discard
...
proc convertCoordinates*(theParentPxSizeX: cint; theParentPxSizeY: cint;
                        ...
                        theQSizeY: var cfloat) {.cdecl.} =
  discard

proc fitIn*(theParentPxSizeX: cint; theParentPxSizeY: cint; thePxLeft: var cint;
           thePxTop: var cint; thePxSizeX: var cint; thePxSizeY: var cint) {.cdecl.} =
  discard
