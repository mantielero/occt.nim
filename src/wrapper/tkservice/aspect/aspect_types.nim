# PROVIDES: AspectBackground AspectFrustumLRBT AspectGenId AspectInteriorStyle AspectPolygonOffsetMode AspectScrollDelta AspectTouch AspectTrackedDevicePose AspectTypeOfTriedronPosition AspectVKey AspectVKeyBasic AspectVKeyFlags AspectVKeyMouse HandleAspectWindow AspectXRAnalogActionData AspectXRDigitalActionData AspectXRGenericAction AspectXRHapticActionData AspectXRPoseActionData AspectXRSessionInfoString AspectXRTrackedDeviceRole AspectGradientBackground
# DEPENDS: AspectGrid StandardTransient StandardTransient AspectWindow AspectXRSession AspectGrid StandardTransient StandardTransient StandardTransient StandardTransient StandardTransient
