# PROVIDES: BRepBuilderAPI BRepBuilderAPI_BndBoxTree BRepBuilderAPI_Collect BRepBuilderAPI_Command BRepBuilderAPI_FindPlane HandleBRepBuilderAPI_Sewing VectorOfPoint BRepBuilderAPI_MakeShape EdgeObj Edge2dObj BRepBuilderAPI_MakeFace BRepBuilderAPI_MakePolygon BRepBuilderAPI_MakeShell BRepBuilderAPI_MakeSolid BRepBuilderAPI_MakeVertex BRepBuilderAPI_MakeWire BRepBuilderAPI_ModifyShape BRepBuilderAPI_Copy BRepBuilderAPI_GTransform BRepBuilderAPI_NurbsConvert BRepBuilderAPI_Transform
# DEPENDS: Selector StandardTransient StandardTransient NCollectionCellFilterInspectorXYZ
