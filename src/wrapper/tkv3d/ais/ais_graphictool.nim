...
proc getLineColor*(aDrawer: Handle[Prs3dDrawer];
    ...
    cdecl, importcpp: "AIS_GraphicTool::GetLineColor(@)", header: "AIS_GraphicTool.hxx".}
proc getLineColor*(aDrawer: Handle[Prs3dDrawer];
                  theTypeOfAttributes: AIS_TypeOfAttribute;
                  theLineColor: var QuantityColor) {.cdecl,
    importcpp: "AIS_GraphicTool::GetLineColor(@)", header: "AIS_GraphicTool.hxx".}
proc getLineWidth*(aDrawer: Handle[Prs3dDrawer];
                  theTypeOfAttributes: AIS_TypeOfAttribute): cfloat {.cdecl,
...
proc getLineType*(aDrawer: Handle[Prs3dDrawer];
    ...
    cdecl, importcpp: "AIS_GraphicTool::GetLineType(@)", header: "AIS_GraphicTool.hxx".}
proc getLineAtt*(aDrawer: Handle[Prs3dDrawer];
                theTypeOfAttributes: AIS_TypeOfAttribute;
                aCol: var QuantityNameOfColor; aWidth: var cfloat;
                aTyp: var AspectTypeOfLine) {.cdecl,
    importcpp: "AIS_GraphicTool::GetLineAtt(@)", header: "AIS_GraphicTool.hxx".}
proc getInteriorColor*(aDrawer: Handle[Prs3dDrawer]): QuantityNameOfColor {.cdecl,
    importcpp: "AIS_GraphicTool::GetInteriorColor(@)", header: "AIS_GraphicTool.hxx".}
