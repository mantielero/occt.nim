...
#type
#  MatrixType*[T] {.importcpp: "Graphic3d_TransformUtils::MatrixType<\'0>",
#                  header: "Graphic3d_TransformUtils.hxx", bycopy.} = object
...
#type
#  VectorType*[T] {.importcpp: "Graphic3d_TransformUtils::VectorType<\'0>",
#                  header: "Graphic3d_TransformUtils.hxx", bycopy.} = object
...
#var convert* {.importcpp: "Graphic3d_TransformUtils::Convert", header: "Graphic3d_TransformUtils.hxx".}: nil
#
### ! Constructs a 3D orthographic projection matrix.
#
#var ortho* {.importcpp: "Graphic3d_TransformUtils::Ortho", header: "Graphic3d_TransformUtils.hxx".}: nil
#
### ! Constructs a 2D orthographic projection matrix.
#
#var ortho2D* {.importcpp: "Graphic3d_TransformUtils::Ortho2D", header: "Graphic3d_TransformUtils.hxx".}: nil
#
### ! Maps object coordinates to window coordinates.
#
#var project* {.importcpp: "Graphic3d_TransformUtils::Project", header: "Graphic3d_TransformUtils.hxx".}: bool
#
### ! Maps window coordinates to object coordinates.
#
#var unProject* {.importcpp: "Graphic3d_TransformUtils::UnProject", header: "Graphic3d_TransformUtils.hxx".}: bool
#
### ! Constructs a 4x4 rotation matrix.
#
#var constructRotate* {.importcpp: "Graphic3d_TransformUtils::ConstructRotate",
#                     header: "Graphic3d_TransformUtils.hxx".}: nil
#
### ! Constructs a 4x4 rotation matrix.
#
#var rotate* {.importcpp: "Graphic3d_TransformUtils::Rotate", header: "Graphic3d_TransformUtils.hxx".}: nil
#
### ! Constructs a 4x4 scaling matrix.
#
#var scale* {.importcpp: "Graphic3d_TransformUtils::Scale", header: "Graphic3d_TransformUtils.hxx".}: nil
#
### ! Constructs a 4x4 translation matrix.
#
#var translate* {.importcpp: "Graphic3d_TransformUtils::Translate", header: "Graphic3d_TransformUtils.hxx".}: nil
#
### ! Returns scaling factor from 3x3 affine matrix.
#
#var scaleFactor* {.importcpp: "Graphic3d_TransformUtils::ScaleFactor", header: "Graphic3d_TransformUtils.hxx".}: cfloat
