...
# ls /usr/include/opencascade/PrsDim*.hxx | cut -c 26-

genFiles("PrsDim_AngleDimension")
genFiles("PrsDim_Chamf2dDimension")
genFiles("PrsDim_Chamf3dDimension")
genFiles("PrsDim_ConcentricRelation")
genFiles("PrsDim_DiameterDimension")
genFiles("PrsDim_Dimension")
genFiles("PrsDim_DimensionOwner")
genFiles("PrsDim_DimensionSelectionMode")
genFiles("PrsDim_DisplaySpecialSymbol")
genFiles("PrsDim_EllipseRadiusDimension")
genFiles("PrsDim_EqualDistanceRelation")
genFiles("PrsDim_EqualRadiusRelation")
genFiles("PrsDim_FixRelation")
genFiles("PrsDim")
genFiles("PrsDim_IdenticRelation")
genFiles("PrsDim_KindOfDimension")
genFiles("PrsDim_KindOfRelation")
genFiles("PrsDim_KindOfSurface")
genFiles("PrsDim_LengthDimension")
genFiles("PrsDim_MaxRadiusDimension")
genFiles("PrsDim_MidPointRelation")
genFiles("PrsDim_MinRadiusDimension")
genFiles("PrsDim_OffsetDimension")
genFiles("PrsDim_ParallelRelation")
genFiles("PrsDim_PerpendicularRelation")
genFiles("PrsDim_RadiusDimension")
genFiles("PrsDim_Relation")
genFiles("PrsDim_SymmetricRelation")
genFiles("PrsDim_TangentRelation")
genFiles("PrsDim_TypeOfAngleArrowVisibility")
genFiles("PrsDim_TypeOfAngle")
genFiles("PrsDim_TypeOfDist")
