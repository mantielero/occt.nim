...
proc nearest*(aShape: TopoDS_Shape; aPoint: Pnt): Pnt {.cdecl,
    importcpp: "PrsDim::Nearest(@)", header: "PrsDim.hxx".}
proc nearest*(theLine: Lin; thePoint: Pnt): Pnt {.cdecl,
    importcpp: "PrsDim::Nearest(@)", header: "PrsDim.hxx".}
proc nearest*(theCurve: Handle[GeomCurve]; thePoint: Pnt; theFirstPoint: Pnt;
             theLastPoint: Pnt; theNearestPoint: var Pnt): bool {.cdecl,
    importcpp: "PrsDim::Nearest(@)", header: "PrsDim.hxx".}
proc farest*(aShape: TopoDS_Shape; aPoint: Pnt): Pnt {.cdecl,
    importcpp: "PrsDim::Farest(@)", header: "PrsDim.hxx".}
proc computeGeometry*(theEdge: TopoDS_Edge; theCurve: var Handle[GeomCurve];
                     theFirstPnt: var Pnt; theLastPnt: var Pnt): bool {.cdecl,
...
proc computeGeometry*(theFirstEdge: TopoDS_Edge; theSecondEdge: TopoDS_Edge;
                     ...
                     theLastPnt2: var Pnt; thePlane: Handle[GeomPlane]): bool {.cdecl,
    importcpp: "PrsDim::ComputeGeometry(@)", header: "PrsDim.hxx".}
proc computeGeometry*(theFirstEdge: TopoDS_Edge; theSecondEdge: TopoDS_Edge;
                     theFirstCurve: var Handle[GeomCurve];
                     theSecondCurve: var Handle[GeomCurve]; theFirstPnt1: var Pnt;
...
proc projectPointOnPlane*(aPoint: Pnt; aPlane: Pln): Pnt {.cdecl,
    importcpp: "PrsDim::ProjectPointOnPlane(@)", header: "PrsDim.hxx".}
proc projectPointOnLine*(aPoint: Pnt; aLine: Lin): Pnt {.cdecl,
    importcpp: "PrsDim::ProjectPointOnLine(@)", header: "PrsDim.hxx".}
proc translatePointToBound*(aPoint: Pnt; aDir: Dir; aBndBox: BndBox): Pnt {.cdecl,
...
proc nearestApex*(elips: Elips; pApex: Pnt; nApex: Pnt; fpara: cfloat; lpara: cfloat;
                 isInDomain: var bool): Pnt {.cdecl,
    importcpp: "PrsDim::NearestApex(@)", header: "PrsDim.hxx".}
proc distanceFromApex*(elips: Elips; apex: Pnt; par: cfloat): cfloat {.cdecl,
