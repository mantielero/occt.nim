# PROVIDES: PrsDim HandlePrsDimAngleDimension HandlePrsDimChamf2dDimension HandlePrsDimChamf3dDimension HandlePrsDimConcentricRelation HandlePrsDimDiameterDimension HandlePrsDimDimension HandlePrsDimDimensionOwner HandlePrsDimEllipseRadiusDimension HandlePrsDimEqualDistanceRelation HandlePrsDimFixRelation HandlePrsDimIdenticRelation HandlePrsDimLengthDimension HandlePrsDimMaxRadiusDimension HandlePrsDimMidPointRelation HandlePrsDimMinRadiusDimension HandlePrsDimOffsetDimension HandlePrsDimParallelRelation HandlePrsDimPerpendicularRelation HandlePrsDimRadiusDimension HandlePrsDimSymmetricRelation HandlePrsDimTangentRelation
# DEPENDS: PrsDimDimension PrsDimRelation PrsDimRelation PrsDimRelation PrsDimDimension AIS_InteractiveObject SelectMgrEntityOwner PrsDimRelation PrsDimRelation PrsDimRelation PrsDimRelation PrsDimRelation PrsDimDimension PrsDimEllipseRadiusDimension PrsDimRelation PrsDimEllipseRadiusDimension PrsDimRelation PrsDimRelation PrsDimRelation PrsDimDimension AIS_InteractiveObject PrsDimRelation PrsDimRelation
