# PROVIDES: SelectMgr HandleSelectMgrAndFilter HandleSelectMgrAndOrFilter SelectMgrBVHThreadPoolSentry HandleSelectMgrCompositionFilter HandleSelectMgrEntityOwner HandleSelectMgrFilter HandleSelectMgrOrFilter SelectMgrSelectableObjectSetBVHSubset SelectMgrSelectableObjectSetIterator SelectMgrIndexedMapOfHSensitive SelectMgrSortCriterion SelectMgrToleranceMap SelectMgrTriangFrustumsIter SelectMgrMat4 SelectMgrViewClipRange SelectMgrFrustumCache
# DEPENDS: SelectMgrCompositionFilter SelectMgrCompositionFilter StandardTransient StandardTransient OSD_Thread SelectMgrFilter StandardTransient StandardTransient SelectMgrBaseFrustum StandardTransient SelectMgrCompositionFilter SelectMgrFrustum PrsMgrPresentableObject SelectBasicsSelectingVolumeManager StandardTransient StandardTransient StandardTransient StandardTransient BVH_PrimitiveSet3d SelectMgrFrustum SelectMgrBaseFrustum StandardTransient SelectMgrViewerSelector
