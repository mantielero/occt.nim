...
genFiles("TopLoc_Datum3D")
genFiles("TopLoc_IndexedMapOfLocation")
genFiles("TopLoc_ItemLocation")
genFiles("TopLoc_Location")
genFiles("TopLoc_MapIteratorOfMapOfLocation")
genFiles("TopLoc_MapLocationHasher")
genFiles("TopLoc_MapOfLocation")
pp("toploc_mapoflocation.nim",
  replaceAll = @[("TopLocMapIteratorOfMapOfLocation* = Iterator[TopLocLocation,", """TopLocMapIteratorOfMapOfLocation* {.importcpp:"NCollection_Map<TopLoc_Location,TopLoc_MapLocationHasher>::Iterator", header: "TopoDS_MapOfLocation.hxx", bycopy.} = object""")],
  comment = @[20]
)
genFiles("TopLoc_SListNodeOfItemLocation")
genFiles("TopLoc_SListOfItemLocation")
