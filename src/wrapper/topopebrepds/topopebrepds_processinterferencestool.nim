...
proc makeCPVInterference*(t: TopOpeBRepDS_Transition; s: cint; g: cint; p: cfloat;
    ...
    cdecl, importcpp: "MakeCPVInterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
  ##  transition
  ##  curve/edge index
  ##  point/vertex index
  ##  parameter of G on S
...
proc fUN_hasStateShape*(t: TopOpeBRepDS_Transition; state: TopAbsState;
    ...
    importcpp: "FUN_hasStateShape(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectTRASHAinterference*(l1: var TopOpeBRepDS_ListOfInterference;
                                  sha: TopAbsShapeEnum;
                                  l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectTRASHAinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectITRASHAinterference*(l1: var TopOpeBRepDS_ListOfInterference;
                                   index: cint;
                                   l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectITRASHAinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectTRAUNKinterference*(l1: var TopOpeBRepDS_ListOfInterference;
                                  l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectTRAUNKinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectTRAORIinterference*(l1: var TopOpeBRepDS_ListOfInterference;
                                  o: TopAbsOrientation;
                                  l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectTRAORIinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectGKinterference*(l1: var TopOpeBRepDS_ListOfInterference;
                              gk: TopOpeBRepDS_Kind;
                              l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectGKinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectSKinterference*(l1: var TopOpeBRepDS_ListOfInterference;
                              sk: TopOpeBRepDS_Kind;
                              l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectSKinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectGIinterference*(l1: var TopOpeBRepDS_ListOfInterference; gi: cint;
                              l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectGIinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectSIinterference*(l1: var TopOpeBRepDS_ListOfInterference; si: cint;
                              l2: var TopOpeBRepDS_ListOfInterference): cint {.
    cdecl, importcpp: "FUN_selectSIinterference(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_interfhassupport*(ds: TopOpeBRepDS_DataStructure;
                          i: Handle[TopOpeBRepDS_Interference]; s: TopoDS_Shape): bool {.
    cdecl, importcpp: "FUN_interfhassupport(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_transitionEQUAL*(a1: TopOpeBRepDS_Transition; a2: TopOpeBRepDS_Transition): bool {.
    cdecl, importcpp: "FUN_transitionEQUAL(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_transitionSTATEEQUAL*(a1: TopOpeBRepDS_Transition;
                              a2: TopOpeBRepDS_Transition): bool {.cdecl,
    importcpp: "FUN_transitionSTATEEQUAL(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_transitionSHAPEEQUAL*(a1: TopOpeBRepDS_Transition;
                              a2: TopOpeBRepDS_Transition): bool {.cdecl,
    importcpp: "FUN_transitionSHAPEEQUAL(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_transitionINDEXEQUAL*(a1: TopOpeBRepDS_Transition;
                              a2: TopOpeBRepDS_Transition): bool {.cdecl,
    importcpp: "FUN_transitionINDEXEQUAL(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_reducedoublons*(li: var TopOpeBRepDS_ListOfInterference;
                        bds: TopOpeBRepDS_DataStructure; six: cint) {.cdecl,
    importcpp: "FUN_reducedoublons(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_unkeepUNKNOWN*(li: var TopOpeBRepDS_ListOfInterference;
                       bds: var TopOpeBRepDS_DataStructure; six: cint) {.cdecl,
    importcpp: "FUN_unkeepUNKNOWN(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_select2dI*(six: cint; bds: var TopOpeBRepDS_DataStructure;
    ...
    importcpp: "FUN_select2dI(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_selectpure2dI*(lF: TopOpeBRepDS_ListOfInterference;
    ...
    importcpp: "FUN_selectpure2dI(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
proc fUN_select1dI*(six: cint; bds: var TopOpeBRepDS_DataStructure;
                   li: var TopOpeBRepDS_ListOfInterference;
                   l1dI: var TopOpeBRepDS_ListOfInterference): cint {.cdecl,
    importcpp: "FUN_select1dI(@)", header: "TopOpeBRepDS_ProcessInterferencesTool.hxx".}
