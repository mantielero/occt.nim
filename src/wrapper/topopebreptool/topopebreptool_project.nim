...
proc fUN_toolGetindex*(ponc: ExtremaExtPC2d): cint {.cdecl,
    importcpp: "FUN_tool_getindex(@)", header: "TopOpeBRepTool_PROJECT.hxx".}
proc fUN_toolProjPonC*(p: gp_Pnt; tole: cfloat; bac: BRepAdaptorCurve; pmin: cfloat;
                      pmax: cfloat; param: var cfloat; dist: var cfloat): bool {.cdecl,
    importcpp: "FUN_tool_projPonC(@)", header: "TopOpeBRepTool_PROJECT.hxx".}
proc fUN_toolProjPonC*(p: gp_Pnt; bac: BRepAdaptorCurve; pmin: cfloat; pmax: cfloat;
                      param: var cfloat; dist: var cfloat): bool {.cdecl,
    importcpp: "FUN_tool_projPonC(@)", header: "TopOpeBRepTool_PROJECT.hxx".}
proc fUN_toolProjPonC*(p: gp_Pnt; bac: BRepAdaptorCurve; param: var cfloat;
                      dist: var cfloat): bool {.cdecl,
    importcpp: "FUN_tool_projPonC(@)", header: "TopOpeBRepTool_PROJECT.hxx".}
proc fUN_toolProjPonC2D*(p: gp_Pnt; tole: cfloat; bac2d: BRepAdaptorCurve2d; pmin: cfloat;
                        pmax: cfloat; param: var cfloat; dist: var cfloat): bool {.cdecl,
    importcpp: "FUN_tool_projPonC2D(@)", header: "TopOpeBRepTool_PROJECT.hxx".}
proc fUN_toolProjPonC2D*(p: gp_Pnt; bac2d: BRepAdaptorCurve2d; pmin: cfloat; pmax: cfloat;
                        param: var cfloat; dist: var cfloat): bool {.cdecl,
    importcpp: "FUN_tool_projPonC2D(@)", header: "TopOpeBRepTool_PROJECT.hxx".}
...
proc fUN_toolProjPonE*(p: gp_Pnt; tole: cfloat; e: TopoDS_Edge; param: var cfloat;
                      dist: var cfloat): bool {.cdecl,
