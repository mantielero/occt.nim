...
proc newXCAFDoc_Datum*(): XCAFDoc_Datum {.cdecl, constructor,
                                       importcpp: "XCAFDoc_Datum(@)",
                                       header: "XCAFDoc_Datum.hxx".}
proc GetID*(): Standard_GUID {.cdecl, importcpp: "XCAFDoc_Datum::GetID(@)",
                            header: "XCAFDoc_Datum.hxx".}
...
proc Set*(theLabel: TDF_Label): handle[XCAFDoc_Datum] {.cdecl,
...
proc Set*(this: var XCAFDoc_Datum; aName: handle[TCollection_HAsciiString];
         aDescription: handle[TCollection_HAsciiString];
         anIdentification: handle[TCollection_HAsciiString]) {.cdecl,
...
proc SetObject*(this: var XCAFDoc_Datum;
               theDatumObject: handle[XCAFDimTolObjects_DatumObject]) {.cdecl,
    importcpp: "SetObject", header: "XCAFDoc_Datum.hxx".}
proc ID*(this: XCAFDoc_Datum): Standard_GUID {.noSideEffect, cdecl, importcpp: "ID",
    header: "XCAFDoc_Datum.hxx".}
proc Restore*(this: var XCAFDoc_Datum; With: handle[TDF_Attribute]) {.cdecl,
    importcpp: "Restore", header: "XCAFDoc_Datum.hxx".}
proc NewEmpty*(this: XCAFDoc_Datum): handle[TDF_Attribute] {.noSideEffect, cdecl,
