...
type
  AIS_AnimationProgress* {.importcpp: "AIS_AnimationProgress",
    ...
    pts* {.importc: "Pts".}: StandardReal ## !< global presentation timestamp
    localPts* {.importc: "LocalPts".}: StandardReal ## !< presentation within current animation
    localNormalized* {.importc: "LocalNormalized".}: StandardReal ## !< normalized position within current animation within 0..1 range
...
proc startPts*(this: AIS_Animation): StandardReal {.noSideEffect,
    importcpp: "StartPts", header: "AIS_Animation.hxx".}
proc setStartPts*(this: var AIS_Animation; thePtsStart: StandardReal) {.
    importcpp: "SetStartPts", header: "AIS_Animation.hxx".}
proc duration*(this: AIS_Animation): StandardReal {.noSideEffect,
...
proc hasOwnDuration*(this: AIS_Animation): StandardBoolean {.noSideEffect,
    importcpp: "HasOwnDuration", header: "AIS_Animation.hxx".}
proc ownDuration*(this: AIS_Animation): StandardReal {.noSideEffect,
    importcpp: "OwnDuration", header: "AIS_Animation.hxx".}
proc setOwnDuration*(this: var AIS_Animation; theDuration: StandardReal) {.
...
proc remove*(this: var AIS_Animation; theAnimation: Handle[AIS_Animation]): StandardBoolean {.
    importcpp: "Remove", header: "AIS_Animation.hxx".}
proc replace*(this: var AIS_Animation; theAnimationOld: Handle[AIS_Animation];
             theAnimationNew: Handle[AIS_Animation]): StandardBoolean {.
...
proc startTimer*(this: var AIS_Animation; theStartPts: StandardReal;
                thePlaySpeed: StandardReal; theToUpdate: StandardBoolean;
                theToStopTimer: StandardBoolean = standardFalse) {.
    importcpp: "StartTimer", header: "AIS_Animation.hxx".}
proc updateTimer*(this: var AIS_Animation): StandardReal {.importcpp: "UpdateTimer",
    header: "AIS_Animation.hxx".}
proc elapsedTime*(this: AIS_Animation): StandardReal {.noSideEffect,
    importcpp: "ElapsedTime", header: "AIS_Animation.hxx".}
proc start*(this: var AIS_Animation; theToUpdate: StandardBoolean) {.
...
proc isStopped*(this: var AIS_Animation): bool {.importcpp: "IsStopped",
    header: "AIS_Animation.hxx".}
proc update*(this: var AIS_Animation; thePts: StandardReal): StandardBoolean {.
