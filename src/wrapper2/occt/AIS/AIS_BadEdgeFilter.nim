...
proc actsOn*(this: AIS_BadEdgeFilter; aType: TopAbsShapeEnum): StandardBoolean {.
    noSideEffect, importcpp: "ActsOn", header: "AIS_BadEdgeFilter.hxx".}
proc isOk*(this: AIS_BadEdgeFilter; eo: Handle[SelectMgrEntityOwner]): StandardBoolean {.
    noSideEffect, importcpp: "IsOk", header: "AIS_BadEdgeFilter.hxx".}
proc setContour*(this: var AIS_BadEdgeFilter; index: StandardInteger) {.
    importcpp: "SetContour", header: "AIS_BadEdgeFilter.hxx".}
proc addEdge*(this: var AIS_BadEdgeFilter; anEdge: TopoDS_Edge; index: StandardInteger) {.
    importcpp: "AddEdge", header: "AIS_BadEdgeFilter.hxx".}
proc removeEdges*(this: var AIS_BadEdgeFilter; index: StandardInteger) {.
