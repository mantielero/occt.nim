...
proc isSelected*(this: AIS_Selection; theObject: Handle[SelectMgrEntityOwner]): StandardBoolean {.
...
proc extent*(this: AIS_Selection): StandardInteger {.noSideEffect,
    importcpp: "Extent", header: "AIS_Selection.hxx".}
proc isEmpty*(this: AIS_Selection): StandardBoolean {.noSideEffect,
    importcpp: "IsEmpty", header: "AIS_Selection.hxx".}
proc init*(this: var AIS_Selection) {.importcpp: "Init", header: "AIS_Selection.hxx".}
proc more*(this: AIS_Selection): StandardBoolean {.noSideEffect, importcpp: "More",
    header: "AIS_Selection.hxx".}
