...
proc hasOwnSize*(this: AIS_Trihedron): StandardBoolean {.noSideEffect,
    importcpp: "HasOwnSize", header: "AIS_Trihedron.hxx".}
proc setSize*(this: var AIS_Trihedron; theValue: StandardReal) {.importcpp: "SetSize",
    header: "AIS_Trihedron.hxx".}
proc unsetSize*(this: var AIS_Trihedron) {.importcpp: "UnsetSize",
                                       header: "AIS_Trihedron.hxx".}
proc size*(this: AIS_Trihedron): StandardReal {.noSideEffect, importcpp: "Size",
    header: "AIS_Trihedron.hxx".}
proc acceptDisplayMode*(this: AIS_Trihedron; theMode: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "AcceptDisplayMode", header: "AIS_Trihedron.hxx".}
proc signature*(this: AIS_Trihedron): StandardInteger {.noSideEffect,
...
proc hasTextColor*(this: AIS_Trihedron): StandardBoolean {.noSideEffect,
...
proc hasArrowColor*(this: AIS_Trihedron): StandardBoolean {.noSideEffect,
...
proc toDrawArrows*(this: AIS_Trihedron): StandardBoolean {.noSideEffect,
    importcpp: "ToDrawArrows", header: "AIS_Trihedron.hxx".}
proc setDrawArrows*(this: var AIS_Trihedron; theToDraw: StandardBoolean) {.
...
proc selectionPriority*(this: var AIS_Trihedron; thePart: Prs3dDatumParts): StandardInteger {.
