...
proc toAutoStartAnimation*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
...
proc isFixedAnimationLoop*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
...
proc resetStyles*(this: var AIS_ViewCube) {.importcpp: "ResetStyles",
                                        header: "AIS_ViewCube.hxx".}
proc size*(this: AIS_ViewCube): StandardReal {.noSideEffect, importcpp: "Size",
    header: "AIS_ViewCube.hxx".}
proc setSize*(this: var AIS_ViewCube; theValue: StandardReal;
             theToAdaptAnother: StandardBoolean = true) {.importcpp: "SetSize",
    header: "AIS_ViewCube.hxx".}
proc boxFacetExtension*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "BoxFacetExtension", header: "AIS_ViewCube.hxx".}
proc setBoxFacetExtension*(this: var AIS_ViewCube; theValue: StandardReal) {.
    importcpp: "SetBoxFacetExtension", header: "AIS_ViewCube.hxx".}
proc axesPadding*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "AxesPadding", header: "AIS_ViewCube.hxx".}
proc setAxesPadding*(this: var AIS_ViewCube; theValue: StandardReal) {.
    importcpp: "SetAxesPadding", header: "AIS_ViewCube.hxx".}
proc boxEdgeGap*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "BoxEdgeGap", header: "AIS_ViewCube.hxx".}
proc setBoxEdgeGap*(this: var AIS_ViewCube; theValue: StandardReal) {.
    importcpp: "SetBoxEdgeGap", header: "AIS_ViewCube.hxx".}
proc boxEdgeMinSize*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "BoxEdgeMinSize", header: "AIS_ViewCube.hxx".}
proc setBoxEdgeMinSize*(this: var AIS_ViewCube; theValue: StandardReal) {.
    importcpp: "SetBoxEdgeMinSize", header: "AIS_ViewCube.hxx".}
proc boxCornerMinSize*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "BoxCornerMinSize", header: "AIS_ViewCube.hxx".}
proc setBoxCornerMinSize*(this: var AIS_ViewCube; theValue: StandardReal) {.
    importcpp: "SetBoxCornerMinSize", header: "AIS_ViewCube.hxx".}
proc roundRadius*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "RoundRadius", header: "AIS_ViewCube.hxx".}
proc setRoundRadius*(this: var AIS_ViewCube; theValue: StandardReal) {.
    importcpp: "SetRoundRadius", header: "AIS_ViewCube.hxx".}
proc axesRadius*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "AxesRadius", header: "AIS_ViewCube.hxx".}
proc setAxesRadius*(this: var AIS_ViewCube; theRadius: StandardReal) {.
    importcpp: "SetAxesRadius", header: "AIS_ViewCube.hxx".}
proc axesConeRadius*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "AxesConeRadius", header: "AIS_ViewCube.hxx".}
proc setAxesConeRadius*(this: var AIS_ViewCube; theRadius: StandardReal) {.
    importcpp: "SetAxesConeRadius", header: "AIS_ViewCube.hxx".}
proc axesSphereRadius*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "AxesSphereRadius", header: "AIS_ViewCube.hxx".}
proc setAxesSphereRadius*(this: var AIS_ViewCube; theRadius: StandardReal) {.
    importcpp: "SetAxesSphereRadius", header: "AIS_ViewCube.hxx".}
proc toDrawAxes*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
    importcpp: "ToDrawAxes", header: "AIS_ViewCube.hxx".}
proc setDrawAxes*(this: var AIS_ViewCube; theValue: StandardBoolean) {.
    importcpp: "SetDrawAxes", header: "AIS_ViewCube.hxx".}
proc toDrawEdges*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
    importcpp: "ToDrawEdges", header: "AIS_ViewCube.hxx".}
proc setDrawEdges*(this: var AIS_ViewCube; theValue: StandardBoolean) {.
    importcpp: "SetDrawEdges", header: "AIS_ViewCube.hxx".}
proc toDrawVertices*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
    importcpp: "ToDrawVertices", header: "AIS_ViewCube.hxx".}
proc setDrawVertices*(this: var AIS_ViewCube; theValue: StandardBoolean) {.
    importcpp: "SetDrawVertices", header: "AIS_ViewCube.hxx".}
proc isYup*(this: AIS_ViewCube): StandardBoolean {.noSideEffect, importcpp: "IsYup",
    header: "AIS_ViewCube.hxx".}
proc setYup*(this: var AIS_ViewCube; theIsYup: StandardBoolean;
            theToUpdateLabels: StandardBoolean = standardTrue) {.
...
proc boxTransparency*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "BoxTransparency", header: "AIS_ViewCube.hxx".}
proc setBoxTransparency*(this: var AIS_ViewCube; theValue: StandardReal) {.
...
proc fontHeight*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "FontHeight", header: "AIS_ViewCube.hxx".}
proc setFontHeight*(this: var AIS_ViewCube; theValue: StandardReal) {.
...
proc unsetColor*(this: var AIS_ViewCube) {.importcpp: "UnsetColor",
                                       header: "AIS_ViewCube.hxx".}
proc setTransparency*(this: var AIS_ViewCube; theValue: StandardReal) {.
...
proc unsetMaterial*(this: var AIS_ViewCube) {.importcpp: "UnsetMaterial",
    header: "AIS_ViewCube.hxx".}
proc duration*(this: AIS_ViewCube): StandardReal {.noSideEffect,
    importcpp: "Duration", header: "AIS_ViewCube.hxx".}
proc setDuration*(this: var AIS_ViewCube; theValue: StandardReal) {.
    importcpp: "SetDuration", header: "AIS_ViewCube.hxx".}
proc toResetCameraUp*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
    importcpp: "ToResetCameraUp", header: "AIS_ViewCube.hxx".}
proc setResetCamera*(this: var AIS_ViewCube; theToReset: StandardBoolean) {.
    importcpp: "SetResetCamera", header: "AIS_ViewCube.hxx".}
proc toFitSelected*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
    importcpp: "ToFitSelected", header: "AIS_ViewCube.hxx".}
proc setFitSelected*(this: var AIS_ViewCube; theToFitSelected: StandardBoolean) {.
    importcpp: "SetFitSelected", header: "AIS_ViewCube.hxx".}
proc hasAnimation*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
...
proc updateAnimation*(this: var AIS_ViewCube; theToUpdate: StandardBoolean): StandardBoolean {.
...
proc acceptDisplayMode*(this: AIS_ViewCube; theMode: StandardInteger): StandardBoolean {.
...
proc compute*(this: var AIS_ViewCube;
             ...
             thePrs: Handle[Prs3dPresentation]; theMode: StandardInteger = 0) {.
...
proc computeSelection*(this: var AIS_ViewCube;
    ...
    header: "AIS_ViewCube.hxx".}
proc isAutoHilight*(this: AIS_ViewCube): StandardBoolean {.noSideEffect,
...
proc constructAIS_ViewCubeOwner*(theObject: Handle[AIS_ViewCube];
                                ...
                                thePriority: StandardInteger = 5): AIS_ViewCubeOwner {.
    constructor, importcpp: "AIS_ViewCubeOwner(@)", header: "AIS_ViewCube.hxx".}
proc isForcedHilight*(this: AIS_ViewCubeOwner): StandardBoolean {.noSideEffect,
