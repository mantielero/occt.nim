...
proc firstParameter*(this: Adaptor2dCurve2d): StandardReal {.noSideEffect,
    importcpp: "FirstParameter", header: "Adaptor2d_Curve2d.hxx".}
proc lastParameter*(this: Adaptor2dCurve2d): StandardReal {.noSideEffect,
...
proc nbIntervals*(this: Adaptor2dCurve2d; s: GeomAbsShape): StandardInteger {.
...
proc trim*(this: Adaptor2dCurve2d; first: StandardReal; last: StandardReal;
          tol: StandardReal): Handle[Adaptor2dHCurve2d] {.noSideEffect,
    importcpp: "Trim", header: "Adaptor2d_Curve2d.hxx".}
proc isClosed*(this: Adaptor2dCurve2d): StandardBoolean {.noSideEffect,
    importcpp: "IsClosed", header: "Adaptor2d_Curve2d.hxx".}
proc isPeriodic*(this: Adaptor2dCurve2d): StandardBoolean {.noSideEffect,
    importcpp: "IsPeriodic", header: "Adaptor2d_Curve2d.hxx".}
proc period*(this: Adaptor2dCurve2d): StandardReal {.noSideEffect,
    importcpp: "Period", header: "Adaptor2d_Curve2d.hxx".}
proc value*(this: Adaptor2dCurve2d; u: StandardReal): GpPnt2d {.noSideEffect,
    importcpp: "Value", header: "Adaptor2d_Curve2d.hxx".}
proc d0*(this: Adaptor2dCurve2d; u: StandardReal; p: var GpPnt2d) {.noSideEffect,
    importcpp: "D0", header: "Adaptor2d_Curve2d.hxx".}
proc d1*(this: Adaptor2dCurve2d; u: StandardReal; p: var GpPnt2d; v: var GpVec2d) {.
    noSideEffect, importcpp: "D1", header: "Adaptor2d_Curve2d.hxx".}
proc d2*(this: Adaptor2dCurve2d; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d) {.noSideEffect, importcpp: "D2",
                        header: "Adaptor2d_Curve2d.hxx".}
proc d3*(this: Adaptor2dCurve2d; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d; v3: var GpVec2d) {.noSideEffect, importcpp: "D3",
                                      header: "Adaptor2d_Curve2d.hxx".}
proc dn*(this: Adaptor2dCurve2d; u: StandardReal; n: StandardInteger): GpVec2d {.
    noSideEffect, importcpp: "DN", header: "Adaptor2d_Curve2d.hxx".}
proc resolution*(this: Adaptor2dCurve2d; r3d: StandardReal): StandardReal {.
...
proc line*(this: Adaptor2dCurve2d): GpLin2d {.noSideEffect, importcpp: "Line",
    header: "Adaptor2d_Curve2d.hxx".}
proc circle*(this: Adaptor2dCurve2d): GpCirc2d {.noSideEffect, importcpp: "Circle",
    header: "Adaptor2d_Curve2d.hxx".}
proc ellipse*(this: Adaptor2dCurve2d): GpElips2d {.noSideEffect,
    importcpp: "Ellipse", header: "Adaptor2d_Curve2d.hxx".}
proc hyperbola*(this: Adaptor2dCurve2d): GpHypr2d {.noSideEffect,
    importcpp: "Hyperbola", header: "Adaptor2d_Curve2d.hxx".}
proc parabola*(this: Adaptor2dCurve2d): GpParab2d {.noSideEffect,
    importcpp: "Parabola", header: "Adaptor2d_Curve2d.hxx".}
proc degree*(this: Adaptor2dCurve2d): StandardInteger {.noSideEffect,
    importcpp: "Degree", header: "Adaptor2d_Curve2d.hxx".}
proc isRational*(this: Adaptor2dCurve2d): StandardBoolean {.noSideEffect,
    importcpp: "IsRational", header: "Adaptor2d_Curve2d.hxx".}
proc nbPoles*(this: Adaptor2dCurve2d): StandardInteger {.noSideEffect,
    importcpp: "NbPoles", header: "Adaptor2d_Curve2d.hxx".}
proc nbKnots*(this: Adaptor2dCurve2d): StandardInteger {.noSideEffect,
    importcpp: "NbKnots", header: "Adaptor2d_Curve2d.hxx".}
proc nbSamples*(this: Adaptor2dCurve2d): StandardInteger {.noSideEffect,
