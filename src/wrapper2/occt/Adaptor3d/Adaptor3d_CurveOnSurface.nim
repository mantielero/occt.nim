...
proc firstParameter*(this: Adaptor3dCurveOnSurface): StandardReal {.noSideEffect,
    importcpp: "FirstParameter", header: "Adaptor3d_CurveOnSurface.hxx".}
proc lastParameter*(this: Adaptor3dCurveOnSurface): StandardReal {.noSideEffect,
...
proc nbIntervals*(this: Adaptor3dCurveOnSurface; s: GeomAbsShape): StandardInteger {.
...
proc intervals*(this: Adaptor3dCurveOnSurface; t: var TColStdArray1OfReal;
               s: GeomAbsShape) {.noSideEffect, importcpp: "Intervals",
                                header: "Adaptor3d_CurveOnSurface.hxx".}
proc trim*(this: Adaptor3dCurveOnSurface; first: StandardReal; last: StandardReal;
          tol: StandardReal): Handle[Adaptor3dHCurve] {.noSideEffect,
    importcpp: "Trim", header: "Adaptor3d_CurveOnSurface.hxx".}
proc isClosed*(this: Adaptor3dCurveOnSurface): StandardBoolean {.noSideEffect,
    importcpp: "IsClosed", header: "Adaptor3d_CurveOnSurface.hxx".}
proc isPeriodic*(this: Adaptor3dCurveOnSurface): StandardBoolean {.noSideEffect,
    importcpp: "IsPeriodic", header: "Adaptor3d_CurveOnSurface.hxx".}
proc period*(this: Adaptor3dCurveOnSurface): StandardReal {.noSideEffect,
    importcpp: "Period", header: "Adaptor3d_CurveOnSurface.hxx".}
proc value*(this: Adaptor3dCurveOnSurface; u: StandardReal): GpPnt {.noSideEffect,
    importcpp: "Value", header: "Adaptor3d_CurveOnSurface.hxx".}
proc d0*(this: Adaptor3dCurveOnSurface; u: StandardReal; p: var GpPnt) {.noSideEffect,
    importcpp: "D0", header: "Adaptor3d_CurveOnSurface.hxx".}
proc d1*(this: Adaptor3dCurveOnSurface; u: StandardReal; p: var GpPnt; v: var GpVec) {.
    noSideEffect, importcpp: "D1", header: "Adaptor3d_CurveOnSurface.hxx".}
proc d2*(this: Adaptor3dCurveOnSurface; u: StandardReal; p: var GpPnt; v1: var GpVec;
        v2: var GpVec) {.noSideEffect, importcpp: "D2",
                      header: "Adaptor3d_CurveOnSurface.hxx".}
proc d3*(this: Adaptor3dCurveOnSurface; u: StandardReal; p: var GpPnt; v1: var GpVec;
        v2: var GpVec; v3: var GpVec) {.noSideEffect, importcpp: "D3",
                                  header: "Adaptor3d_CurveOnSurface.hxx".}
proc dn*(this: Adaptor3dCurveOnSurface; u: StandardReal; n: StandardInteger): GpVec {.
    noSideEffect, importcpp: "DN", header: "Adaptor3d_CurveOnSurface.hxx".}
proc resolution*(this: Adaptor3dCurveOnSurface; r3d: StandardReal): StandardReal {.
...
proc line*(this: Adaptor3dCurveOnSurface): GpLin {.noSideEffect, importcpp: "Line",
    header: "Adaptor3d_CurveOnSurface.hxx".}
proc circle*(this: Adaptor3dCurveOnSurface): GpCirc {.noSideEffect,
    importcpp: "Circle", header: "Adaptor3d_CurveOnSurface.hxx".}
proc ellipse*(this: Adaptor3dCurveOnSurface): GpElips {.noSideEffect,
    importcpp: "Ellipse", header: "Adaptor3d_CurveOnSurface.hxx".}
proc hyperbola*(this: Adaptor3dCurveOnSurface): GpHypr {.noSideEffect,
    importcpp: "Hyperbola", header: "Adaptor3d_CurveOnSurface.hxx".}
proc parabola*(this: Adaptor3dCurveOnSurface): GpParab {.noSideEffect,
    importcpp: "Parabola", header: "Adaptor3d_CurveOnSurface.hxx".}
proc degree*(this: Adaptor3dCurveOnSurface): StandardInteger {.noSideEffect,
    importcpp: "Degree", header: "Adaptor3d_CurveOnSurface.hxx".}
proc isRational*(this: Adaptor3dCurveOnSurface): StandardBoolean {.noSideEffect,
    importcpp: "IsRational", header: "Adaptor3d_CurveOnSurface.hxx".}
proc nbPoles*(this: Adaptor3dCurveOnSurface): StandardInteger {.noSideEffect,
    importcpp: "NbPoles", header: "Adaptor3d_CurveOnSurface.hxx".}
proc nbKnots*(this: Adaptor3dCurveOnSurface): StandardInteger {.noSideEffect,
