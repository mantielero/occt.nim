...
proc constructAdaptor3dIsoCurve*(s: Handle[Adaptor3dHSurface]; iso: GeomAbsIsoType;
                                param: StandardReal): Adaptor3dIsoCurve {.
    constructor, importcpp: "Adaptor3d_IsoCurve(@)",
    header: "Adaptor3d_IsoCurve.hxx".}
proc constructAdaptor3dIsoCurve*(s: Handle[Adaptor3dHSurface]; iso: GeomAbsIsoType;
                                param: StandardReal; wFirst: StandardReal;
                                wLast: StandardReal): Adaptor3dIsoCurve {.
    constructor, importcpp: "Adaptor3d_IsoCurve(@)",
    header: "Adaptor3d_IsoCurve.hxx".}
proc load*(this: var Adaptor3dIsoCurve; s: Handle[Adaptor3dHSurface]) {.
    importcpp: "Load", header: "Adaptor3d_IsoCurve.hxx".}
proc load*(this: var Adaptor3dIsoCurve; iso: GeomAbsIsoType; param: StandardReal) {.
    importcpp: "Load", header: "Adaptor3d_IsoCurve.hxx".}
proc load*(this: var Adaptor3dIsoCurve; iso: GeomAbsIsoType; param: StandardReal;
          wFirst: StandardReal; wLast: StandardReal) {.importcpp: "Load",
    header: "Adaptor3d_IsoCurve.hxx".}
...
proc iso*(this: Adaptor3dIsoCurve): GeomAbsIsoType {.noSideEffect, importcpp: "Iso",
    header: "Adaptor3d_IsoCurve.hxx".}
proc parameter*(this: Adaptor3dIsoCurve): StandardReal {.noSideEffect,
    importcpp: "Parameter", header: "Adaptor3d_IsoCurve.hxx".}
proc firstParameter*(this: Adaptor3dIsoCurve): StandardReal {.noSideEffect,
    importcpp: "FirstParameter", header: "Adaptor3d_IsoCurve.hxx".}
proc lastParameter*(this: Adaptor3dIsoCurve): StandardReal {.noSideEffect,
...
proc nbIntervals*(this: Adaptor3dIsoCurve; s: GeomAbsShape): StandardInteger {.
...
proc trim*(this: Adaptor3dIsoCurve; first: StandardReal; last: StandardReal;
          tol: StandardReal): Handle[Adaptor3dHCurve] {.noSideEffect,
    importcpp: "Trim", header: "Adaptor3d_IsoCurve.hxx".}
proc isClosed*(this: Adaptor3dIsoCurve): StandardBoolean {.noSideEffect,
    importcpp: "IsClosed", header: "Adaptor3d_IsoCurve.hxx".}
proc isPeriodic*(this: Adaptor3dIsoCurve): StandardBoolean {.noSideEffect,
    importcpp: "IsPeriodic", header: "Adaptor3d_IsoCurve.hxx".}
proc period*(this: Adaptor3dIsoCurve): StandardReal {.noSideEffect,
    importcpp: "Period", header: "Adaptor3d_IsoCurve.hxx".}
proc value*(this: Adaptor3dIsoCurve; u: StandardReal): GpPnt {.noSideEffect,
    importcpp: "Value", header: "Adaptor3d_IsoCurve.hxx".}
proc d0*(this: Adaptor3dIsoCurve; u: StandardReal; p: var GpPnt) {.noSideEffect,
    importcpp: "D0", header: "Adaptor3d_IsoCurve.hxx".}
proc d1*(this: Adaptor3dIsoCurve; u: StandardReal; p: var GpPnt; v: var GpVec) {.
    noSideEffect, importcpp: "D1", header: "Adaptor3d_IsoCurve.hxx".}
proc d2*(this: Adaptor3dIsoCurve; u: StandardReal; p: var GpPnt; v1: var GpVec;
        v2: var GpVec) {.noSideEffect, importcpp: "D2",
                      header: "Adaptor3d_IsoCurve.hxx".}
proc d3*(this: Adaptor3dIsoCurve; u: StandardReal; p: var GpPnt; v1: var GpVec;
        v2: var GpVec; v3: var GpVec) {.noSideEffect, importcpp: "D3",
                                  header: "Adaptor3d_IsoCurve.hxx".}
proc dn*(this: Adaptor3dIsoCurve; u: StandardReal; n: StandardInteger): GpVec {.
    noSideEffect, importcpp: "DN", header: "Adaptor3d_IsoCurve.hxx".}
proc resolution*(this: Adaptor3dIsoCurve; r3d: StandardReal): StandardReal {.
...
proc line*(this: Adaptor3dIsoCurve): GpLin {.noSideEffect, importcpp: "Line",
    header: "Adaptor3d_IsoCurve.hxx".}
proc circle*(this: Adaptor3dIsoCurve): GpCirc {.noSideEffect, importcpp: "Circle",
    header: "Adaptor3d_IsoCurve.hxx".}
proc ellipse*(this: Adaptor3dIsoCurve): GpElips {.noSideEffect, importcpp: "Ellipse",
    header: "Adaptor3d_IsoCurve.hxx".}
proc hyperbola*(this: Adaptor3dIsoCurve): GpHypr {.noSideEffect,
    importcpp: "Hyperbola", header: "Adaptor3d_IsoCurve.hxx".}
proc parabola*(this: Adaptor3dIsoCurve): GpParab {.noSideEffect,
    importcpp: "Parabola", header: "Adaptor3d_IsoCurve.hxx".}
proc degree*(this: Adaptor3dIsoCurve): StandardInteger {.noSideEffect,
    importcpp: "Degree", header: "Adaptor3d_IsoCurve.hxx".}
proc isRational*(this: Adaptor3dIsoCurve): StandardBoolean {.noSideEffect,
    importcpp: "IsRational", header: "Adaptor3d_IsoCurve.hxx".}
proc nbPoles*(this: Adaptor3dIsoCurve): StandardInteger {.noSideEffect,
    importcpp: "NbPoles", header: "Adaptor3d_IsoCurve.hxx".}
proc nbKnots*(this: Adaptor3dIsoCurve): StandardInteger {.noSideEffect,
