...
proc constructAdvApp2VarIso*(`type`: GeomAbsIsoType; iu: StandardInteger;
                            iv: StandardInteger): AdvApp2VarIso {.constructor,
    importcpp: "AdvApp2Var_Iso(@)", header: "AdvApp2Var_Iso.hxx".}
proc constructAdvApp2VarIso*(`type`: GeomAbsIsoType; cte: StandardReal;
                            ufirst: StandardReal; ulast: StandardReal;
                            vfirst: StandardReal; vlast: StandardReal;
                            pos: StandardInteger; iu: StandardInteger;
                            iv: StandardInteger): AdvApp2VarIso {.constructor,
    importcpp: "AdvApp2Var_Iso(@)", header: "AdvApp2Var_Iso.hxx".}
proc isApproximated*(this: AdvApp2VarIso): StandardBoolean {.noSideEffect,
    importcpp: "IsApproximated", header: "AdvApp2Var_Iso.hxx".}
proc hasResult*(this: AdvApp2VarIso): StandardBoolean {.noSideEffect,
    importcpp: "HasResult", header: "AdvApp2Var_Iso.hxx".}
proc makeApprox*(this: var AdvApp2VarIso; conditions: AdvApp2VarContext;
                a: StandardReal; b: StandardReal; c: StandardReal; d: StandardReal;
...
proc changeDomain*(this: var AdvApp2VarIso; a: StandardReal; b: StandardReal) {.
    importcpp: "ChangeDomain", header: "AdvApp2Var_Iso.hxx".}
proc changeDomain*(this: var AdvApp2VarIso; a: StandardReal; b: StandardReal;
                  c: StandardReal; d: StandardReal) {.importcpp: "ChangeDomain",
    header: "AdvApp2Var_Iso.hxx".}
proc setConstante*(this: var AdvApp2VarIso; newcte: StandardReal) {.
    importcpp: "SetConstante", header: "AdvApp2Var_Iso.hxx".}
proc setPosition*(this: var AdvApp2VarIso; newpos: StandardInteger) {.
...
proc `type`*(this: AdvApp2VarIso): GeomAbsIsoType {.noSideEffect, importcpp: "Type",
    header: "AdvApp2Var_Iso.hxx".}
proc constante*(this: AdvApp2VarIso): StandardReal {.noSideEffect,
    importcpp: "Constante", header: "AdvApp2Var_Iso.hxx".}
proc t0*(this: AdvApp2VarIso): StandardReal {.noSideEffect, importcpp: "T0",
    header: "AdvApp2Var_Iso.hxx".}
proc t1*(this: AdvApp2VarIso): StandardReal {.noSideEffect, importcpp: "T1",
    header: "AdvApp2Var_Iso.hxx".}
proc u0*(this: AdvApp2VarIso): StandardReal {.noSideEffect, importcpp: "U0",
    header: "AdvApp2Var_Iso.hxx".}
proc u1*(this: AdvApp2VarIso): StandardReal {.noSideEffect, importcpp: "U1",
    header: "AdvApp2Var_Iso.hxx".}
proc v0*(this: AdvApp2VarIso): StandardReal {.noSideEffect, importcpp: "V0",
    header: "AdvApp2Var_Iso.hxx".}
proc v1*(this: AdvApp2VarIso): StandardReal {.noSideEffect, importcpp: "V1",
    header: "AdvApp2Var_Iso.hxx".}
proc uOrder*(this: AdvApp2VarIso): StandardInteger {.noSideEffect,
    importcpp: "UOrder", header: "AdvApp2Var_Iso.hxx".}
proc vOrder*(this: AdvApp2VarIso): StandardInteger {.noSideEffect,
    importcpp: "VOrder", header: "AdvApp2Var_Iso.hxx".}
proc position*(this: AdvApp2VarIso): StandardInteger {.noSideEffect,
    importcpp: "Position", header: "AdvApp2Var_Iso.hxx".}
proc nbCoeff*(this: AdvApp2VarIso): StandardInteger {.noSideEffect,
