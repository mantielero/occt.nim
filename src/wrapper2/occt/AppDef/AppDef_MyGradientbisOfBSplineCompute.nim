...
proc constructAppDefMyGradientbisOfBSplineCompute*(ssp: AppDefMultiLine;
    ...
    tol2d: StandardReal; nbIterations: StandardInteger = 200): AppDefMyGradientbisOfBSplineCompute {.
    constructor, importcpp: "AppDef_MyGradientbisOfBSplineCompute(@)",
    header: "AppDef_MyGradientbisOfBSplineCompute.hxx".}
proc isDone*(this: AppDefMyGradientbisOfBSplineCompute): StandardBoolean {.
    noSideEffect, importcpp: "IsDone",
    header: "AppDef_MyGradientbisOfBSplineCompute.hxx".}
proc value*(this: AppDefMyGradientbisOfBSplineCompute): AppParCurvesMultiCurve {.
    noSideEffect, importcpp: "Value",
    header: "AppDef_MyGradientbisOfBSplineCompute.hxx".}
proc error*(this: AppDefMyGradientbisOfBSplineCompute; index: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "Error",
    header: "AppDef_MyGradientbisOfBSplineCompute.hxx".}
proc maxError3d*(this: AppDefMyGradientbisOfBSplineCompute): StandardReal {.
    noSideEffect, importcpp: "MaxError3d",
    header: "AppDef_MyGradientbisOfBSplineCompute.hxx".}
proc maxError2d*(this: AppDefMyGradientbisOfBSplineCompute): StandardReal {.
    noSideEffect, importcpp: "MaxError2d",
    header: "AppDef_MyGradientbisOfBSplineCompute.hxx".}
proc averageError*(this: AppDefMyGradientbisOfBSplineCompute): StandardReal {.
