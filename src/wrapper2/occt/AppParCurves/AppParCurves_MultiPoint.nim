...
proc constructAppParCurvesMultiPoint*(nbPoints: StandardInteger;
                                     nbPoints2d: StandardInteger): AppParCurvesMultiPoint {.
...
proc destroyAppParCurvesMultiPoint*(this: var AppParCurvesMultiPoint) {.
    ...
    header: "AppParCurves_MultiPoint.hxx".}
proc setPoint*(this: var AppParCurvesMultiPoint; index: StandardInteger; point: GpPnt) {.
    importcpp: "SetPoint", header: "AppParCurves_MultiPoint.hxx".}
proc point*(this: AppParCurvesMultiPoint; index: StandardInteger): GpPnt {.
    noSideEffect, importcpp: "Point", header: "AppParCurves_MultiPoint.hxx".}
proc setPoint2d*(this: var AppParCurvesMultiPoint; index: StandardInteger;
                point: GpPnt2d) {.importcpp: "SetPoint2d",
                                header: "AppParCurves_MultiPoint.hxx".}
proc point2d*(this: AppParCurvesMultiPoint; index: StandardInteger): GpPnt2d {.
    noSideEffect, importcpp: "Point2d", header: "AppParCurves_MultiPoint.hxx".}
proc dimension*(this: AppParCurvesMultiPoint; index: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "Dimension", header: "AppParCurves_MultiPoint.hxx".}
proc nbPoints*(this: AppParCurvesMultiPoint): StandardInteger {.noSideEffect,
    importcpp: "NbPoints", header: "AppParCurves_MultiPoint.hxx".}
proc nbPoints2d*(this: AppParCurvesMultiPoint): StandardInteger {.noSideEffect,
    importcpp: "NbPoints2d", header: "AppParCurves_MultiPoint.hxx".}
proc transform*(this: var AppParCurvesMultiPoint; cuIndex: StandardInteger;
               x: StandardReal; dx: StandardReal; y: StandardReal; dy: StandardReal;
               z: StandardReal; dz: StandardReal) {.importcpp: "Transform",
    header: "AppParCurves_MultiPoint.hxx".}
proc transform2d*(this: var AppParCurvesMultiPoint; cuIndex: StandardInteger;
                 x: StandardReal; dx: StandardReal; y: StandardReal; dy: StandardReal) {.
    importcpp: "Transform2d", header: "AppParCurves_MultiPoint.hxx".}
