...
proc constructApproxCurveOnSurface*(theC2D: Handle[Adaptor2dHCurve2d];
                                   ...
                                   theFirst: StandardReal; theLast: StandardReal;
                                   theTol: StandardReal): ApproxCurveOnSurface {.
    constructor, importcpp: "Approx_CurveOnSurface(@)",
    header: "Approx_CurveOnSurface.hxx".}
proc isDone*(this: ApproxCurveOnSurface): StandardBoolean {.noSideEffect,
    importcpp: "IsDone", header: "Approx_CurveOnSurface.hxx".}
proc hasResult*(this: ApproxCurveOnSurface): StandardBoolean {.noSideEffect,
...
proc maxError3d*(this: ApproxCurveOnSurface): StandardReal {.noSideEffect,
...
proc maxError2dU*(this: ApproxCurveOnSurface): StandardReal {.noSideEffect,
    importcpp: "MaxError2dU", header: "Approx_CurveOnSurface.hxx".}
proc maxError2dV*(this: ApproxCurveOnSurface): StandardReal {.noSideEffect,
    importcpp: "MaxError2dV", header: "Approx_CurveOnSurface.hxx".}
proc perform*(this: var ApproxCurveOnSurface; theMaxSegments: StandardInteger;
             theMaxDegree: StandardInteger; theContinuity: GeomAbsShape;
             theOnly3d: StandardBoolean = standardFalse;
             theOnly2d: StandardBoolean = standardFalse) {.importcpp: "Perform",
    header: "Approx_CurveOnSurface.hxx".}
