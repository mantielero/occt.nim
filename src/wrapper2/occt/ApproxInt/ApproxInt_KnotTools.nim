...
proc buildKnots*(thePntsXYZ: TColgpArray1OfPnt; thePntsU1V1: TColgpArray1OfPnt2d;
                ...
                theApproxXYZ: StandardBoolean; theApproxU1V1: StandardBoolean;
                theApproxU2V2: StandardBoolean; theMinNbPnts: StandardInteger;
                theKnots: var NCollectionVector[StandardInteger]) {.
