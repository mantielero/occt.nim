...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "Aspect_XRDigitalActionData.hxx",
              bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "Aspect_XRDigitalActionData.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "Aspect_XRDigitalActionData.hxx",
          bycopy.} = object
...
var time* {.importcpp: "time", header: "Aspect_XRDigitalActionData.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "Aspect_XRDigitalActionData.hxx", bycopy.} = object
...
var itInterval* {.importcpp: "it_interval", header: "Aspect_XRDigitalActionData.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "Aspect_XRDigitalActionData.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "Aspect_XRDigitalActionData.hxx".}: array[
...
type
  ...
  AspectXRDigitalActionData* {.importcpp: "timex::itimerspec::timespec::__locale_struct::Aspect_XRDigitalActionData",
                              header: "Aspect_XRDigitalActionData.hxx", bycopy.} = object
    activeOrigin* {.importc: "ActiveOrigin".}: uint64T
...
proc constructAspectXRDigitalActionData*(): AspectXRDigitalActionData {.
    constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::Aspect_XRDigitalActionData(@)",
