...
proc setNonDestructive*(this: var BOPAlgoBuilder; theFlag: StandardBoolean) {.
    importcpp: "SetNonDestructive", header: "BOPAlgo_Builder.hxx".}
proc nonDestructive*(this: BOPAlgoBuilder): StandardBoolean {.noSideEffect,
...
proc glue*(this: BOPAlgoBuilder): BOPAlgoGlueEnum {.noSideEffect, importcpp: "Glue",
    header: "BOPAlgo_Builder.hxx".}
proc setCheckInverted*(this: var BOPAlgoBuilder; theCheck: StandardBoolean) {.
    importcpp: "SetCheckInverted", header: "BOPAlgo_Builder.hxx".}
proc checkInverted*(this: BOPAlgoBuilder): StandardBoolean {.noSideEffect,
