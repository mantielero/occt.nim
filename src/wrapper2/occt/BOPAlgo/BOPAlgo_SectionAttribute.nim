...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "BOPAlgo_SectionAttribute.hxx",
              bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "BOPAlgo_SectionAttribute.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "BOPAlgo_SectionAttribute.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "BOPAlgo_SectionAttribute.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "BOPAlgo_SectionAttribute.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "BOPAlgo_SectionAttribute.hxx",
             bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
...
var itInterval* {.importcpp: "it_interval", header: "BOPAlgo_SectionAttribute.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "BOPAlgo_SectionAttribute.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "BOPAlgo_SectionAttribute.hxx".}: array[
...
type
  ...
  BOPAlgoSectionAttribute* {.importcpp: "timex::itimerspec::timespec::__locale_struct::BOPAlgo_SectionAttribute",
                            header: "BOPAlgo_SectionAttribute.hxx", bycopy.} = object


proc constructBOPAlgoSectionAttribute*(): BOPAlgoSectionAttribute {.constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::BOPAlgo_SectionAttribute(@)",
    header: "BOPAlgo_SectionAttribute.hxx".}
proc constructBOPAlgoSectionAttribute*(theAproximation: StandardBoolean;
                                      thePCurveOnS1: StandardBoolean;
                                      thePCurveOnS2: StandardBoolean): BOPAlgoSectionAttribute {.
    constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::BOPAlgo_SectionAttribute(@)",
    header: "BOPAlgo_SectionAttribute.hxx".}
proc approximation*(this: var BOPAlgoSectionAttribute; theApprox: StandardBoolean) {.
    importcpp: "Approximation", header: "BOPAlgo_SectionAttribute.hxx".}
proc pCurveOnS1*(this: var BOPAlgoSectionAttribute; thePCurveOnS1: StandardBoolean) {.
    importcpp: "PCurveOnS1", header: "BOPAlgo_SectionAttribute.hxx".}
proc pCurveOnS2*(this: var BOPAlgoSectionAttribute; thePCurveOnS2: StandardBoolean) {.
    importcpp: "PCurveOnS2", header: "BOPAlgo_SectionAttribute.hxx".}
proc approximation*(this: BOPAlgoSectionAttribute): StandardBoolean {.noSideEffect,
    importcpp: "Approximation", header: "BOPAlgo_SectionAttribute.hxx".}
proc pCurveOnS1*(this: BOPAlgoSectionAttribute): StandardBoolean {.noSideEffect,
    importcpp: "PCurveOnS1", header: "BOPAlgo_SectionAttribute.hxx".}
proc pCurveOnS2*(this: BOPAlgoSectionAttribute): StandardBoolean {.noSideEffect,
    importcpp: "PCurveOnS2", header: "BOPAlgo_SectionAttribute.hxx".}