...
proc setFirst*(this: var BOPDS_IndexRange; theI1: StandardInteger) {.
    importcpp: "SetFirst", header: "BOPDS_IndexRange.hxx".}
proc setLast*(this: var BOPDS_IndexRange; theI2: StandardInteger) {.
    importcpp: "SetLast", header: "BOPDS_IndexRange.hxx".}
proc first*(this: BOPDS_IndexRange): StandardInteger {.noSideEffect,
    importcpp: "First", header: "BOPDS_IndexRange.hxx".}
proc last*(this: BOPDS_IndexRange): StandardInteger {.noSideEffect,
    importcpp: "Last", header: "BOPDS_IndexRange.hxx".}
proc setIndices*(this: var BOPDS_IndexRange; theI1: StandardInteger;
                theI2: StandardInteger) {.importcpp: "SetIndices",
                                        header: "BOPDS_IndexRange.hxx".}
proc indices*(this: BOPDS_IndexRange; theI1: var StandardInteger;
             theI2: var StandardInteger) {.noSideEffect, importcpp: "Indices",
                                        header: "BOPDS_IndexRange.hxx".}
proc contains*(this: BOPDS_IndexRange; theIndex: StandardInteger): StandardBoolean {.
