...
proc pave2*(this: BOPDS_PaveBlock): BOPDS_Pave {.noSideEffect, importcpp: "Pave2",
    header: "BOPDS_PaveBlock.hxx".}
proc setEdge*(this: var BOPDS_PaveBlock; theEdge: StandardInteger) {.
    importcpp: "SetEdge", header: "BOPDS_PaveBlock.hxx".}
proc edge*(this: BOPDS_PaveBlock): StandardInteger {.noSideEffect, importcpp: "Edge",
    header: "BOPDS_PaveBlock.hxx".}
proc hasEdge*(this: BOPDS_PaveBlock): StandardBoolean {.noSideEffect,
    importcpp: "HasEdge", header: "BOPDS_PaveBlock.hxx".}
proc hasEdge*(this: BOPDS_PaveBlock; theEdge: var StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "HasEdge", header: "BOPDS_PaveBlock.hxx".}
proc setOriginalEdge*(this: var BOPDS_PaveBlock; theEdge: StandardInteger) {.
    importcpp: "SetOriginalEdge", header: "BOPDS_PaveBlock.hxx".}
proc originalEdge*(this: BOPDS_PaveBlock): StandardInteger {.noSideEffect,
    importcpp: "OriginalEdge", header: "BOPDS_PaveBlock.hxx".}
proc isSplitEdge*(this: BOPDS_PaveBlock): StandardBoolean {.noSideEffect,
    importcpp: "IsSplitEdge", header: "BOPDS_PaveBlock.hxx".}
proc range*(this: BOPDS_PaveBlock; theT1: var StandardReal; theT2: var StandardReal) {.
    noSideEffect, importcpp: "Range", header: "BOPDS_PaveBlock.hxx".}
proc hasSameBounds*(this: BOPDS_PaveBlock; theOther: Handle[BOPDS_PaveBlock]): StandardBoolean {.
    noSideEffect, importcpp: "HasSameBounds", header: "BOPDS_PaveBlock.hxx".}
proc indices*(this: BOPDS_PaveBlock; theIndex1: var StandardInteger;
             theIndex2: var StandardInteger) {.noSideEffect, importcpp: "Indices",
    header: "BOPDS_PaveBlock.hxx".}
proc isToUpdate*(this: BOPDS_PaveBlock): StandardBoolean {.noSideEffect,
...
proc removeExtPave*(this: var BOPDS_PaveBlock; theVertNum: StandardInteger) {.
...
proc update*(this: var BOPDS_PaveBlock; theLPB: var BOPDS_ListOfPaveBlock;
            theFlag: StandardBoolean = standardTrue) {.importcpp: "Update",
    header: "BOPDS_PaveBlock.hxx".}
proc containsParameter*(this: BOPDS_PaveBlock; thePrm: StandardReal;
                       theTol: StandardReal; theInd: var StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "ContainsParameter", header: "BOPDS_PaveBlock.hxx".}
proc setShrunkData*(this: var BOPDS_PaveBlock; theTS1: StandardReal;
                   theTS2: StandardReal; theBox: BndBox;
                   theIsSplittable: StandardBoolean) {.importcpp: "SetShrunkData",
    header: "BOPDS_PaveBlock.hxx".}
proc shrunkData*(this: BOPDS_PaveBlock; theTS1: var StandardReal;
                theTS2: var StandardReal; theBox: var BndBox;
                theIsSplittable: var StandardBoolean) {.noSideEffect,
    importcpp: "ShrunkData", header: "BOPDS_PaveBlock.hxx".}
proc hasShrunkData*(this: BOPDS_PaveBlock): StandardBoolean {.noSideEffect,
    importcpp: "HasShrunkData", header: "BOPDS_PaveBlock.hxx".}
proc dump*(this: BOPDS_PaveBlock) {.noSideEffect, importcpp: "Dump",
                                 header: "BOPDS_PaveBlock.hxx".}
proc isSplittable*(this: BOPDS_PaveBlock): StandardBoolean {.noSideEffect,
