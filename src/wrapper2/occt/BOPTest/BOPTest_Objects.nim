...
proc setDefaultOptions*() {.importcpp: "BOPTest_Objects::SetDefaultOptions(@)",
                          header: "BOPTest_Objects.hxx".}
proc setRunParallel*(theFlag: StandardBoolean) {.
    importcpp: "BOPTest_Objects::SetRunParallel(@)", header: "BOPTest_Objects.hxx".}
proc runParallel*(): StandardBoolean {.importcpp: "BOPTest_Objects::RunParallel(@)",
                                    header: "BOPTest_Objects.hxx".}
proc setFuzzyValue*(theValue: StandardReal) {.
    importcpp: "BOPTest_Objects::SetFuzzyValue(@)", header: "BOPTest_Objects.hxx".}
proc fuzzyValue*(): StandardReal {.importcpp: "BOPTest_Objects::FuzzyValue(@)",
                                header: "BOPTest_Objects.hxx".}
proc setNonDestructive*(theFlag: StandardBoolean) {.
    importcpp: "BOPTest_Objects::SetNonDestructive(@)",
    header: "BOPTest_Objects.hxx".}
proc nonDestructive*(): StandardBoolean {.importcpp: "BOPTest_Objects::NonDestructive(@)",
                                       header: "BOPTest_Objects.hxx".}
...
proc glue*(): BOPAlgoGlueEnum {.importcpp: "BOPTest_Objects::Glue(@)",
                             header: "BOPTest_Objects.hxx".}
proc setDrawWarnShapes*(bDraw: StandardBoolean) {.
    importcpp: "BOPTest_Objects::SetDrawWarnShapes(@)",
    header: "BOPTest_Objects.hxx".}
proc drawWarnShapes*(): StandardBoolean {.importcpp: "BOPTest_Objects::DrawWarnShapes(@)",
                                       header: "BOPTest_Objects.hxx".}
proc setCheckInverted*(bCheck: StandardBoolean) {.
    importcpp: "BOPTest_Objects::SetCheckInverted(@)",
    header: "BOPTest_Objects.hxx".}
proc checkInverted*(): StandardBoolean {.importcpp: "BOPTest_Objects::CheckInverted(@)",
                                      header: "BOPTest_Objects.hxx".}
proc setUseOBB*(bUseOBB: StandardBoolean) {.
    importcpp: "BOPTest_Objects::SetUseOBB(@)", header: "BOPTest_Objects.hxx".}
proc useOBB*(): StandardBoolean {.importcpp: "BOPTest_Objects::UseOBB(@)",
                               header: "BOPTest_Objects.hxx".}
proc setUnifyEdges*(bUE: StandardBoolean) {.
    importcpp: "BOPTest_Objects::SetUnifyEdges(@)", header: "BOPTest_Objects.hxx".}
proc unifyEdges*(): StandardBoolean {.importcpp: "BOPTest_Objects::UnifyEdges(@)",
                                   header: "BOPTest_Objects.hxx".}
proc setUnifyFaces*(bUF: StandardBoolean) {.
    importcpp: "BOPTest_Objects::SetUnifyFaces(@)", header: "BOPTest_Objects.hxx".}
proc unifyFaces*(): StandardBoolean {.importcpp: "BOPTest_Objects::UnifyFaces(@)",
                                   header: "BOPTest_Objects.hxx".}
proc setAngular*(bAngTol: StandardReal) {.importcpp: "BOPTest_Objects::SetAngular(@)",
                                       header: "BOPTest_Objects.hxx".}
proc angular*(): StandardReal {.importcpp: "BOPTest_Objects::Angular(@)",
                             header: "BOPTest_Objects.hxx".}
