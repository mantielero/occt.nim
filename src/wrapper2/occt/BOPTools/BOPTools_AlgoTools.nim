...
proc dTolerance*(): StandardReal {.importcpp: "BOPTools_AlgoTools::DTolerance(@)",
                                header: "BOPTools_AlgoTools.hxx".}
proc computeVV*(theV: TopoDS_Vertex; theP: GpPnt; theTolP: StandardReal): StandardInteger {.
    importcpp: "BOPTools_AlgoTools::ComputeVV(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc computeVV*(theV1: TopoDS_Vertex; theV2: TopoDS_Vertex;
               theFuzz: StandardReal = confusion()): StandardInteger {.
    importcpp: "BOPTools_AlgoTools::ComputeVV(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc makeVertex*(theLV: TopToolsListOfShape; theV: var TopoDS_Vertex) {.
    importcpp: "BOPTools_AlgoTools::MakeVertex(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc makeNewVertex*(aP1: GpPnt; aTol: StandardReal; aNewVertex: var TopoDS_Vertex) {.
...
proc makeNewVertex*(aV1: TopoDS_Vertex; aV2: TopoDS_Vertex;
    ...
    importcpp: "BOPTools_AlgoTools::MakeNewVertex(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc makeNewVertex*(aE1: TopoDS_Edge; aP1: StandardReal; aE2: TopoDS_Edge;
                   aP2: StandardReal; aNewVertex: var TopoDS_Vertex) {.
    importcpp: "BOPTools_AlgoTools::MakeNewVertex(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc makeNewVertex*(aE1: TopoDS_Edge; aP1: StandardReal; aF2: TopoDS_Face;
                   aNewVertex: var TopoDS_Vertex) {.
    importcpp: "BOPTools_AlgoTools::MakeNewVertex(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc updateVertex*(aIC: IntToolsCurve; aT: StandardReal; aV: TopoDS_Vertex) {.
    importcpp: "BOPTools_AlgoTools::UpdateVertex(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc updateVertex*(aE: TopoDS_Edge; aT: StandardReal; aV: TopoDS_Vertex) {.
    importcpp: "BOPTools_AlgoTools::UpdateVertex(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc updateVertex*(aVF: TopoDS_Vertex; aVN: TopoDS_Vertex) {.
    importcpp: "BOPTools_AlgoTools::UpdateVertex(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc makeEdge*(theCurve: IntToolsCurve; theV1: TopoDS_Vertex; theT1: StandardReal;
              theV2: TopoDS_Vertex; theT2: StandardReal; theTolR3D: StandardReal;
...
proc makeSplitEdge*(aE1: TopoDS_Edge; aV1: TopoDS_Vertex; aP1: StandardReal;
                   aV2: TopoDS_Vertex; aP2: StandardReal; aNewEdge: var TopoDS_Edge) {.
    importcpp: "BOPTools_AlgoTools::MakeSplitEdge(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc makeSectEdge*(aIC: IntToolsCurve; aV1: TopoDS_Vertex; aP1: StandardReal;
                  aV2: TopoDS_Vertex; aP2: StandardReal; aNewEdge: var TopoDS_Edge) {.
    importcpp: "BOPTools_AlgoTools::MakeSectEdge(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc computeState*(thePoint: GpPnt; theSolid: TopoDS_Solid; theTol: StandardReal;
...
proc computeState*(theVertex: TopoDS_Vertex; theSolid: TopoDS_Solid;
                  theTol: StandardReal; theContext: Handle[IntToolsContext]): TopAbsState {.
    importcpp: "BOPTools_AlgoTools::ComputeState(@)",
    header: "BOPTools_AlgoTools.hxx".}
...
proc computeState*(theFace: TopoDS_Face; theSolid: TopoDS_Solid;
                  theTol: StandardReal; theBounds: TopToolsIndexedMapOfShape;
                  theContext: Handle[IntToolsContext]): TopAbsState {.
    importcpp: "BOPTools_AlgoTools::ComputeState(@)",
    header: "BOPTools_AlgoTools.hxx".}
...
proc getFaceOff*(theEdge: TopoDS_Edge; theFace: TopoDS_Face;
                ...
                theFaceOff: var TopoDS_Face; theContext: Handle[IntToolsContext]): StandardBoolean {.
...
proc isInternalFace*(theFace: TopoDS_Face; theSolid: TopoDS_Solid;
                    ...
                    theTol: StandardReal; theContext: Handle[IntToolsContext]): StandardBoolean {.
    importcpp: "BOPTools_AlgoTools::IsInternalFace(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc makePCurve*(theE: TopoDS_Edge; theF1: TopoDS_Face; theF2: TopoDS_Face;
                theCurve: IntToolsCurve; thePC1: StandardBoolean;
                thePC2: StandardBoolean;
                theContext: Handle[IntToolsContext] = handle[IntToolsContext]()) {.
    importcpp: "BOPTools_AlgoTools::MakePCurve(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc isHole*(theW: TopoDS_Shape; theF: TopoDS_Shape): StandardBoolean {.
...
proc correctTolerances*(theS: TopoDS_Shape;
                       ...
                       theTolMax: StandardReal = 0.0001;
                       theRunParallel: StandardBoolean = standardFalse) {.
...
proc isMicroEdge*(theEdge: TopoDS_Edge; theContext: Handle[IntToolsContext];
                 theCheckSplittable: StandardBoolean = standardTrue): StandardBoolean {.
    importcpp: "BOPTools_AlgoTools::IsMicroEdge(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc isInvertedSolid*(theSolid: TopoDS_Solid): StandardBoolean {.
    importcpp: "BOPTools_AlgoTools::IsInvertedSolid(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc computeTolerance*(theFace: TopoDS_Face; theEdge: TopoDS_Edge;
                      theMaxDist: var StandardReal; theMaxPar: var StandardReal): StandardBoolean {.
...
proc makeContainer*(theType: TopAbsShapeEnum; theShape: var TopoDS_Shape) {.
    ...
    header: "BOPTools_AlgoTools.hxx".}
proc pointOnEdge*(aEdge: TopoDS_Edge; aPrm: StandardReal; aP: var GpPnt) {.
    importcpp: "BOPTools_AlgoTools::PointOnEdge(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc isBlockInOnFace*(aShR: IntToolsRange; aF: TopoDS_Face; aE: TopoDS_Edge;
                     aContext: Handle[IntToolsContext]): StandardBoolean {.
    importcpp: "BOPTools_AlgoTools::IsBlockInOnFace(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc dimensions*(theS: TopoDS_Shape; theDMin: var StandardInteger;
                theDMax: var StandardInteger) {.
    importcpp: "BOPTools_AlgoTools::Dimensions(@)",
    header: "BOPTools_AlgoTools.hxx".}
proc dimension*(theS: TopoDS_Shape): StandardInteger {.
...
proc treatCompound*(theS: TopoDS_Shape; theList: var TopToolsListOfShape;
    ...
    header: "BOPTools_AlgoTools.hxx".}
proc isOpenShell*(theShell: TopoDS_Shell): StandardBoolean {.
