...
proc nbShapes*(this: BOPToolsSet): StandardInteger {.noSideEffect,
    importcpp: "NbShapes", header: "BOPTools_Set.hxx".}
proc isEqual*(this: BOPToolsSet; aOther: BOPToolsSet): StandardBoolean {.noSideEffect,
    importcpp: "IsEqual", header: "BOPTools_Set.hxx".}
proc hashCode*(this: BOPToolsSet; theUpperBound: StandardInteger): StandardInteger {.
