...
## !!!Ignored construct:  # _BRepAlgo_Fuse_HeaderFile [NewLine] # _BRepAlgo_Fuse_HeaderFile [NewLine] # ../Standard/Standard.hxx [NewLine] # ../Standard/Standard_DefineAlloc.hxx [NewLine] # ../Standard/Standard_Handle.hxx [NewLine] # BRepAlgo_BooleanOperation.hxx [NewLine] class TopoDS_Shape ;
