...
proc setParams*(this: var BRepAlgoNormalProjection; tol3D: StandardReal;
               ...
               maxDegree: StandardInteger; maxSeg: StandardInteger) {.
...
proc compute3d*(this: var BRepAlgoNormalProjection;
               with3d: StandardBoolean = standardTrue) {.importcpp: "Compute3d",
    header: "BRepAlgo_NormalProjection.hxx".}
proc setLimit*(this: var BRepAlgoNormalProjection;
              faceBoundaries: StandardBoolean = standardTrue) {.
