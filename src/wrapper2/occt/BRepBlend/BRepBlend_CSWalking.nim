...
proc perform*(this: var BRepBlendCSWalking; f: var BlendCSFunction; pdep: StandardReal;
             pmax: StandardReal; maxStep: StandardReal; tolGuide: StandardReal;
             soldep: MathVector; tolesp: StandardReal; fleche: StandardReal;
             appro: StandardBoolean = standardFalse) {.importcpp: "Perform",
    header: "BRepBlend_CSWalking.hxx".}
proc complete*(this: var BRepBlendCSWalking; f: var BlendCSFunction; pmin: StandardReal): StandardBoolean {.
    importcpp: "Complete", header: "BRepBlend_CSWalking.hxx".}
proc isDone*(this: BRepBlendCSWalking): StandardBoolean {.noSideEffect,
