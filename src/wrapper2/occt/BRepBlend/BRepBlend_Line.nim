...
proc prepend*(this: var BRepBlendLine; p: BlendPoint) {.importcpp: "Prepend",
    header: "BRepBlend_Line.hxx".}
proc insertBefore*(this: var BRepBlendLine; index: StandardInteger; p: BlendPoint) {.
    importcpp: "InsertBefore", header: "BRepBlend_Line.hxx".}
proc remove*(this: var BRepBlendLine; fromIndex: StandardInteger;
            toIndex: StandardInteger) {.importcpp: "Remove",
                                      header: "BRepBlend_Line.hxx".}
...
proc setEndPoints*(this: var BRepBlendLine; endPt1: BRepBlendExtremity;
    ...
    header: "BRepBlend_Line.hxx".}
proc nbPoints*(this: BRepBlendLine): StandardInteger {.noSideEffect,
    importcpp: "NbPoints", header: "BRepBlend_Line.hxx".}
proc point*(this: BRepBlendLine; index: StandardInteger): BlendPoint {.noSideEffect,
