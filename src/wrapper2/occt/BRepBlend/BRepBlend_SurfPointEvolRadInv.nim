...
proc constructBRepBlendSurfPointEvolRadInv*(s: Handle[Adaptor3dHSurface];
    ...
    header: "BRepBlend_SurfPointEvolRadInv.hxx".}
proc set*(this: var BRepBlendSurfPointEvolRadInv; choix: StandardInteger) {.
    importcpp: "Set", header: "BRepBlend_SurfPointEvolRadInv.hxx".}
proc nbEquations*(this: BRepBlendSurfPointEvolRadInv): StandardInteger {.
...
proc values*(this: var BRepBlendSurfPointEvolRadInv; x: MathVector; f: var MathVector;
    ...
    header: "BRepBlend_SurfPointEvolRadInv.hxx".}
proc set*(this: var BRepBlendSurfPointEvolRadInv; p: GpPnt) {.importcpp: "Set",
    header: "BRepBlend_SurfPointEvolRadInv.hxx".}
