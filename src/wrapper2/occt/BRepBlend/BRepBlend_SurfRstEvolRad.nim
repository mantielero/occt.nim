...
proc nbVariables*(this: BRepBlendSurfRstEvolRad): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc nbEquations*(this: BRepBlendSurfRstEvolRad): StandardInteger {.noSideEffect,
...
proc getMinimalDistance*(this: BRepBlendSurfRstEvolRad): StandardReal {.
    ...
    header: "BRepBlend_SurfRstEvolRad.hxx".}
proc pointOnS*(this: BRepBlendSurfRstEvolRad): GpPnt {.noSideEffect,
    importcpp: "PointOnS", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc pointOnRst*(this: BRepBlendSurfRstEvolRad): GpPnt {.noSideEffect,
    importcpp: "PointOnRst", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc pnt2dOnS*(this: BRepBlendSurfRstEvolRad): GpPnt2d {.noSideEffect,
    importcpp: "Pnt2dOnS", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc pnt2dOnRst*(this: BRepBlendSurfRstEvolRad): GpPnt2d {.noSideEffect,
...
proc isTangencyPoint*(this: BRepBlendSurfRstEvolRad): StandardBoolean {.
    ...
    header: "BRepBlend_SurfRstEvolRad.hxx".}
proc tangentOnS*(this: BRepBlendSurfRstEvolRad): GpVec {.noSideEffect,
    importcpp: "TangentOnS", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc tangent2dOnS*(this: BRepBlendSurfRstEvolRad): GpVec2d {.noSideEffect,
    importcpp: "Tangent2dOnS", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc tangentOnRst*(this: BRepBlendSurfRstEvolRad): GpVec {.noSideEffect,
    importcpp: "TangentOnRst", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc tangent2dOnRst*(this: BRepBlendSurfRstEvolRad): GpVec2d {.noSideEffect,
    importcpp: "Tangent2dOnRst", header: "BRepBlend_SurfRstEvolRad.hxx".}
proc decroch*(this: BRepBlendSurfRstEvolRad; sol: MathVector; ns: var GpVec;
             tgS: var GpVec): StandardBoolean {.noSideEffect, importcpp: "Decroch",
    header: "BRepBlend_SurfRstEvolRad.hxx".}
proc set*(this: var BRepBlendSurfRstEvolRad; choix: StandardInteger) {.
    importcpp: "Set", header: "BRepBlend_SurfRstEvolRad.hxx".}
...
proc nbIntervals*(this: BRepBlendSurfRstEvolRad; s: GeomAbsShape): StandardInteger {.
...
proc intervals*(this: BRepBlendSurfRstEvolRad; t: var TColStdArray1OfReal;
               s: GeomAbsShape) {.noSideEffect, importcpp: "Intervals",
                                header: "BRepBlend_SurfRstEvolRad.hxx".}
proc getShape*(this: var BRepBlendSurfRstEvolRad; nbPoles: var StandardInteger;
...
proc section*(this: var BRepBlendSurfRstEvolRad; p: BlendPoint;
    ...
    header: "BRepBlend_SurfRstEvolRad.hxx".}
proc resolution*(this: BRepBlendSurfRstEvolRad; iC2d: StandardInteger;
