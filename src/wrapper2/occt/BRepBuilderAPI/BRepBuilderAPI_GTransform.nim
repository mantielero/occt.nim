...
proc constructBRepBuilderAPI_GTransform*(t: GpGTrsf): BRepBuilderAPI_GTransform {.
    constructor, importcpp: "BRepBuilderAPI_GTransform(@)",
    header: "BRepBuilderAPI_GTransform.hxx".}
proc constructBRepBuilderAPI_GTransform*(s: TopoDS_Shape; t: GpGTrsf;
                                        copy: StandardBoolean = standardFalse): BRepBuilderAPI_GTransform {.
    constructor, importcpp: "BRepBuilderAPI_GTransform(@)",
    header: "BRepBuilderAPI_GTransform.hxx".}
