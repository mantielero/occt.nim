...
proc blind*(this: var BRepCheckFace) {.importcpp: "Blind",
                                   header: "BRepCheck_Face.hxx".}
proc intersectWires*(this: var BRepCheckFace;
                    update: StandardBoolean = standardFalse): BRepCheckStatus {.
    importcpp: "IntersectWires", header: "BRepCheck_Face.hxx".}
proc classifyWires*(this: var BRepCheckFace; update: StandardBoolean = standardFalse): BRepCheckStatus {.
    importcpp: "ClassifyWires", header: "BRepCheck_Face.hxx".}
proc orientationOfWires*(this: var BRepCheckFace;
                        update: StandardBoolean = standardFalse): BRepCheckStatus {.
