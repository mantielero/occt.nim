...
proc blind*(this: var BRepCheckShell) {.importcpp: "Blind",
                                    header: "BRepCheck_Shell.hxx".}
proc closed*(this: var BRepCheckShell; update: StandardBoolean = standardFalse): BRepCheckStatus {.
    importcpp: "Closed", header: "BRepCheck_Shell.hxx".}
proc orientation*(this: var BRepCheckShell; update: StandardBoolean = standardFalse): BRepCheckStatus {.
...
proc nbConnectedSet*(this: var BRepCheckShell; theSets: var TopToolsListOfShape): StandardInteger {.
