...
proc blind*(this: var BRepCheckWire) {.importcpp: "Blind",
                                   header: "BRepCheck_Wire.hxx".}
proc closed*(this: var BRepCheckWire; update: StandardBoolean = standardFalse): BRepCheckStatus {.
...
proc selfIntersect*(this: var BRepCheckWire; f: TopoDS_Face; e1: var TopoDS_Edge;
                   e2: var TopoDS_Edge; update: StandardBoolean = standardFalse): BRepCheckStatus {.
