...
proc constructBRepClassFClassifier*(f: var BRepClassFaceExplorer; p: GpPnt2d;
                                   tol: StandardReal): BRepClassFClassifier {.
    constructor, importcpp: "BRepClass_FClassifier(@)",
    header: "BRepClass_FClassifier.hxx".}
proc perform*(this: var BRepClassFClassifier; f: var BRepClassFaceExplorer; p: GpPnt2d;
...
proc rejected*(this: BRepClassFClassifier): StandardBoolean {.noSideEffect,
    importcpp: "Rejected", header: "BRepClass_FClassifier.hxx".}
proc noWires*(this: BRepClassFClassifier): StandardBoolean {.noSideEffect,
...
proc edgeParameter*(this: BRepClassFClassifier): StandardReal {.noSideEffect,
