...
proc constructBRepClassFaceClassifier*(f: var BRepClassFaceExplorer; p: GpPnt2d;
                                      tol: StandardReal): BRepClassFaceClassifier {.
    constructor, importcpp: "BRepClass_FaceClassifier(@)",
    header: "BRepClass_FaceClassifier.hxx".}
proc constructBRepClassFaceClassifier*(f: TopoDS_Face; p: GpPnt2d; tol: StandardReal): BRepClassFaceClassifier {.
    constructor, importcpp: "BRepClass_FaceClassifier(@)",
    header: "BRepClass_FaceClassifier.hxx".}
proc perform*(this: var BRepClassFaceClassifier; f: TopoDS_Face; p: GpPnt2d;
             tol: StandardReal) {.importcpp: "Perform",
                                header: "BRepClass_FaceClassifier.hxx".}
proc constructBRepClassFaceClassifier*(f: TopoDS_Face; p: GpPnt; tol: StandardReal): BRepClassFaceClassifier {.
    constructor, importcpp: "BRepClass_FaceClassifier(@)",
    header: "BRepClass_FaceClassifier.hxx".}
proc perform*(this: var BRepClassFaceClassifier; f: TopoDS_Face; p: GpPnt;
             tol: StandardReal) {.importcpp: "Perform",
                                header: "BRepClass_FaceClassifier.hxx".}
