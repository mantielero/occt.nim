...
proc reset*(this: var BRepClass3dSolidPassiveClassifier; L: GpLin; p: StandardReal;
...
proc parameter*(this: BRepClass3dSolidPassiveClassifier): StandardReal {.
    noSideEffect, importcpp: "Parameter",
    header: "BRepClass3d_SolidPassiveClassifier.hxx".}
proc hasIntersection*(this: BRepClass3dSolidPassiveClassifier): StandardBoolean {.
