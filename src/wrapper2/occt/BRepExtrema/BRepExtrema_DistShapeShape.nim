...
proc nbSolution*(this: BRepExtremaDistShapeShape): StandardInteger {.noSideEffect,
...
proc innerSolution*(this: BRepExtremaDistShapeShape): StandardBoolean {.
    ...
    header: "BRepExtrema_DistShapeShape.hxx".}
proc pointOnShape1*(this: BRepExtremaDistShapeShape; n: StandardInteger): GpPnt {.
    noSideEffect, importcpp: "PointOnShape1",
    header: "BRepExtrema_DistShapeShape.hxx".}
proc pointOnShape2*(this: BRepExtremaDistShapeShape; n: StandardInteger): GpPnt {.
    noSideEffect, importcpp: "PointOnShape2",
    header: "BRepExtrema_DistShapeShape.hxx".}
proc supportTypeShape1*(this: BRepExtremaDistShapeShape; n: StandardInteger): BRepExtremaSupportType {.
    noSideEffect, importcpp: "SupportTypeShape1",
    header: "BRepExtrema_DistShapeShape.hxx".}
proc supportTypeShape2*(this: BRepExtremaDistShapeShape; n: StandardInteger): BRepExtremaSupportType {.
    noSideEffect, importcpp: "SupportTypeShape2",
    header: "BRepExtrema_DistShapeShape.hxx".}
proc supportOnShape1*(this: BRepExtremaDistShapeShape; n: StandardInteger): TopoDS_Shape {.
    noSideEffect, importcpp: "SupportOnShape1",
    header: "BRepExtrema_DistShapeShape.hxx".}
proc supportOnShape2*(this: BRepExtremaDistShapeShape; n: StandardInteger): TopoDS_Shape {.
    noSideEffect, importcpp: "SupportOnShape2",
    header: "BRepExtrema_DistShapeShape.hxx".}
proc parOnEdgeS1*(this: BRepExtremaDistShapeShape; n: StandardInteger;
                 t: var StandardReal) {.noSideEffect, importcpp: "ParOnEdgeS1",
                                     header: "BRepExtrema_DistShapeShape.hxx".}
proc parOnEdgeS2*(this: BRepExtremaDistShapeShape; n: StandardInteger;
                 t: var StandardReal) {.noSideEffect, importcpp: "ParOnEdgeS2",
                                     header: "BRepExtrema_DistShapeShape.hxx".}
proc parOnFaceS1*(this: BRepExtremaDistShapeShape; n: StandardInteger;
                 u: var StandardReal; v: var StandardReal) {.noSideEffect,
    importcpp: "ParOnFaceS1", header: "BRepExtrema_DistShapeShape.hxx".}
proc parOnFaceS2*(this: BRepExtremaDistShapeShape; n: StandardInteger;
                 u: var StandardReal; v: var StandardReal) {.noSideEffect,
