...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "BRepExtrema_ElementFilter.hxx",
              bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "BRepExtrema_ElementFilter.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "BRepExtrema_ElementFilter.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "BRepExtrema_ElementFilter.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "BRepExtrema_ElementFilter.hxx", bycopy.} = object
...
var itInterval* {.importcpp: "it_interval", header: "BRepExtrema_ElementFilter.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "BRepExtrema_ElementFilter.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "BRepExtrema_ElementFilter.hxx".}: array[
...
type
  ...
  BRepExtremaElementFilter* {.importcpp: "timex::itimerspec::timespec::__locale_struct::BRepExtrema_ElementFilter",
                             header: "BRepExtrema_ElementFilter.hxx", bycopy.} = object

  BRepExtremaElementFilterFilterResult* {.size: sizeof(cint), importcpp: "timex::itimerspec::timespec::__locale_struct::BRepExtrema_ElementFilter::FilterResult",
...
proc preCheckElements*(this: var BRepExtremaElementFilter; a2: StandardInteger;
                      a3: StandardInteger): BRepExtremaElementFilterFilterResult {.
