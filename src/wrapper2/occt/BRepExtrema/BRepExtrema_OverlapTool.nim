...
type
  BRepExtremaOverlapTool* {.importcpp: "BRepExtrema_OverlapTool",
      ...
      StandardReal, 3] ## ! Creates new unitialized overlap tool.
...
proc perform*(this: var BRepExtremaOverlapTool; theTolerance: StandardReal = 0.0) {.
    importcpp: "Perform", header: "BRepExtrema_OverlapTool.hxx".}
proc isDone*(this: BRepExtremaOverlapTool): StandardBoolean {.noSideEffect,
...
proc accept*(this: var BRepExtremaOverlapTool; theLeaf1: StandardInteger;
            theLeaf2: StandardInteger): StandardBoolean {.importcpp: "Accept",
    header: "BRepExtrema_OverlapTool.hxx".}
