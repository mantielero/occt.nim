...
proc destroyBRepExtremaTriangleSet*(this: var BRepExtremaTriangleSet) {.
    ...
    header: "BRepExtrema_TriangleSet.hxx".}
proc size*(this: BRepExtremaTriangleSet): StandardInteger {.noSideEffect,
    importcpp: "Size", header: "BRepExtrema_TriangleSet.hxx".}
proc box*(this: BRepExtremaTriangleSet; theIndex: StandardInteger): BVH_Box[
    StandardReal, 3] {.noSideEffect, importcpp: "Box",
                     header: "BRepExtrema_TriangleSet.hxx".}
## using statement

proc center*(this: BRepExtremaTriangleSet; theIndex: StandardInteger;
            theAxis: StandardInteger): StandardReal {.noSideEffect,
    importcpp: "Center", header: "BRepExtrema_TriangleSet.hxx".}
proc swap*(this: var BRepExtremaTriangleSet; theIndex1: StandardInteger;
          theIndex2: StandardInteger) {.importcpp: "Swap",
                                      header: "BRepExtrema_TriangleSet.hxx".}
proc clear*(this: var BRepExtremaTriangleSet) {.importcpp: "Clear",
    header: "BRepExtrema_TriangleSet.hxx".}
proc init*(this: var BRepExtremaTriangleSet; theFaces: BRepExtremaShapeList): StandardBoolean {.
    importcpp: "Init", header: "BRepExtrema_TriangleSet.hxx".}
proc getVertices*(this: BRepExtremaTriangleSet; theIndex: StandardInteger;
...
proc getFaceID*(this: BRepExtremaTriangleSet; theIndex: StandardInteger): StandardInteger {.
