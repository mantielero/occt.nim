...
discard "forward decl of BRepFill_LocationLaw"
type
  HandleBRepFillLocationLaw* = Handle[BRepFillLocationLaw]
...
proc nbHoles*(this: var BRepFillLocationLaw; tol: StandardReal = 1.0e-7): StandardInteger {.
...
proc nbLaw*(this: BRepFillLocationLaw): StandardInteger {.noSideEffect,
    importcpp: "NbLaw", header: "BRepFill_LocationLaw.hxx".}
proc law*(this: BRepFillLocationLaw; index: StandardInteger): Handle[
    GeomFillLocationLaw] {.noSideEffect, importcpp: "Law",
                          header: "BRepFill_LocationLaw.hxx".}
proc wire*(this: BRepFillLocationLaw): TopoDS_Wire {.noSideEffect, importcpp: "Wire",
    header: "BRepFill_LocationLaw.hxx".}
proc edge*(this: BRepFillLocationLaw; index: StandardInteger): TopoDS_Edge {.
    noSideEffect, importcpp: "Edge", header: "BRepFill_LocationLaw.hxx".}
proc vertex*(this: BRepFillLocationLaw; index: StandardInteger): TopoDS_Vertex {.
    noSideEffect, importcpp: "Vertex", header: "BRepFill_LocationLaw.hxx".}
proc performVertex*(this: BRepFillLocationLaw; index: StandardInteger;
                   inputVertex: TopoDS_Vertex; tolMin: StandardReal;
                   outputVertex: var TopoDS_Vertex; location: StandardInteger = 0) {.
    noSideEffect, importcpp: "PerformVertex", header: "BRepFill_LocationLaw.hxx".}
proc curvilinearBounds*(this: BRepFillLocationLaw; index: StandardInteger;
...
proc isG1*(this: BRepFillLocationLaw; index: StandardInteger;
          spatialTolerance: StandardReal = 1.0e-7;
          angularTolerance: StandardReal = 1.0e-4): StandardInteger {.noSideEffect,
...
proc d0*(this: var BRepFillLocationLaw; abscissa: StandardReal;
        section: var TopoDS_Shape) {.importcpp: "D0",
                                  header: "BRepFill_LocationLaw.hxx".}
proc parameter*(this: var BRepFillLocationLaw; abscissa: StandardReal;
               index: var StandardInteger; param: var StandardReal) {.
    importcpp: "Parameter", header: "BRepFill_LocationLaw.hxx".}
proc abscissa*(this: var BRepFillLocationLaw; index: StandardInteger;
              param: StandardReal): StandardReal {.importcpp: "Abscissa",
    header: "BRepFill_LocationLaw.hxx".}
type
