...
proc value*(this: BRepFillMultiLine; u: StandardReal): GpPnt {.noSideEffect,
    importcpp: "Value", header: "BRepFill_MultiLine.hxx".}
proc valueOnF1*(this: BRepFillMultiLine; u: StandardReal): GpPnt2d {.noSideEffect,
    importcpp: "ValueOnF1", header: "BRepFill_MultiLine.hxx".}
proc valueOnF2*(this: BRepFillMultiLine; u: StandardReal): GpPnt2d {.noSideEffect,
    importcpp: "ValueOnF2", header: "BRepFill_MultiLine.hxx".}
proc value3dOnF1OnF2*(this: BRepFillMultiLine; u: StandardReal; p3d: var GpPnt;
                     pf1: var GpPnt2d; pf2: var GpPnt2d) {.noSideEffect,
