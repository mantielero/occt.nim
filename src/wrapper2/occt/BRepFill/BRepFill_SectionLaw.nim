...
proc nbLaw*(this: BRepFillSectionLaw): StandardInteger {.noSideEffect,
    importcpp: "NbLaw", header: "BRepFill_SectionLaw.hxx".}
proc law*(this: BRepFillSectionLaw; index: StandardInteger): Handle[
    GeomFillSectionLaw] {.noSideEffect, importcpp: "Law",
                         header: "BRepFill_SectionLaw.hxx".}
proc indexOfEdge*(this: BRepFillSectionLaw; anEdge: TopoDS_Shape): StandardInteger {.
...
proc continuity*(this: BRepFillSectionLaw; index: StandardInteger;
                tolAngular: StandardReal): GeomAbsShape {.noSideEffect,
    importcpp: "Continuity", header: "BRepFill_SectionLaw.hxx".}
proc vertexTol*(this: BRepFillSectionLaw; index: StandardInteger; param: StandardReal): StandardReal {.
    noSideEffect, importcpp: "VertexTol", header: "BRepFill_SectionLaw.hxx".}
proc vertex*(this: BRepFillSectionLaw; index: StandardInteger; param: StandardReal): TopoDS_Vertex {.
