...
proc constructBRepFillShapeLaw*(v: TopoDS_Vertex;
                               build: StandardBoolean = standardTrue): BRepFillShapeLaw {.
    constructor, importcpp: "BRepFill_ShapeLaw(@)", header: "BRepFill_ShapeLaw.hxx".}
proc constructBRepFillShapeLaw*(w: TopoDS_Wire;
                               build: StandardBoolean = standardTrue): BRepFillShapeLaw {.
    constructor, importcpp: "BRepFill_ShapeLaw(@)", header: "BRepFill_ShapeLaw.hxx".}
...
proc continuity*(this: BRepFillShapeLaw; index: StandardInteger;
                tolAngular: StandardReal): GeomAbsShape {.noSideEffect,
    importcpp: "Continuity", header: "BRepFill_ShapeLaw.hxx".}
proc vertexTol*(this: BRepFillShapeLaw; index: StandardInteger; param: StandardReal): StandardReal {.
    noSideEffect, importcpp: "VertexTol", header: "BRepFill_ShapeLaw.hxx".}
proc vertex*(this: BRepFillShapeLaw; index: StandardInteger; param: StandardReal): TopoDS_Vertex {.
...
proc edge*(this: BRepFillShapeLaw; index: StandardInteger): TopoDS_Edge {.
