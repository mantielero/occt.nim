...
proc constructBRepGPropTFunction*(theSurface: BRepGPropFace; theVertex: GpPnt;
...
proc init*(this: var BRepGPropTFunction) {.importcpp: "Init",
                                       header: "BRepGProp_TFunction.hxx".}
proc setNbKronrodPoints*(this: var BRepGPropTFunction; theNbPoints: StandardInteger) {.
...
proc getStateNumber*(this: var BRepGPropTFunction): StandardInteger {.
