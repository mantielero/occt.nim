...
proc constructBRepLibFuseEdges*(theShape: TopoDS_Shape;
                               performNow: StandardBoolean = standardFalse): BRepLibFuseEdges {.
...
proc setConcatBSpl*(this: var BRepLibFuseEdges;
                   theConcatBSpl: StandardBoolean = standardTrue) {.
...
proc nbVertices*(this: var BRepLibFuseEdges): StandardInteger {.
