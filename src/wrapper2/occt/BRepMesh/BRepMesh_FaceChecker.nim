...
type
  ...
  BRepMeshFaceCheckerSegment* {.importcpp: "BRepMesh_FaceChecker::Segment",
    ...
    point1* {.importc: "Point1".}: ptr GpPnt2d ##  \ Use explicit pointers to points instead of accessing
    point2* {.importc: "Point2".}: ptr GpPnt2d ##  / using indices.
...
proc constructBRepMeshFaceCheckerSegment*(theEdgePtr: IEdgePtr;
    thePoint1: ptr GpPnt2d; thePoint2: ptr GpPnt2d): BRepMeshFaceCheckerSegment {.
    constructor, importcpp: "BRepMesh_FaceChecker::Segment(@)",
    header: "BRepMesh_FaceChecker.hxx".}
type
...
proc perform*(this: var BRepMeshFaceChecker): StandardBoolean {.importcpp: "Perform",
    header: "BRepMesh_FaceChecker.hxx".}
proc getIntersectingEdges*(this: BRepMeshFaceChecker): Handle[MapOfIEdgePtr] {.
    noSideEffect, importcpp: "GetIntersectingEdges",
    header: "BRepMesh_FaceChecker.hxx".}
proc `()`*(this: BRepMeshFaceChecker; theWireIndex: StandardInteger) {.noSideEffect,
