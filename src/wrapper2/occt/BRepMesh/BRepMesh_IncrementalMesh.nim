...
proc constructBRepMeshIncrementalMesh*(theShape: TopoDS_Shape;
                                      theLinDeflection: StandardReal; isRelative: StandardBoolean = standardFalse;
                                      theAngDeflection: StandardReal = 0.5;
    isInParallel: StandardBoolean = standardFalse): BRepMeshIncrementalMesh {.
...
proc getStatusFlags*(this: BRepMeshIncrementalMesh): StandardInteger {.noSideEffect,
...
proc discret*(theShape: TopoDS_Shape; theLinDeflection: StandardReal;
             theAngDeflection: StandardReal; theAlgo: ptr BRepMeshDiscretRoot): StandardInteger {.
