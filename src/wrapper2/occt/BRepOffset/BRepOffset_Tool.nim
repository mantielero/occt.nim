...
proc inter3D*(f1: TopoDS_Face; f2: TopoDS_Face; lInt1: var TopToolsListOfShape;
             ...
             isRefEdgeDefined: StandardBoolean = standardFalse) {.
...
proc enLargeFace*(f: TopoDS_Face; nf: var TopoDS_Face; changeGeom: StandardBoolean;
                 upDatePCurve: StandardBoolean = standardFalse;
                 enlargeU: StandardBoolean = standardTrue;
                 enlargeVfirst: StandardBoolean = standardTrue;
                 enlargeVlast: StandardBoolean = standardTrue;
                 theExtensionMode: StandardInteger = 1;
