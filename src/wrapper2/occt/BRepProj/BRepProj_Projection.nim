...
proc constructBRepProjProjection*(wire: TopoDS_Shape; shape: TopoDS_Shape; d: GpDir): BRepProjProjection {.
    constructor, importcpp: "BRepProj_Projection(@)",
    header: "BRepProj_Projection.hxx".}
proc constructBRepProjProjection*(wire: TopoDS_Shape; shape: TopoDS_Shape; p: GpPnt): BRepProjProjection {.
    constructor, importcpp: "BRepProj_Projection(@)",
    header: "BRepProj_Projection.hxx".}
proc isDone*(this: BRepProjProjection): StandardBoolean {.noSideEffect,
    importcpp: "IsDone", header: "BRepProj_Projection.hxx".}
proc init*(this: var BRepProjProjection) {.importcpp: "Init",
                                       header: "BRepProj_Projection.hxx".}
proc more*(this: BRepProjProjection): StandardBoolean {.noSideEffect,
