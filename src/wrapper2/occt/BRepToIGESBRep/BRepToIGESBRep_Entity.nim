...
proc indexVertex*(this: BRepToIGESBRepEntity; myvertex: TopoDS_Vertex): StandardInteger {.
    noSideEffect, importcpp: "IndexVertex", header: "BRepToIGESBRep_Entity.hxx".}
proc addVertex*(this: var BRepToIGESBRepEntity; myvertex: TopoDS_Vertex): StandardInteger {.
...
proc indexEdge*(this: BRepToIGESBRepEntity; myedge: TopoDS_Edge): StandardInteger {.
...
proc addEdge*(this: var BRepToIGESBRepEntity; myedge: TopoDS_Edge;
             mycurve3d: Handle[IGESDataIGESEntity]): StandardInteger {.
...
proc transferEdge*(this: var BRepToIGESBRepEntity; myedge: TopoDS_Edge;
                  myface: TopoDS_Face; length: StandardReal): Handle[
    IGESDataIGESEntity] {.importcpp: "TransferEdge",
                         header: "BRepToIGESBRep_Entity.hxx".}
proc transferWire*(this: var BRepToIGESBRepEntity; mywire: TopoDS_Wire;
                  myface: TopoDS_Face; length: StandardReal): Handle[IGESSolidLoop] {.
