...
discard "forward decl of BRepTools_GTrsfModification"
type
  HandleBRepToolsGTrsfModification* = Handle[BRepToolsGTrsfModification]
...
proc constructBRepToolsGTrsfModification*(t: GpGTrsf): BRepToolsGTrsfModification {.
    constructor, importcpp: "BRepTools_GTrsfModification(@)",
    header: "BRepTools_GTrsfModification.hxx".}
proc gTrsf*(this: var BRepToolsGTrsfModification): var GpGTrsf {.importcpp: "GTrsf",
    header: "BRepTools_GTrsfModification.hxx".}
...
proc newPoint*(this: var BRepToolsGTrsfModification; v: TopoDS_Vertex; p: var GpPnt;
