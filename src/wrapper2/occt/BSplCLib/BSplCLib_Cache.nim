...
proc constructBSplCLibCache*(theDegree: StandardInteger;
                            thePeriodic: StandardBoolean;
...
proc constructBSplCLibCache*(theDegree: StandardInteger;
                            ...
                            theWeights: ptr TColStdArray1OfReal = nil): BSplCLibCache {.
    constructor, importcpp: "BSplCLib_Cache(@)", header: "BSplCLib_Cache.hxx".}
proc isCacheValid*(this: BSplCLibCache; theParameter: StandardReal): StandardBoolean {.
    noSideEffect, importcpp: "IsCacheValid", header: "BSplCLib_Cache.hxx".}
proc buildCache*(this: var BSplCLibCache; theParameter: StandardReal;
                theFlatKnots: TColStdArray1OfReal;
                thePoles2d: TColgpArray1OfPnt2d;
...
proc buildCache*(this: var BSplCLibCache; theParameter: StandardReal;
    ...
    header: "BSplCLib_Cache.hxx".}
proc d0*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt2d) {.
    noSideEffect, importcpp: "D0", header: "BSplCLib_Cache.hxx".}
proc d0*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt) {.
    noSideEffect, importcpp: "D0", header: "BSplCLib_Cache.hxx".}
proc d1*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt2d;
        theTangent: var GpVec2d) {.noSideEffect, importcpp: "D1",
                                header: "BSplCLib_Cache.hxx".}
proc d1*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt;
        theTangent: var GpVec) {.noSideEffect, importcpp: "D1",
                              header: "BSplCLib_Cache.hxx".}
proc d2*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt2d;
        theTangent: var GpVec2d; theCurvature: var GpVec2d) {.noSideEffect,
    importcpp: "D2", header: "BSplCLib_Cache.hxx".}
proc d2*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt;
        theTangent: var GpVec; theCurvature: var GpVec) {.noSideEffect,
    importcpp: "D2", header: "BSplCLib_Cache.hxx".}
proc d3*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt2d;
        theTangent: var GpVec2d; theCurvature: var GpVec2d; theTorsion: var GpVec2d) {.
    noSideEffect, importcpp: "D3", header: "BSplCLib_Cache.hxx".}
proc d3*(this: BSplCLibCache; theParameter: StandardReal; thePoint: var GpPnt;
        theTangent: var GpVec; theCurvature: var GpVec; theTorsion: var GpVec) {.
    noSideEffect, importcpp: "D3", header: "BSplCLib_Cache.hxx".}
type
