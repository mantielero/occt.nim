...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "BSplCLib_EvaluatorFunction.hxx",
              bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "BSplCLib_EvaluatorFunction.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "BSplCLib_EvaluatorFunction.hxx",
          bycopy.} = object
...
var time* {.importcpp: "time", header: "BSplCLib_EvaluatorFunction.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "BSplCLib_EvaluatorFunction.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec",
...
var itInterval* {.importcpp: "it_interval", header: "BSplCLib_EvaluatorFunction.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "BSplCLib_EvaluatorFunction.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "BSplCLib_EvaluatorFunction.hxx".}: array[
...
type
  ...
  BSplCLibEvaluatorFunction* {.importcpp: "timex::itimerspec::timespec::__locale_struct::BSplCLib_EvaluatorFunction",
                              header: "BSplCLib_EvaluatorFunction.hxx", bycopy.} = object


proc constructBSplCLibEvaluatorFunction*(): BSplCLibEvaluatorFunction {.
    constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::BSplCLib_EvaluatorFunction(@)",
...
proc destroyBSplCLibEvaluatorFunction*(this: var BSplCLibEvaluatorFunction) {.
    ...
    header: "BSplCLib_EvaluatorFunction.hxx".}
proc evaluate*(this: BSplCLibEvaluatorFunction;
              theDerivativeRequest: StandardInteger;
              theStartEnd: ptr StandardReal; theParameter: StandardReal;
              theResult: var StandardReal; theErrorCode: var StandardInteger) {.
    noSideEffect, importcpp: "Evaluate", header: "BSplCLib_EvaluatorFunction.hxx".}
proc `()`*(this: BSplCLibEvaluatorFunction; theDerivativeRequest: StandardInteger;
          theStartEnd: ptr StandardReal; theParameter: StandardReal;
          theResult: var StandardReal; theErrorCode: var StandardInteger) {.
    noSideEffect, importcpp: "#(@)", header: "BSplCLib_EvaluatorFunction.hxx".}