...
proc destroyBSplSLibEvaluatorFunction*(this: var BSplSLibEvaluatorFunction) {.
    ...
    header: "BSplSLib_EvaluatorFunction.hxx".}
proc evaluate*(this: BSplSLibEvaluatorFunction;
              theDerivativeRequest: StandardInteger; theUParameter: StandardReal;
              theVParameter: StandardReal; theResult: var StandardReal;
              theErrorCode: var StandardInteger) {.noSideEffect,
    importcpp: "Evaluate", header: "BSplSLib_EvaluatorFunction.hxx".}
proc `()`*(this: BSplSLibEvaluatorFunction; theDerivativeRequest: StandardInteger;
          theUParameter: StandardReal; theVParameter: StandardReal;
          theResult: var StandardReal; theErrorCode: var StandardInteger) {.
    noSideEffect, importcpp: "#(@)", header: "BSplSLib_EvaluatorFunction.hxx".}
