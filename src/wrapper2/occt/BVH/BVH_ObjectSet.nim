...
proc size*[T; N: static[cint]](this: BVH_ObjectSet[T, N]): StandardInteger {.
    noSideEffect, importcpp: "Size", header: "BVH_ObjectSet.hxx".}
## using statement

proc box*[T; N: static[cint]](this: BVH_ObjectSet[T, N]; theIndex: StandardInteger): BVH_Box[
    T, N] {.noSideEffect, importcpp: "Box", header: "BVH_ObjectSet.hxx".}
proc center*[T; N: static[cint]](this: BVH_ObjectSet[T, N]; theIndex: StandardInteger;
...
proc swap*[T; N: static[cint]](this: var BVH_ObjectSet[T, N];
    ...
    importcpp: "Swap", header: "BVH_ObjectSet.hxx".}
