...
proc constructBinMDataStdByteArrayDriver*(
    theMessageDriver: Handle[MessageMessenger]): BinMDataStdByteArrayDriver {.
    constructor, importcpp: "BinMDataStd_ByteArrayDriver(@)",
    header: "BinMDataStd_ByteArrayDriver.hxx".}
proc newEmpty*(this: BinMDataStdByteArrayDriver): Handle[TDF_Attribute] {.
    noSideEffect, importcpp: "NewEmpty", header: "BinMDataStd_ByteArrayDriver.hxx".}
proc paste*(this: BinMDataStdByteArrayDriver; source: BinObjMgtPersistent;
...
proc paste*(this: BinMDataStdByteArrayDriver; source: Handle[TDF_Attribute];
...
type
  BinMDataStdByteArrayDriverbaseType* = BinMDF_ADriver

proc getTypeName*(): cstring {.importcpp: "BinMDataStd_ByteArrayDriver::get_type_name(@)",
                            header: "BinMDataStd_ByteArrayDriver.hxx".}
