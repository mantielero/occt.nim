...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "BinObjMgt_PByte.hxx", bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "BinObjMgt_PByte.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "BinObjMgt_PByte.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "BinObjMgt_PByte.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "BinObjMgt_PByte.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "BinObjMgt_PByte.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
  ...
  Itimerspec* {.importcpp: "timex::itimerspec::timespec::itimerspec",
               header: "BinObjMgt_PByte.hxx", bycopy.} = object


var itInterval* {.importcpp: "it_interval", header: "BinObjMgt_PByte.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "BinObjMgt_PByte.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "BinObjMgt_PByte.hxx".}: array[13,
...
type
  ...
  BinObjMgtPByte* = ptr StandardByte
