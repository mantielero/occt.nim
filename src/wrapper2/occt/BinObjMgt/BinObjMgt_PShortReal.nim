...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "BinObjMgt_PShortReal.hxx", bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "BinObjMgt_PShortReal.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "BinObjMgt_PShortReal.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "BinObjMgt_PShortReal.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "BinObjMgt_PShortReal.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "BinObjMgt_PShortReal.hxx",
             bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
  ...
  Itimerspec* {.importcpp: "timex::itimerspec::timespec::itimerspec",
               header: "BinObjMgt_PShortReal.hxx", bycopy.} = object


var itInterval* {.importcpp: "it_interval", header: "BinObjMgt_PShortReal.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "BinObjMgt_PShortReal.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "BinObjMgt_PShortReal.hxx".}: array[13,
...
type
  ...
  BinObjMgtPShortReal* = ptr StandardShortReal
