...
proc `<<`*(this: var BinObjMgtPersistent; theValue: StandardExtCharacter): var BinObjMgtPersistent {.
    importcpp: "(# << #)", header: "BinObjMgt_Persistent.hxx".}
proc putInteger*(this: var BinObjMgtPersistent; theValue: StandardInteger): var BinObjMgtPersistent {.
    importcpp: "PutInteger", header: "BinObjMgt_Persistent.hxx".}
proc `<<`*(this: var BinObjMgtPersistent; theValue: StandardInteger): var BinObjMgtPersistent {.
    importcpp: "(# << #)", header: "BinObjMgt_Persistent.hxx".}
proc putBoolean*(this: var BinObjMgtPersistent; theValue: StandardBoolean): var BinObjMgtPersistent {.
    importcpp: "PutBoolean", header: "BinObjMgt_Persistent.hxx".}
proc `<<`*(this: var BinObjMgtPersistent; theValue: StandardBoolean): var BinObjMgtPersistent {.
    importcpp: "(# << #)", header: "BinObjMgt_Persistent.hxx".}
proc putReal*(this: var BinObjMgtPersistent; theValue: StandardReal): var BinObjMgtPersistent {.
    importcpp: "PutReal", header: "BinObjMgt_Persistent.hxx".}
proc `<<`*(this: var BinObjMgtPersistent; theValue: StandardReal): var BinObjMgtPersistent {.
    importcpp: "(# << #)", header: "BinObjMgt_Persistent.hxx".}
...
proc putCharArray*(this: var BinObjMgtPersistent; theArray: BinObjMgtPChar;
                  theLength: StandardInteger): var BinObjMgtPersistent {.
...
proc putShortRealArray*(this: var BinObjMgtPersistent;
                       theArray: BinObjMgtPShortReal; theLength: StandardInteger): var BinObjMgtPersistent {.
...
proc `>>`*(this: BinObjMgtPersistent; theValue: var StandardExtCharacter): BinObjMgtPersistent {.
    noSideEffect, importcpp: "(# >> #)", header: "BinObjMgt_Persistent.hxx".}
proc getInteger*(this: BinObjMgtPersistent; theValue: var StandardInteger): BinObjMgtPersistent {.
    noSideEffect, importcpp: "GetInteger", header: "BinObjMgt_Persistent.hxx".}
proc `>>`*(this: BinObjMgtPersistent; theValue: var StandardInteger): BinObjMgtPersistent {.
    noSideEffect, importcpp: "(# >> #)", header: "BinObjMgt_Persistent.hxx".}
proc getBoolean*(this: BinObjMgtPersistent; theValue: var StandardBoolean): BinObjMgtPersistent {.
    noSideEffect, importcpp: "GetBoolean", header: "BinObjMgt_Persistent.hxx".}
proc `>>`*(this: BinObjMgtPersistent; theValue: var StandardBoolean): BinObjMgtPersistent {.
    noSideEffect, importcpp: "(# >> #)", header: "BinObjMgt_Persistent.hxx".}
proc getReal*(this: BinObjMgtPersistent; theValue: var StandardReal): BinObjMgtPersistent {.
    noSideEffect, importcpp: "GetReal", header: "BinObjMgt_Persistent.hxx".}
proc `>>`*(this: BinObjMgtPersistent; theValue: var StandardReal): BinObjMgtPersistent {.
    noSideEffect, importcpp: "(# >> #)", header: "BinObjMgt_Persistent.hxx".}
...
proc getCharArray*(this: BinObjMgtPersistent; theArray: BinObjMgtPChar;
                  theLength: StandardInteger): BinObjMgtPersistent {.noSideEffect,
...
proc getExtCharArray*(this: BinObjMgtPersistent; theArray: BinObjMgtPExtChar;
                     theLength: StandardInteger): BinObjMgtPersistent {.
...
proc getShortRealArray*(this: BinObjMgtPersistent; theArray: BinObjMgtPShortReal;
    ...
    header: "BinObjMgt_Persistent.hxx".}
proc position*(this: BinObjMgtPersistent): StandardInteger {.noSideEffect,
    importcpp: "Position", header: "BinObjMgt_Persistent.hxx".}
proc setPosition*(this: BinObjMgtPersistent; thePos: StandardInteger): StandardBoolean {.
...
proc truncate*(this: var BinObjMgtPersistent) {.importcpp: "Truncate",
    header: "BinObjMgt_Persistent.hxx".}
proc isError*(this: BinObjMgtPersistent): StandardBoolean {.noSideEffect,
    importcpp: "IsError", header: "BinObjMgt_Persistent.hxx".}
proc `!`*(this: BinObjMgtPersistent): StandardBoolean {.noSideEffect,
    importcpp: "(! #)", header: "BinObjMgt_Persistent.hxx".}
proc isOK*(this: BinObjMgtPersistent): StandardBoolean {.noSideEffect,
    importcpp: "IsOK", header: "BinObjMgt_Persistent.hxx".}
converter `standardBoolean`*(this: BinObjMgtPersistent): StandardBoolean {.
...
proc init*(this: var BinObjMgtPersistent) {.importcpp: "Init",
                                        header: "BinObjMgt_Persistent.hxx".}
proc setId*(this: var BinObjMgtPersistent; theId: StandardInteger) {.
    importcpp: "SetId", header: "BinObjMgt_Persistent.hxx".}
proc setTypeId*(this: var BinObjMgtPersistent; theId: StandardInteger) {.
    importcpp: "SetTypeId", header: "BinObjMgt_Persistent.hxx".}
proc id*(this: BinObjMgtPersistent): StandardInteger {.noSideEffect, importcpp: "Id",
    header: "BinObjMgt_Persistent.hxx".}
proc typeId*(this: BinObjMgtPersistent): StandardInteger {.noSideEffect,
    importcpp: "TypeId", header: "BinObjMgt_Persistent.hxx".}
proc length*(this: BinObjMgtPersistent): StandardInteger {.noSideEffect,
