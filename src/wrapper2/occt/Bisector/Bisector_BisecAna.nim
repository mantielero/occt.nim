...
discard "forward decl of Bisector_BisecAna"
type
  HandleBisectorBisecAna* = Handle[BisectorBisecAna]
...
proc perform*(this: var BisectorBisecAna; cu1: Handle[Geom2dCurve];
             cu2: Handle[Geom2dCurve]; p: GpPnt2d; v1: GpVec2d; v2: GpVec2d;
             sense: StandardReal; jointype: GeomAbsJoinType;
             tolerance: StandardReal; oncurve: StandardBoolean = standardTrue) {.
    importcpp: "Perform", header: "Bisector_BisecAna.hxx".}
proc perform*(this: var BisectorBisecAna; cu: Handle[Geom2dCurve];
             pnt: Handle[Geom2dPoint]; p: GpPnt2d; v1: GpVec2d; v2: GpVec2d;
             sense: StandardReal; tolerance: StandardReal;
             oncurve: StandardBoolean = standardTrue) {.importcpp: "Perform",
    header: "Bisector_BisecAna.hxx".}
proc perform*(this: var BisectorBisecAna; pnt: Handle[Geom2dPoint];
             cu: Handle[Geom2dCurve]; p: GpPnt2d; v1: GpVec2d; v2: GpVec2d;
             sense: StandardReal; tolerance: StandardReal;
             oncurve: StandardBoolean = standardTrue) {.importcpp: "Perform",
    header: "Bisector_BisecAna.hxx".}
proc perform*(this: var BisectorBisecAna; pnt1: Handle[Geom2dPoint];
             pnt2: Handle[Geom2dPoint]; p: GpPnt2d; v1: GpVec2d; v2: GpVec2d;
             sense: StandardReal; tolerance: StandardReal = 0.0;
             oncurve: StandardBoolean = standardTrue) {.importcpp: "Perform",
    header: "Bisector_BisecAna.hxx".}
proc init*(this: var BisectorBisecAna; bisector: Handle[Geom2dTrimmedCurve]) {.
    importcpp: "Init", header: "Bisector_BisecAna.hxx".}
proc isExtendAtStart*(this: BisectorBisecAna): StandardBoolean {.noSideEffect,
    importcpp: "IsExtendAtStart", header: "Bisector_BisecAna.hxx".}
proc isExtendAtEnd*(this: BisectorBisecAna): StandardBoolean {.noSideEffect,
...
proc setTrim*(this: var BisectorBisecAna; uf: StandardReal; ul: StandardReal) {.
    importcpp: "SetTrim", header: "Bisector_BisecAna.hxx".}
proc reverse*(this: var BisectorBisecAna) {.importcpp: "Reverse",
                                        header: "Bisector_BisecAna.hxx".}
proc reversedParameter*(this: BisectorBisecAna; u: StandardReal): StandardReal {.
    noSideEffect, importcpp: "ReversedParameter", header: "Bisector_BisecAna.hxx".}
proc isCN*(this: BisectorBisecAna; n: StandardInteger): StandardBoolean {.
...
proc transform*(this: var BisectorBisecAna; t: GpTrsf2d) {.importcpp: "Transform",
    header: "Bisector_BisecAna.hxx".}
proc firstParameter*(this: BisectorBisecAna): StandardReal {.noSideEffect,
    importcpp: "FirstParameter", header: "Bisector_BisecAna.hxx".}
proc lastParameter*(this: BisectorBisecAna): StandardReal {.noSideEffect,
    importcpp: "LastParameter", header: "Bisector_BisecAna.hxx".}
proc isClosed*(this: BisectorBisecAna): StandardBoolean {.noSideEffect,
    importcpp: "IsClosed", header: "Bisector_BisecAna.hxx".}
proc isPeriodic*(this: BisectorBisecAna): StandardBoolean {.noSideEffect,
...
proc d0*(this: BisectorBisecAna; u: StandardReal; p: var GpPnt2d) {.noSideEffect,
    importcpp: "D0", header: "Bisector_BisecAna.hxx".}
proc d1*(this: BisectorBisecAna; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d) {.
    noSideEffect, importcpp: "D1", header: "Bisector_BisecAna.hxx".}
proc d2*(this: BisectorBisecAna; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d) {.noSideEffect, importcpp: "D2",
                        header: "Bisector_BisecAna.hxx".}
proc d3*(this: BisectorBisecAna; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d; v3: var GpVec2d) {.noSideEffect, importcpp: "D3",
                                      header: "Bisector_BisecAna.hxx".}
proc dn*(this: BisectorBisecAna; u: StandardReal; n: StandardInteger): GpVec2d {.
...
proc parameter*(this: BisectorBisecAna; p: GpPnt2d): StandardReal {.noSideEffect,
    importcpp: "Parameter", header: "Bisector_BisecAna.hxx".}
proc parameterOfStartPoint*(this: BisectorBisecAna): StandardReal {.noSideEffect,
    importcpp: "ParameterOfStartPoint", header: "Bisector_BisecAna.hxx".}
proc parameterOfEndPoint*(this: BisectorBisecAna): StandardReal {.noSideEffect,
    importcpp: "ParameterOfEndPoint", header: "Bisector_BisecAna.hxx".}
proc nbIntervals*(this: BisectorBisecAna): StandardInteger {.noSideEffect,
    importcpp: "NbIntervals", header: "Bisector_BisecAna.hxx".}
proc intervalFirst*(this: BisectorBisecAna; index: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "IntervalFirst", header: "Bisector_BisecAna.hxx".}
proc intervalLast*(this: BisectorBisecAna; index: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "IntervalLast", header: "Bisector_BisecAna.hxx".}
proc dump*(this: BisectorBisecAna; deep: StandardInteger = 0;
