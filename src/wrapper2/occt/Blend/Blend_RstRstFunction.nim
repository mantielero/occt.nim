...
proc nbVariables*(this: BlendRstRstFunction): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "Blend_RstRstFunction.hxx".}
proc nbEquations*(this: BlendRstRstFunction): StandardInteger {.noSideEffect,
    importcpp: "NbEquations", header: "Blend_RstRstFunction.hxx".}
proc value*(this: var BlendRstRstFunction; x: MathVector; f: var MathVector): StandardBoolean {.
    importcpp: "Value", header: "Blend_RstRstFunction.hxx".}
proc derivatives*(this: var BlendRstRstFunction; x: MathVector; d: var MathMatrix): StandardBoolean {.
...
proc set*(this: var BlendRstRstFunction; param: StandardReal) {.importcpp: "Set",
    header: "Blend_RstRstFunction.hxx".}
proc set*(this: var BlendRstRstFunction; first: StandardReal; last: StandardReal) {.
    importcpp: "Set", header: "Blend_RstRstFunction.hxx".}
proc getTolerance*(this: BlendRstRstFunction; tolerance: var MathVector;
...
proc getBounds*(this: BlendRstRstFunction; infBound: var MathVector;
               supBound: var MathVector) {.noSideEffect, importcpp: "GetBounds",
                                        header: "Blend_RstRstFunction.hxx".}
proc isSolution*(this: var BlendRstRstFunction; sol: MathVector; tol: StandardReal): StandardBoolean {.
    importcpp: "IsSolution", header: "Blend_RstRstFunction.hxx".}
proc getMinimalDistance*(this: BlendRstRstFunction): StandardReal {.noSideEffect,
    importcpp: "GetMinimalDistance", header: "Blend_RstRstFunction.hxx".}
proc pnt1*(this: BlendRstRstFunction): GpPnt {.noSideEffect, importcpp: "Pnt1",
    header: "Blend_RstRstFunction.hxx".}
proc pnt2*(this: BlendRstRstFunction): GpPnt {.noSideEffect, importcpp: "Pnt2",
    header: "Blend_RstRstFunction.hxx".}
proc pointOnRst1*(this: BlendRstRstFunction): GpPnt {.noSideEffect,
    importcpp: "PointOnRst1", header: "Blend_RstRstFunction.hxx".}
proc pointOnRst2*(this: BlendRstRstFunction): GpPnt {.noSideEffect,
    importcpp: "PointOnRst2", header: "Blend_RstRstFunction.hxx".}
proc pnt2dOnRst1*(this: BlendRstRstFunction): GpPnt2d {.noSideEffect,
    importcpp: "Pnt2dOnRst1", header: "Blend_RstRstFunction.hxx".}
proc pnt2dOnRst2*(this: BlendRstRstFunction): GpPnt2d {.noSideEffect,
    importcpp: "Pnt2dOnRst2", header: "Blend_RstRstFunction.hxx".}
proc parameterOnRst1*(this: BlendRstRstFunction): StandardReal {.noSideEffect,
    importcpp: "ParameterOnRst1", header: "Blend_RstRstFunction.hxx".}
proc parameterOnRst2*(this: BlendRstRstFunction): StandardReal {.noSideEffect,
    importcpp: "ParameterOnRst2", header: "Blend_RstRstFunction.hxx".}
proc isTangencyPoint*(this: BlendRstRstFunction): StandardBoolean {.noSideEffect,
    importcpp: "IsTangencyPoint", header: "Blend_RstRstFunction.hxx".}
proc tangentOnRst1*(this: BlendRstRstFunction): GpVec {.noSideEffect,
    importcpp: "TangentOnRst1", header: "Blend_RstRstFunction.hxx".}
proc tangent2dOnRst1*(this: BlendRstRstFunction): GpVec2d {.noSideEffect,
    importcpp: "Tangent2dOnRst1", header: "Blend_RstRstFunction.hxx".}
proc tangentOnRst2*(this: BlendRstRstFunction): GpVec {.noSideEffect,
    importcpp: "TangentOnRst2", header: "Blend_RstRstFunction.hxx".}
proc tangent2dOnRst2*(this: BlendRstRstFunction): GpVec2d {.noSideEffect,
    importcpp: "Tangent2dOnRst2", header: "Blend_RstRstFunction.hxx".}
proc decroch*(this: BlendRstRstFunction; sol: MathVector; nRst1: var GpVec;
...
proc isRational*(this: BlendRstRstFunction): StandardBoolean {.noSideEffect,
    importcpp: "IsRational", header: "Blend_RstRstFunction.hxx".}
proc getSectionSize*(this: BlendRstRstFunction): StandardReal {.noSideEffect,
...
proc nbIntervals*(this: BlendRstRstFunction; s: GeomAbsShape): StandardInteger {.
...
proc getShape*(this: var BlendRstRstFunction; nbPoles: var StandardInteger;
              nbKnots: var StandardInteger; degree: var StandardInteger;
              nbPoles2d: var StandardInteger) {.importcpp: "GetShape",
    header: "Blend_RstRstFunction.hxx".}
proc getTolerance*(this: BlendRstRstFunction; boundTol: StandardReal;
