...
proc nbVariables*(this: BlendSurfCurvFuncInv): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "Blend_SurfCurvFuncInv.hxx".}
proc nbEquations*(this: BlendSurfCurvFuncInv): StandardInteger {.noSideEffect,
    importcpp: "NbEquations", header: "Blend_SurfCurvFuncInv.hxx".}
proc value*(this: var BlendSurfCurvFuncInv; x: MathVector; f: var MathVector): StandardBoolean {.
    importcpp: "Value", header: "Blend_SurfCurvFuncInv.hxx".}
proc derivatives*(this: var BlendSurfCurvFuncInv; x: MathVector; d: var MathMatrix): StandardBoolean {.
...
proc getTolerance*(this: BlendSurfCurvFuncInv; tolerance: var MathVector;
...
proc getBounds*(this: BlendSurfCurvFuncInv; infBound: var MathVector;
               supBound: var MathVector) {.noSideEffect, importcpp: "GetBounds",
                                        header: "Blend_SurfCurvFuncInv.hxx".}
proc isSolution*(this: var BlendSurfCurvFuncInv; sol: MathVector; tol: StandardReal): StandardBoolean {.
