...
type
  BndLib_Add2dCurve* {.importcpp: "BndLib_Add2dCurve",
...
proc Add*(C: Adaptor2d_Curve2d; Tol: Standard_Real; B: var Bnd_Box2d) {.
    importcpp: "BndLib_Add2dCurve::Add(@)", header: "BndLib_Add2dCurve.hxx".}
proc Add*(C: Adaptor2d_Curve2d; U1: Standard_Real; U2: Standard_Real;
         Tol: Standard_Real; B: var Bnd_Box2d) {.
    importcpp: "BndLib_Add2dCurve::Add(@)", header: "BndLib_Add2dCurve.hxx".}
proc Add*(C: handle[Geom2d_Curve]; Tol: Standard_Real; Box: var Bnd_Box2d) {.
    importcpp: "BndLib_Add2dCurve::Add(@)", header: "BndLib_Add2dCurve.hxx".}
proc Add*(C: handle[Geom2d_Curve]; U1: Standard_Real; U2: Standard_Real;
         Tol: Standard_Real; B: var Bnd_Box2d) {.
    importcpp: "BndLib_Add2dCurve::Add(@)", header: "BndLib_Add2dCurve.hxx".}
proc AddOptimal*(C: handle[Geom2d_Curve]; U1: Standard_Real; U2: Standard_Real;
                Tol: Standard_Real; B: var Bnd_Box2d) {.
