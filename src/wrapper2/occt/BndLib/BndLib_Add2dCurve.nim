...
proc add*(c: Adaptor2dCurve2d; tol: StandardReal; b: var BndBox2d) {.
    importcpp: "BndLib_Add2dCurve::Add(@)", header: "BndLib_Add2dCurve.hxx".}
proc add*(c: Adaptor2dCurve2d; u1: StandardReal; u2: StandardReal; tol: StandardReal;
         b: var BndBox2d) {.importcpp: "BndLib_Add2dCurve::Add(@)",
                         header: "BndLib_Add2dCurve.hxx".}
proc add*(c: Handle[Geom2dCurve]; tol: StandardReal; box: var BndBox2d) {.
    importcpp: "BndLib_Add2dCurve::Add(@)", header: "BndLib_Add2dCurve.hxx".}
proc add*(c: Handle[Geom2dCurve]; u1: StandardReal; u2: StandardReal;
         tol: StandardReal; b: var BndBox2d) {.
    importcpp: "BndLib_Add2dCurve::Add(@)", header: "BndLib_Add2dCurve.hxx".}
proc addOptimal*(c: Handle[Geom2dCurve]; u1: StandardReal; u2: StandardReal;
                tol: StandardReal; b: var BndBox2d) {.
    importcpp: "BndLib_Add2dCurve::AddOptimal(@)", header: "BndLib_Add2dCurve.hxx".}
