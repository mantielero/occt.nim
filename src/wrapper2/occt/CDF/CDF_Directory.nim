...
proc contains*(this: CDF_Directory; aDocument: Handle[CDM_Document]): StandardBoolean {.
...
proc length*(this: CDF_Directory): StandardInteger {.noSideEffect,
    importcpp: "Length", header: "CDF_Directory.hxx".}
proc isEmpty*(this: CDF_Directory): StandardBoolean {.noSideEffect,
