...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "CPnts_RealFunction.hxx", bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "CPnts_RealFunction.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "CPnts_RealFunction.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "CPnts_RealFunction.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "CPnts_RealFunction.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "CPnts_RealFunction.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
  ...
  Itimerspec* {.importcpp: "timex::itimerspec::timespec::itimerspec",
               header: "CPnts_RealFunction.hxx", bycopy.} = object


var itInterval* {.importcpp: "it_interval", header: "CPnts_RealFunction.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "CPnts_RealFunction.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "CPnts_RealFunction.hxx".}: array[13,
...
type
  ...
  CPntsRealFunction* = proc (a1: StandardReal; a2: StandardAddress): StandardReal
