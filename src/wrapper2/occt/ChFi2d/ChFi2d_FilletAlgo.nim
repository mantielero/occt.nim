...
proc constructChFi2dFilletAlgo*(theWire: TopoDS_Wire; thePlane: GpPln): ChFi2dFilletAlgo {.
...
proc constructChFi2dFilletAlgo*(theEdge1: TopoDS_Edge; theEdge2: TopoDS_Edge;
                               thePlane: GpPln): ChFi2dFilletAlgo {.constructor,
    importcpp: "ChFi2d_FilletAlgo(@)", header: "ChFi2d_FilletAlgo.hxx".}
proc init*(this: var ChFi2dFilletAlgo; theWire: TopoDS_Wire; thePlane: GpPln) {.
    importcpp: "Init", header: "ChFi2d_FilletAlgo.hxx".}
proc init*(this: var ChFi2dFilletAlgo; theEdge1: TopoDS_Edge; theEdge2: TopoDS_Edge;
          thePlane: GpPln) {.importcpp: "Init", header: "ChFi2d_FilletAlgo.hxx".}
...
proc nbResults*(this: var ChFi2dFilletAlgo; thePoint: GpPnt): StandardInteger {.
    importcpp: "NbResults", header: "ChFi2d_FilletAlgo.hxx".}
proc result*(this: var ChFi2dFilletAlgo; thePoint: GpPnt; theEdge1: var TopoDS_Edge;
...
proc getNBValues*(this: var FilletPoint): StandardInteger {.importcpp: "getNBValues",
    header: "ChFi2d_FilletAlgo.hxx".}
...
proc getParam2*(this: var FilletPoint): StandardReal {.importcpp: "getParam2",
    header: "ChFi2d_FilletAlgo.hxx".}
proc setCenter*(this: var FilletPoint; thePoint: GpPnt2d) {.importcpp: "setCenter",
    header: "ChFi2d_FilletAlgo.hxx".}
proc getCenter*(this: var FilletPoint): GpPnt2d {.importcpp: "getCenter",
    header: "ChFi2d_FilletAlgo.hxx".}
...
proc copy*(this: var FilletPoint): ptr FilletPoint {.importcpp: "Copy",
    header: "ChFi2d_FilletAlgo.hxx".}
proc hasSolution*(this: var FilletPoint; theRadius: StandardReal): StandardInteger {.
    importcpp: "hasSolution", header: "ChFi2d_FilletAlgo.hxx".}
proc lowerValue*(this: var FilletPoint): StandardReal {.importcpp: "LowerValue",
    header: "ChFi2d_FilletAlgo.hxx".}
proc remove*(this: var FilletPoint; theIndex: StandardInteger) {.importcpp: "remove",
    header: "ChFi2d_FilletAlgo.hxx".}
