...
type
  Contap_HCurve2dTool* {.importcpp: "Contap_HCurve2dTool",
...
proc Intervals*(C: handle[Adaptor2d_HCurve2d]; T: var TColStd_Array1OfReal;
               S: GeomAbs_Shape) {.importcpp: "Contap_HCurve2dTool::Intervals(@)",
                                 header: "Contap_HCurve2dTool.hxx".}
