...
proc add*(this: var ContapLine; p: IntSurfPntOn2S) {.importcpp: "Add",
    header: "Contap_Line.hxx".}
proc setValue*(this: var ContapLine; L: GpLin) {.importcpp: "SetValue",
    header: "Contap_Line.hxx".}
proc setValue*(this: var ContapLine; c: GpCirc) {.importcpp: "SetValue",
    header: "Contap_Line.hxx".}
...
proc add*(this: var ContapLine; p: ContapPoint) {.importcpp: "Add",
    header: "Contap_Line.hxx".}
proc nbVertex*(this: ContapLine): StandardInteger {.noSideEffect,
    importcpp: "NbVertex", header: "Contap_Line.hxx".}
proc vertex*(this: ContapLine; index: StandardInteger): var ContapPoint {.noSideEffect,
...
proc nbPnts*(this: ContapLine): StandardInteger {.noSideEffect, importcpp: "NbPnts",
    header: "Contap_Line.hxx".}
proc point*(this: ContapLine; index: StandardInteger): IntSurfPntOn2S {.noSideEffect,
    importcpp: "Point", header: "Contap_Line.hxx".}
proc line*(this: ContapLine): GpLin {.noSideEffect, importcpp: "Line",
                                  header: "Contap_Line.hxx".}
proc circle*(this: ContapLine): GpCirc {.noSideEffect, importcpp: "Circle",
                                     header: "Contap_Line.hxx".}
