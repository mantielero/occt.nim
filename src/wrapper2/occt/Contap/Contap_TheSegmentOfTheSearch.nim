...
proc setLimitPoint*(this: var ContapTheSegmentOfTheSearch;
                   v: ContapThePathPointOfTheSearch; first: StandardBoolean) {.
...
proc hasFirstPoint*(this: ContapTheSegmentOfTheSearch): StandardBoolean {.
...
proc firstPoint*(this: ContapTheSegmentOfTheSearch): ContapThePathPointOfTheSearch {.
    ...
    header: "Contap_TheSegmentOfTheSearch.hxx".}
proc hasLastPoint*(this: ContapTheSegmentOfTheSearch): StandardBoolean {.
