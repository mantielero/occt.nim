...
proc constructConvertCompPolynomialToPoles*(numCurves: StandardInteger;
    continuity: StandardInteger; dimension: StandardInteger;
    maxDegree: StandardInteger; numCoeffPerCurve: Handle[TColStdHArray1OfInteger];
    ...
    header: "Convert_CompPolynomialToPoles.hxx".}
proc constructConvertCompPolynomialToPoles*(numCurves: StandardInteger;
    dimension: StandardInteger; maxDegree: StandardInteger;
    continuity: TColStdArray1OfInteger; numCoeffPerCurve: TColStdArray1OfInteger;
    coefficients: TColStdArray1OfReal; polynomialIntervals: TColStdArray2OfReal;
    trueIntervals: TColStdArray1OfReal): ConvertCompPolynomialToPoles {.
    constructor, importcpp: "Convert_CompPolynomialToPoles(@)",
    header: "Convert_CompPolynomialToPoles.hxx".}
proc constructConvertCompPolynomialToPoles*(dimension: StandardInteger;
    maxDegree: StandardInteger; degree: StandardInteger;
    coefficients: TColStdArray1OfReal; polynomialIntervals: TColStdArray1OfReal;
    trueIntervals: TColStdArray1OfReal): ConvertCompPolynomialToPoles {.
    constructor, importcpp: "Convert_CompPolynomialToPoles(@)",
    header: "Convert_CompPolynomialToPoles.hxx".}
proc nbPoles*(this: ConvertCompPolynomialToPoles): StandardInteger {.noSideEffect,
...
proc degree*(this: ConvertCompPolynomialToPoles): StandardInteger {.noSideEffect,
    importcpp: "Degree", header: "Convert_CompPolynomialToPoles.hxx".}
proc nbKnots*(this: ConvertCompPolynomialToPoles): StandardInteger {.noSideEffect,
...
proc isDone*(this: ConvertCompPolynomialToPoles): StandardBoolean {.noSideEffect,
