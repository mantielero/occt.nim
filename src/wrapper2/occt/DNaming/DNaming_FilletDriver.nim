...
proc mustExecute*(this: DNamingFilletDriver; theLog: Handle[TFunctionLogbook]): StandardBoolean {.
    noSideEffect, importcpp: "MustExecute", header: "DNaming_FilletDriver.hxx".}
proc execute*(this: DNamingFilletDriver; theLog: var Handle[TFunctionLogbook]): StandardInteger {.
