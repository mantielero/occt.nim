...
proc mustExecute*(this: DNamingLine3DDriver; theLog: Handle[TFunctionLogbook]): StandardBoolean {.
    noSideEffect, importcpp: "MustExecute", header: "DNaming_Line3DDriver.hxx".}
proc execute*(this: DNamingLine3DDriver; theLog: var Handle[TFunctionLogbook]): StandardInteger {.
