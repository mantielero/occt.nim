...
proc mustExecute*(this: DNamingPrismDriver; theLog: Handle[TFunctionLogbook]): StandardBoolean {.
    noSideEffect, importcpp: "MustExecute", header: "DNaming_PrismDriver.hxx".}
proc execute*(this: DNamingPrismDriver; theLog: var Handle[TFunctionLogbook]): StandardInteger {.
