...
proc constructDrawMarker3D*(p: GpPnt; t: DrawMarkerShape; c: DrawColor;
                           iSize: StandardInteger = 5): DrawMarker3D {.constructor,
    importcpp: "Draw_Marker3D(@)", header: "Draw_Marker3D.hxx".}
proc constructDrawMarker3D*(p: GpPnt; t: DrawMarkerShape; c: DrawColor;
                           rSize: StandardReal): DrawMarker3D {.constructor,
    importcpp: "Draw_Marker3D(@)", header: "Draw_Marker3D.hxx".}
proc changePos*(this: var DrawMarker3D): var GpPnt {.importcpp: "ChangePos",
...
proc pickReject*(this: DrawMarker3D; x: StandardReal; y: StandardReal;
