...
proc constructDrawText2D*(p: GpPnt2d; t: StandardCString; col: DrawColor): DrawText2D {.
    constructor, importcpp: "Draw_Text2D(@)", header: "Draw_Text2D.hxx".}
proc constructDrawText2D*(p: GpPnt2d; t: StandardCString; col: DrawColor;
                         moveX: StandardInteger; moveY: StandardInteger): DrawText2D {.
    constructor, importcpp: "Draw_Text2D(@)", header: "Draw_Text2D.hxx".}
proc setPnt2d*(this: var DrawText2D; p: GpPnt2d) {.importcpp: "SetPnt2d",
