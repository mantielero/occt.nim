...
proc constructDrawTrSurfBezierSurface*(s: Handle[GeomBezierSurface];
                                      ...
                                      drawMode: StandardInteger): DrawTrSurfBezierSurface {.
    constructor, importcpp: "DrawTrSurf_BezierSurface(@)",
    header: "DrawTrSurf_BezierSurface.hxx".}
...
proc clearPoles*(this: var DrawTrSurfBezierSurface) {.importcpp: "ClearPoles",
    header: "DrawTrSurf_BezierSurface.hxx".}
proc findPole*(this: DrawTrSurfBezierSurface; x: StandardReal; y: StandardReal;
