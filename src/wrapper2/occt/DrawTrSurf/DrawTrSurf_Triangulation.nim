...
proc triangulation*(this: DrawTrSurfTriangulation): Handle[PolyTriangulation] {.
    ...
    header: "DrawTrSurf_Triangulation.hxx".}
proc showNodes*(this: var DrawTrSurfTriangulation; b: StandardBoolean) {.
    importcpp: "ShowNodes", header: "DrawTrSurf_Triangulation.hxx".}
proc showNodes*(this: DrawTrSurfTriangulation): StandardBoolean {.noSideEffect,
    importcpp: "ShowNodes", header: "DrawTrSurf_Triangulation.hxx".}
proc showTriangles*(this: var DrawTrSurfTriangulation; b: StandardBoolean) {.
    importcpp: "ShowTriangles", header: "DrawTrSurf_Triangulation.hxx".}
proc showTriangles*(this: DrawTrSurfTriangulation): StandardBoolean {.noSideEffect,
    importcpp: "ShowTriangles", header: "DrawTrSurf_Triangulation.hxx".}
