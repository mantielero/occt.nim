...
proc add*(aPresentation: Handle[Prs3dPresentation]; aDrawer: Handle[Prs3dDrawer];
         thevalue: StandardReal; aText: TCollectionExtendedString; aPosition: GpPnt;
         aNormalDir: GpDir; aBasePnt: GpPnt; aFirstPoint: GpPnt; aSecondPoint: GpPnt;
         aCenter: GpPnt; arrowPrs: DsgPrsArrowSide; drawRevers: StandardBoolean;
         drawPosition: var GpPnt; endOfArrow: var GpPnt;
         trimCurve: var Handle[GeomTrimmedCurve]; hasCircle: var StandardBoolean) {.
