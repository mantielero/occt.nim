...
proc add*(aPresentation: Handle[Prs3dPresentation]; aDrawer: Handle[Prs3dDrawer];
         ...
         firstparam: StandardReal; lastparam: StandardReal;
         drawFromCenter: StandardBoolean = standardTrue;
         reverseArrow: StandardBoolean = standardFalse) {.
    importcpp: "DsgPrs_RadiusPresentation::Add(@)",
    header: "DsgPrs_RadiusPresentation.hxx".}
proc add*(aPresentation: Handle[Prs3dPresentation]; aDrawer: Handle[Prs3dDrawer];
         aText: TCollectionExtendedString; attachmentPoint: GpPnt; aCircle: GpCirc;
         firstparam: StandardReal; lastparam: StandardReal;
         arrowSide: DsgPrsArrowSide;
         drawFromCenter: StandardBoolean = standardTrue;
         reverseArrow: StandardBoolean = standardFalse) {.
    importcpp: "DsgPrs_RadiusPresentation::Add(@)",
    header: "DsgPrs_RadiusPresentation.hxx".}
proc add*(aPresentation: Handle[Prs3dPresentation]; aDrawer: Handle[Prs3dDrawer];
         aText: TCollectionExtendedString; attachmentPoint: GpPnt; center: GpPnt;
         endOfArrow: GpPnt; arrowSide: DsgPrsArrowSide;
         drawFromCenter: StandardBoolean = standardTrue;
         reverseArrow: StandardBoolean = standardFalse) {.
    importcpp: "DsgPrs_RadiusPresentation::Add(@)",
    header: "DsgPrs_RadiusPresentation.hxx".}
