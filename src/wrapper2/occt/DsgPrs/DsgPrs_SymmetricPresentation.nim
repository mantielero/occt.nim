...
proc add*(aPresentation: Handle[Prs3dPresentation]; aDrawer: Handle[Prs3dDrawer];
         attachmentPoint1: GpPnt; attachmentPoint2: GpPnt; aDirection1: GpDir;
         aAxis: GpLin; offsetPoint: GpPnt) {.
    importcpp: "DsgPrs_SymmetricPresentation::Add(@)",
    header: "DsgPrs_SymmetricPresentation.hxx".}
proc add*(aPresentation: Handle[Prs3dPresentation]; aDrawer: Handle[Prs3dDrawer];
         attachmentPoint1: GpPnt; attachmentPoint2: GpPnt; aCircle1: GpCirc;
         aAxis: GpLin; offsetPoint: GpPnt) {.
    importcpp: "DsgPrs_SymmetricPresentation::Add(@)",
    header: "DsgPrs_SymmetricPresentation.hxx".}
proc add*(aPresentation: Handle[Prs3dPresentation]; aDrawer: Handle[Prs3dDrawer];
         attachmentPoint1: GpPnt; attachmentPoint2: GpPnt; aAxis: GpLin;
         offsetPoint: GpPnt) {.importcpp: "DsgPrs_SymmetricPresentation::Add(@)",
                             header: "DsgPrs_SymmetricPresentation.hxx".}
