...
proc isIdentical*(this: ExprDifference; other: Handle[ExprGeneralExpression]): StandardBoolean {.
    noSideEffect, importcpp: "IsIdentical", header: "Expr_Difference.hxx".}
proc isLinear*(this: ExprDifference): StandardBoolean {.noSideEffect,
...
proc nDerivative*(this: ExprDifference; x: Handle[ExprNamedUnknown];
                 n: StandardInteger): Handle[ExprGeneralExpression] {.noSideEffect,
    importcpp: "NDerivative", header: "Expr_Difference.hxx".}
