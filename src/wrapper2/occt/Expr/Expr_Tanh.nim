...
discard "forward decl of Expr_Tanh"
type
  HandleExprTanh* = Handle[ExprTanh]
...
proc isIdentical*(this: ExprTanh; other: Handle[ExprGeneralExpression]): StandardBoolean {.
    noSideEffect, importcpp: "IsIdentical", header: "Expr_Tanh.hxx".}
proc isLinear*(this: ExprTanh): StandardBoolean {.noSideEffect,
