...
proc constructExtremaCCLocFOfLocECC2d*(thetol: StandardReal = 1.0e-10): ExtremaCCLocFOfLocECC2d {.
...
proc constructExtremaCCLocFOfLocECC2d*(c1: Adaptor2dCurve2d; c2: Adaptor2dCurve2d;
                                      thetol: StandardReal = 1.0e-10): ExtremaCCLocFOfLocECC2d {.
    constructor, importcpp: "Extrema_CCLocFOfLocECC2d(@)",
    header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc setCurve*(this: var ExtremaCCLocFOfLocECC2d; theRank: StandardInteger;
              c1: Adaptor2dCurve2d) {.importcpp: "SetCurve",
                                    header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc setTolerance*(this: var ExtremaCCLocFOfLocECC2d; theTol: StandardReal) {.
    importcpp: "SetTolerance", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc nbVariables*(this: ExtremaCCLocFOfLocECC2d): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc nbEquations*(this: ExtremaCCLocFOfLocECC2d): StandardInteger {.noSideEffect,
    importcpp: "NbEquations", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc value*(this: var ExtremaCCLocFOfLocECC2d; uv: MathVector; f: var MathVector): StandardBoolean {.
    importcpp: "Value", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc derivatives*(this: var ExtremaCCLocFOfLocECC2d; uv: MathVector;
                 df: var MathMatrix): StandardBoolean {.importcpp: "Derivatives",
    header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc values*(this: var ExtremaCCLocFOfLocECC2d; uv: MathVector; f: var MathVector;
    ...
    header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc getStateNumber*(this: var ExtremaCCLocFOfLocECC2d): StandardInteger {.
    importcpp: "GetStateNumber", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc nbExt*(this: ExtremaCCLocFOfLocECC2d): StandardInteger {.noSideEffect,
    importcpp: "NbExt", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc squareDistance*(this: ExtremaCCLocFOfLocECC2d; n: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "SquareDistance",
    header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc points*(this: ExtremaCCLocFOfLocECC2d; n: StandardInteger;
            p1: var ExtremaPOnCurv2d; p2: var ExtremaPOnCurv2d) {.noSideEffect,
    importcpp: "Points", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc curvePtr*(this: ExtremaCCLocFOfLocECC2d; theRank: StandardInteger): StandardAddress {.
    noSideEffect, importcpp: "CurvePtr", header: "Extrema_CCLocFOfLocECC2d.hxx".}
proc tolerance*(this: ExtremaCCLocFOfLocECC2d): StandardReal {.noSideEffect,
...
proc searchOfTolerance*(this: var ExtremaCCLocFOfLocECC2d; c: StandardAddress): StandardReal {.
