...
proc constructExtremaECC*(c1: Adaptor3dCurve; c2: Adaptor3dCurve; uinf: StandardReal;
                         usup: StandardReal; vinf: StandardReal; vsup: StandardReal): ExtremaECC {.
    constructor, importcpp: "Extrema_ECC(@)", header: "Extrema_ECC.hxx".}
proc setParams*(this: var ExtremaECC; c1: Adaptor3dCurve; c2: Adaptor3dCurve;
               uinf: StandardReal; usup: StandardReal; vinf: StandardReal;
               vsup: StandardReal) {.importcpp: "SetParams",
                                   header: "Extrema_ECC.hxx".}
proc setTolerance*(this: var ExtremaECC; tol: StandardReal) {.
    importcpp: "SetTolerance", header: "Extrema_ECC.hxx".}
proc setSingleSolutionFlag*(this: var ExtremaECC;
                           theSingleSolutionFlag: StandardBoolean) {.
    importcpp: "SetSingleSolutionFlag", header: "Extrema_ECC.hxx".}
proc getSingleSolutionFlag*(this: ExtremaECC): StandardBoolean {.noSideEffect,
...
proc isDone*(this: ExtremaECC): StandardBoolean {.noSideEffect, importcpp: "IsDone",
    header: "Extrema_ECC.hxx".}
proc isParallel*(this: ExtremaECC): StandardBoolean {.noSideEffect,
    importcpp: "IsParallel", header: "Extrema_ECC.hxx".}
proc nbExt*(this: ExtremaECC): StandardInteger {.noSideEffect, importcpp: "NbExt",
    header: "Extrema_ECC.hxx".}
proc squareDistance*(this: ExtremaECC; n: StandardInteger = 1): StandardReal {.
    noSideEffect, importcpp: "SquareDistance", header: "Extrema_ECC.hxx".}
proc points*(this: ExtremaECC; n: StandardInteger; p1: var ExtremaPOnCurv;
