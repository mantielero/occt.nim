...
proc constructExtremaGlobOptFuncCCC0*(c1: Adaptor2dCurve2d; c2: Adaptor2dCurve2d): ExtremaGlobOptFuncCCC0 {.
    constructor, importcpp: "Extrema_GlobOptFuncCCC0(@)",
    header: "Extrema_GlobOptFuncCC.hxx".}
proc nbVariables*(this: ExtremaGlobOptFuncCCC0): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "Extrema_GlobOptFuncCC.hxx".}
proc value*(this: var ExtremaGlobOptFuncCCC0; x: MathVector; f: var StandardReal): StandardBoolean {.
...
proc constructExtremaGlobOptFuncCCC1*(c1: Adaptor2dCurve2d; c2: Adaptor2dCurve2d): ExtremaGlobOptFuncCCC1 {.
    constructor, importcpp: "Extrema_GlobOptFuncCCC1(@)",
    header: "Extrema_GlobOptFuncCC.hxx".}
proc nbVariables*(this: ExtremaGlobOptFuncCCC1): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "Extrema_GlobOptFuncCC.hxx".}
proc value*(this: var ExtremaGlobOptFuncCCC1; x: MathVector; f: var StandardReal): StandardBoolean {.
    importcpp: "Value", header: "Extrema_GlobOptFuncCC.hxx".}
proc gradient*(this: var ExtremaGlobOptFuncCCC1; x: MathVector; g: var MathVector): StandardBoolean {.
    importcpp: "Gradient", header: "Extrema_GlobOptFuncCC.hxx".}
proc values*(this: var ExtremaGlobOptFuncCCC1; x: MathVector; f: var StandardReal;
...
proc constructExtremaGlobOptFuncCCC2*(c1: Adaptor2dCurve2d; c2: Adaptor2dCurve2d): ExtremaGlobOptFuncCCC2 {.
    constructor, importcpp: "Extrema_GlobOptFuncCCC2(@)",
    header: "Extrema_GlobOptFuncCC.hxx".}
proc nbVariables*(this: ExtremaGlobOptFuncCCC2): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "Extrema_GlobOptFuncCC.hxx".}
proc value*(this: var ExtremaGlobOptFuncCCC2; x: MathVector; f: var StandardReal): StandardBoolean {.
    importcpp: "Value", header: "Extrema_GlobOptFuncCC.hxx".}
proc gradient*(this: var ExtremaGlobOptFuncCCC2; x: MathVector; g: var MathVector): StandardBoolean {.
    importcpp: "Gradient", header: "Extrema_GlobOptFuncCC.hxx".}
proc values*(this: var ExtremaGlobOptFuncCCC2; x: MathVector; f: var StandardReal;
            g: var MathVector): StandardBoolean {.importcpp: "Values",
    header: "Extrema_GlobOptFuncCC.hxx".}
proc values*(this: var ExtremaGlobOptFuncCCC2; x: MathVector; f: var StandardReal;
            g: var MathVector; h: var MathMatrix): StandardBoolean {.
