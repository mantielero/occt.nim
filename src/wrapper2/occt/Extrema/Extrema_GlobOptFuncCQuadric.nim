...
proc constructExtremaGlobOptFuncCQuadric*(c: ptr Adaptor3dCurve;
    theTf: StandardReal; theTl: StandardReal): ExtremaGlobOptFuncCQuadric {.
    constructor, importcpp: "Extrema_GlobOptFuncCQuadric(@)",
    header: "Extrema_GlobOptFuncCQuadric.hxx".}
proc constructExtremaGlobOptFuncCQuadric*(c: ptr Adaptor3dCurve;
...
proc loadQuad*(this: var ExtremaGlobOptFuncCQuadric; s: ptr Adaptor3dSurface;
              theUf: StandardReal; theUl: StandardReal; theVf: StandardReal;
              theVl: StandardReal) {.importcpp: "LoadQuad",
                                   header: "Extrema_GlobOptFuncCQuadric.hxx".}
proc nbVariables*(this: ExtremaGlobOptFuncCQuadric): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "Extrema_GlobOptFuncCQuadric.hxx".}
proc value*(this: var ExtremaGlobOptFuncCQuadric; theX: MathVector;
