...
proc constructExtremaLocateExtPC*(p: GpPnt; c: Adaptor3dCurve; u0: StandardReal;
                                 tolF: StandardReal): ExtremaLocateExtPC {.
...
proc constructExtremaLocateExtPC*(p: GpPnt; c: Adaptor3dCurve; u0: StandardReal;
    ...
    constructor, importcpp: "Extrema_LocateExtPC(@)",
    header: "Extrema_LocateExtPC.hxx".}
proc initialize*(this: var ExtremaLocateExtPC; c: Adaptor3dCurve; umin: StandardReal;
                usup: StandardReal; tolF: StandardReal) {.importcpp: "Initialize",
    header: "Extrema_LocateExtPC.hxx".}
proc perform*(this: var ExtremaLocateExtPC; p: GpPnt; u0: StandardReal) {.
    importcpp: "Perform", header: "Extrema_LocateExtPC.hxx".}
proc isDone*(this: ExtremaLocateExtPC): StandardBoolean {.noSideEffect,
    importcpp: "IsDone", header: "Extrema_LocateExtPC.hxx".}
proc squareDistance*(this: ExtremaLocateExtPC): StandardReal {.noSideEffect,
    importcpp: "SquareDistance", header: "Extrema_LocateExtPC.hxx".}
proc isMin*(this: ExtremaLocateExtPC): StandardBoolean {.noSideEffect,
