...
proc constructExtremaPOnCurv*(u: StandardReal; p: GpPnt): ExtremaPOnCurv {.
    constructor, importcpp: "Extrema_POnCurv(@)", header: "Extrema_POnCurv.hxx".}
proc setValues*(this: var ExtremaPOnCurv; u: StandardReal; p: GpPnt) {.
    importcpp: "SetValues", header: "Extrema_POnCurv.hxx".}
proc value*(this: ExtremaPOnCurv): GpPnt {.noSideEffect, importcpp: "Value",
                                       header: "Extrema_POnCurv.hxx".}
proc parameter*(this: ExtremaPOnCurv): StandardReal {.noSideEffect,
