...
proc constructExtremaPOnSurf*(u: StandardReal; v: StandardReal; p: GpPnt): ExtremaPOnSurf {.
    constructor, importcpp: "Extrema_POnSurf(@)", header: "Extrema_POnSurf.hxx".}
proc value*(this: ExtremaPOnSurf): GpPnt {.noSideEffect, importcpp: "Value",
                                       header: "Extrema_POnSurf.hxx".}
proc setParameters*(this: var ExtremaPOnSurf; theU: StandardReal; theV: StandardReal;
                   thePnt: GpPnt) {.importcpp: "SetParameters",
                                  header: "Extrema_POnSurf.hxx".}
proc parameter*(this: ExtremaPOnSurf; u: var StandardReal; v: var StandardReal) {.
