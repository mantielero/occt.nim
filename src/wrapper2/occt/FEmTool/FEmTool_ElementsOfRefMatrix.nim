...
proc constructFEmToolElementsOfRefMatrix*(theBase: Handle[PLibBase];
    derOrder: StandardInteger): FEmToolElementsOfRefMatrix {.constructor,
    importcpp: "FEmTool_ElementsOfRefMatrix(@)",
    header: "FEmTool_ElementsOfRefMatrix.hxx".}
proc nbVariables*(this: FEmToolElementsOfRefMatrix): StandardInteger {.noSideEffect,
    importcpp: "NbVariables", header: "FEmTool_ElementsOfRefMatrix.hxx".}
proc nbEquations*(this: FEmToolElementsOfRefMatrix): StandardInteger {.noSideEffect,
    importcpp: "NbEquations", header: "FEmTool_ElementsOfRefMatrix.hxx".}
proc value*(this: var FEmToolElementsOfRefMatrix; x: MathVector; f: var MathVector): StandardBoolean {.
