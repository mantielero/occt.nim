...
proc writePersistentObjectHeader*(this: var FSD_CmpFile; aRef: StandardInteger;
...
proc readPersistentObjectHeader*(this: var FSD_CmpFile; aRef: var StandardInteger;
