...
proc isEnd*(this: var FSD_File): StandardBoolean {.importcpp: "IsEnd",
    header: "FSD_File.hxx".}
...
proc writeInfo*(this: var FSD_File; nbObj: StandardInteger;
...
proc readInfo*(this: var FSD_File; nbObj: var StandardInteger;
...
proc setTypeSectionSize*(this: var FSD_File; aSize: StandardInteger) {.
    importcpp: "SetTypeSectionSize", header: "FSD_File.hxx".}
proc writeTypeInformations*(this: var FSD_File; typeNum: StandardInteger;
...
proc typeSectionSize*(this: var FSD_File): StandardInteger {.
    importcpp: "TypeSectionSize", header: "FSD_File.hxx".}
proc readTypeInformations*(this: var FSD_File; typeNum: var StandardInteger;
...
proc setRootSectionSize*(this: var FSD_File; aSize: StandardInteger) {.
    importcpp: "SetRootSectionSize", header: "FSD_File.hxx".}
proc writeRoot*(this: var FSD_File; rootName: TCollectionAsciiString;
...
proc rootSectionSize*(this: var FSD_File): StandardInteger {.
...
proc setRefSectionSize*(this: var FSD_File; aSize: StandardInteger) {.
    importcpp: "SetRefSectionSize", header: "FSD_File.hxx".}
proc writeReferenceType*(this: var FSD_File; reference: StandardInteger;
...
proc refSectionSize*(this: var FSD_File): StandardInteger {.
    importcpp: "RefSectionSize", header: "FSD_File.hxx".}
proc readReferenceType*(this: var FSD_File; reference: var StandardInteger;
...
proc writePersistentObjectHeader*(this: var FSD_File; aRef: StandardInteger;
...
proc readPersistentObjectHeader*(this: var FSD_File; aRef: var StandardInteger;
...
proc putReference*(this: var FSD_File; aValue: StandardInteger): var StorageBaseDriver {.
...
proc putInteger*(this: var FSD_File; aValue: StandardInteger): var StorageBaseDriver {.
    importcpp: "PutInteger", header: "FSD_File.hxx".}
proc putBoolean*(this: var FSD_File; aValue: StandardBoolean): var StorageBaseDriver {.
    importcpp: "PutBoolean", header: "FSD_File.hxx".}
proc putReal*(this: var FSD_File; aValue: StandardReal): var StorageBaseDriver {.
...
proc getReference*(this: var FSD_File; aValue: var StandardInteger): var StorageBaseDriver {.
...
proc getInteger*(this: var FSD_File; aValue: var StandardInteger): var StorageBaseDriver {.
    importcpp: "GetInteger", header: "FSD_File.hxx".}
proc getBoolean*(this: var FSD_File; aValue: var StandardBoolean): var StorageBaseDriver {.
    importcpp: "GetBoolean", header: "FSD_File.hxx".}
proc getReal*(this: var FSD_File; aValue: var StandardReal): var StorageBaseDriver {.
