...
proc constructFairCurveEnergyOfBatten*(bSplOrder: StandardInteger;
                                      ...
                                      lengthSliding: StandardReal; freeSliding: StandardBoolean = standardTrue;
                                      angle1: StandardReal = 0;
                                      angle2: StandardReal = 0): FairCurveEnergyOfBatten {.
    constructor, importcpp: "FairCurve_EnergyOfBatten(@)",
    header: "FairCurve_EnergyOfBatten.hxx".}
proc lengthSliding*(this: FairCurveEnergyOfBatten): StandardReal {.noSideEffect,
...
proc variable*(this: FairCurveEnergyOfBatten; x: var MathVector): StandardBoolean {.
