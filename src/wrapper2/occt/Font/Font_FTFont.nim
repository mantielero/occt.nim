...
proc init*(this: var FontFTFont; theFontPath: TCollectionAsciiString;
          theParams: FontFTFontParams; theFaceId: StandardInteger = 0): bool {.
...
proc init*(this: var FontFTFont; theData: Handle[NCollectionBuffer];
          ...
          theFaceId: StandardInteger = 0): bool {.importcpp: "Init",
    header: "Font_FTFont.hxx".}
...
proc toUseUnicodeSubsetFallback*(this: FontFTFont): StandardBoolean {.noSideEffect,
    importcpp: "ToUseUnicodeSubsetFallback", header: "Font_FTFont.hxx".}
proc setUseUnicodeSubsetFallback*(this: var FontFTFont;
                                 theToFallback: StandardBoolean) {.
...
proc advanceY*(this: var FontFTFont; theUChar: StandardUtf32Char;
    ...
    header: "Font_FTFont.hxx".}
proc glyphsNumber*(this: FontFTFont; theToIncludeFallback: bool = false): StandardInteger {.
