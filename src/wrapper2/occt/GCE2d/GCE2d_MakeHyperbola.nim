...
proc constructGCE2dMakeHyperbola*(h: GpHypr2d): GCE2dMakeHyperbola {.constructor,
    importcpp: "GCE2d_MakeHyperbola(@)", header: "GCE2d_MakeHyperbola.hxx".}
proc constructGCE2dMakeHyperbola*(majorAxis: GpAx2d; majorRadius: StandardReal;
                                 minorRadius: StandardReal; sense: StandardBoolean): GCE2dMakeHyperbola {.
    constructor, importcpp: "GCE2d_MakeHyperbola(@)",
    header: "GCE2d_MakeHyperbola.hxx".}
proc constructGCE2dMakeHyperbola*(axis: GpAx22d; majorRadius: StandardReal;
                                 minorRadius: StandardReal): GCE2dMakeHyperbola {.
    constructor, importcpp: "GCE2d_MakeHyperbola(@)",
    header: "GCE2d_MakeHyperbola.hxx".}
proc constructGCE2dMakeHyperbola*(s1: GpPnt2d; s2: GpPnt2d; center: GpPnt2d): GCE2dMakeHyperbola {.
    constructor, importcpp: "GCE2d_MakeHyperbola(@)",
    header: "GCE2d_MakeHyperbola.hxx".}
