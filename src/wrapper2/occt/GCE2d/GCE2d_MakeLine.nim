...
proc constructGCE2dMakeLine*(a: GpAx2d): GCE2dMakeLine {.constructor,
    importcpp: "GCE2d_MakeLine(@)", header: "GCE2d_MakeLine.hxx".}
proc constructGCE2dMakeLine*(L: GpLin2d): GCE2dMakeLine {.constructor,
    importcpp: "GCE2d_MakeLine(@)", header: "GCE2d_MakeLine.hxx".}
proc constructGCE2dMakeLine*(p: GpPnt2d; v: GpDir2d): GCE2dMakeLine {.constructor,
    importcpp: "GCE2d_MakeLine(@)", header: "GCE2d_MakeLine.hxx".}
proc constructGCE2dMakeLine*(lin: GpLin2d; point: GpPnt2d): GCE2dMakeLine {.
    constructor, importcpp: "GCE2d_MakeLine(@)", header: "GCE2d_MakeLine.hxx".}
proc constructGCE2dMakeLine*(lin: GpLin2d; dist: StandardReal): GCE2dMakeLine {.
    constructor, importcpp: "GCE2d_MakeLine(@)", header: "GCE2d_MakeLine.hxx".}
proc constructGCE2dMakeLine*(p1: GpPnt2d; p2: GpPnt2d): GCE2dMakeLine {.constructor,
    importcpp: "GCE2d_MakeLine(@)", header: "GCE2d_MakeLine.hxx".}
