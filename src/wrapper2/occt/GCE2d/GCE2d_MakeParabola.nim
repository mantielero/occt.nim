...
proc constructGCE2dMakeParabola*(prb: GpParab2d): GCE2dMakeParabola {.constructor,
    importcpp: "GCE2d_MakeParabola(@)", header: "GCE2d_MakeParabola.hxx".}
proc constructGCE2dMakeParabola*(axis: GpAx22d; focal: StandardReal): GCE2dMakeParabola {.
    constructor, importcpp: "GCE2d_MakeParabola(@)",
    header: "GCE2d_MakeParabola.hxx".}
proc constructGCE2dMakeParabola*(mirrorAxis: GpAx2d; focal: StandardReal;
                                sense: StandardBoolean): GCE2dMakeParabola {.
    constructor, importcpp: "GCE2d_MakeParabola(@)",
    header: "GCE2d_MakeParabola.hxx".}
proc constructGCE2dMakeParabola*(d: GpAx2d; f: GpPnt2d;
                                sense: StandardBoolean = standardTrue): GCE2dMakeParabola {.
    constructor, importcpp: "GCE2d_MakeParabola(@)",
    header: "GCE2d_MakeParabola.hxx".}
proc constructGCE2dMakeParabola*(s1: GpPnt2d; o: GpPnt2d): GCE2dMakeParabola {.
    constructor, importcpp: "GCE2d_MakeParabola(@)",
    header: "GCE2d_MakeParabola.hxx".}
