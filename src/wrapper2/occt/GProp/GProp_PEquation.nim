...
proc constructGPropPEquation*(pnts: TColgpArray1OfPnt; tol: StandardReal): GPropPEquation {.
    constructor, importcpp: "GProp_PEquation(@)", header: "GProp_PEquation.hxx".}
proc isPlanar*(this: GPropPEquation): StandardBoolean {.noSideEffect,
    importcpp: "IsPlanar", header: "GProp_PEquation.hxx".}
proc isLinear*(this: GPropPEquation): StandardBoolean {.noSideEffect,
    importcpp: "IsLinear", header: "GProp_PEquation.hxx".}
proc isPoint*(this: GPropPEquation): StandardBoolean {.noSideEffect,
    importcpp: "IsPoint", header: "GProp_PEquation.hxx".}
proc isSpace*(this: GPropPEquation): StandardBoolean {.noSideEffect,
    importcpp: "IsSpace", header: "GProp_PEquation.hxx".}
proc plane*(this: GPropPEquation): GpPln {.noSideEffect, importcpp: "Plane",
                                       header: "GProp_PEquation.hxx".}
proc line*(this: GPropPEquation): GpLin {.noSideEffect, importcpp: "Line",
                                      header: "GProp_PEquation.hxx".}
proc point*(this: GPropPEquation): GpPnt {.noSideEffect, importcpp: "Point",
                                       header: "GProp_PEquation.hxx".}
proc box*(this: GPropPEquation; p: var GpPnt; v1: var GpVec; v2: var GpVec; v3: var GpVec) {.
