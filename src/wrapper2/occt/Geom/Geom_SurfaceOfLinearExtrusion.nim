...
proc constructGeomSurfaceOfLinearExtrusion*(c: Handle[GeomCurve]; v: GpDir): GeomSurfaceOfLinearExtrusion {.
    constructor, importcpp: "Geom_SurfaceOfLinearExtrusion(@)",
    header: "Geom_SurfaceOfLinearExtrusion.hxx".}
proc setDirection*(this: var GeomSurfaceOfLinearExtrusion; v: GpDir) {.
...
proc isCNu*(this: GeomSurfaceOfLinearExtrusion; n: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsCNu", header: "Geom_SurfaceOfLinearExtrusion.hxx".}
proc isCNv*(this: GeomSurfaceOfLinearExtrusion; n: StandardInteger): StandardBoolean {.
...
proc d3*(this: GeomSurfaceOfLinearExtrusion; u: StandardReal; v: StandardReal;
    ...
    noSideEffect, importcpp: "D3", header: "Geom_SurfaceOfLinearExtrusion.hxx".}
proc dn*(this: GeomSurfaceOfLinearExtrusion; u: StandardReal; v: StandardReal;
        nu: StandardInteger; nv: StandardInteger): GpVec {.noSideEffect,
    importcpp: "DN", header: "Geom_SurfaceOfLinearExtrusion.hxx".}
proc transform*(this: var GeomSurfaceOfLinearExtrusion; t: GpTrsf) {.
...
proc parametricTransformation*(this: GeomSurfaceOfLinearExtrusion; t: GpTrsf): GpGTrsf2d {.
