...
proc constructGeomSurfaceOfRevolution*(c: Handle[GeomCurve]; a1: GpAx1): GeomSurfaceOfRevolution {.
    constructor, importcpp: "Geom_SurfaceOfRevolution(@)",
    header: "Geom_SurfaceOfRevolution.hxx".}
proc setAxis*(this: var GeomSurfaceOfRevolution; a1: GpAx1) {.importcpp: "SetAxis",
    header: "Geom_SurfaceOfRevolution.hxx".}
proc setDirection*(this: var GeomSurfaceOfRevolution; v: GpDir) {.
...
proc setLocation*(this: var GeomSurfaceOfRevolution; p: GpPnt) {.
    importcpp: "SetLocation", header: "Geom_SurfaceOfRevolution.hxx".}
proc axis*(this: GeomSurfaceOfRevolution): GpAx1 {.noSideEffect, importcpp: "Axis",
    header: "Geom_SurfaceOfRevolution.hxx".}
proc location*(this: GeomSurfaceOfRevolution): GpPnt {.noSideEffect,
    importcpp: "Location", header: "Geom_SurfaceOfRevolution.hxx".}
proc referencePlane*(this: GeomSurfaceOfRevolution): GpAx2 {.noSideEffect,
...
proc parametricTransformation*(this: GeomSurfaceOfRevolution; t: GpTrsf): GpGTrsf2d {.
...
proc isCNu*(this: GeomSurfaceOfRevolution; n: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsCNu", header: "Geom_SurfaceOfRevolution.hxx".}
proc isCNv*(this: GeomSurfaceOfRevolution; n: StandardInteger): StandardBoolean {.
...
proc d0*(this: GeomSurfaceOfRevolution; u: StandardReal; v: StandardReal; p: var GpPnt) {.
    noSideEffect, importcpp: "D0", header: "Geom_SurfaceOfRevolution.hxx".}
proc d1*(this: GeomSurfaceOfRevolution; u: StandardReal; v: StandardReal; p: var GpPnt;
        d1u: var GpVec; d1v: var GpVec) {.noSideEffect, importcpp: "D1",
                                    header: "Geom_SurfaceOfRevolution.hxx".}
proc d2*(this: GeomSurfaceOfRevolution; u: StandardReal; v: StandardReal; p: var GpPnt;
        d1u: var GpVec; d1v: var GpVec; d2u: var GpVec; d2v: var GpVec; d2uv: var GpVec) {.
    noSideEffect, importcpp: "D2", header: "Geom_SurfaceOfRevolution.hxx".}
proc d3*(this: GeomSurfaceOfRevolution; u: StandardReal; v: StandardReal; p: var GpPnt;
        d1u: var GpVec; d1v: var GpVec; d2u: var GpVec; d2v: var GpVec; d2uv: var GpVec;
        d3u: var GpVec; d3v: var GpVec; d3uuv: var GpVec; d3uvv: var GpVec) {.noSideEffect,
    importcpp: "D3", header: "Geom_SurfaceOfRevolution.hxx".}
proc dn*(this: GeomSurfaceOfRevolution; u: StandardReal; v: StandardReal;
        nu: StandardInteger; nv: StandardInteger): GpVec {.noSideEffect,
    importcpp: "DN", header: "Geom_SurfaceOfRevolution.hxx".}
proc transform*(this: var GeomSurfaceOfRevolution; t: GpTrsf) {.
