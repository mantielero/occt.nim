...
proc constructGeomTrimmedCurve*(c: Handle[GeomCurve]; u1: StandardReal;
    ...
    theAdjustPeriodic: StandardBoolean = standardTrue): GeomTrimmedCurve {.
...
proc isCN*(this: GeomTrimmedCurve; n: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsCN", header: "Geom_TrimmedCurve.hxx".}
proc endPoint*(this: GeomTrimmedCurve): GpPnt {.noSideEffect, importcpp: "EndPoint",
    header: "Geom_TrimmedCurve.hxx".}
...
proc startPoint*(this: GeomTrimmedCurve): GpPnt {.noSideEffect,
    importcpp: "StartPoint", header: "Geom_TrimmedCurve.hxx".}
proc d0*(this: GeomTrimmedCurve; u: StandardReal; p: var GpPnt) {.noSideEffect,
    importcpp: "D0", header: "Geom_TrimmedCurve.hxx".}
proc d1*(this: GeomTrimmedCurve; u: StandardReal; p: var GpPnt; v1: var GpVec) {.
    noSideEffect, importcpp: "D1", header: "Geom_TrimmedCurve.hxx".}
proc d2*(this: GeomTrimmedCurve; u: StandardReal; p: var GpPnt; v1: var GpVec;
        v2: var GpVec) {.noSideEffect, importcpp: "D2",
                      header: "Geom_TrimmedCurve.hxx".}
proc d3*(this: GeomTrimmedCurve; u: StandardReal; p: var GpPnt; v1: var GpVec;
        v2: var GpVec; v3: var GpVec) {.noSideEffect, importcpp: "D3",
                                  header: "Geom_TrimmedCurve.hxx".}
proc dn*(this: GeomTrimmedCurve; u: StandardReal; n: StandardInteger): GpVec {.
    noSideEffect, importcpp: "DN", header: "Geom_TrimmedCurve.hxx".}
proc transform*(this: var GeomTrimmedCurve; t: GpTrsf) {.importcpp: "Transform",
    header: "Geom_TrimmedCurve.hxx".}
proc transformedParameter*(this: GeomTrimmedCurve; u: StandardReal; t: GpTrsf): StandardReal {.
    noSideEffect, importcpp: "TransformedParameter",
    header: "Geom_TrimmedCurve.hxx".}
proc parametricTransformation*(this: GeomTrimmedCurve; t: GpTrsf): StandardReal {.
