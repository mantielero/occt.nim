...
proc constructGeom2dAxisPlacement*(a: GpAx2d): Geom2dAxisPlacement {.constructor,
    importcpp: "Geom2d_AxisPlacement(@)", header: "Geom2d_AxisPlacement.hxx".}
proc constructGeom2dAxisPlacement*(p: GpPnt2d; v: GpDir2d): Geom2dAxisPlacement {.
...
proc setAxis*(this: var Geom2dAxisPlacement; a: GpAx2d) {.importcpp: "SetAxis",
    header: "Geom2d_AxisPlacement.hxx".}
proc setDirection*(this: var Geom2dAxisPlacement; v: GpDir2d) {.
    importcpp: "SetDirection", header: "Geom2d_AxisPlacement.hxx".}
proc setLocation*(this: var Geom2dAxisPlacement; p: GpPnt2d) {.
...
proc ax2d*(this: Geom2dAxisPlacement): GpAx2d {.noSideEffect, importcpp: "Ax2d",
    header: "Geom2d_AxisPlacement.hxx".}
proc direction*(this: Geom2dAxisPlacement): GpDir2d {.noSideEffect,
    importcpp: "Direction", header: "Geom2d_AxisPlacement.hxx".}
proc location*(this: Geom2dAxisPlacement): GpPnt2d {.noSideEffect,
    importcpp: "Location", header: "Geom2d_AxisPlacement.hxx".}
proc transform*(this: var Geom2dAxisPlacement; t: GpTrsf2d) {.importcpp: "Transform",
    header: "Geom2d_AxisPlacement.hxx".}
