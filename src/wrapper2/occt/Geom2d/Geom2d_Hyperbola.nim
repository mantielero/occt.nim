...
proc constructGeom2dHyperbola*(h: GpHypr2d): Geom2dHyperbola {.constructor,
    importcpp: "Geom2d_Hyperbola(@)", header: "Geom2d_Hyperbola.hxx".}
proc constructGeom2dHyperbola*(majorAxis: GpAx2d; majorRadius: StandardReal;
                              minorRadius: StandardReal;
                              sense: StandardBoolean = standardTrue): Geom2dHyperbola {.
    constructor, importcpp: "Geom2d_Hyperbola(@)", header: "Geom2d_Hyperbola.hxx".}
proc constructGeom2dHyperbola*(axis: GpAx22d; majorRadius: StandardReal;
                              minorRadius: StandardReal): Geom2dHyperbola {.
    constructor, importcpp: "Geom2d_Hyperbola(@)", header: "Geom2d_Hyperbola.hxx".}
proc setHypr2d*(this: var Geom2dHyperbola; h: GpHypr2d) {.importcpp: "SetHypr2d",
...
proc hypr2d*(this: Geom2dHyperbola): GpHypr2d {.noSideEffect, importcpp: "Hypr2d",
    header: "Geom2d_Hyperbola.hxx".}
...
proc asymptote1*(this: Geom2dHyperbola): GpAx2d {.noSideEffect,
    importcpp: "Asymptote1", header: "Geom2d_Hyperbola.hxx".}
proc asymptote2*(this: Geom2dHyperbola): GpAx2d {.noSideEffect,
    importcpp: "Asymptote2", header: "Geom2d_Hyperbola.hxx".}
proc conjugateBranch1*(this: Geom2dHyperbola): GpHypr2d {.noSideEffect,
    importcpp: "ConjugateBranch1", header: "Geom2d_Hyperbola.hxx".}
proc conjugateBranch2*(this: Geom2dHyperbola): GpHypr2d {.noSideEffect,
    importcpp: "ConjugateBranch2", header: "Geom2d_Hyperbola.hxx".}
proc directrix1*(this: Geom2dHyperbola): GpAx2d {.noSideEffect,
    importcpp: "Directrix1", header: "Geom2d_Hyperbola.hxx".}
proc directrix2*(this: Geom2dHyperbola): GpAx2d {.noSideEffect,
...
proc focal*(this: Geom2dHyperbola): StandardReal {.noSideEffect, importcpp: "Focal",
    header: "Geom2d_Hyperbola.hxx".}
proc focus1*(this: Geom2dHyperbola): GpPnt2d {.noSideEffect, importcpp: "Focus1",
    header: "Geom2d_Hyperbola.hxx".}
proc focus2*(this: Geom2dHyperbola): GpPnt2d {.noSideEffect, importcpp: "Focus2",
    header: "Geom2d_Hyperbola.hxx".}
...
proc otherBranch*(this: Geom2dHyperbola): GpHypr2d {.noSideEffect,
...
proc d0*(this: Geom2dHyperbola; u: StandardReal; p: var GpPnt2d) {.noSideEffect,
    importcpp: "D0", header: "Geom2d_Hyperbola.hxx".}
proc d1*(this: Geom2dHyperbola; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d) {.
    noSideEffect, importcpp: "D1", header: "Geom2d_Hyperbola.hxx".}
proc d2*(this: Geom2dHyperbola; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d) {.noSideEffect, importcpp: "D2",
                        header: "Geom2d_Hyperbola.hxx".}
proc d3*(this: Geom2dHyperbola; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d; v3: var GpVec2d) {.noSideEffect, importcpp: "D3",
                                      header: "Geom2d_Hyperbola.hxx".}
proc dn*(this: Geom2dHyperbola; u: StandardReal; n: StandardInteger): GpVec2d {.
    noSideEffect, importcpp: "DN", header: "Geom2d_Hyperbola.hxx".}
proc transform*(this: var Geom2dHyperbola; t: GpTrsf2d) {.importcpp: "Transform",
    header: "Geom2d_Hyperbola.hxx".}
