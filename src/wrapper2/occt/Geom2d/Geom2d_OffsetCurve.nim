...
proc constructGeom2dOffsetCurve*(c: Handle[Geom2dCurve]; offset: StandardReal;
                                isNotCheckC0: StandardBoolean = standardFalse): Geom2dOffsetCurve {.
...
proc d0*(this: Geom2dOffsetCurve; u: StandardReal; p: var GpPnt2d) {.noSideEffect,
    importcpp: "D0", header: "Geom2d_OffsetCurve.hxx".}
proc d1*(this: Geom2dOffsetCurve; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d) {.
    noSideEffect, importcpp: "D1", header: "Geom2d_OffsetCurve.hxx".}
proc d2*(this: Geom2dOffsetCurve; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d) {.noSideEffect, importcpp: "D2",
                        header: "Geom2d_OffsetCurve.hxx".}
proc d3*(this: Geom2dOffsetCurve; u: StandardReal; p: var GpPnt2d; v1: var GpVec2d;
        v2: var GpVec2d; v3: var GpVec2d) {.noSideEffect, importcpp: "D3",
                                      header: "Geom2d_OffsetCurve.hxx".}
proc dn*(this: Geom2dOffsetCurve; u: StandardReal; n: StandardInteger): GpVec2d {.
...
proc isCN*(this: Geom2dOffsetCurve; n: StandardInteger): StandardBoolean {.
...
proc transform*(this: var Geom2dOffsetCurve; t: GpTrsf2d) {.importcpp: "Transform",
    header: "Geom2d_OffsetCurve.hxx".}
proc transformedParameter*(this: Geom2dOffsetCurve; u: StandardReal; t: GpTrsf2d): StandardReal {.
    noSideEffect, importcpp: "TransformedParameter",
    header: "Geom2d_OffsetCurve.hxx".}
proc parametricTransformation*(this: Geom2dOffsetCurve; t: GpTrsf2d): StandardReal {.
