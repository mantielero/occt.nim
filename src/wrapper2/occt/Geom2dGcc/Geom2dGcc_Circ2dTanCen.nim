...
proc nbSolutions*(this: Geom2dGccCirc2dTanCen): StandardInteger {.noSideEffect,
    importcpp: "NbSolutions", header: "Geom2dGcc_Circ2dTanCen.hxx".}
proc thisSolution*(this: Geom2dGccCirc2dTanCen; index: StandardInteger): GpCirc2d {.
    noSideEffect, importcpp: "ThisSolution", header: "Geom2dGcc_Circ2dTanCen.hxx".}
proc whichQualifier*(this: Geom2dGccCirc2dTanCen; index: StandardInteger;
                    qualif1: var GccEntPosition) {.noSideEffect,
    importcpp: "WhichQualifier", header: "Geom2dGcc_Circ2dTanCen.hxx".}
proc tangency1*(this: Geom2dGccCirc2dTanCen; index: StandardInteger;
               parSol: var StandardReal; parArg: var StandardReal; pntSol: var GpPnt2d) {.
    noSideEffect, importcpp: "Tangency1", header: "Geom2dGcc_Circ2dTanCen.hxx".}
proc isTheSame1*(this: Geom2dGccCirc2dTanCen; index: StandardInteger): StandardBoolean {.
