...
proc constructGeom2dGccCirc2dTanOnRadGeo*(qualified1: Geom2dGccQCurve;
    onLine: GpLin2d; radius: StandardReal; tolerance: StandardReal): Geom2dGccCirc2dTanOnRadGeo {.
    constructor, importcpp: "Geom2dGcc_Circ2dTanOnRadGeo(@)",
    header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
proc constructGeom2dGccCirc2dTanOnRadGeo*(qualified1: Geom2dGccQCurve;
    onCirc: GpCirc2d; radius: StandardReal; tolerance: StandardReal): Geom2dGccCirc2dTanOnRadGeo {.
    constructor, importcpp: "Geom2dGcc_Circ2dTanOnRadGeo(@)",
    header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
...
proc constructGeom2dGccCirc2dTanOnRadGeo*(qualified1: Geom2dGccQCurve;
    ...
    constructor, importcpp: "Geom2dGcc_Circ2dTanOnRadGeo(@)",
    header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
proc constructGeom2dGccCirc2dTanOnRadGeo*(point1: GpPnt2d;
    onCurv: Geom2dAdaptorCurve; radius: StandardReal; tolerance: StandardReal): Geom2dGccCirc2dTanOnRadGeo {.
    constructor, importcpp: "Geom2dGcc_Circ2dTanOnRadGeo(@)",
    header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
...
proc nbSolutions*(this: Geom2dGccCirc2dTanOnRadGeo): StandardInteger {.noSideEffect,
    importcpp: "NbSolutions", header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
proc thisSolution*(this: Geom2dGccCirc2dTanOnRadGeo; index: StandardInteger): GpCirc2d {.
    noSideEffect, importcpp: "ThisSolution",
    header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
proc whichQualifier*(this: Geom2dGccCirc2dTanOnRadGeo; index: StandardInteger;
                    qualif1: var GccEntPosition) {.noSideEffect,
    importcpp: "WhichQualifier", header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
proc tangency1*(this: Geom2dGccCirc2dTanOnRadGeo; index: StandardInteger;
...
proc centerOn3*(this: Geom2dGccCirc2dTanOnRadGeo; index: StandardInteger;
               parArg: var StandardReal; pntSol: var GpPnt2d) {.noSideEffect,
    importcpp: "CenterOn3", header: "Geom2dGcc_Circ2dTanOnRadGeo.hxx".}
proc isTheSame1*(this: Geom2dGccCirc2dTanOnRadGeo; index: StandardInteger): StandardBoolean {.
