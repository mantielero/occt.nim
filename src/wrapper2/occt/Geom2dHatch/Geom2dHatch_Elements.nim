...
proc destroyGeom2dHatchElements*(this: var Geom2dHatchElements) {.
    importcpp: "#.~Geom2dHatch_Elements()", header: "Geom2dHatch_Elements.hxx".}
proc `bind`*(this: var Geom2dHatchElements; k: StandardInteger; i: Geom2dHatchElement): StandardBoolean {.
    importcpp: "Bind", header: "Geom2dHatch_Elements.hxx".}
proc isBound*(this: Geom2dHatchElements; k: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsBound", header: "Geom2dHatch_Elements.hxx".}
proc unBind*(this: var Geom2dHatchElements; k: StandardInteger): StandardBoolean {.
    importcpp: "UnBind", header: "Geom2dHatch_Elements.hxx".}
proc find*(this: Geom2dHatchElements; k: StandardInteger): Geom2dHatchElement {.
    noSideEffect, importcpp: "Find", header: "Geom2dHatch_Elements.hxx".}
proc `()`*(this: Geom2dHatchElements; k: StandardInteger): Geom2dHatchElement {.
    noSideEffect, importcpp: "#(@)", header: "Geom2dHatch_Elements.hxx".}
proc changeFind*(this: var Geom2dHatchElements; k: StandardInteger): var Geom2dHatchElement {.
    importcpp: "ChangeFind", header: "Geom2dHatch_Elements.hxx".}
proc `()`*(this: var Geom2dHatchElements; k: StandardInteger): var Geom2dHatchElement {.
    importcpp: "#(@)", header: "Geom2dHatch_Elements.hxx".}
proc checkPoint*(this: var Geom2dHatchElements; p: var GpPnt2d): StandardBoolean {.
    importcpp: "CheckPoint", header: "Geom2dHatch_Elements.hxx".}
proc reject*(this: Geom2dHatchElements; p: GpPnt2d): StandardBoolean {.noSideEffect,
    importcpp: "Reject", header: "Geom2dHatch_Elements.hxx".}
proc segment*(this: var Geom2dHatchElements; p: GpPnt2d; L: var GpLin2d;
             par: var StandardReal): StandardBoolean {.importcpp: "Segment",
    header: "Geom2dHatch_Elements.hxx".}
proc otherSegment*(this: var Geom2dHatchElements; p: GpPnt2d; L: var GpLin2d;
...
proc nextWire*(this: var Geom2dHatchElements) {.importcpp: "NextWire",
    header: "Geom2dHatch_Elements.hxx".}
proc rejectWire*(this: Geom2dHatchElements; L: GpLin2d; par: StandardReal): StandardBoolean {.
...
proc nextEdge*(this: var Geom2dHatchElements) {.importcpp: "NextEdge",
    header: "Geom2dHatch_Elements.hxx".}
proc rejectEdge*(this: Geom2dHatchElements; L: GpLin2d; par: StandardReal): StandardBoolean {.
