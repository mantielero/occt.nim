...
proc reset*(this: var Geom2dHatchFClass2dOfClassifier; L: GpLin2d; p: StandardReal;
...
proc parameter*(this: Geom2dHatchFClass2dOfClassifier): StandardReal {.noSideEffect,
...
proc closestIntersection*(this: Geom2dHatchFClass2dOfClassifier): StandardInteger {.
...
proc isHeadOrEnd*(this: Geom2dHatchFClass2dOfClassifier): StandardBoolean {.
