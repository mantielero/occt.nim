...
proc constructGeom2dIntGInter*(c: Adaptor2dCurve2d; tolConf: StandardReal;
                              tol: StandardReal): Geom2dIntGInter {.constructor,
    importcpp: "Geom2dInt_GInter(@)", header: "Geom2dInt_GInter.hxx".}
proc constructGeom2dIntGInter*(c: Adaptor2dCurve2d; d: IntRes2dDomain;
                              tolConf: StandardReal; tol: StandardReal): Geom2dIntGInter {.
...
proc constructGeom2dIntGInter*(c1: Adaptor2dCurve2d; d1: IntRes2dDomain;
                              c2: Adaptor2dCurve2d; tolConf: StandardReal;
                              tol: StandardReal): Geom2dIntGInter {.constructor,
    importcpp: "Geom2dInt_GInter(@)", header: "Geom2dInt_GInter.hxx".}
proc constructGeom2dIntGInter*(c1: Adaptor2dCurve2d; c2: Adaptor2dCurve2d;
...
proc perform*(this: var Geom2dIntGInter; c1: Adaptor2dCurve2d; d1: IntRes2dDomain;
             c2: Adaptor2dCurve2d; d2: IntRes2dDomain; tolConf: StandardReal;
...
proc perform*(this: var Geom2dIntGInter; c1: Adaptor2dCurve2d; d1: IntRes2dDomain;
             tolConf: StandardReal; tol: StandardReal) {.importcpp: "Perform",
    header: "Geom2dInt_GInter.hxx".}
proc perform*(this: var Geom2dIntGInter; c1: Adaptor2dCurve2d; tolConf: StandardReal;
             tol: StandardReal) {.importcpp: "Perform",
                                header: "Geom2dInt_GInter.hxx".}
proc perform*(this: var Geom2dIntGInter; c1: Adaptor2dCurve2d; d1: IntRes2dDomain;
             c2: Adaptor2dCurve2d; tolConf: StandardReal; tol: StandardReal) {.
    importcpp: "Perform", header: "Geom2dInt_GInter.hxx".}
proc perform*(this: var Geom2dIntGInter; c1: Adaptor2dCurve2d; c2: Adaptor2dCurve2d;
             d2: IntRes2dDomain; tolConf: StandardReal; tol: StandardReal) {.
    importcpp: "Perform", header: "Geom2dInt_GInter.hxx".}
proc computeDomain*(this: Geom2dIntGInter; c1: Adaptor2dCurve2d;
                   tolDomain: StandardReal): IntRes2dDomain {.noSideEffect,
    importcpp: "ComputeDomain", header: "Geom2dInt_GInter.hxx".}
proc setMinNbSamples*(this: var Geom2dIntGInter; theMinNbSamples: StandardInteger) {.
    importcpp: "SetMinNbSamples", header: "Geom2dInt_GInter.hxx".}
proc getMinNbSamples*(this: Geom2dIntGInter): StandardInteger {.noSideEffect,
