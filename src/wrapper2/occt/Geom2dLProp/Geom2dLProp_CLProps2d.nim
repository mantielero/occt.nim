...
proc constructGeom2dLPropCLProps2d*(c: Handle[Geom2dCurve]; n: StandardInteger;
                                   resolution: StandardReal): Geom2dLPropCLProps2d {.
    constructor, importcpp: "Geom2dLProp_CLProps2d(@)",
    header: "Geom2dLProp_CLProps2d.hxx".}
proc constructGeom2dLPropCLProps2d*(c: Handle[Geom2dCurve]; u: StandardReal;
                                   n: StandardInteger; resolution: StandardReal): Geom2dLPropCLProps2d {.
    constructor, importcpp: "Geom2dLProp_CLProps2d(@)",
    header: "Geom2dLProp_CLProps2d.hxx".}
proc constructGeom2dLPropCLProps2d*(n: StandardInteger; resolution: StandardReal): Geom2dLPropCLProps2d {.
    constructor, importcpp: "Geom2dLProp_CLProps2d(@)",
    header: "Geom2dLProp_CLProps2d.hxx".}
...
proc value*(this: Geom2dLPropCLProps2d): GpPnt2d {.noSideEffect, importcpp: "Value",
    header: "Geom2dLProp_CLProps2d.hxx".}
proc d1*(this: var Geom2dLPropCLProps2d): GpVec2d {.importcpp: "D1",
    header: "Geom2dLProp_CLProps2d.hxx".}
proc d2*(this: var Geom2dLPropCLProps2d): GpVec2d {.importcpp: "D2",
    header: "Geom2dLProp_CLProps2d.hxx".}
proc d3*(this: var Geom2dLPropCLProps2d): GpVec2d {.importcpp: "D3",
    header: "Geom2dLProp_CLProps2d.hxx".}
...
proc tangent*(this: var Geom2dLPropCLProps2d; d: var GpDir2d) {.importcpp: "Tangent",
    header: "Geom2dLProp_CLProps2d.hxx".}
proc curvature*(this: var Geom2dLPropCLProps2d): StandardReal {.
    importcpp: "Curvature", header: "Geom2dLProp_CLProps2d.hxx".}
proc normal*(this: var Geom2dLPropCLProps2d; n: var GpDir2d) {.importcpp: "Normal",
    header: "Geom2dLProp_CLProps2d.hxx".}
proc centreOfCurvature*(this: var Geom2dLPropCLProps2d; p: var GpPnt2d) {.
