...
proc constructGeomEvaluatorOffsetCurve*(theBase: Handle[GeomCurve];
                                       ...
                                       theDirection: GpDir): GeomEvaluatorOffsetCurve {.
...
proc setOffsetDirection*(this: var GeomEvaluatorOffsetCurve; theDirection: GpDir) {.
    importcpp: "SetOffsetDirection", header: "GeomEvaluator_OffsetCurve.hxx".}
proc d0*(this: GeomEvaluatorOffsetCurve; theU: StandardReal; theValue: var GpPnt) {.
    noSideEffect, importcpp: "D0", header: "GeomEvaluator_OffsetCurve.hxx".}
proc d1*(this: GeomEvaluatorOffsetCurve; theU: StandardReal; theValue: var GpPnt;
        theD1: var GpVec) {.noSideEffect, importcpp: "D1",
                         header: "GeomEvaluator_OffsetCurve.hxx".}
proc d2*(this: GeomEvaluatorOffsetCurve; theU: StandardReal; theValue: var GpPnt;
        theD1: var GpVec; theD2: var GpVec) {.noSideEffect, importcpp: "D2",
                                        header: "GeomEvaluator_OffsetCurve.hxx".}
proc d3*(this: GeomEvaluatorOffsetCurve; theU: StandardReal; theValue: var GpPnt;
        theD1: var GpVec; theD2: var GpVec; theD3: var GpVec) {.noSideEffect,
    importcpp: "D3", header: "GeomEvaluator_OffsetCurve.hxx".}
proc dn*(this: GeomEvaluatorOffsetCurve; theU: StandardReal;
        theDeriv: StandardInteger): GpVec {.noSideEffect, importcpp: "DN",
    header: "GeomEvaluator_OffsetCurve.hxx".}
type
