...
proc constructGeomFillAppSurf*(degmin: StandardInteger; degmax: StandardInteger;
                              tol3d: StandardReal; tol2d: StandardReal;
                              nbIt: StandardInteger;
                              knownParameters: StandardBoolean = standardFalse): GeomFillAppSurf {.
    constructor, importcpp: "GeomFill_AppSurf(@)", header: "GeomFill_AppSurf.hxx".}
proc init*(this: var GeomFillAppSurf; degmin: StandardInteger;
...
proc setCriteriumWeight*(this: var GeomFillAppSurf; w1: StandardReal;
...
proc criteriumWeight*(this: GeomFillAppSurf; w1: var StandardReal;
...
proc perform*(this: var GeomFillAppSurf; lin: Handle[GeomFillLine];
             secGen: var GeomFillSectionGenerator; nbMaxP: StandardInteger) {.
    importcpp: "Perform", header: "GeomFill_AppSurf.hxx".}
proc isDone*(this: GeomFillAppSurf): StandardBoolean {.noSideEffect,
    importcpp: "IsDone", header: "GeomFill_AppSurf.hxx".}
proc surfShape*(this: GeomFillAppSurf; uDegree: var StandardInteger;
...
proc uDegree*(this: GeomFillAppSurf): StandardInteger {.noSideEffect,
    importcpp: "UDegree", header: "GeomFill_AppSurf.hxx".}
proc vDegree*(this: GeomFillAppSurf): StandardInteger {.noSideEffect,
...
proc nbCurves2d*(this: GeomFillAppSurf): StandardInteger {.noSideEffect,
    importcpp: "NbCurves2d", header: "GeomFill_AppSurf.hxx".}
proc curves2dShape*(this: GeomFillAppSurf; degree: var StandardInteger;
                   nbPoles: var StandardInteger; nbKnots: var StandardInteger) {.
    noSideEffect, importcpp: "Curves2dShape", header: "GeomFill_AppSurf.hxx".}
proc curve2d*(this: GeomFillAppSurf; index: StandardInteger;
...
proc curves2dDegree*(this: GeomFillAppSurf): StandardInteger {.noSideEffect,
    importcpp: "Curves2dDegree", header: "GeomFill_AppSurf.hxx".}
proc curve2dPoles*(this: GeomFillAppSurf; index: StandardInteger): TColgpArray1OfPnt2d {.
...
proc tolReached*(this: GeomFillAppSurf; tol3d: var StandardReal;
                tol2d: var StandardReal) {.noSideEffect, importcpp: "TolReached",
                                        header: "GeomFill_AppSurf.hxx".}
proc tolCurveOnSurf*(this: GeomFillAppSurf; index: StandardInteger): StandardReal {.
