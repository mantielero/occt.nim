...
proc setTrsf*(this: var GeomFillCurveAndTrihedron; transfo: GpMat) {.
...
proc d0*(this: var GeomFillCurveAndTrihedron; param: StandardReal; m: var GpMat;
        v: var GpVec): StandardBoolean {.importcpp: "D0",
                                     header: "GeomFill_CurveAndTrihedron.hxx".}
proc d0*(this: var GeomFillCurveAndTrihedron; param: StandardReal; m: var GpMat;
        v: var GpVec; poles2d: var TColgpArray1OfPnt2d): StandardBoolean {.
    importcpp: "D0", header: "GeomFill_CurveAndTrihedron.hxx".}
proc d1*(this: var GeomFillCurveAndTrihedron; param: StandardReal; m: var GpMat;
    ...
    header: "GeomFill_CurveAndTrihedron.hxx".}
proc d2*(this: var GeomFillCurveAndTrihedron; param: StandardReal; m: var GpMat;
    ...
    header: "GeomFill_CurveAndTrihedron.hxx".}
proc nbIntervals*(this: GeomFillCurveAndTrihedron; s: GeomAbsShape): StandardInteger {.
...
proc getAverageLaw*(this: var GeomFillCurveAndTrihedron; am: var GpMat; av: var GpVec) {.
...
proc rotation*(this: GeomFillCurveAndTrihedron; center: var GpPnt) {.noSideEffect,
