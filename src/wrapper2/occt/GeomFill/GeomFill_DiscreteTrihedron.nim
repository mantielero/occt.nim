...
proc d0*(this: var GeomFillDiscreteTrihedron; param: StandardReal; tangent: var GpVec;
        normal: var GpVec; biNormal: var GpVec): StandardBoolean {.importcpp: "D0",
    header: "GeomFill_DiscreteTrihedron.hxx".}
proc d1*(this: var GeomFillDiscreteTrihedron; param: StandardReal; tangent: var GpVec;
        dTangent: var GpVec; normal: var GpVec; dNormal: var GpVec; biNormal: var GpVec;
        dBiNormal: var GpVec): StandardBoolean {.importcpp: "D1",
    header: "GeomFill_DiscreteTrihedron.hxx".}
proc d2*(this: var GeomFillDiscreteTrihedron; param: StandardReal; tangent: var GpVec;
    ...
    header: "GeomFill_DiscreteTrihedron.hxx".}
proc nbIntervals*(this: GeomFillDiscreteTrihedron; s: GeomAbsShape): StandardInteger {.
    noSideEffect, importcpp: "NbIntervals",
    header: "GeomFill_DiscreteTrihedron.hxx".}
proc intervals*(this: GeomFillDiscreteTrihedron; t: var TColStdArray1OfReal;
               s: GeomAbsShape) {.noSideEffect, importcpp: "Intervals",
                                header: "GeomFill_DiscreteTrihedron.hxx".}
proc getAverageLaw*(this: var GeomFillDiscreteTrihedron; aTangent: var GpVec;
