...
proc constructGeomFillFixed*(tangent: GpVec; normal: GpVec): GeomFillFixed {.
...
proc d2*(this: var GeomFillFixed; param: StandardReal; tangent: var GpVec;
    ...
    header: "GeomFill_Fixed.hxx".}
proc nbIntervals*(this: GeomFillFixed; s: GeomAbsShape): StandardInteger {.
...
proc getAverageLaw*(this: var GeomFillFixed; aTangent: var GpVec; aNormal: var GpVec;
