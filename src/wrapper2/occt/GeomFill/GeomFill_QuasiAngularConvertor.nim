...
proc init*(this: var GeomFillQuasiAngularConvertor) {.importcpp: "Init",
    header: "GeomFill_QuasiAngularConvertor.hxx".}
proc section*(this: var GeomFillQuasiAngularConvertor; firstPnt: GpPnt; center: GpPnt;
             dir: GpVec; angle: StandardReal; poles: var TColgpArray1OfPnt;
             weights: var TColStdArray1OfReal) {.importcpp: "Section",
    header: "GeomFill_QuasiAngularConvertor.hxx".}
proc section*(this: var GeomFillQuasiAngularConvertor; firstPnt: GpPnt;
             dFirstPnt: GpVec; center: GpPnt; dCenter: GpVec; dir: GpVec; dDir: GpVec;
...
proc section*(this: var GeomFillQuasiAngularConvertor; firstPnt: GpPnt;
             dFirstPnt: GpVec; d2FirstPnt: GpVec; center: GpPnt; dCenter: GpVec;
             d2Center: GpVec; dir: GpVec; dDir: GpVec; d2Dir: GpVec;
             angle: StandardReal; dAngle: StandardReal; d2Angle: StandardReal;
             poles: var TColgpArray1OfPnt; dPoles: var TColgpArray1OfVec;
