...
proc value*(this: GeomFillTgtField; w: StandardReal): GpVec {.noSideEffect,
    importcpp: "Value", header: "GeomFill_TgtField.hxx".}
proc d1*(this: GeomFillTgtField; w: StandardReal): GpVec {.noSideEffect,
    importcpp: "D1", header: "GeomFill_TgtField.hxx".}
proc d1*(this: GeomFillTgtField; w: StandardReal; v: var GpVec; dv: var GpVec) {.
