...
proc nbParts*(this: GeomIntLineConstructor): StandardInteger {.noSideEffect,
    importcpp: "NbParts", header: "GeomInt_LineConstructor.hxx".}
proc part*(this: GeomIntLineConstructor; i: StandardInteger;
          wFirst: var StandardReal; wLast: var StandardReal) {.noSideEffect,
