...
proc constructGeomIntParFunctionOfMyGradientbisOfTheComputeLineOfWLApprox*(
    ...
    parameters: MathVector; deg: StandardInteger): GeomIntParFunctionOfMyGradientbisOfTheComputeLineOfWLApprox {.
...
proc nbVariables*(this: GeomIntParFunctionOfMyGradientbisOfTheComputeLineOfWLApprox): StandardInteger {.
