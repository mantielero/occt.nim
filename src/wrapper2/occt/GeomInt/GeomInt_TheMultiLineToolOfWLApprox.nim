...
proc firstPoint*(ml: GeomIntTheMultiLineOfWLApprox): StandardInteger {.
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::FirstPoint(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc lastPoint*(ml: GeomIntTheMultiLineOfWLApprox): StandardInteger {.
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::LastPoint(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc nbP2d*(ml: GeomIntTheMultiLineOfWLApprox): StandardInteger {.
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::NbP2d(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc nbP3d*(ml: GeomIntTheMultiLineOfWLApprox): StandardInteger {.
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::NbP3d(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc value*(ml: GeomIntTheMultiLineOfWLApprox; mPointIndex: StandardInteger;
...
proc value*(ml: GeomIntTheMultiLineOfWLApprox; mPointIndex: StandardInteger;
    ...
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::Value(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc tangency*(ml: GeomIntTheMultiLineOfWLApprox; mPointIndex: StandardInteger;
...
proc tangency*(ml: GeomIntTheMultiLineOfWLApprox; mPointIndex: StandardInteger;
    ...
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::Tangency(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc curvature*(ml: GeomIntTheMultiLineOfWLApprox; mPointIndex: StandardInteger;
               tabV: var TColgpArray1OfVec): StandardBoolean {.
...
proc curvature*(ml: GeomIntTheMultiLineOfWLApprox; mPointIndex: StandardInteger;
    ...
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::Curvature(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc makeMLBetween*(ml: GeomIntTheMultiLineOfWLApprox; i1: StandardInteger;
                   i2: StandardInteger; nbPMin: StandardInteger): GeomIntTheMultiLineOfWLApprox {.
    importcpp: "GeomInt_TheMultiLineToolOfWLApprox::MakeMLBetween(@)",
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc makeMLOneMorePoint*(ml: GeomIntTheMultiLineOfWLApprox; i1: StandardInteger;
    ...
    header: "GeomInt_TheMultiLineToolOfWLApprox.hxx".}
proc whatStatus*(ml: GeomIntTheMultiLineOfWLApprox; i1: StandardInteger;
