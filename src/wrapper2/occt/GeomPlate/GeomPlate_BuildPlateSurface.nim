...
proc constructGeomPlateBuildPlateSurface*(
    ...
    tang: Handle[TColStdHArray1OfInteger]; degree: StandardInteger;
    nbIter: StandardInteger = 3; tol2d: StandardReal = 0.00001;
    tol3d: StandardReal = 0.0001; tolAng: StandardReal = 0.01;
    tolCurv: StandardReal = 0.1; anisotropie: StandardBoolean = standardFalse): GeomPlateBuildPlateSurface {.
...
proc constructGeomPlateBuildPlateSurface*(surf: Handle[GeomSurface];
    degree: StandardInteger = 3; nbPtsOnCur: StandardInteger = 10;
    nbIter: StandardInteger = 3; tol2d: StandardReal = 0.00001;
    tol3d: StandardReal = 0.0001; tolAng: StandardReal = 0.01;
    tolCurv: StandardReal = 0.1; anisotropie: StandardBoolean = standardFalse): GeomPlateBuildPlateSurface {.
    constructor, importcpp: "GeomPlate_BuildPlateSurface(@)",
    header: "GeomPlate_BuildPlateSurface.hxx".}
proc constructGeomPlateBuildPlateSurface*(degree: StandardInteger = 3;
    nbPtsOnCur: StandardInteger = 10; nbIter: StandardInteger = 3;
    tol2d: StandardReal = 0.00001; tol3d: StandardReal = 0.0001;
    tolAng: StandardReal = 0.01; tolCurv: StandardReal = 0.1;
    anisotropie: StandardBoolean = standardFalse): GeomPlateBuildPlateSurface {.
    constructor, importcpp: "GeomPlate_BuildPlateSurface(@)",
    header: "GeomPlate_BuildPlateSurface.hxx".}
...
proc add*(this: var GeomPlateBuildPlateSurface;
    ...
    header: "GeomPlate_BuildPlateSurface.hxx".}
proc setNbBounds*(this: var GeomPlateBuildPlateSurface; nbBounds: StandardInteger) {.
...
proc curveConstraint*(this: GeomPlateBuildPlateSurface; order: StandardInteger): Handle[
    GeomPlateCurveConstraint] {.noSideEffect, importcpp: "CurveConstraint",
                               header: "GeomPlate_BuildPlateSurface.hxx".}
proc pointConstraint*(this: GeomPlateBuildPlateSurface; order: StandardInteger): Handle[
    GeomPlatePointConstraint] {.noSideEffect, importcpp: "PointConstraint",
                               header: "GeomPlate_BuildPlateSurface.hxx".}
proc disc2dContour*(this: var GeomPlateBuildPlateSurface; nbp: StandardInteger;
                   seq2d: var TColgpSequenceOfXY) {.importcpp: "Disc2dContour",
    header: "GeomPlate_BuildPlateSurface.hxx".}
proc disc3dContour*(this: var GeomPlateBuildPlateSurface; nbp: StandardInteger;
                   iordre: StandardInteger; seq3d: var TColgpSequenceOfXYZ) {.
...
proc g0Error*(this: var GeomPlateBuildPlateSurface; index: StandardInteger): StandardReal {.
    importcpp: "G0Error", header: "GeomPlate_BuildPlateSurface.hxx".}
proc g1Error*(this: var GeomPlateBuildPlateSurface; index: StandardInteger): StandardReal {.
    importcpp: "G1Error", header: "GeomPlate_BuildPlateSurface.hxx".}
proc g2Error*(this: var GeomPlateBuildPlateSurface; index: StandardInteger): StandardReal {.
    importcpp: "G2Error", header: "GeomPlate_BuildPlateSurface.hxx".}
