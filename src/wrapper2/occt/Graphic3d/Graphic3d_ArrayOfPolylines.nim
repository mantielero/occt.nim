...
proc dynamicType*(this: Graphic3dArrayOfPolylines): Handle[StandardType] {.
    ...
    header: "Graphic3d_ArrayOfPolylines.hxx".}
proc constructGraphic3dArrayOfPolylines*(theMaxVertexs: StandardInteger;
...
proc constructGraphic3dArrayOfPolylines*(theMaxVertexs: StandardInteger;
    ...
    theHasVColors: StandardBoolean = standardFalse; theHasBColors: StandardBoolean = standardFalse): Graphic3dArrayOfPolylines {.
    constructor, importcpp: "Graphic3d_ArrayOfPolylines(@)",
    header: "Graphic3d_ArrayOfPolylines.hxx".}
