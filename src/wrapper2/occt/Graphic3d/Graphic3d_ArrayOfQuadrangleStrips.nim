...
proc dynamicType*(this: Graphic3dArrayOfQuadrangleStrips): Handle[StandardType] {.
    ...
    header: "Graphic3d_ArrayOfQuadrangleStrips.hxx".}
proc constructGraphic3dArrayOfQuadrangleStrips*(theMaxVertexs: StandardInteger;
    theMaxStrips: StandardInteger; theArrayFlags: Graphic3dArrayFlags): Graphic3dArrayOfQuadrangleStrips {.
...
proc constructGraphic3dArrayOfQuadrangleStrips*(theMaxVertexs: StandardInteger;
    ...
    theHasSColors: StandardBoolean = standardFalse;
    theHasVTexels: StandardBoolean = standardFalse): Graphic3dArrayOfQuadrangleStrips {.
    constructor, importcpp: "Graphic3d_ArrayOfQuadrangleStrips(@)",
    header: "Graphic3d_ArrayOfQuadrangleStrips.hxx".}
