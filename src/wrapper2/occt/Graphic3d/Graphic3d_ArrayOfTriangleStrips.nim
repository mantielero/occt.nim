...
type
  ...
  Graphic3dArrayOfTriangleStripsbaseType* = Graphic3dArrayOfPrimitives

proc getTypeName*(): cstring {.importcpp: "Graphic3d_ArrayOfTriangleStrips::get_type_name(@)",
...
proc dynamicType*(this: Graphic3dArrayOfTriangleStrips): Handle[StandardType] {.
    ...
    header: "Graphic3d_ArrayOfTriangleStrips.hxx".}
proc constructGraphic3dArrayOfTriangleStrips*(theMaxVertexs: StandardInteger;
    theMaxStrips: StandardInteger; theArrayFlags: Graphic3dArrayFlags): Graphic3dArrayOfTriangleStrips {.
    constructor, importcpp: "Graphic3d_ArrayOfTriangleStrips(@)",
    header: "Graphic3d_ArrayOfTriangleStrips.hxx".}
proc constructGraphic3dArrayOfTriangleStrips*(theMaxVertexs: StandardInteger;
    theMaxStrips: StandardInteger = 0;
    ...
    theHasVTexels: StandardBoolean = standardFalse): Graphic3dArrayOfTriangleStrips {.
    constructor, importcpp: "Graphic3d_ArrayOfTriangleStrips(@)",
    header: "Graphic3d_ArrayOfTriangleStrips.hxx".}
