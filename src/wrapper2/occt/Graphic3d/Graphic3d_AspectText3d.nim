...
proc constructGraphic3dAspectText3d*(theColor: QuantityColor;
                                    ...
                                    theExpansionFactor: StandardReal;
                                    theSpace: StandardReal; theStyle: AspectTypeOfStyleText = aspectTOST_NORMAL;
...
proc setTextAngle*(this: var Graphic3dAspectText3d; theAngle: StandardReal) {.
