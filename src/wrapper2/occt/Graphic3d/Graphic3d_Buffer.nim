...
proc stride*(this: Graphic3dAttribute): StandardInteger {.noSideEffect,
    importcpp: "Stride", header: "Graphic3d_Buffer.hxx".}
proc stride*(theType: Graphic3dTypeOfData): StandardInteger {.
...
type
  Graphic3dBuffer* {.importcpp: "Graphic3d_Buffer", header: "Graphic3d_Buffer.hxx",
    ...
    stride* {.importc: "Stride".}: StandardInteger ## !< the distance to the attributes of the next vertex within interleaved array
    nbElements* {.importc: "NbElements".}: StandardInteger ## !< number of the elements (@sa NbMaxElements() specifying the number of initially allocated number of elements)
    nbAttributes* {.importc: "NbAttributes".}: StandardInteger ## !< number of vertex attributes
...
proc nbMaxElements*(this: Graphic3dBuffer): StandardInteger {.noSideEffect,
...
proc attribute*(this: Graphic3dBuffer; theAttribIndex: StandardInteger): Graphic3dAttribute {.
    noSideEffect, importcpp: "Attribute", header: "Graphic3d_Buffer.hxx".}
proc changeAttribute*(this: var Graphic3dBuffer; theAttribIndex: StandardInteger): var Graphic3dAttribute {.
    importcpp: "ChangeAttribute", header: "Graphic3d_Buffer.hxx".}
proc findAttribute*(this: Graphic3dBuffer; theAttrib: Graphic3dTypeOfAttribute): StandardInteger {.
    noSideEffect, importcpp: "FindAttribute", header: "Graphic3d_Buffer.hxx".}
proc attributeOffset*(this: Graphic3dBuffer; theAttribIndex: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "AttributeOffset", header: "Graphic3d_Buffer.hxx".}
proc data*(this: Graphic3dBuffer; theAttribIndex: StandardInteger): ptr StandardByte {.
    noSideEffect, importcpp: "Data", header: "Graphic3d_Buffer.hxx".}
proc changeData*(this: var Graphic3dBuffer; theAttribIndex: StandardInteger): ptr StandardByte {.
    importcpp: "ChangeData", header: "Graphic3d_Buffer.hxx".}
proc value*(this: Graphic3dBuffer; theElem: StandardInteger): ptr StandardByte {.
    noSideEffect, importcpp: "value", header: "Graphic3d_Buffer.hxx".}
proc changeValue*(this: var Graphic3dBuffer; theElem: StandardInteger): ptr StandardByte {.
    importcpp: "changeValue", header: "Graphic3d_Buffer.hxx".}
proc value*[TypeT](this: Graphic3dBuffer; theElem: StandardInteger): TypeT {.
    noSideEffect, importcpp: "Value", header: "Graphic3d_Buffer.hxx".}
proc changeValue*[TypeT](this: var Graphic3dBuffer; theElem: StandardInteger): var TypeT {.
    importcpp: "ChangeValue", header: "Graphic3d_Buffer.hxx".}
## using statement
...
proc changeAttributeData*(this: var Graphic3dBuffer;
                         ...
                         theAttribIndex: var StandardInteger;
...
proc release*(this: var Graphic3dBuffer) {.importcpp: "release",
                                       header: "Graphic3d_Buffer.hxx".}
proc init*(this: var Graphic3dBuffer; theNbElems: StandardInteger;
...
proc init*(this: var Graphic3dBuffer; theNbElems: StandardInteger;
    ...
    header: "Graphic3d_Buffer.hxx".}
proc isInterleaved*(this: Graphic3dBuffer): StandardBoolean {.noSideEffect,
    importcpp: "IsInterleaved", header: "Graphic3d_Buffer.hxx".}
proc isMutable*(this: Graphic3dBuffer): StandardBoolean {.noSideEffect,
