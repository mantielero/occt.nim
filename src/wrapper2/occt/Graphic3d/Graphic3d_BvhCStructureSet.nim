...
proc constructGraphic3dBvhCStructureSet*(): Graphic3dBvhCStructureSet {.
    ...
    header: "Graphic3d_BvhCStructureSet.hxx".}
proc size*(this: Graphic3dBvhCStructureSet): StandardInteger {.noSideEffect,
    importcpp: "Size", header: "Graphic3d_BvhCStructureSet.hxx".}
proc box*(this: Graphic3dBvhCStructureSet; theIdx: StandardInteger): Graphic3dBndBox3d {.
    noSideEffect, importcpp: "Box", header: "Graphic3d_BvhCStructureSet.hxx".}
proc center*(this: Graphic3dBvhCStructureSet; theIdx: StandardInteger;
            theAxis: StandardInteger): StandardReal {.noSideEffect,
    importcpp: "Center", header: "Graphic3d_BvhCStructureSet.hxx".}
proc swap*(this: var Graphic3dBvhCStructureSet; theIdx1: StandardInteger;
          theIdx2: StandardInteger) {.importcpp: "Swap",
                                    header: "Graphic3d_BvhCStructureSet.hxx".}
proc add*(this: var Graphic3dBvhCStructureSet; theStruct: ptr Graphic3dCStructure): StandardBoolean {.
    importcpp: "Add", header: "Graphic3d_BvhCStructureSet.hxx".}
proc remove*(this: var Graphic3dBvhCStructureSet; theStruct: ptr Graphic3dCStructure): StandardBoolean {.
    importcpp: "Remove", header: "Graphic3d_BvhCStructureSet.hxx".}
proc clear*(this: var Graphic3dBvhCStructureSet) {.importcpp: "Clear",
    header: "Graphic3d_BvhCStructureSet.hxx".}
proc getStructureById*(this: var Graphic3dBvhCStructureSet; theId: StandardInteger): ptr Graphic3dCStructure {.
