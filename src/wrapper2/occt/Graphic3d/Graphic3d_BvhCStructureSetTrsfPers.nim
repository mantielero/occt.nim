...
type
  Graphic3dBvhCStructureSetTrsfPers* {.importcpp: "Graphic3d_BvhCStructureSetTrsfPers", header: "Graphic3d_BvhCStructureSetTrsfPers.hxx",
                                      bycopy.} = object of BVH_Set[StandardReal, 3] ## !
                                                                              ## Creates an
                                                                              ## empty
                                                                              ## primitive
                                                                              ## set
...
proc size*(this: Graphic3dBvhCStructureSetTrsfPers): StandardInteger {.noSideEffect,
    importcpp: "Size", header: "Graphic3d_BvhCStructureSetTrsfPers.hxx".}
proc box*(this: Graphic3dBvhCStructureSetTrsfPers; theIdx: StandardInteger): Graphic3dBndBox3d {.
    noSideEffect, importcpp: "Box",
    header: "Graphic3d_BvhCStructureSetTrsfPers.hxx".}
proc center*(this: Graphic3dBvhCStructureSetTrsfPers; theIdx: StandardInteger;
            theAxis: StandardInteger): StandardReal {.noSideEffect,
    importcpp: "Center", header: "Graphic3d_BvhCStructureSetTrsfPers.hxx".}
proc swap*(this: var Graphic3dBvhCStructureSetTrsfPers; theIdx1: StandardInteger;
          theIdx2: StandardInteger) {.importcpp: "Swap", header: "Graphic3d_BvhCStructureSetTrsfPers.hxx".}
proc add*(this: var Graphic3dBvhCStructureSetTrsfPers;
         theStruct: ptr Graphic3dCStructure): StandardBoolean {.importcpp: "Add",
    header: "Graphic3d_BvhCStructureSetTrsfPers.hxx".}
proc remove*(this: var Graphic3dBvhCStructureSetTrsfPers;
            theStruct: ptr Graphic3dCStructure): StandardBoolean {.
...
proc clear*(this: var Graphic3dBvhCStructureSetTrsfPers) {.importcpp: "Clear",
    header: "Graphic3d_BvhCStructureSetTrsfPers.hxx".}
proc getStructureById*(this: var Graphic3dBvhCStructureSetTrsfPers;
                      theId: StandardInteger): ptr Graphic3dCStructure {.
...
proc bvh*(this: var Graphic3dBvhCStructureSetTrsfPers;
         ...
         theWorldViewMatrix: Graphic3dMat4d; theViewportWidth: StandardInteger;
         theViewportHeight: StandardInteger;
         theWVPState: Graphic3dWorldViewProjState): Handle[
    BVH_Tree[StandardReal, 3]] {.importcpp: "BVH",
                               header: "Graphic3d_BvhCStructureSetTrsfPers.hxx".}
