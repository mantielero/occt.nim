...
proc isVisible*(this: Graphic3dCStructure; theViewId: StandardInteger): bool {.
...
proc highlightStyle*(this: Graphic3dCStructure): Handle[
    Graphic3dPresentationAttributes] {.noSideEffect, importcpp: "HighlightStyle",
                                      header: "Graphic3d_CStructure.hxx".}
proc isCulled*(this: Graphic3dCStructure): StandardBoolean {.noSideEffect,
    importcpp: "IsCulled", header: "Graphic3d_CStructure.hxx".}
proc setCulled*(this: Graphic3dCStructure; theIsCulled: StandardBoolean) {.
...
proc bndBoxClipCheck*(this: Graphic3dCStructure): StandardBoolean {.noSideEffect,
    importcpp: "BndBoxClipCheck", header: "Graphic3d_CStructure.hxx".}
proc setBndBoxClipCheck*(this: var Graphic3dCStructure;
                        theBndBoxClipCheck: StandardBoolean) {.
    importcpp: "SetBndBoxClipCheck", header: "Graphic3d_CStructure.hxx".}
proc isAlwaysRendered*(this: Graphic3dCStructure): StandardBoolean {.noSideEffect,
