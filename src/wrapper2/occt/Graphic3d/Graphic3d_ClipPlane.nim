...
proc constructGraphic3dClipPlane*(theEquation: Graphic3dVec4d): Graphic3dClipPlane {.
    constructor, importcpp: "Graphic3d_ClipPlane(@)",
    header: "Graphic3d_ClipPlane.hxx".}
proc constructGraphic3dClipPlane*(thePlane: GpPln): Graphic3dClipPlane {.
    constructor, importcpp: "Graphic3d_ClipPlane(@)",
    header: "Graphic3d_ClipPlane.hxx".}
proc setEquation*(this: var Graphic3dClipPlane; thePlane: GpPln) {.
...
proc isOn*(this: Graphic3dClipPlane): StandardBoolean {.noSideEffect,
    importcpp: "IsOn", header: "Graphic3d_ClipPlane.hxx".}
proc setOn*(this: var Graphic3dClipPlane; theIsOn: StandardBoolean) {.
    importcpp: "SetOn", header: "Graphic3d_ClipPlane.hxx".}
proc setCapping*(this: var Graphic3dClipPlane; theIsOn: StandardBoolean) {.
    importcpp: "SetCapping", header: "Graphic3d_ClipPlane.hxx".}
proc isCapping*(this: Graphic3dClipPlane): StandardBoolean {.noSideEffect,
    importcpp: "IsCapping", header: "Graphic3d_ClipPlane.hxx".}
proc toPlane*(this: Graphic3dClipPlane): GpPln {.noSideEffect, importcpp: "ToPlane",
    header: "Graphic3d_ClipPlane.hxx".}
proc clone*(this: Graphic3dClipPlane): Handle[Graphic3dClipPlane] {.noSideEffect,
    importcpp: "Clone", header: "Graphic3d_ClipPlane.hxx".}
proc isChain*(this: Graphic3dClipPlane): StandardBoolean {.noSideEffect,
...
proc nbChainNextPlanes*(this: Graphic3dClipPlane): StandardInteger {.noSideEffect,
...
proc isHatchOn*(this: Graphic3dClipPlane): StandardBoolean {.noSideEffect,
...
proc probeBoxTouch*(this: Graphic3dClipPlane; theBox: Graphic3dBndBox3d): StandardBoolean {.
