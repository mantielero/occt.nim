...
proc frameRate*(this: Graphic3dFrameStatsData): StandardReal {.noSideEffect,
    importcpp: "FrameRate", header: "Graphic3d_FrameStatsData.hxx".}
proc frameRateCpu*(this: Graphic3dFrameStatsData): StandardReal {.noSideEffect,
    importcpp: "FrameRateCpu", header: "Graphic3d_FrameStatsData.hxx".}
proc immediateFrameRate*(this: Graphic3dFrameStatsData): StandardReal {.
    noSideEffect, importcpp: "ImmediateFrameRate",
    header: "Graphic3d_FrameStatsData.hxx".}
proc immediateFrameRateCpu*(this: Graphic3dFrameStatsData): StandardReal {.
...
proc timerValue*(this: Graphic3dFrameStatsData; theIndex: Graphic3dFrameStatsTimer): StandardReal {.
    noSideEffect, importcpp: "TimerValue", header: "Graphic3d_FrameStatsData.hxx".}
proc `[]`*(this: Graphic3dFrameStatsData; theIndex: Graphic3dFrameStatsTimer): StandardReal {.
    noSideEffect, importcpp: "#[@]", header: "Graphic3d_FrameStatsData.hxx".}
...
proc reset*(this: var Graphic3dFrameStatsDataTmp) {.importcpp: "Reset",
    header: "Graphic3d_FrameStatsData.hxx".}
proc changeFrameRate*(this: var Graphic3dFrameStatsDataTmp): var StandardReal {.
    importcpp: "ChangeFrameRate", header: "Graphic3d_FrameStatsData.hxx".}
proc changeFrameRateCpu*(this: var Graphic3dFrameStatsDataTmp): var StandardReal {.
    importcpp: "ChangeFrameRateCpu", header: "Graphic3d_FrameStatsData.hxx".}
proc changeImmediateFrameRate*(this: var Graphic3dFrameStatsDataTmp): var StandardReal {.
    importcpp: "ChangeImmediateFrameRate", header: "Graphic3d_FrameStatsData.hxx".}
proc changeImmediateFrameRateCpu*(this: var Graphic3dFrameStatsDataTmp): var StandardReal {.
...
proc changeTimerValue*(this: var Graphic3dFrameStatsDataTmp;
                      theIndex: Graphic3dFrameStatsTimer): var StandardReal {.
    importcpp: "ChangeTimerValue", header: "Graphic3d_FrameStatsData.hxx".}
proc `[]`*(this: var Graphic3dFrameStatsDataTmp; theIndex: Graphic3dFrameStatsTimer): var StandardReal {.
    importcpp: "#[@]", header: "Graphic3d_FrameStatsData.hxx".}
