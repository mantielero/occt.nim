...
proc constructGraphic3dLightSetIterator*(theSet: Handle[Graphic3dLightSet];
    ...
    constructor, importcpp: "Graphic3d_LightSet::Iterator(@)",
    header: "Graphic3d_LightSet.hxx".}
proc more*(this: Graphic3dLightSetIterator): StandardBoolean {.noSideEffect,
...
proc lower*(this: Graphic3dLightSet): StandardInteger {.noSideEffect,
    importcpp: "Lower", header: "Graphic3d_LightSet.hxx".}
proc upper*(this: Graphic3dLightSet): StandardInteger {.noSideEffect,
    importcpp: "Upper", header: "Graphic3d_LightSet.hxx".}
proc isEmpty*(this: Graphic3dLightSet): StandardBoolean {.noSideEffect,
    importcpp: "IsEmpty", header: "Graphic3d_LightSet.hxx".}
proc extent*(this: Graphic3dLightSet): StandardInteger {.noSideEffect,
    importcpp: "Extent", header: "Graphic3d_LightSet.hxx".}
proc value*(this: Graphic3dLightSet; theIndex: StandardInteger): Handle[
    Graphic3dCLight] {.noSideEffect, importcpp: "Value",
                      header: "Graphic3d_LightSet.hxx".}
proc contains*(this: Graphic3dLightSet; theLight: Handle[Graphic3dCLight]): StandardBoolean {.
    noSideEffect, importcpp: "Contains", header: "Graphic3d_LightSet.hxx".}
proc add*(this: var Graphic3dLightSet; theLight: Handle[Graphic3dCLight]): StandardBoolean {.
    importcpp: "Add", header: "Graphic3d_LightSet.hxx".}
proc remove*(this: var Graphic3dLightSet; theLight: Handle[Graphic3dCLight]): StandardBoolean {.
    importcpp: "Remove", header: "Graphic3d_LightSet.hxx".}
proc nbLightsOfType*(this: Graphic3dLightSet; theType: Graphic3dTypeOfLightSource): StandardInteger {.
...
proc nbEnabled*(this: Graphic3dLightSet): StandardInteger {.noSideEffect,
    importcpp: "NbEnabled", header: "Graphic3d_LightSet.hxx".}
proc nbEnabledLightsOfType*(this: Graphic3dLightSet;
                           theType: Graphic3dTypeOfLightSource): StandardInteger {.
