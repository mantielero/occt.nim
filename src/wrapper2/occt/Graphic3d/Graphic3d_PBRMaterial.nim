...
proc `==`*(this: Graphic3dPBRMaterial; theOther: Graphic3dPBRMaterial): StandardBoolean {.
...
proc generateEnvLUT*(theLUT: Handle[ImagePixMap];
    ...
    header: "Graphic3d_PBRMaterial.hxx".}
proc roughnessFromSpecular*(theSpecular: QuantityColor; theShiness: StandardReal): StandardShortReal {.
