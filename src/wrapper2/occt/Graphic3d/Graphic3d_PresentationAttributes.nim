...
proc setZLayer*(this: var Graphic3dPresentationAttributes;
    ...
    header: "Graphic3d_PresentationAttributes.hxx".}
proc displayMode*(this: Graphic3dPresentationAttributes): StandardInteger {.
    noSideEffect, importcpp: "DisplayMode",
    header: "Graphic3d_PresentationAttributes.hxx".}
proc setDisplayMode*(this: var Graphic3dPresentationAttributes;
                    theMode: StandardInteger) {.importcpp: "SetDisplayMode",
    header: "Graphic3d_PresentationAttributes.hxx".}
