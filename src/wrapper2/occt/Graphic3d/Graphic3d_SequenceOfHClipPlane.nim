...
proc constructGraphic3dSequenceOfHClipPlane*(): Graphic3dSequenceOfHClipPlane {.
    ...
    header: "Graphic3d_SequenceOfHClipPlane.hxx".}
proc toOverrideGlobal*(this: Graphic3dSequenceOfHClipPlane): StandardBoolean {.
    noSideEffect, importcpp: "ToOverrideGlobal",
    header: "Graphic3d_SequenceOfHClipPlane.hxx".}
proc setOverrideGlobal*(this: var Graphic3dSequenceOfHClipPlane;
                       theToOverride: StandardBoolean) {.
...
proc size*(this: Graphic3dSequenceOfHClipPlane): StandardInteger {.noSideEffect,
