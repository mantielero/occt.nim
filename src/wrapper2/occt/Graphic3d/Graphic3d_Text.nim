...
proc position*(this: Graphic3dText): GpPnt {.noSideEffect, importcpp: "Position",
    header: "Graphic3d_Text.hxx".}
proc setPosition*(this: var Graphic3dText; thePoint: GpPnt) {.
    importcpp: "SetPosition", header: "Graphic3d_Text.hxx".}
proc orientation*(this: Graphic3dText): GpAx2 {.noSideEffect,
    importcpp: "Orientation", header: "Graphic3d_Text.hxx".}
proc hasPlane*(this: Graphic3dText): StandardBoolean {.noSideEffect,
    importcpp: "HasPlane", header: "Graphic3d_Text.hxx".}
proc setOrientation*(this: var Graphic3dText; theOrientation: GpAx2) {.
...
proc resetOrientation*(this: var Graphic3dText) {.importcpp: "ResetOrientation",
    header: "Graphic3d_Text.hxx".}
proc hasOwnAnchorPoint*(this: Graphic3dText): StandardBoolean {.noSideEffect,
    importcpp: "HasOwnAnchorPoint", header: "Graphic3d_Text.hxx".}
proc setOwnAnchorPoint*(this: var Graphic3dText; theHasOwnAnchor: StandardBoolean) {.
