...
type
  Graphic3d_TypeOfShadingModel* {.size: sizeof(cint),
                                 ...
                                 header: "Graphic3d_TypeOfShadingModel.hxx".} = enum ##
                                                                                 ...
                                                                                 ## entire
                                                                                 ## Viewer.
    Graphic3d_TOSM_DEFAULT = -1, ## ! Unlit Shading (or shadeless), lighting is ignored and facet is fully filled by its material color.
    ...
    Graphic3d_TOSM_UNLIT = 0, ## ! Flat Shading, calculated per-facet basing on facet normal.
    ...
    Graphic3d_TOSM_FACET, ## ! Gouraud Shading, calculated per-vertex basing on nodal normal, and then color is interpolated across fragments.
    ...
    Graphic3d_TOSM_VERTEX, ## ! Phong Shading, calculated per-fragment basing on nodal normal, so that normal is interpolated across fragments.
                          ## ! This is a main shading model nowadays, providing the best image quality.
                          ## ! Shading model requires normals to be defined within vertex attributes.
    Graphic3d_TOSM_FRAGMENT,  ## ! Metallic-roughness physically based (PBR) illumination system.
    Graphic3d_TOSM_PBR,       ## ! Same as Graphic3d_TOSM_PBR but using flat per-triangle normal.
    Graphic3d_TOSM_PBR_FACET  ##  obsolete aliases
