...
proc constructHLRBRepCInter*(c: StandardAddress; tolConf: StandardReal;
                            tol: StandardReal): HLRBRepCInter {.constructor,
    importcpp: "HLRBRep_CInter(@)", header: "HLRBRep_CInter.hxx".}
proc constructHLRBRepCInter*(c: StandardAddress; d: IntRes2dDomain;
                            tolConf: StandardReal; tol: StandardReal): HLRBRepCInter {.
...
proc constructHLRBRepCInter*(c1: StandardAddress; d1: IntRes2dDomain;
                            c2: StandardAddress; tolConf: StandardReal;
                            tol: StandardReal): HLRBRepCInter {.constructor,
    importcpp: "HLRBRep_CInter(@)", header: "HLRBRep_CInter.hxx".}
proc constructHLRBRepCInter*(c1: StandardAddress; c2: StandardAddress;
    ...
    importcpp: "HLRBRep_CInter(@)", header: "HLRBRep_CInter.hxx".}
proc constructHLRBRepCInter*(c1: StandardAddress; d1: IntRes2dDomain;
                            c2: StandardAddress; d2: IntRes2dDomain;
                            tolConf: StandardReal; tol: StandardReal): HLRBRepCInter {.
    constructor, importcpp: "HLRBRep_CInter(@)", header: "HLRBRep_CInter.hxx".}
proc perform*(this: var HLRBRepCInter; c1: StandardAddress; d1: IntRes2dDomain;
             c2: StandardAddress; d2: IntRes2dDomain; tolConf: StandardReal;
             tol: StandardReal) {.importcpp: "Perform", header: "HLRBRep_CInter.hxx".}
...
proc perform*(this: var HLRBRepCInter; c1: StandardAddress; d1: IntRes2dDomain;
             tolConf: StandardReal; tol: StandardReal) {.importcpp: "Perform",
    header: "HLRBRep_CInter.hxx".}
proc perform*(this: var HLRBRepCInter; c1: StandardAddress; tolConf: StandardReal;
             tol: StandardReal) {.importcpp: "Perform", header: "HLRBRep_CInter.hxx".}
proc perform*(this: var HLRBRepCInter; c1: StandardAddress; d1: IntRes2dDomain;
             c2: StandardAddress; tolConf: StandardReal; tol: StandardReal) {.
    importcpp: "Perform", header: "HLRBRep_CInter.hxx".}
proc perform*(this: var HLRBRepCInter; c1: StandardAddress; c2: StandardAddress;
             d2: IntRes2dDomain; tolConf: StandardReal; tol: StandardReal) {.
    importcpp: "Perform", header: "HLRBRep_CInter.hxx".}
proc computeDomain*(this: HLRBRepCInter; c1: StandardAddress; tolDomain: StandardReal): IntRes2dDomain {.
    noSideEffect, importcpp: "ComputeDomain", header: "HLRBRep_CInter.hxx".}
proc setMinNbSamples*(this: var HLRBRepCInter; theMinNbSamples: StandardInteger) {.
    importcpp: "SetMinNbSamples", header: "HLRBRep_CInter.hxx".}
proc getMinNbSamples*(this: HLRBRepCInter): StandardInteger {.noSideEffect,
