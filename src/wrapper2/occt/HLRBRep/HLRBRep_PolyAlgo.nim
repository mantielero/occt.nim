...
proc constructHLRBRepPolyAlgo*(s: TopoDS_Shape): HLRBRepPolyAlgo {.constructor,
    importcpp: "HLRBRep_PolyAlgo(@)", header: "HLRBRep_PolyAlgo.hxx".}
proc nbShapes*(this: HLRBRepPolyAlgo): StandardInteger {.noSideEffect,
    importcpp: "NbShapes", header: "HLRBRep_PolyAlgo.hxx".}
proc shape*(this: var HLRBRepPolyAlgo; i: StandardInteger): var TopoDS_Shape {.
    importcpp: "Shape", header: "HLRBRep_PolyAlgo.hxx".}
proc remove*(this: var HLRBRepPolyAlgo; i: StandardInteger) {.importcpp: "Remove",
    header: "HLRBRep_PolyAlgo.hxx".}
proc index*(this: HLRBRepPolyAlgo; s: TopoDS_Shape): StandardInteger {.noSideEffect,
...
proc projector*(this: var HLRBRepPolyAlgo; theProj: HLRAlgoProjector) {.
    importcpp: "Projector", header: "HLRBRep_PolyAlgo.hxx".}
proc tolAngular*(this: HLRBRepPolyAlgo): StandardReal {.noSideEffect,
    importcpp: "TolAngular", header: "HLRBRep_PolyAlgo.hxx".}
proc tolAngular*(this: var HLRBRepPolyAlgo; theTol: StandardReal) {.
    importcpp: "TolAngular", header: "HLRBRep_PolyAlgo.hxx".}
proc tolCoef*(this: HLRBRepPolyAlgo): StandardReal {.noSideEffect,
    importcpp: "TolCoef", header: "HLRBRep_PolyAlgo.hxx".}
proc tolCoef*(this: var HLRBRepPolyAlgo; theTol: StandardReal) {.importcpp: "TolCoef",
    header: "HLRBRep_PolyAlgo.hxx".}
proc update*(this: var HLRBRepPolyAlgo) {.importcpp: "Update",
                                      header: "HLRBRep_PolyAlgo.hxx".}
proc initHide*(this: var HLRBRepPolyAlgo) {.importcpp: "InitHide",
                                        header: "HLRBRep_PolyAlgo.hxx".}
proc moreHide*(this: HLRBRepPolyAlgo): StandardBoolean {.noSideEffect,
...
proc hide*(this: var HLRBRepPolyAlgo; status: var HLRAlgoEdgeStatus;
          s: var TopoDS_Shape; reg1: var StandardBoolean; regn: var StandardBoolean;
...
proc initShow*(this: var HLRBRepPolyAlgo) {.importcpp: "InitShow",
                                        header: "HLRBRep_PolyAlgo.hxx".}
proc moreShow*(this: HLRBRepPolyAlgo): StandardBoolean {.noSideEffect,
    importcpp: "MoreShow", header: "HLRBRep_PolyAlgo.hxx".}
proc nextShow*(this: var HLRBRepPolyAlgo) {.importcpp: "NextShow",
                                        header: "HLRBRep_PolyAlgo.hxx".}
proc show*(this: var HLRBRepPolyAlgo; s: var TopoDS_Shape; reg1: var StandardBoolean;
          regn: var StandardBoolean; outl: var StandardBoolean;
          intl: var StandardBoolean): var PointsT {.importcpp: "Show",
    header: "HLRBRep_PolyAlgo.hxx".}
...
proc debug*(this: HLRBRepPolyAlgo): StandardBoolean {.noSideEffect,
    importcpp: "Debug", header: "HLRBRep_PolyAlgo.hxx".}
proc debug*(this: var HLRBRepPolyAlgo; theDebug: StandardBoolean) {.
    importcpp: "Debug", header: "HLRBRep_PolyAlgo.hxx".}
type
