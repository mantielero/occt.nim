...
proc constructHLRBRepTheIntConicCurveOfCInter*(L: GpLin2d; d1: IntRes2dDomain;
    pCurve: StandardAddress; d2: IntRes2dDomain; tolConf: StandardReal;
    tol: StandardReal): HLRBRepTheIntConicCurveOfCInter {.constructor,
    importcpp: "HLRBRep_TheIntConicCurveOfCInter(@)",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc constructHLRBRepTheIntConicCurveOfCInter*(c: GpCirc2d; d1: IntRes2dDomain;
    pCurve: StandardAddress; d2: IntRes2dDomain; tolConf: StandardReal;
    tol: StandardReal): HLRBRepTheIntConicCurveOfCInter {.constructor,
    importcpp: "HLRBRep_TheIntConicCurveOfCInter(@)",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc constructHLRBRepTheIntConicCurveOfCInter*(e: GpElips2d; d1: IntRes2dDomain;
    pCurve: StandardAddress; d2: IntRes2dDomain; tolConf: StandardReal;
    tol: StandardReal): HLRBRepTheIntConicCurveOfCInter {.constructor,
    importcpp: "HLRBRep_TheIntConicCurveOfCInter(@)",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc constructHLRBRepTheIntConicCurveOfCInter*(prb: GpParab2d; d1: IntRes2dDomain;
    pCurve: StandardAddress; d2: IntRes2dDomain; tolConf: StandardReal;
    tol: StandardReal): HLRBRepTheIntConicCurveOfCInter {.constructor,
    importcpp: "HLRBRep_TheIntConicCurveOfCInter(@)",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc constructHLRBRepTheIntConicCurveOfCInter*(h: GpHypr2d; d1: IntRes2dDomain;
    pCurve: StandardAddress; d2: IntRes2dDomain; tolConf: StandardReal;
    tol: StandardReal): HLRBRepTheIntConicCurveOfCInter {.constructor,
    importcpp: "HLRBRep_TheIntConicCurveOfCInter(@)",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc perform*(this: var HLRBRepTheIntConicCurveOfCInter; L: GpLin2d;
             d1: IntRes2dDomain; pCurve: StandardAddress; d2: IntRes2dDomain;
             tolConf: StandardReal; tol: StandardReal) {.importcpp: "Perform",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc perform*(this: var HLRBRepTheIntConicCurveOfCInter; c: GpCirc2d;
             d1: IntRes2dDomain; pCurve: StandardAddress; d2: IntRes2dDomain;
             tolConf: StandardReal; tol: StandardReal) {.importcpp: "Perform",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc perform*(this: var HLRBRepTheIntConicCurveOfCInter; e: GpElips2d;
             d1: IntRes2dDomain; pCurve: StandardAddress; d2: IntRes2dDomain;
             tolConf: StandardReal; tol: StandardReal) {.importcpp: "Perform",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc perform*(this: var HLRBRepTheIntConicCurveOfCInter; prb: GpParab2d;
             d1: IntRes2dDomain; pCurve: StandardAddress; d2: IntRes2dDomain;
             tolConf: StandardReal; tol: StandardReal) {.importcpp: "Perform",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
proc perform*(this: var HLRBRepTheIntConicCurveOfCInter; h: GpHypr2d;
             d1: IntRes2dDomain; pCurve: StandardAddress; d2: IntRes2dDomain;
             tolConf: StandardReal; tol: StandardReal) {.importcpp: "Perform",
    header: "HLRBRep_TheIntConicCurveOfCInter.hxx".}
