...
proc perform*(this: var HLRBRepTheIntPCurvePCurveOfCInter; curve1: StandardAddress;
             ...
             domain2: IntRes2dDomain; tolConf: StandardReal; tol: StandardReal) {.
    importcpp: "Perform", header: "HLRBRep_TheIntPCurvePCurveOfCInter.hxx".}
proc perform*(this: var HLRBRepTheIntPCurvePCurveOfCInter; curve1: StandardAddress;
             domain1: IntRes2dDomain; tolConf: StandardReal; tol: StandardReal) {.
    importcpp: "Perform", header: "HLRBRep_TheIntPCurvePCurveOfCInter.hxx".}
...
proc getMinNbSamples*(this: HLRBRepTheIntPCurvePCurveOfCInter): StandardInteger {.
