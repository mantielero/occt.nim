...
proc deflectionOverEstimation*(thePolygon: HLRBRepThePolygonOfInterCSurf): StandardReal {.importcpp: "HLRBRep_ThePolygonToolOfInterCSurf::DeflectionOverEstimation(@)",
    header: "HLRBRep_ThePolygonToolOfInterCSurf.hxx".}
proc closed*(thePolygon: HLRBRepThePolygonOfInterCSurf): StandardBoolean {.
    importcpp: "HLRBRep_ThePolygonToolOfInterCSurf::Closed(@)",
    header: "HLRBRep_ThePolygonToolOfInterCSurf.hxx".}
proc nbSegments*(thePolygon: HLRBRepThePolygonOfInterCSurf): StandardInteger {.
    importcpp: "HLRBRep_ThePolygonToolOfInterCSurf::NbSegments(@)",
    header: "HLRBRep_ThePolygonToolOfInterCSurf.hxx".}
proc beginOfSeg*(thePolygon: HLRBRepThePolygonOfInterCSurf; index: StandardInteger): GpPnt {.
    importcpp: "HLRBRep_ThePolygonToolOfInterCSurf::BeginOfSeg(@)",
    header: "HLRBRep_ThePolygonToolOfInterCSurf.hxx".}
proc endOfSeg*(thePolygon: HLRBRepThePolygonOfInterCSurf; index: StandardInteger): GpPnt {.
