...
proc findParameter*(c: StandardAddress; pnt: GpPnt2d; tol: StandardReal): StandardReal {.
    importcpp: "HLRBRep_TheProjPCurOfCInter::FindParameter(@)",
    header: "HLRBRep_TheProjPCurOfCInter.hxx".}
proc findParameter*(c: StandardAddress; pnt: GpPnt2d; lowParameter: StandardReal;
