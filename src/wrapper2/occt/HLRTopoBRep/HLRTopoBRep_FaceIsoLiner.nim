...
proc perform*(fi: StandardInteger; f: TopoDS_Face; ds: var HLRTopoBRepData;
             nbIsos: StandardInteger) {.importcpp: "HLRTopoBRep_FaceIsoLiner::Perform(@)",
                                      header: "HLRTopoBRep_FaceIsoLiner.hxx".}
proc makeVertex*(e: TopoDS_Edge; p: GpPnt; par: StandardReal; tol: StandardReal;
...
proc makeIsoLine*(f: TopoDS_Face; iso: Handle[Geom2dLine]; v1: var TopoDS_Vertex;
                 v2: var TopoDS_Vertex; u1: StandardReal; u2: StandardReal;
                 tol: StandardReal; ds: var HLRTopoBRepData) {.
