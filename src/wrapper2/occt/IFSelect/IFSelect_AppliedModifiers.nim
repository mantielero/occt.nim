...
proc constructIFSelectAppliedModifiers*(nbmax: StandardInteger;
                                       nbent: StandardInteger): IFSelectAppliedModifiers {.
...
proc addNum*(this: var IFSelectAppliedModifiers; nument: StandardInteger): StandardBoolean {.
    importcpp: "AddNum", header: "IFSelect_AppliedModifiers.hxx".}
proc count*(this: IFSelectAppliedModifiers): StandardInteger {.noSideEffect,
    importcpp: "Count", header: "IFSelect_AppliedModifiers.hxx".}
proc item*(this: var IFSelectAppliedModifiers; num: StandardInteger;
          modif: var Handle[IFSelectGeneralModifier]; entcount: var StandardInteger): StandardBoolean {.
    importcpp: "Item", header: "IFSelect_AppliedModifiers.hxx".}
proc itemNum*(this: IFSelectAppliedModifiers; nument: StandardInteger): StandardInteger {.
...
proc isForAll*(this: IFSelectAppliedModifiers): StandardBoolean {.noSideEffect,
