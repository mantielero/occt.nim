...
proc constructIFSelectCheckCounter*(withlist: StandardBoolean = standardFalse): IFSelectCheckCounter {.
...
proc analyse*(this: var IFSelectCheckCounter; list: InterfaceCheckIterator;
             ...
             original: StandardBoolean = standardFalse;
             failsonly: StandardBoolean = standardFalse) {.importcpp: "Analyse",
    header: "IFSelect_CheckCounter.hxx".}
type
