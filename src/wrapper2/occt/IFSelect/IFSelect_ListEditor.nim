...
proc constructIFSelectListEditor*(def: Handle[InterfaceTypedValue];
                                 max: StandardInteger = 0): IFSelectListEditor {.
...
proc loadEdited*(this: var IFSelectListEditor;
                list: Handle[TColStdHSequenceOfHAsciiString]): StandardBoolean {.
    importcpp: "LoadEdited", header: "IFSelect_ListEditor.hxx".}
proc setValue*(this: var IFSelectListEditor; num: StandardInteger;
              val: Handle[TCollectionHAsciiString]): StandardBoolean {.
...
proc addValue*(this: var IFSelectListEditor; val: Handle[TCollectionHAsciiString];
              atnum: StandardInteger = 0): StandardBoolean {.importcpp: "AddValue",
    header: "IFSelect_ListEditor.hxx".}
proc remove*(this: var IFSelectListEditor; num: StandardInteger = 0;
            howmany: StandardInteger = 1): StandardBoolean {.importcpp: "Remove",
    header: "IFSelect_ListEditor.hxx".}
...
proc nbValues*(this: IFSelectListEditor; edited: StandardBoolean = standardTrue): StandardInteger {.
    noSideEffect, importcpp: "NbValues", header: "IFSelect_ListEditor.hxx".}
proc value*(this: IFSelectListEditor; num: StandardInteger;
           edited: StandardBoolean = standardTrue): Handle[TCollectionHAsciiString] {.
    noSideEffect, importcpp: "Value", header: "IFSelect_ListEditor.hxx".}
proc isChanged*(this: IFSelectListEditor; num: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsChanged", header: "IFSelect_ListEditor.hxx".}
proc isModified*(this: IFSelectListEditor; num: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsModified", header: "IFSelect_ListEditor.hxx".}
proc isAdded*(this: IFSelectListEditor; num: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsAdded", header: "IFSelect_ListEditor.hxx".}
proc isTouched*(this: IFSelectListEditor): StandardBoolean {.noSideEffect,
