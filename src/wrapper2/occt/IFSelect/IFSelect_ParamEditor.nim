...
proc constructIFSelectParamEditor*(nbmax: StandardInteger = 100;
                                  label: StandardCString = ""): IFSelectParamEditor {.
...
proc recognize*(this: IFSelectParamEditor; form: Handle[IFSelectEditForm]): StandardBoolean {.
