...
proc constructIFSelectSignatureList*(withlist: StandardBoolean = standardFalse): IFSelectSignatureList {.
    constructor, importcpp: "IFSelect_SignatureList(@)",
    header: "IFSelect_SignatureList.hxx".}
proc setList*(this: var IFSelectSignatureList; withlist: StandardBoolean) {.
    importcpp: "SetList", header: "IFSelect_SignatureList.hxx".}
proc modeSignOnly*(this: var IFSelectSignatureList): var StandardBoolean {.
...
proc init*(this: var IFSelectSignatureList; name: StandardCString; count: NCollectionIndexedDataMap[
    TCollectionAsciiString, StandardInteger]; list: NCollectionIndexedDataMap[
    TCollectionAsciiString, Handle[StandardTransient]]; nbnuls: StandardInteger) {.
...
proc list*(this: IFSelectSignatureList; root: StandardCString = ""): Handle[
    TColStdHSequenceOfHAsciiString] {.noSideEffect, importcpp: "List",
                                     header: "IFSelect_SignatureList.hxx".}
proc hasEntities*(this: IFSelectSignatureList): StandardBoolean {.noSideEffect,
    importcpp: "HasEntities", header: "IFSelect_SignatureList.hxx".}
proc nbNulls*(this: IFSelectSignatureList): StandardInteger {.noSideEffect,
    importcpp: "NbNulls", header: "IFSelect_SignatureList.hxx".}
proc nbTimes*(this: IFSelectSignatureList; sign: StandardCString): StandardInteger {.
