...
proc readFile*(this: IFSelectWorkLibrary; name: StandardCString;
              ...
              protocol: Handle[InterfaceProtocol]): StandardInteger {.noSideEffect,
...
proc readStream*(this: IFSelectWorkLibrary; theName: StandardCString;
                ...
                model: var Handle[InterfaceInterfaceModel];
                protocol: Handle[InterfaceProtocol]): StandardInteger {.
    noSideEffect, importcpp: "ReadStream", header: "IFSelect_WorkLibrary.hxx".}
proc writeFile*(this: IFSelectWorkLibrary; ctx: var IFSelectContextWrite): StandardBoolean {.
...
proc dumpEntity*(this: IFSelectWorkLibrary; model: Handle[InterfaceInterfaceModel];
                ...
                level: StandardInteger) {.noSideEffect, importcpp: "DumpEntity",
                                        header: "IFSelect_WorkLibrary.hxx".}
proc dumpEntity*(this: IFSelectWorkLibrary; model: Handle[InterfaceInterfaceModel];
                protocol: Handle[InterfaceProtocol];
                entity: Handle[StandardTransient]; s: var StandardOStream) {.
    noSideEffect, importcpp: "DumpEntity", header: "IFSelect_WorkLibrary.hxx".}
proc setDumpLevels*(this: var IFSelectWorkLibrary; def: StandardInteger;
                   max: StandardInteger) {.importcpp: "SetDumpLevels",
    header: "IFSelect_WorkLibrary.hxx".}
proc dumpLevels*(this: IFSelectWorkLibrary; def: var StandardInteger;
                max: var StandardInteger) {.noSideEffect, importcpp: "DumpLevels",
    header: "IFSelect_WorkLibrary.hxx".}
proc setDumpHelp*(this: var IFSelectWorkLibrary; level: StandardInteger;
                 help: StandardCString) {.importcpp: "SetDumpHelp",
                                        header: "IFSelect_WorkLibrary.hxx".}
proc dumpHelp*(this: IFSelectWorkLibrary; level: StandardInteger): StandardCString {.
