...
proc init*(this: var IGESAppliLevelFunction; nbPropVal: StandardInteger;
          aCode: StandardInteger; aFuncDescrip: Handle[TCollectionHAsciiString]) {.
    importcpp: "Init", header: "IGESAppli_LevelFunction.hxx".}
proc nbPropertyValues*(this: IGESAppliLevelFunction): StandardInteger {.
    noSideEffect, importcpp: "NbPropertyValues",
    header: "IGESAppli_LevelFunction.hxx".}
proc funcDescriptionCode*(this: IGESAppliLevelFunction): StandardInteger {.
