...
proc init*(this: var IGESAppliLevelToPWBLayerMap; nbPropVal: StandardInteger;
...
proc nbPropertyValues*(this: IGESAppliLevelToPWBLayerMap): StandardInteger {.
    noSideEffect, importcpp: "NbPropertyValues",
    header: "IGESAppli_LevelToPWBLayerMap.hxx".}
proc nbLevelToLayerDefs*(this: IGESAppliLevelToPWBLayerMap): StandardInteger {.
    noSideEffect, importcpp: "NbLevelToLayerDefs",
    header: "IGESAppli_LevelToPWBLayerMap.hxx".}
proc exchangeFileLevelNumber*(this: IGESAppliLevelToPWBLayerMap;
                             index: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "ExchangeFileLevelNumber",
    header: "IGESAppli_LevelToPWBLayerMap.hxx".}
proc nativeLevel*(this: IGESAppliLevelToPWBLayerMap; index: StandardInteger): Handle[
    TCollectionHAsciiString] {.noSideEffect, importcpp: "NativeLevel",
                              header: "IGESAppli_LevelToPWBLayerMap.hxx".}
proc physicalLayerNumber*(this: IGESAppliLevelToPWBLayerMap; index: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "PhysicalLayerNumber",
    header: "IGESAppli_LevelToPWBLayerMap.hxx".}
proc exchangeFileLevelIdent*(this: IGESAppliLevelToPWBLayerMap;
                            index: StandardInteger): Handle[
