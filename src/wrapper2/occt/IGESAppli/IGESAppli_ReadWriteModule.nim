...
discard "forward decl of IGESAppli_ReadWriteModule"
type
  HandleIGESAppliReadWriteModule* = Handle[IGESAppliReadWriteModule]
...
proc caseIGES*(this: IGESAppliReadWriteModule; typenum: StandardInteger;
              formnum: StandardInteger): StandardInteger {.noSideEffect,
    importcpp: "CaseIGES", header: "IGESAppli_ReadWriteModule.hxx".}
proc readOwnParams*(this: IGESAppliReadWriteModule; cn: StandardInteger;
                   ent: Handle[IGESDataIGESEntity];
                   ir: Handle[IGESDataIGESReaderData]; pr: var IGESDataParamReader) {.
    noSideEffect, importcpp: "ReadOwnParams",
    header: "IGESAppli_ReadWriteModule.hxx".}
proc writeOwnParams*(this: IGESAppliReadWriteModule; cn: StandardInteger;
