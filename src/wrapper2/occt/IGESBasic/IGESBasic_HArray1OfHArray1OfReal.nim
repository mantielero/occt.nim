...
proc constructIGESBasicHArray1OfHArray1OfReal*(low: StandardInteger;
    up: StandardInteger): IGESBasicHArray1OfHArray1OfReal {.constructor,
    importcpp: "IGESBasic_HArray1OfHArray1OfReal(@)",
    header: "IGESBasic_HArray1OfHArray1OfReal.hxx".}
proc lower*(this: IGESBasicHArray1OfHArray1OfReal): StandardInteger {.noSideEffect,
    importcpp: "Lower", header: "IGESBasic_HArray1OfHArray1OfReal.hxx".}
proc upper*(this: IGESBasicHArray1OfHArray1OfReal): StandardInteger {.noSideEffect,
    importcpp: "Upper", header: "IGESBasic_HArray1OfHArray1OfReal.hxx".}
proc length*(this: IGESBasicHArray1OfHArray1OfReal): StandardInteger {.noSideEffect,
    importcpp: "Length", header: "IGESBasic_HArray1OfHArray1OfReal.hxx".}
proc setValue*(this: var IGESBasicHArray1OfHArray1OfReal; num: StandardInteger;
              val: Handle[TColStdHArray1OfReal]) {.importcpp: "SetValue",
    header: "IGESBasic_HArray1OfHArray1OfReal.hxx".}
proc value*(this: IGESBasicHArray1OfHArray1OfReal; num: StandardInteger): Handle[
