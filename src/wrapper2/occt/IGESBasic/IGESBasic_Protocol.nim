...
discard "forward decl of IGESBasic_Protocol"
type
  HandleIGESBasicProtocol* = Handle[IGESBasicProtocol]
...
proc nbResources*(this: IGESBasicProtocol): StandardInteger {.noSideEffect,
    importcpp: "NbResources", header: "IGESBasic_Protocol.hxx".}
proc resource*(this: IGESBasicProtocol; num: StandardInteger): Handle[
    InterfaceProtocol] {.noSideEffect, importcpp: "Resource",
                        header: "IGESBasic_Protocol.hxx".}
proc typeNumber*(this: IGESBasicProtocol; atype: Handle[StandardType]): StandardInteger {.
