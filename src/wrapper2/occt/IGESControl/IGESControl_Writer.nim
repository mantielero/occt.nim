...
proc constructIGESControlWriter*(unit: StandardCString; modecr: StandardInteger = 0): IGESControlWriter {.
    constructor, importcpp: "IGESControl_Writer(@)",
    header: "IGESControl_Writer.hxx".}
proc constructIGESControlWriter*(model: Handle[IGESDataIGESModel];
                                modecr: StandardInteger = 0): IGESControlWriter {.
    constructor, importcpp: "IGESControl_Writer(@)",
    header: "IGESControl_Writer.hxx".}
...
proc addGeom*(this: var IGESControlWriter; geom: Handle[StandardTransient]): StandardBoolean {.
    importcpp: "AddGeom", header: "IGESControl_Writer.hxx".}
proc addEntity*(this: var IGESControlWriter; ent: Handle[IGESDataIGESEntity]): StandardBoolean {.
    importcpp: "AddEntity", header: "IGESControl_Writer.hxx".}
proc computeModel*(this: var IGESControlWriter) {.importcpp: "ComputeModel",
    header: "IGESControl_Writer.hxx".}
proc write*(this: var IGESControlWriter; s: var StandardOStream;
           fnes: StandardBoolean = standardFalse): StandardBoolean {.
    importcpp: "Write", header: "IGESControl_Writer.hxx".}
proc write*(this: var IGESControlWriter; file: StandardCString;
           fnes: StandardBoolean = standardFalse): StandardBoolean {.
    importcpp: "Write", header: "IGESControl_Writer.hxx".}
