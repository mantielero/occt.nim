...
proc constructIGESDataDirChecker*(atype: StandardInteger): IGESDataDirChecker {.
    constructor, importcpp: "IGESData_DirChecker(@)",
    header: "IGESData_DirChecker.hxx".}
proc constructIGESDataDirChecker*(atype: StandardInteger; aform: StandardInteger): IGESDataDirChecker {.
    constructor, importcpp: "IGESData_DirChecker(@)",
    header: "IGESData_DirChecker.hxx".}
proc constructIGESDataDirChecker*(atype: StandardInteger; aform1: StandardInteger;
                                 aform2: StandardInteger): IGESDataDirChecker {.
    constructor, importcpp: "IGESData_DirChecker(@)",
    header: "IGESData_DirChecker.hxx".}
proc isSet*(this: IGESDataDirChecker): StandardBoolean {.noSideEffect,
...
proc color*(this: var IGESDataDirChecker; crit: IGESDataDefType) {.importcpp: "Color",
    header: "IGESData_DirChecker.hxx".}
proc graphicsIgnored*(this: var IGESDataDirChecker; hierarchy: StandardInteger = -1) {.
...
proc blankStatusRequired*(this: var IGESDataDirChecker; val: StandardInteger) {.
...
proc subordinateStatusRequired*(this: var IGESDataDirChecker; val: StandardInteger) {.
...
proc useFlagIgnored*(this: var IGESDataDirChecker) {.importcpp: "UseFlagIgnored",
    header: "IGESData_DirChecker.hxx".}
proc useFlagRequired*(this: var IGESDataDirChecker; val: StandardInteger) {.
...
proc hierarchyStatusRequired*(this: var IGESDataDirChecker; val: StandardInteger) {.
...
proc correct*(this: IGESDataDirChecker; ent: Handle[IGESDataIGESEntity]): StandardBoolean {.
