...
proc init*(this: var IGESDefsAttributeDef; aName: Handle[TCollectionHAsciiString];
          aListType: StandardInteger; attrTypes: Handle[TColStdHArray1OfInteger];
...
proc hasTableName*(this: IGESDefsAttributeDef): StandardBoolean {.noSideEffect,
...
proc listType*(this: IGESDefsAttributeDef): StandardInteger {.noSideEffect,
    importcpp: "ListType", header: "IGESDefs_AttributeDef.hxx".}
proc nbAttributes*(this: IGESDefsAttributeDef): StandardInteger {.noSideEffect,
    importcpp: "NbAttributes", header: "IGESDefs_AttributeDef.hxx".}
proc attributeType*(this: IGESDefsAttributeDef; num: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "AttributeType", header: "IGESDefs_AttributeDef.hxx".}
proc attributeValueDataType*(this: IGESDefsAttributeDef; num: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "AttributeValueDataType",
    header: "IGESDefs_AttributeDef.hxx".}
proc attributeValueCount*(this: IGESDefsAttributeDef; num: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "AttributeValueCount",
    header: "IGESDefs_AttributeDef.hxx".}
proc hasValues*(this: IGESDefsAttributeDef): StandardBoolean {.noSideEffect,
    importcpp: "HasValues", header: "IGESDefs_AttributeDef.hxx".}
proc hasTextDisplay*(this: IGESDefsAttributeDef): StandardBoolean {.noSideEffect,
    importcpp: "HasTextDisplay", header: "IGESDefs_AttributeDef.hxx".}
proc attributeTextDisplay*(this: IGESDefsAttributeDef; attrNum: StandardInteger;
                          pointerNum: StandardInteger): Handle[
    IGESGraphTextDisplayTemplate] {.noSideEffect,
                                   importcpp: "AttributeTextDisplay",
                                   header: "IGESDefs_AttributeDef.hxx".}
proc attributeList*(this: IGESDefsAttributeDef; attrNum: StandardInteger): Handle[
    StandardTransient] {.noSideEffect, importcpp: "AttributeList",
                        header: "IGESDefs_AttributeDef.hxx".}
proc attributeAsInteger*(this: IGESDefsAttributeDef; attrNum: StandardInteger;
                        valueNum: StandardInteger): StandardInteger {.noSideEffect,
    importcpp: "AttributeAsInteger", header: "IGESDefs_AttributeDef.hxx".}
proc attributeAsReal*(this: IGESDefsAttributeDef; attrNum: StandardInteger;
                     valueNum: StandardInteger): StandardReal {.noSideEffect,
    importcpp: "AttributeAsReal", header: "IGESDefs_AttributeDef.hxx".}
proc attributeAsString*(this: IGESDefsAttributeDef; attrNum: StandardInteger;
                       valueNum: StandardInteger): Handle[TCollectionHAsciiString] {.
    noSideEffect, importcpp: "AttributeAsString",
    header: "IGESDefs_AttributeDef.hxx".}
proc attributeAsEntity*(this: IGESDefsAttributeDef; attrNum: StandardInteger;
                       valueNum: StandardInteger): Handle[IGESDataIGESEntity] {.
    noSideEffect, importcpp: "AttributeAsEntity",
    header: "IGESDefs_AttributeDef.hxx".}
proc attributeAsLogical*(this: IGESDefsAttributeDef; attrNum: StandardInteger;
                        valueNum: StandardInteger): StandardBoolean {.noSideEffect,
    importcpp: "AttributeAsLogical", header: "IGESDefs_AttributeDef.hxx".}
type
