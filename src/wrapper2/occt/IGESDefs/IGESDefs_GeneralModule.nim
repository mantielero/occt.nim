...
discard "forward decl of IGESDefs_GeneralModule"
type
  HandleIGESDefsGeneralModule* = Handle[IGESDefsGeneralModule]
...
proc categoryNumber*(this: IGESDefsGeneralModule; cn: StandardInteger;
