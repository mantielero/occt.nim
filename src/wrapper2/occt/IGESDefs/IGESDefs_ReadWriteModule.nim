...
proc caseIGES*(this: IGESDefsReadWriteModule; typenum: StandardInteger;
              formnum: StandardInteger): StandardInteger {.noSideEffect,
    importcpp: "CaseIGES", header: "IGESDefs_ReadWriteModule.hxx".}
proc readOwnParams*(this: IGESDefsReadWriteModule; cn: StandardInteger;
                   ent: Handle[IGESDataIGESEntity];
                   ir: Handle[IGESDataIGESReaderData]; pr: var IGESDataParamReader) {.
    noSideEffect, importcpp: "ReadOwnParams",
    header: "IGESDefs_ReadWriteModule.hxx".}
proc writeOwnParams*(this: IGESDefsReadWriteModule; cn: StandardInteger;
