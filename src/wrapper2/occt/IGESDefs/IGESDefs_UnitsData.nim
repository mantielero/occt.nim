...
proc nbUnits*(this: IGESDefsUnitsData): StandardInteger {.noSideEffect,
    importcpp: "NbUnits", header: "IGESDefs_UnitsData.hxx".}
proc unitType*(this: IGESDefsUnitsData; unitNum: StandardInteger): Handle[
    TCollectionHAsciiString] {.noSideEffect, importcpp: "UnitType",
                              header: "IGESDefs_UnitsData.hxx".}
proc unitValue*(this: IGESDefsUnitsData; unitNum: StandardInteger): Handle[
    TCollectionHAsciiString] {.noSideEffect, importcpp: "UnitValue",
                              header: "IGESDefs_UnitsData.hxx".}
proc scaleFactor*(this: IGESDefsUnitsData; unitNum: StandardInteger): StandardReal {.
