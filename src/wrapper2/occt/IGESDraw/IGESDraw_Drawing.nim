...
proc nbViews*(this: IGESDrawDrawing): StandardInteger {.noSideEffect,
    importcpp: "NbViews", header: "IGESDraw_Drawing.hxx".}
proc viewItem*(this: IGESDrawDrawing; viewIndex: StandardInteger): Handle[
    IGESDataViewKindEntity] {.noSideEffect, importcpp: "ViewItem",
                             header: "IGESDraw_Drawing.hxx".}
proc viewOrigin*(this: IGESDrawDrawing; tViewIndex: StandardInteger): GpPnt2d {.
    noSideEffect, importcpp: "ViewOrigin", header: "IGESDraw_Drawing.hxx".}
proc nbAnnotations*(this: IGESDrawDrawing): StandardInteger {.noSideEffect,
    importcpp: "NbAnnotations", header: "IGESDraw_Drawing.hxx".}
proc annotation*(this: IGESDrawDrawing; annotationIndex: StandardInteger): Handle[
    IGESDataIGESEntity] {.noSideEffect, importcpp: "Annotation",
                         header: "IGESDraw_Drawing.hxx".}
proc viewToDrawing*(this: IGESDrawDrawing; numView: StandardInteger;
                   viewCoords: GpXYZ): GpXY {.noSideEffect,
    importcpp: "ViewToDrawing", header: "IGESDraw_Drawing.hxx".}
proc drawingUnit*(this: IGESDrawDrawing; value: var StandardReal): StandardBoolean {.
    noSideEffect, importcpp: "DrawingUnit", header: "IGESDraw_Drawing.hxx".}
proc drawingSize*(this: IGESDrawDrawing; x: var StandardReal; y: var StandardReal): StandardBoolean {.
