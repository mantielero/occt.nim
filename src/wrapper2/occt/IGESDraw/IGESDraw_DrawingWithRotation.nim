...
proc nbViews*(this: IGESDrawDrawingWithRotation): StandardInteger {.noSideEffect,
    importcpp: "NbViews", header: "IGESDraw_DrawingWithRotation.hxx".}
proc viewItem*(this: IGESDrawDrawingWithRotation; index: StandardInteger): Handle[
    IGESDataViewKindEntity] {.noSideEffect, importcpp: "ViewItem",
                             header: "IGESDraw_DrawingWithRotation.hxx".}
proc viewOrigin*(this: IGESDrawDrawingWithRotation; index: StandardInteger): GpPnt2d {.
    noSideEffect, importcpp: "ViewOrigin",
    header: "IGESDraw_DrawingWithRotation.hxx".}
proc orientationAngle*(this: IGESDrawDrawingWithRotation; index: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "OrientationAngle",
    header: "IGESDraw_DrawingWithRotation.hxx".}
proc nbAnnotations*(this: IGESDrawDrawingWithRotation): StandardInteger {.
    noSideEffect, importcpp: "NbAnnotations",
    header: "IGESDraw_DrawingWithRotation.hxx".}
proc annotation*(this: IGESDrawDrawingWithRotation; index: StandardInteger): Handle[
    IGESDataIGESEntity] {.noSideEffect, importcpp: "Annotation",
                         header: "IGESDraw_DrawingWithRotation.hxx".}
proc viewToDrawing*(this: IGESDrawDrawingWithRotation; numView: StandardInteger;
                   viewCoords: GpXYZ): GpXY {.noSideEffect,
    importcpp: "ViewToDrawing", header: "IGESDraw_DrawingWithRotation.hxx".}
proc drawingUnit*(this: IGESDrawDrawingWithRotation; value: var StandardReal): StandardBoolean {.
    noSideEffect, importcpp: "DrawingUnit",
    header: "IGESDraw_DrawingWithRotation.hxx".}
proc drawingSize*(this: IGESDrawDrawingWithRotation; x: var StandardReal;
                 y: var StandardReal): StandardBoolean {.noSideEffect,
