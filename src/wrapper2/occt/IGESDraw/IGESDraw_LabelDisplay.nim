...
proc nbLabels*(this: IGESDrawLabelDisplay): StandardInteger {.noSideEffect,
    importcpp: "NbLabels", header: "IGESDraw_LabelDisplay.hxx".}
proc viewItem*(this: IGESDrawLabelDisplay; viewIndex: StandardInteger): Handle[
    IGESDataViewKindEntity] {.noSideEffect, importcpp: "ViewItem",
                             header: "IGESDraw_LabelDisplay.hxx".}
proc textLocation*(this: IGESDrawLabelDisplay; viewIndex: StandardInteger): GpPnt {.
    noSideEffect, importcpp: "TextLocation", header: "IGESDraw_LabelDisplay.hxx".}
proc leaderEntity*(this: IGESDrawLabelDisplay; viewIndex: StandardInteger): Handle[
    IGESDimenLeaderArrow] {.noSideEffect, importcpp: "LeaderEntity",
                           header: "IGESDraw_LabelDisplay.hxx".}
proc labelLevel*(this: IGESDrawLabelDisplay; viewIndex: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "LabelLevel", header: "IGESDraw_LabelDisplay.hxx".}
proc displayedEntity*(this: IGESDrawLabelDisplay; entityIndex: StandardInteger): Handle[
    IGESDataIGESEntity] {.noSideEffect, importcpp: "DisplayedEntity",
                         header: "IGESDraw_LabelDisplay.hxx".}
proc transformedTextLocation*(this: IGESDrawLabelDisplay;
                             viewIndex: StandardInteger): GpPnt {.noSideEffect,
