...
proc caseIGES*(this: IGESDrawReadWriteModule; typenum: StandardInteger;
              formnum: StandardInteger): StandardInteger {.noSideEffect,
    importcpp: "CaseIGES", header: "IGESDraw_ReadWriteModule.hxx".}
proc readOwnParams*(this: IGESDrawReadWriteModule; cn: StandardInteger;
                   ent: Handle[IGESDataIGESEntity];
                   ir: Handle[IGESDataIGESReaderData]; pr: var IGESDataParamReader) {.
    noSideEffect, importcpp: "ReadOwnParams",
    header: "IGESDraw_ReadWriteModule.hxx".}
proc writeOwnParams*(this: IGESDrawReadWriteModule; cn: StandardInteger;
