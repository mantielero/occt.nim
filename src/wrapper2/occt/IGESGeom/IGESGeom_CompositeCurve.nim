...
proc nbCurves*(this: IGESGeomCompositeCurve): StandardInteger {.noSideEffect,
    importcpp: "NbCurves", header: "IGESGeom_CompositeCurve.hxx".}
proc curve*(this: IGESGeomCompositeCurve; index: StandardInteger): Handle[
    IGESDataIGESEntity] {.noSideEffect, importcpp: "Curve",
                         header: "IGESGeom_CompositeCurve.hxx".}
type
