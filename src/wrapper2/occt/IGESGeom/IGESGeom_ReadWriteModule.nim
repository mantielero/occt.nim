...
proc caseIGES*(this: IGESGeomReadWriteModule; typenum: StandardInteger;
              formnum: StandardInteger): StandardInteger {.noSideEffect,
    importcpp: "CaseIGES", header: "IGESGeom_ReadWriteModule.hxx".}
proc readOwnParams*(this: IGESGeomReadWriteModule; cn: StandardInteger;
                   ent: Handle[IGESDataIGESEntity];
                   ir: Handle[IGESDataIGESReaderData]; pr: var IGESDataParamReader) {.
    noSideEffect, importcpp: "ReadOwnParams",
    header: "IGESGeom_ReadWriteModule.hxx".}
proc writeOwnParams*(this: IGESGeomReadWriteModule; cn: StandardInteger;
