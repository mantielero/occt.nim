...
proc init*(this: var IGESGeomTransformationMatrix;
    ...
    header: "IGESGeom_TransformationMatrix.hxx".}
proc setFormNumber*(this: var IGESGeomTransformationMatrix; form: StandardInteger) {.
    importcpp: "SetFormNumber", header: "IGESGeom_TransformationMatrix.hxx".}
proc data*(this: IGESGeomTransformationMatrix; i: StandardInteger; j: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "Data", header: "IGESGeom_TransformationMatrix.hxx".}
proc value*(this: IGESGeomTransformationMatrix): GpGTrsf {.noSideEffect,
