...
proc init*(this: var IGESGraphDrawingSize; nbProps: StandardInteger;
          aXSize: StandardReal; aYSize: StandardReal) {.importcpp: "Init",
    header: "IGESGraph_DrawingSize.hxx".}
proc nbPropertyValues*(this: IGESGraphDrawingSize): StandardInteger {.noSideEffect,
    importcpp: "NbPropertyValues", header: "IGESGraph_DrawingSize.hxx".}
proc xSize*(this: IGESGraphDrawingSize): StandardReal {.noSideEffect,
    importcpp: "XSize", header: "IGESGraph_DrawingSize.hxx".}
proc ySize*(this: IGESGraphDrawingSize): StandardReal {.noSideEffect,
