...
proc constructIGESGraphHArray1OfTextDisplayTemplate*(theLower: StandardInteger;
    theUpper: StandardInteger): IGESGraphHArray1OfTextDisplayTemplate {.
    constructor, importcpp: "IGESGraph_HArray1OfTextDisplayTemplate(@)",
    header: "IGESGraph_HArray1OfTextDisplayTemplate.hxx".}
proc constructIGESGraphHArray1OfTextDisplayTemplate*(theLower: StandardInteger;
    theUpper: StandardInteger; theValue: ValueType): IGESGraphHArray1OfTextDisplayTemplate {.
    constructor, importcpp: "IGESGraph_HArray1OfTextDisplayTemplate(@)",
    header: "IGESGraph_HArray1OfTextDisplayTemplate.hxx".}
