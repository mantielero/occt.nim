...
proc caseIGES*(this: IGESGraphReadWriteModule; typenum: StandardInteger;
              formnum: StandardInteger): StandardInteger {.noSideEffect,
    importcpp: "CaseIGES", header: "IGESGraph_ReadWriteModule.hxx".}
proc readOwnParams*(this: IGESGraphReadWriteModule; cn: StandardInteger;
                   ent: Handle[IGESDataIGESEntity];
                   ir: Handle[IGESDataIGESReaderData]; pr: var IGESDataParamReader) {.
    noSideEffect, importcpp: "ReadOwnParams",
    header: "IGESGraph_ReadWriteModule.hxx".}
proc writeOwnParams*(this: IGESGraphReadWriteModule; cn: StandardInteger;
