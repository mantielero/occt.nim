...
proc recognize*(this: IGESSelectEditHeader; form: Handle[IFSelectEditForm]): StandardBoolean {.
...
proc update*(this: IGESSelectEditHeader; form: Handle[IFSelectEditForm];
