...
proc add*(this: var IGESSelectViewSorter; ent: Handle[StandardTransient]): StandardBoolean {.
    importcpp: "Add", header: "IGESSelect_ViewSorter.hxx".}
proc addEntity*(this: var IGESSelectViewSorter; igesent: Handle[IGESDataIGESEntity]): StandardBoolean {.
...
proc addModel*(this: var IGESSelectViewSorter;
    ...
    header: "IGESSelect_ViewSorter.hxx".}
proc nbEntities*(this: IGESSelectViewSorter): StandardInteger {.noSideEffect,
    importcpp: "NbEntities", header: "IGESSelect_ViewSorter.hxx".}
proc sortSingleViews*(this: var IGESSelectViewSorter; alsoframes: StandardBoolean) {.
...
proc nbSets*(this: IGESSelectViewSorter; final: StandardBoolean): StandardInteger {.
    noSideEffect, importcpp: "NbSets", header: "IGESSelect_ViewSorter.hxx".}
proc setItem*(this: IGESSelectViewSorter; num: StandardInteger;
             final: StandardBoolean): Handle[IGESDataIGESEntity] {.noSideEffect,
    importcpp: "SetItem", header: "IGESSelect_ViewSorter.hxx".}
proc sets*(this: IGESSelectViewSorter; final: StandardBoolean): Handle[
    IFSelectPacketList] {.noSideEffect, importcpp: "Sets",
                         header: "IGESSelect_ViewSorter.hxx".}
type
