...
proc constructIGESSelectWorkLibrary*(modefnes: StandardBoolean = standardFalse): IGESSelectWorkLibrary {.
...
proc writeFile*(this: IGESSelectWorkLibrary; ctx: var IFSelectContextWrite): StandardBoolean {.
