...
proc length*(this: IGESSolidBooleanTree): StandardInteger {.noSideEffect,
    importcpp: "Length", header: "IGESSolid_BooleanTree.hxx".}
proc isOperand*(this: IGESSolidBooleanTree; index: StandardInteger): StandardBoolean {.
    noSideEffect, importcpp: "IsOperand", header: "IGESSolid_BooleanTree.hxx".}
proc operand*(this: IGESSolidBooleanTree; index: StandardInteger): Handle[
    IGESDataIGESEntity] {.noSideEffect, importcpp: "Operand",
                         header: "IGESSolid_BooleanTree.hxx".}
proc operation*(this: IGESSolidBooleanTree; index: StandardInteger): StandardInteger {.
