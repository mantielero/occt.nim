...
proc init*(this: var IGESSolidCylinder; aHeight: StandardReal; aRadius: StandardReal;
          aCenter: GpXYZ; anAxis: GpXYZ) {.importcpp: "Init",
                                       header: "IGESSolid_Cylinder.hxx".}
proc height*(this: IGESSolidCylinder): StandardReal {.noSideEffect,
    importcpp: "Height", header: "IGESSolid_Cylinder.hxx".}
proc radius*(this: IGESSolidCylinder): StandardReal {.noSideEffect,
    importcpp: "Radius", header: "IGESSolid_Cylinder.hxx".}
proc faceCenter*(this: IGESSolidCylinder): GpPnt {.noSideEffect,
    importcpp: "FaceCenter", header: "IGESSolid_Cylinder.hxx".}
proc transformedFaceCenter*(this: IGESSolidCylinder): GpPnt {.noSideEffect,
    importcpp: "TransformedFaceCenter", header: "IGESSolid_Cylinder.hxx".}
proc axis*(this: IGESSolidCylinder): GpDir {.noSideEffect, importcpp: "Axis",
    header: "IGESSolid_Cylinder.hxx".}
proc transformedAxis*(this: IGESSolidCylinder): GpDir {.noSideEffect,
