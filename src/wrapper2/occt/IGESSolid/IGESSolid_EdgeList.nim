...
proc nbEdges*(this: IGESSolidEdgeList): StandardInteger {.noSideEffect,
    importcpp: "NbEdges", header: "IGESSolid_EdgeList.hxx".}
proc curve*(this: IGESSolidEdgeList; num: StandardInteger): Handle[IGESDataIGESEntity] {.
    noSideEffect, importcpp: "Curve", header: "IGESSolid_EdgeList.hxx".}
proc startVertexList*(this: IGESSolidEdgeList; num: StandardInteger): Handle[
    IGESSolidVertexList] {.noSideEffect, importcpp: "StartVertexList",
                          header: "IGESSolid_EdgeList.hxx".}
proc startVertexIndex*(this: IGESSolidEdgeList; num: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "StartVertexIndex", header: "IGESSolid_EdgeList.hxx".}
proc endVertexList*(this: IGESSolidEdgeList; num: StandardInteger): Handle[
    IGESSolidVertexList] {.noSideEffect, importcpp: "EndVertexList",
                          header: "IGESSolid_EdgeList.hxx".}
proc endVertexIndex*(this: IGESSolidEdgeList; num: StandardInteger): StandardInteger {.
