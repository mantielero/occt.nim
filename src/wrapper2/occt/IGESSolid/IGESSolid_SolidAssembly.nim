...
proc hasBrep*(this: IGESSolidSolidAssembly): StandardBoolean {.noSideEffect,
    importcpp: "HasBrep", header: "IGESSolid_SolidAssembly.hxx".}
proc setBrep*(this: var IGESSolidSolidAssembly; hasbrep: StandardBoolean) {.
    importcpp: "SetBrep", header: "IGESSolid_SolidAssembly.hxx".}
proc nbItems*(this: IGESSolidSolidAssembly): StandardInteger {.noSideEffect,
    importcpp: "NbItems", header: "IGESSolid_SolidAssembly.hxx".}
proc item*(this: IGESSolidSolidAssembly; index: StandardInteger): Handle[
    IGESDataIGESEntity] {.noSideEffect, importcpp: "Item",
                         header: "IGESSolid_SolidAssembly.hxx".}
proc transfMatrix*(this: IGESSolidSolidAssembly; index: StandardInteger): Handle[
