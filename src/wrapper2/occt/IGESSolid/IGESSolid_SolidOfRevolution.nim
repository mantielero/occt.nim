...
proc init*(this: var IGESSolidSolidOfRevolution; aCurve: Handle[IGESDataIGESEntity];
          aFract: StandardReal; aAxisPnt: GpXYZ; aDirection: GpXYZ) {.
    importcpp: "Init", header: "IGESSolid_SolidOfRevolution.hxx".}
proc setClosedToAxis*(this: var IGESSolidSolidOfRevolution; mode: StandardBoolean) {.
    importcpp: "SetClosedToAxis", header: "IGESSolid_SolidOfRevolution.hxx".}
proc isClosedToAxis*(this: IGESSolidSolidOfRevolution): StandardBoolean {.
...
proc fraction*(this: IGESSolidSolidOfRevolution): StandardReal {.noSideEffect,
    importcpp: "Fraction", header: "IGESSolid_SolidOfRevolution.hxx".}
proc axisPoint*(this: IGESSolidSolidOfRevolution): GpPnt {.noSideEffect,
    importcpp: "AxisPoint", header: "IGESSolid_SolidOfRevolution.hxx".}
proc transformedAxisPoint*(this: IGESSolidSolidOfRevolution): GpPnt {.noSideEffect,
    importcpp: "TransformedAxisPoint", header: "IGESSolid_SolidOfRevolution.hxx".}
proc axis*(this: IGESSolidSolidOfRevolution): GpDir {.noSideEffect,
    importcpp: "Axis", header: "IGESSolid_SolidOfRevolution.hxx".}
proc transformedAxis*(this: IGESSolidSolidOfRevolution): GpDir {.noSideEffect,
