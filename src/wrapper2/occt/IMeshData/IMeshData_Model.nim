...
proc getMaxSize*(this: IMeshDataModel): StandardReal {.noSideEffect,
...
proc facesNb*(this: IMeshDataModel): StandardInteger {.noSideEffect,
...
proc getFace*(this: IMeshDataModel; theIndex: StandardInteger): IFaceHandle {.
    noSideEffect, importcpp: "GetFace", header: "IMeshData_Model.hxx".}
proc edgesNb*(this: IMeshDataModel): StandardInteger {.noSideEffect,
...
proc getEdge*(this: IMeshDataModel; theIndex: StandardInteger): IEdgeHandle {.
