...
proc writeImage*(this: var ImageTexture; theFile: TCollectionAsciiString): StandardBoolean {.
...
proc isEqual*(theTex1: Handle[ImageTexture]; theTex2: Handle[ImageTexture]): StandardBoolean {.
