...
proc constructIntAna2dIntPoint*(x: StandardReal; y: StandardReal; u1: StandardReal;
                               u2: StandardReal): IntAna2dIntPoint {.constructor,
    importcpp: "IntAna2d_IntPoint(@)", header: "IntAna2d_IntPoint.hxx".}
proc constructIntAna2dIntPoint*(x: StandardReal; y: StandardReal; u1: StandardReal): IntAna2dIntPoint {.
...
proc constructIntAna2dIntPoint*(): IntAna2dIntPoint {.constructor,
    importcpp: "IntAna2d_IntPoint(@)", header: "IntAna2d_IntPoint.hxx".}
proc setValue*(this: var IntAna2dIntPoint; x: StandardReal; y: StandardReal;
              u1: StandardReal; u2: StandardReal) {.importcpp: "SetValue",
    header: "IntAna2d_IntPoint.hxx".}
proc setValue*(this: var IntAna2dIntPoint; x: StandardReal; y: StandardReal;
              u1: StandardReal) {.importcpp: "SetValue",
                                header: "IntAna2d_IntPoint.hxx".}
proc value*(this: IntAna2dIntPoint): GpPnt2d {.noSideEffect, importcpp: "Value",
    header: "IntAna2d_IntPoint.hxx".}
proc secondIsImplicit*(this: IntAna2dIntPoint): StandardBoolean {.noSideEffect,
    importcpp: "SecondIsImplicit", header: "IntAna2d_IntPoint.hxx".}
proc paramOnFirst*(this: IntAna2dIntPoint): StandardReal {.noSideEffect,
    importcpp: "ParamOnFirst", header: "IntAna2d_IntPoint.hxx".}
proc paramOnSecond*(this: IntAna2dIntPoint): StandardReal {.noSideEffect,
