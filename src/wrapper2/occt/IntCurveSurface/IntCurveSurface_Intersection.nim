...
proc isDone*(this: IntCurveSurfaceIntersection): StandardBoolean {.noSideEffect,
    importcpp: "IsDone", header: "IntCurveSurface_Intersection.hxx".}
proc nbPoints*(this: IntCurveSurfaceIntersection): StandardInteger {.noSideEffect,
    importcpp: "NbPoints", header: "IntCurveSurface_Intersection.hxx".}
proc point*(this: IntCurveSurfaceIntersection; index: StandardInteger): IntCurveSurfaceIntersectionPoint {.
    noSideEffect, importcpp: "Point", header: "IntCurveSurface_Intersection.hxx".}
proc nbSegments*(this: IntCurveSurfaceIntersection): StandardInteger {.noSideEffect,
    importcpp: "NbSegments", header: "IntCurveSurface_Intersection.hxx".}
proc segment*(this: IntCurveSurfaceIntersection; index: StandardInteger): IntCurveSurfaceIntersectionSegment {.
    noSideEffect, importcpp: "Segment", header: "IntCurveSurface_Intersection.hxx".}
proc isParallel*(this: IntCurveSurfaceIntersection): StandardBoolean {.noSideEffect,
