...
proc constructIntCurvesFaceIntersector*(f: TopoDS_Face; aTol: StandardReal;
                                       aRestr: StandardBoolean = standardTrue;
    useBToler: StandardBoolean = standardTrue): IntCurvesFaceIntersector {.
    constructor, importcpp: "IntCurvesFace_Intersector(@)",
    header: "IntCurvesFace_Intersector.hxx".}
proc perform*(this: var IntCurvesFaceIntersector; L: GpLin; pInf: StandardReal;
...
proc isDone*(this: IntCurvesFaceIntersector): StandardBoolean {.noSideEffect,
    importcpp: "IsDone", header: "IntCurvesFace_Intersector.hxx".}
proc nbPnt*(this: IntCurvesFaceIntersector): StandardInteger {.noSideEffect,
    importcpp: "NbPnt", header: "IntCurvesFace_Intersector.hxx".}
proc uParameter*(this: IntCurvesFaceIntersector; i: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "UParameter", header: "IntCurvesFace_Intersector.hxx".}
proc vParameter*(this: IntCurvesFaceIntersector; i: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "VParameter", header: "IntCurvesFace_Intersector.hxx".}
proc wParameter*(this: IntCurvesFaceIntersector; i: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "WParameter", header: "IntCurvesFace_Intersector.hxx".}
proc pnt*(this: IntCurvesFaceIntersector; i: StandardInteger): GpPnt {.noSideEffect,
    importcpp: "Pnt", header: "IntCurvesFace_Intersector.hxx".}
proc transition*(this: IntCurvesFaceIntersector; i: StandardInteger): IntCurveSurfaceTransitionOnCurve {.
    noSideEffect, importcpp: "Transition", header: "IntCurvesFace_Intersector.hxx".}
proc state*(this: IntCurvesFaceIntersector; i: StandardInteger): TopAbsState {.
    noSideEffect, importcpp: "State", header: "IntCurvesFace_Intersector.hxx".}
proc isParallel*(this: IntCurvesFaceIntersector): StandardBoolean {.noSideEffect,
...
proc classifyUVPoint*(this: IntCurvesFaceIntersector; puv: GpPnt2d): TopAbsState {.
...
proc setUseBoundToler*(this: var IntCurvesFaceIntersector;
                      useBToler: StandardBoolean) {.importcpp: "SetUseBoundToler",
    header: "IntCurvesFace_Intersector.hxx".}
proc getUseBoundToler*(this: IntCurvesFaceIntersector): StandardBoolean {.
