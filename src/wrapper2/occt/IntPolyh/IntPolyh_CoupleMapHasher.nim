...
proc hashCode*(theCouple: IntPolyhCouple; theUpperBound: StandardInteger): StandardInteger {.
    importcpp: "IntPolyh_CoupleMapHasher::HashCode(@)",
    header: "IntPolyh_CoupleMapHasher.hxx".}
proc isEqual*(theCouple1: IntPolyhCouple; theCouple2: IntPolyhCouple): StandardBoolean {.
