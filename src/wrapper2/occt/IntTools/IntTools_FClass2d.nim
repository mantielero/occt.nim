...
proc constructIntToolsFClass2d*(f: TopoDS_Face; tol: StandardReal): IntToolsFClass2d {.
    constructor, importcpp: "IntTools_FClass2d(@)", header: "IntTools_FClass2d.hxx".}
proc init*(this: var IntToolsFClass2d; f: TopoDS_Face; tol: StandardReal) {.
...
proc perform*(this: IntToolsFClass2d; puv: GpPnt2d;
...
proc destroyIntToolsFClass2d*(this: var IntToolsFClass2d) {.
    importcpp: "#.~IntTools_FClass2d()", header: "IntTools_FClass2d.hxx".}
proc testOnRestriction*(this: IntToolsFClass2d; puv: GpPnt2d; tol: StandardReal;
                       recadreOnPeriodic: StandardBoolean = standardTrue): TopAbsState {.
    noSideEffect, importcpp: "TestOnRestriction", header: "IntTools_FClass2d.hxx".}
proc isHole*(this: IntToolsFClass2d): StandardBoolean {.noSideEffect,
