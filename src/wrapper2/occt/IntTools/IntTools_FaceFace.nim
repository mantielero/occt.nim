...
proc setParameters*(this: var IntToolsFaceFace; approxCurves: StandardBoolean;
                   computeCurveOnS1: StandardBoolean;
                   computeCurveOnS2: StandardBoolean;
                   approximationTolerance: StandardReal) {.
...
proc isDone*(this: IntToolsFaceFace): StandardBoolean {.noSideEffect,
...
proc face2*(this: IntToolsFaceFace): TopoDS_Face {.noSideEffect, importcpp: "Face2",
    header: "IntTools_FaceFace.hxx".}
proc tangentFaces*(this: IntToolsFaceFace): StandardBoolean {.noSideEffect,
    importcpp: "TangentFaces", header: "IntTools_FaceFace.hxx".}
proc prepareLines3D*(this: var IntToolsFaceFace;
                    bToSplit: StandardBoolean = standardTrue) {.
...
proc setFuzzyValue*(this: var IntToolsFaceFace; theFuzz: StandardReal) {.
    importcpp: "SetFuzzyValue", header: "IntTools_FaceFace.hxx".}
proc fuzzyValue*(this: IntToolsFaceFace): StandardReal {.noSideEffect,
