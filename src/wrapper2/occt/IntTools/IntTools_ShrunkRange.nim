...
proc destroyIntToolsShrunkRange*(this: var IntToolsShrunkRange) {.
    importcpp: "#.~IntTools_ShrunkRange()", header: "IntTools_ShrunkRange.hxx".}
proc setData*(this: var IntToolsShrunkRange; aE: TopoDS_Edge; aT1: StandardReal;
             aT2: StandardReal; aV1: TopoDS_Vertex; aV2: TopoDS_Vertex) {.
...
proc setShrunkRange*(this: var IntToolsShrunkRange; aT1: StandardReal;
                    aT2: StandardReal) {.importcpp: "SetShrunkRange",
                                       header: "IntTools_ShrunkRange.hxx".}
proc shrunkRange*(this: IntToolsShrunkRange; aT1: var StandardReal;
                 aT2: var StandardReal) {.noSideEffect, importcpp: "ShrunkRange",
                                       header: "IntTools_ShrunkRange.hxx".}
...
proc perform*(this: var IntToolsShrunkRange) {.importcpp: "Perform",
    header: "IntTools_ShrunkRange.hxx".}
proc isDone*(this: IntToolsShrunkRange): StandardBoolean {.noSideEffect,
    importcpp: "IsDone", header: "IntTools_ShrunkRange.hxx".}
proc isSplittable*(this: IntToolsShrunkRange): StandardBoolean {.noSideEffect,
    importcpp: "IsSplittable", header: "IntTools_ShrunkRange.hxx".}
proc length*(this: IntToolsShrunkRange): StandardReal {.noSideEffect,
