...
proc addFail*(this: var InterfaceCheck; amsg: MessageMsg) {.importcpp: "AddFail",
    header: "Interface_Check.hxx".}
proc hasFailed*(this: InterfaceCheck): StandardBoolean {.noSideEffect,
    importcpp: "HasFailed", header: "Interface_Check.hxx".}
proc nbFails*(this: InterfaceCheck): StandardInteger {.noSideEffect,
    importcpp: "NbFails", header: "Interface_Check.hxx".}
proc fail*(this: InterfaceCheck; num: StandardInteger;
          final: StandardBoolean = standardTrue): Handle[TCollectionHAsciiString] {.
    noSideEffect, importcpp: "Fail", header: "Interface_Check.hxx".}
proc cFail*(this: InterfaceCheck; num: StandardInteger;
           final: StandardBoolean = standardTrue): StandardCString {.noSideEffect,
    importcpp: "CFail", header: "Interface_Check.hxx".}
proc fails*(this: InterfaceCheck; final: StandardBoolean = standardTrue): Handle[
...
proc addWarning*(this: var InterfaceCheck; amsg: MessageMsg) {.
    importcpp: "AddWarning", header: "Interface_Check.hxx".}
proc hasWarnings*(this: InterfaceCheck): StandardBoolean {.noSideEffect,
    importcpp: "HasWarnings", header: "Interface_Check.hxx".}
proc nbWarnings*(this: InterfaceCheck): StandardInteger {.noSideEffect,
    importcpp: "NbWarnings", header: "Interface_Check.hxx".}
proc warning*(this: InterfaceCheck; num: StandardInteger;
             final: StandardBoolean = standardTrue): Handle[TCollectionHAsciiString] {.
    noSideEffect, importcpp: "Warning", header: "Interface_Check.hxx".}
proc cWarning*(this: InterfaceCheck; num: StandardInteger;
              final: StandardBoolean = standardTrue): StandardCString {.noSideEffect,
    importcpp: "CWarning", header: "Interface_Check.hxx".}
proc warnings*(this: InterfaceCheck; final: StandardBoolean = standardTrue): Handle[
...
proc sendMsg*(this: var InterfaceCheck; amsg: MessageMsg) {.importcpp: "SendMsg",
    header: "Interface_Check.hxx".}
proc nbInfoMsgs*(this: InterfaceCheck): StandardInteger {.noSideEffect,
    importcpp: "NbInfoMsgs", header: "Interface_Check.hxx".}
proc infoMsg*(this: InterfaceCheck; num: StandardInteger;
             final: StandardBoolean = standardTrue): Handle[TCollectionHAsciiString] {.
    noSideEffect, importcpp: "InfoMsg", header: "Interface_Check.hxx".}
proc cInfoMsg*(this: InterfaceCheck; num: StandardInteger;
              final: StandardBoolean = standardTrue): StandardCString {.noSideEffect,
    importcpp: "CInfoMsg", header: "Interface_Check.hxx".}
proc infoMsgs*(this: InterfaceCheck; final: StandardBoolean = standardTrue): Handle[
...
proc complies*(this: InterfaceCheck; status: InterfaceCheckStatus): StandardBoolean {.
...
proc complies*(this: InterfaceCheck; mess: Handle[TCollectionHAsciiString];
    ...
    noSideEffect, importcpp: "Complies", header: "Interface_Check.hxx".}
proc hasEntity*(this: InterfaceCheck): StandardBoolean {.noSideEffect,
...
proc mend*(this: var InterfaceCheck; pref: StandardCString; num: StandardInteger = 0): StandardBoolean {.
...
proc getAsWarning*(this: var InterfaceCheck; other: Handle[InterfaceCheck];
                  failsonly: StandardBoolean) {.importcpp: "GetAsWarning",
    header: "Interface_Check.hxx".}
proc print*(this: InterfaceCheck; s: var StandardOStream; level: StandardInteger;
           final: StandardInteger = 1) {.noSideEffect, importcpp: "Print",
                                     header: "Interface_Check.hxx".}
proc trace*(this: InterfaceCheck; level: StandardInteger = -1;
           final: StandardInteger = 1) {.noSideEffect, importcpp: "Trace",
                                     header: "Interface_Check.hxx".}
type
