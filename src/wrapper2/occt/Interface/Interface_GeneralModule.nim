...
proc fillShared*(this: InterfaceGeneralModule;
                model: Handle[InterfaceInterfaceModel]; cn: StandardInteger;
...
proc fillSharedCase*(this: InterfaceGeneralModule; cn: StandardInteger;
