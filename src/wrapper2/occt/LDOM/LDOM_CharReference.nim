...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "LDOM_CharReference.hxx", bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "LDOM_CharReference.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "LDOM_CharReference.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "LDOM_CharReference.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "LDOM_CharReference.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "LDOM_CharReference.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
...
var itInterval* {.importcpp: "it_interval", header: "LDOM_CharReference.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "LDOM_CharReference.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "LDOM_CharReference.hxx".}: array[13,
...
type
  ...
  LDOM_CharReference* {.importcpp: "timex::itimerspec::timespec::__locale_struct::LDOM_CharReference",
                       header: "LDOM_CharReference.hxx", bycopy.} = object


proc decode*(theSrc: cstring; theLen: var StandardInteger): cstring {.
    importcpp: "LDOM_CharReference::Decode(@)", header: "LDOM_CharReference.hxx".}
proc encode*(theSrc: cstring; theLen: var StandardInteger;
            isAttribute: StandardBoolean): cstring {.
