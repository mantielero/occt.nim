...
proc constructLDOM_SBuffer*(theMaxBuf: StandardInteger): LDOM_SBuffer {.constructor,
...
proc length*(this: LDOM_SBuffer): StandardInteger {.noSideEffect,
...
proc constructLDOM_OSStream*(theMaxBuf: StandardInteger): LDOM_OSStream {.
...
proc str*(this: LDOM_OSStream): StandardCString {.noSideEffect, importcpp: "str",
    header: "LDOM_OSStream.hxx".}
proc length*(this: LDOM_OSStream): StandardInteger {.noSideEffect,
    importcpp: "Length", header: "LDOM_OSStream.hxx".}
