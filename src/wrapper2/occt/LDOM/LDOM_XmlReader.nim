...
proc constructLDOM_XmlReader*(aDocument: Handle[LDOM_MemManager];
                             ...
                             theTagPerStep: StandardBoolean = standardFalse): LDOM_XmlReader {.
...
proc createElement*(this: var LDOM_XmlReader; theName: cstring;
                   theLen: StandardInteger) {.importcpp: "CreateElement",
    header: "LDOM_XmlReader.hxx".}
proc getInteger*(theValue: var LDOMBasicString; theStart: cstring; theEnd: cstring): StandardBoolean {.
