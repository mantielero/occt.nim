...
proc addInflection*(this: var LPropCurAndInf; param: StandardReal) {.
    importcpp: "AddInflection", header: "LProp_CurAndInf.hxx".}
proc addExtCur*(this: var LPropCurAndInf; param: StandardReal; isMin: StandardBoolean) {.
...
proc isEmpty*(this: LPropCurAndInf): StandardBoolean {.noSideEffect,
    importcpp: "IsEmpty", header: "LProp_CurAndInf.hxx".}
proc nbPoints*(this: LPropCurAndInf): StandardInteger {.noSideEffect,
    importcpp: "NbPoints", header: "LProp_CurAndInf.hxx".}
proc parameter*(this: LPropCurAndInf; n: StandardInteger): StandardReal {.
    noSideEffect, importcpp: "Parameter", header: "LProp_CurAndInf.hxx".}
proc `type`*(this: LPropCurAndInf; n: StandardInteger): LPropCIType {.noSideEffect,
