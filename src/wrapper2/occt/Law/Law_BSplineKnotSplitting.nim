...
proc constructLawBSplineKnotSplitting*(basisLaw: Handle[LawBSpline];
                                      continuityRange: StandardInteger): LawBSplineKnotSplitting {.
    constructor, importcpp: "Law_BSplineKnotSplitting(@)",
    header: "Law_BSplineKnotSplitting.hxx".}
proc nbSplits*(this: LawBSplineKnotSplitting): StandardInteger {.noSideEffect,
...
proc splitValue*(this: LawBSplineKnotSplitting; index: StandardInteger): StandardInteger {.
