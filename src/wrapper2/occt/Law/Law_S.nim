...
proc set*(this: var LawS; pdeb: StandardReal; valdeb: StandardReal; pfin: StandardReal;
         valfin: StandardReal) {.importcpp: "Set", header: "Law_S.hxx".}
proc set*(this: var LawS; pdeb: StandardReal; valdeb: StandardReal; ddeb: StandardReal;
         pfin: StandardReal; valfin: StandardReal; dfin: StandardReal) {.
