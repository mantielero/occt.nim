...
proc constructLocOpeDPrism*(spine: TopoDS_Face; height1: StandardReal;
                           height2: StandardReal; angle: StandardReal): LocOpeDPrism {.
    constructor, importcpp: "LocOpe_DPrism(@)", header: "LocOpe_DPrism.hxx".}
proc constructLocOpeDPrism*(spine: TopoDS_Face; height: StandardReal;
                           angle: StandardReal): LocOpeDPrism {.constructor,
    importcpp: "LocOpe_DPrism(@)", header: "LocOpe_DPrism.hxx".}
proc isDone*(this: LocOpeDPrism): StandardBoolean {.noSideEffect,
