...
proc canSplit*(this: LocOpeSplitShape; e: TopoDS_Edge): StandardBoolean {.
    noSideEffect, importcpp: "CanSplit", header: "LocOpe_SplitShape.hxx".}
proc add*(this: var LocOpeSplitShape; v: TopoDS_Vertex; p: StandardReal; e: TopoDS_Edge) {.
    importcpp: "Add", header: "LocOpe_SplitShape.hxx".}
proc add*(this: var LocOpeSplitShape; w: TopoDS_Wire; f: TopoDS_Face): StandardBoolean {.
    importcpp: "Add", header: "LocOpe_SplitShape.hxx".}
proc add*(this: var LocOpeSplitShape; lwires: TopToolsListOfShape; f: TopoDS_Face): StandardBoolean {.
    importcpp: "Add", header: "LocOpe_SplitShape.hxx".}
