...
proc constructLocalAnalysisCurveContinuity*(curv1: Handle[GeomCurve];
    u1: StandardReal; curv2: Handle[GeomCurve]; u2: StandardReal; order: GeomAbsShape;
    epsNul: StandardReal = 0.001; epsC0: StandardReal = 0.001;
    epsC1: StandardReal = 0.001; epsC2: StandardReal = 0.001;
    epsG1: StandardReal = 0.001; epsG2: StandardReal = 0.001;
    percent: StandardReal = 0.01; maxlen: StandardReal = 10000): LocalAnalysisCurveContinuity {.
    constructor, importcpp: "LocalAnalysis_CurveContinuity(@)",
    header: "LocalAnalysis_CurveContinuity.hxx".}
proc isDone*(this: LocalAnalysisCurveContinuity): StandardBoolean {.noSideEffect,
...
proc continuityStatus*(this: LocalAnalysisCurveContinuity): GeomAbsShape {.
    ...
    header: "LocalAnalysis_CurveContinuity.hxx".}
proc c0Value*(this: LocalAnalysisCurveContinuity): StandardReal {.noSideEffect,
    importcpp: "C0Value", header: "LocalAnalysis_CurveContinuity.hxx".}
proc c1Angle*(this: LocalAnalysisCurveContinuity): StandardReal {.noSideEffect,
    importcpp: "C1Angle", header: "LocalAnalysis_CurveContinuity.hxx".}
proc c1Ratio*(this: LocalAnalysisCurveContinuity): StandardReal {.noSideEffect,
    importcpp: "C1Ratio", header: "LocalAnalysis_CurveContinuity.hxx".}
proc c2Angle*(this: LocalAnalysisCurveContinuity): StandardReal {.noSideEffect,
    importcpp: "C2Angle", header: "LocalAnalysis_CurveContinuity.hxx".}
proc c2Ratio*(this: LocalAnalysisCurveContinuity): StandardReal {.noSideEffect,
    importcpp: "C2Ratio", header: "LocalAnalysis_CurveContinuity.hxx".}
proc g1Angle*(this: LocalAnalysisCurveContinuity): StandardReal {.noSideEffect,
    importcpp: "G1Angle", header: "LocalAnalysis_CurveContinuity.hxx".}
proc g2Angle*(this: LocalAnalysisCurveContinuity): StandardReal {.noSideEffect,
    importcpp: "G2Angle", header: "LocalAnalysis_CurveContinuity.hxx".}
proc g2CurvatureVariation*(this: LocalAnalysisCurveContinuity): StandardReal {.
    noSideEffect, importcpp: "G2CurvatureVariation",
    header: "LocalAnalysis_CurveContinuity.hxx".}
proc isC0*(this: LocalAnalysisCurveContinuity): StandardBoolean {.noSideEffect,
    importcpp: "IsC0", header: "LocalAnalysis_CurveContinuity.hxx".}
proc isC1*(this: LocalAnalysisCurveContinuity): StandardBoolean {.noSideEffect,
    importcpp: "IsC1", header: "LocalAnalysis_CurveContinuity.hxx".}
proc isC2*(this: LocalAnalysisCurveContinuity): StandardBoolean {.noSideEffect,
    importcpp: "IsC2", header: "LocalAnalysis_CurveContinuity.hxx".}
proc isG1*(this: LocalAnalysisCurveContinuity): StandardBoolean {.noSideEffect,
    importcpp: "IsG1", header: "LocalAnalysis_CurveContinuity.hxx".}
proc isG2*(this: LocalAnalysisCurveContinuity): StandardBoolean {.noSideEffect,
