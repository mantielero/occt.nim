...
proc constructMAT_Arc*(arcIndex: StandardInteger; geomIndex: StandardInteger;
...
proc index*(this: MAT_Arc): StandardInteger {.noSideEffect, importcpp: "Index",
    header: "MAT_Arc.hxx".}
proc geomIndex*(this: MAT_Arc): StandardInteger {.noSideEffect,
...
proc hasNeighbour*(this: MAT_Arc; aNode: Handle[MAT_Node]; aSide: MAT_Side): StandardBoolean {.
...
proc setIndex*(this: var MAT_Arc; anInteger: StandardInteger) {.importcpp: "SetIndex",
    header: "MAT_Arc.hxx".}
proc setGeomIndex*(this: var MAT_Arc; anInteger: StandardInteger) {.
