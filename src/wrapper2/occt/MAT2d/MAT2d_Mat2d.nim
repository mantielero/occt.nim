...
proc constructMAT2dMat2d*(isOpenResult: StandardBoolean = standardFalse): MAT2dMat2d {.
...
proc isDone*(this: MAT2dMat2d): StandardBoolean {.noSideEffect, importcpp: "IsDone",
    header: "MAT2d_Mat2d.hxx".}
proc init*(this: var MAT2dMat2d) {.importcpp: "Init", header: "MAT2d_Mat2d.hxx".}
proc more*(this: MAT2dMat2d): StandardBoolean {.noSideEffect, importcpp: "More",
    header: "MAT2d_Mat2d.hxx".}
...
proc semiInfinite*(this: MAT2dMat2d): StandardBoolean {.noSideEffect,
    importcpp: "SemiInfinite", header: "MAT2d_Mat2d.hxx".}
proc numberOfBisectors*(this: MAT2dMat2d): StandardInteger {.noSideEffect,
