...
proc setInput*(this: var MediaPlayerContext; theInputPath: TCollectionAsciiString;
              theToWait: StandardBoolean) {.importcpp: "SetInput",
    header: "Media_PlayerContext.hxx".}
proc playbackState*(this: var MediaPlayerContext; theIsPaused: var StandardBoolean;
                   theProgress: var StandardReal; theDuration: var StandardReal) {.
    importcpp: "PlaybackState", header: "Media_PlayerContext.hxx".}
proc playPause*(this: var MediaPlayerContext; theIsPaused: var StandardBoolean;
               theProgress: var StandardReal; theDuration: var StandardReal) {.
    importcpp: "PlayPause", header: "Media_PlayerContext.hxx".}
proc seek*(this: var MediaPlayerContext; thePosSec: StandardReal) {.importcpp: "Seek",
    header: "Media_PlayerContext.hxx".}
