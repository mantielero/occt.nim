...
type
  MeshVS_DisplayModeFlags* = Standard_Integer
...
const
  ...
  MeshVS_DMF_OCCMask* = (
    MeshVS_DMF_WireFrame or MeshVS_DMF_Shading or MeshVS_DMF_Shrink) ##  the mask which helps pick out CasCade display mode
  ...
  MeshVS_DMF_DeformedMask* = (MeshVS_DMF_DeformedPrsWireFrame or
      MeshVS_DMF_DeformedPrsShading or MeshVS_DMF_DeformedPrsShrink)
