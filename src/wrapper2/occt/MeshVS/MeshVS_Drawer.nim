...
proc setInteger*(this: var MeshVS_Drawer; key: StandardInteger; value: StandardInteger) {.
    importcpp: "SetInteger", header: "MeshVS_Drawer.hxx".}
proc setDouble*(this: var MeshVS_Drawer; key: StandardInteger; value: StandardReal) {.
    importcpp: "SetDouble", header: "MeshVS_Drawer.hxx".}
proc setBoolean*(this: var MeshVS_Drawer; key: StandardInteger; value: StandardBoolean) {.
    importcpp: "SetBoolean", header: "MeshVS_Drawer.hxx".}
proc setColor*(this: var MeshVS_Drawer; key: StandardInteger; value: QuantityColor) {.
    importcpp: "SetColor", header: "MeshVS_Drawer.hxx".}
proc setMaterial*(this: var MeshVS_Drawer; key: StandardInteger;
                 value: Graphic3dMaterialAspect) {.importcpp: "SetMaterial",
    header: "MeshVS_Drawer.hxx".}
proc setAsciiString*(this: var MeshVS_Drawer; key: StandardInteger;
                    value: TCollectionAsciiString) {.importcpp: "SetAsciiString",
    header: "MeshVS_Drawer.hxx".}
proc getInteger*(this: MeshVS_Drawer; key: StandardInteger;
                value: var StandardInteger): StandardBoolean {.noSideEffect,
    importcpp: "GetInteger", header: "MeshVS_Drawer.hxx".}
proc getDouble*(this: MeshVS_Drawer; key: StandardInteger; value: var StandardReal): StandardBoolean {.
    noSideEffect, importcpp: "GetDouble", header: "MeshVS_Drawer.hxx".}
proc getBoolean*(this: MeshVS_Drawer; key: StandardInteger;
                value: var StandardBoolean): StandardBoolean {.noSideEffect,
    importcpp: "GetBoolean", header: "MeshVS_Drawer.hxx".}
proc getColor*(this: MeshVS_Drawer; key: StandardInteger; value: var QuantityColor): StandardBoolean {.
    noSideEffect, importcpp: "GetColor", header: "MeshVS_Drawer.hxx".}
proc getMaterial*(this: MeshVS_Drawer; key: StandardInteger;
                 value: var Graphic3dMaterialAspect): StandardBoolean {.
    noSideEffect, importcpp: "GetMaterial", header: "MeshVS_Drawer.hxx".}
proc getAsciiString*(this: MeshVS_Drawer; key: StandardInteger;
                    value: var TCollectionAsciiString): StandardBoolean {.
    noSideEffect, importcpp: "GetAsciiString", header: "MeshVS_Drawer.hxx".}
proc removeInteger*(this: var MeshVS_Drawer; key: StandardInteger): StandardBoolean {.
    importcpp: "RemoveInteger", header: "MeshVS_Drawer.hxx".}
proc removeDouble*(this: var MeshVS_Drawer; key: StandardInteger): StandardBoolean {.
    importcpp: "RemoveDouble", header: "MeshVS_Drawer.hxx".}
proc removeBoolean*(this: var MeshVS_Drawer; key: StandardInteger): StandardBoolean {.
    importcpp: "RemoveBoolean", header: "MeshVS_Drawer.hxx".}
proc removeColor*(this: var MeshVS_Drawer; key: StandardInteger): StandardBoolean {.
    importcpp: "RemoveColor", header: "MeshVS_Drawer.hxx".}
proc removeMaterial*(this: var MeshVS_Drawer; key: StandardInteger): StandardBoolean {.
    importcpp: "RemoveMaterial", header: "MeshVS_Drawer.hxx".}
proc removeAsciiString*(this: var MeshVS_Drawer; key: StandardInteger): StandardBoolean {.
