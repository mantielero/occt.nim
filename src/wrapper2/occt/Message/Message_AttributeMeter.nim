...
proc undefinedMetricValue*(): StandardReal {.
...
proc constructMessageAttributeMeter*(theName: TCollectionAsciiString = tCollectionAsciiString()): MessageAttributeMeter {.
    ...
    header: "Message_AttributeMeter.hxx".}
proc hasMetric*(this: MessageAttributeMeter; theMetric: MessageMetricType): StandardBoolean {.
    noSideEffect, importcpp: "HasMetric", header: "Message_AttributeMeter.hxx".}
proc isMetricValid*(this: MessageAttributeMeter; theMetric: MessageMetricType): StandardBoolean {.
    noSideEffect, importcpp: "IsMetricValid", header: "Message_AttributeMeter.hxx".}
proc startValue*(this: MessageAttributeMeter; theMetric: MessageMetricType): StandardReal {.
...
proc setStartValue*(this: var MessageAttributeMeter; theMetric: MessageMetricType;
                   theValue: StandardReal) {.importcpp: "SetStartValue",
    header: "Message_AttributeMeter.hxx".}
proc stopValue*(this: MessageAttributeMeter; theMetric: MessageMetricType): StandardReal {.
...
proc setStopValue*(this: var MessageAttributeMeter; theMetric: MessageMetricType;
                  theValue: StandardReal) {.importcpp: "SetStopValue",
    header: "Message_AttributeMeter.hxx".}
...
proc stopAlert*(theAlert: Handle[MessageAlertExtended]) {.
    ...
    header: "Message_AttributeMeter.hxx".}
proc setAlertMetrics*(theAlert: Handle[MessageAlertExtended];
                     theStartValue: StandardBoolean) {.
