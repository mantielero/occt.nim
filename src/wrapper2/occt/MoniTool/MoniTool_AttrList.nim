...
proc removeAttribute*(this: var MoniToolAttrList; name: StandardCString): StandardBoolean {.
...
proc setIntegerAttribute*(this: var MoniToolAttrList; name: StandardCString;
                         val: StandardInteger) {.importcpp: "SetIntegerAttribute",
    header: "MoniTool_AttrList.hxx".}
...
proc integerAttribute*(this: MoniToolAttrList; name: StandardCString): StandardInteger {.
    noSideEffect, importcpp: "IntegerAttribute", header: "MoniTool_AttrList.hxx".}
proc setRealAttribute*(this: var MoniToolAttrList; name: StandardCString;
                      val: StandardReal) {.importcpp: "SetRealAttribute",
    header: "MoniTool_AttrList.hxx".}
proc getRealAttribute*(this: MoniToolAttrList; name: StandardCString;
                      val: var StandardReal): StandardBoolean {.noSideEffect,
    importcpp: "GetRealAttribute", header: "MoniTool_AttrList.hxx".}
proc realAttribute*(this: MoniToolAttrList; name: StandardCString): StandardReal {.
...
proc getAttributes*(this: var MoniToolAttrList; other: MoniToolAttrList;
                   fromname: StandardCString = "";
                   copied: StandardBoolean = standardTrue) {.
