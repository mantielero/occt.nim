...
type
  NCollectionArray2*[TheItemType] {.importcpp: "NCollection_Array2<\'0>",
                                   header: "NCollection_Array2.hxx", bycopy.} = object ##
                                                                                  ...
                                                                                  ## and
                                                                                  ## Move().
    myUpperRow* {.importc: "myUpperRow".}: StandardInteger
    myLowerCol* {.importc: "myLowerCol".}: StandardInteger
    myUpperCol* {.importc: "myUpperCol".}: StandardInteger
    ...
    myDeletable* {.importc: "myDeletable".}: StandardBoolean ## !< Flag showing who allocated the array
                                                         ##  ----------- FRIEND CLASSES ------------
...
proc constructNCollectionArray2Iterator*[TheItemType](): NCollectionArray2Iterator[
    TheItemType] {.constructor,
                  importcpp: "NCollection_Array2<\'*0>::Iterator(@)",
                  header: "NCollection_Array2.hxx".}
proc constructNCollectionArray2Iterator*[TheItemType](theArray: NCollectionArray2): NCollectionArray2Iterator[
    TheItemType] {.constructor,
                  importcpp: "NCollection_Array2<\'*0>::Iterator(@)",
                  header: "NCollection_Array2.hxx".}
proc init*[TheItemType](this: var NCollectionArray2Iterator[TheItemType];
                       theArray: NCollectionArray2) {.importcpp: "Init",
    header: "NCollection_Array2.hxx".}
proc more*[TheItemType](this: NCollectionArray2Iterator[TheItemType]): StandardBoolean {.
    noSideEffect, importcpp: "More", header: "NCollection_Array2.hxx".}
proc next*[TheItemType](this: var NCollectionArray2Iterator[TheItemType]) {.
...
proc constructNCollectionArray2*[TheItemType](): NCollectionArray2[TheItemType] {.
    constructor, importcpp: "NCollection_Array2<\'*0>(@)",
    header: "NCollection_Array2.hxx".}
proc constructNCollectionArray2*[TheItemType](theRowLower: StandardInteger;
    theRowUpper: StandardInteger; theColLower: StandardInteger;
    theColUpper: StandardInteger): NCollectionArray2[TheItemType] {.constructor,
    importcpp: "NCollection_Array2<\'*0>(@)", header: "NCollection_Array2.hxx".}
proc constructNCollectionArray2*[TheItemType](theOther: NCollectionArray2): NCollectionArray2[
