...
proc hashCodeProxy*[TheKeyType](theKey: TheKeyType; theUpperBound: StandardInteger): StandardInteger =
  discard
...
proc hashCode*[TheKeyType](theKey: TheKeyType; theUpperBound: StandardInteger): StandardInteger {.
