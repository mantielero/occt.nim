...
template ncollection_Harray1*(hClassName, `type`: untyped): void =
  ...
  proc constructHClassName*(theLower: StandardInteger; theUpper: StandardInteger): HClassName {.
      constructor, importcpp: "HClassName(@)", header: "NCollection_HArray1.hxx".}
  proc constructHClassName*(theLower: StandardInteger; theUpper: StandardInteger;
                           theValue: ValueType[Type]): HClassName {.constructor,
