...
proc constructNLPlateHPG0G1Constraint*(uv: GpXY; value: GpXYZ; d1t: PlateD1): NLPlateHPG0G1Constraint {.
    constructor, importcpp: "NLPlate_HPG0G1Constraint(@)",
    header: "NLPlate_HPG0G1Constraint.hxx".}
proc setOrientation*(this: var NLPlateHPG0G1Constraint; orient: StandardInteger = 0) {.
    importcpp: "SetOrientation", header: "NLPlate_HPG0G1Constraint.hxx".}
proc activeOrder*(this: NLPlateHPG0G1Constraint): StandardInteger {.noSideEffect,
    importcpp: "ActiveOrder", header: "NLPlate_HPG0G1Constraint.hxx".}
proc orientation*(this: var NLPlateHPG0G1Constraint): StandardInteger {.
