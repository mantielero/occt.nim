...
proc constructNLPlateHPG3Constraint*(uv: GpXY; d1t: PlateD1; d2t: PlateD2; d3t: PlateD3): NLPlateHPG3Constraint {.
    constructor, importcpp: "NLPlate_HPG3Constraint(@)",
    header: "NLPlate_HPG3Constraint.hxx".}
proc activeOrder*(this: NLPlateHPG3Constraint): StandardInteger {.noSideEffect,
