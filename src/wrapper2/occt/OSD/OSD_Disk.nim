...
proc constructOSD_Disk*(pathName: StandardCString): OSD_Disk {.constructor,
    importcpp: "OSD_Disk(@)", header: "OSD_Disk.hxx".}
...
proc setName*(this: var OSD_Disk; name: OSD_Path) {.importcpp: "SetName",
    header: "OSD_Disk.hxx".}
proc diskSize*(this: var OSD_Disk): StandardInteger {.importcpp: "DiskSize",
    header: "OSD_Disk.hxx".}
proc diskFree*(this: var OSD_Disk): StandardInteger {.importcpp: "DiskFree",
    header: "OSD_Disk.hxx".}
proc failed*(this: OSD_Disk): StandardBoolean {.noSideEffect, importcpp: "Failed",
    header: "OSD_Disk.hxx".}
...
proc error*(this: OSD_Disk): StandardInteger {.noSideEffect, importcpp: "Error",
    header: "OSD_Disk.hxx".}
