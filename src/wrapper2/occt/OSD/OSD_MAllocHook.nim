...
proc open*(this: var OSD_MAllocHookLogFileHandler; theFileName: cstring): StandardBoolean {.
...
proc makeReport*(theLogFile: cstring; theOutFile: cstring;
                theIncludeAlive: StandardBoolean = standardFalse): StandardBoolean {.
...
proc reset*(this: var OSD_MAllocHookCollectBySize) {.importcpp: "Reset",
    header: "OSD_MAllocHook.hxx".}
proc makeReport*(this: var OSD_MAllocHookCollectBySize; theOutFile: cstring): StandardBoolean {.
