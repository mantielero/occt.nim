...
proc destroyOSD_Thread*(this: var OSD_Thread) {.importcpp: "#.~OSD_Thread()",
    header: "OSD_Thread.hxx".}
proc setPriority*(this: var OSD_Thread; thePriority: StandardInteger) {.
...
proc run*(this: var OSD_Thread; data: StandardAddress = 0;
         wNTStackSize: StandardInteger = 0): StandardBoolean {.importcpp: "Run",
    header: "OSD_Thread.hxx".}
proc detach*(this: var OSD_Thread) {.importcpp: "Detach", header: "OSD_Thread.hxx".}
proc wait*(this: var OSD_Thread): StandardBoolean {.importcpp: "Wait",
    header: "OSD_Thread.hxx".}
proc wait*(this: var OSD_Thread; theResult: var StandardAddress): StandardBoolean {.
    importcpp: "Wait", header: "OSD_Thread.hxx".}
proc wait*(this: var OSD_Thread; time: StandardInteger; theResult: var StandardAddress): StandardBoolean {.
    importcpp: "Wait", header: "OSD_Thread.hxx".}
