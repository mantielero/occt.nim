...
type
  OpenGlCaps* {.importcpp: "OpenGl_Caps", header: "OpenGl_Caps.hxx", bycopy.} = object of StandardTransient ##
                                                                                                  ...
                                                                                                  ## Not
                                                                                                  ## implemented
    sRGBDisable* {.importc: "sRGBDisable".}: StandardBoolean ## !< Disables sRGB rendering (OFF by default)
    compressedTexturesDisable* {.importc: "compressedTexturesDisable".}: StandardBoolean ## !< Disables uploading of compressed texture formats native to GPU (OFF by default)
    vboDisable* {.importc: "vboDisable".}: StandardBoolean ## !< disallow VBO usage for debugging purposes (OFF by default)
    pntSpritesDisable* {.importc: "pntSpritesDisable".}: StandardBoolean ## !< flag permits Point Sprites usage, will significantly affect performance (OFF by default)
    keepArrayData* {.importc: "keepArrayData".}: StandardBoolean ## !< Disables freeing CPU memory after building VBOs (OFF by default)
    ffpEnable* {.importc: "ffpEnable".}: StandardBoolean ## !< Enables FFP (fixed-function pipeline), do not use built-in GLSL programs (OFF by default)
    usePolygonMode* {.importc: "usePolygonMode".}: StandardBoolean ## !< Enables Polygon Mode instead of built-in GLSL programs (OFF by default; unsupported on OpenGL ES)
    useSystemBuffer* {.importc: "useSystemBuffer".}: StandardBoolean ## !< Enables usage of system backbuffer for blitting (OFF by default on desktop OpenGL and ON on OpenGL ES for testing)
    swapInterval* {.importc: "swapInterval".}: StandardInteger ## !< controls swap interval - 0 for VSync off and 1 for VSync on, 1 by default
    buffersNoSwap* {.importc: "buffersNoSwap".}: StandardBoolean ## *
                                                             ##  Request stereoscopic context (with Quad Buffer). This flag requires support in OpenGL driver.
                                                             ##
                                                             ##  OFF by default.
                                                             ##
    contextStereo* {.importc: "contextStereo".}: StandardBoolean ## *
                                                             ...
                                                             ##  OFF by default.
                                                             ##
    contextDebug* {.importc: "contextDebug".}: StandardBoolean ## *
                                                           ...
                                                           ##  OFF by default.
                                                           ##
    contextSyncDebug* {.importc: "contextSyncDebug".}: StandardBoolean ## *
                                                                   ...
                                                                   ##
    contextNoAccel* {.importc: "contextNoAccel".}: StandardBoolean ## *
                                                               ...
                                                               ##  ON by default.
                                                               ##
    contextCompatible* {.importc: "contextCompatible".}: StandardBoolean ## *
                                                                     ##  Disallow using OpenGL extensions.
                                                                     ##  Should be used for debugging purposes only!
                                                                     ##
                                                                     ##  OFF by default.
                                                                     ##
    contextNoExtensions* {.importc: "contextNoExtensions".}: StandardBoolean ## *
                                                                         ##  Synthetically restrict upper version of OpenGL functionality to be used.
                                                                         ##  Should be used for debugging purposes only!
                                                                         ##
                                                                         ##  (-1, -1) by default, which means no restriction.
                                                                         ##
    contextMajorVersionUpper* {.importc: "contextMajorVersionUpper".}: StandardInteger
    contextMinorVersionUpper* {.importc: "contextMinorVersionUpper".}: StandardInteger ## *
                                                                                   ...
                                                                                   ##
    isTopDownTextureUV* {.importc: "isTopDownTextureUV".}: StandardBoolean
    glslWarnings* {.importc: "glslWarnings".}: StandardBoolean ## ! Suppress redundant messages from debug GL context. ON by default.
    suppressExtraMsg* {.importc: "suppressExtraMsg".}: StandardBoolean ## ! Print GLSL program source code. OFF by default.
