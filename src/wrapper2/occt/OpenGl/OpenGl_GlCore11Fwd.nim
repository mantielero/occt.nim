...
type
  OpenGlGlCore11Fwd* {.importcpp: "OpenGl_GlCore11Fwd",
                      header: "OpenGl_GlCore11Fwd.hxx", bycopy.} = object of OpenGlGlFunctions ##
                                                                                        ## !
                                                                                        ## @name
                                                                                        ## Miscellaneous
                                                                                        ##
...
proc glClearColor*(this: var OpenGlGlCore11Fwd; theRed: GLclampf; theGreen: GLclampf;
                  theBlue: GLclampf; theAlpha: GLclampf) {.
    importcpp: "glClearColor", header: "OpenGl_GlCore11Fwd.hxx".}
proc glClear*(this: var OpenGlGlCore11Fwd; theMask: GLbitfield) {.
    importcpp: "glClear", header: "OpenGl_GlCore11Fwd.hxx".}
proc glColorMask*(this: var OpenGlGlCore11Fwd; theRed: GLboolean; theGreen: GLboolean;
                 theBlue: GLboolean; theAlpha: GLboolean) {.
    importcpp: "glColorMask", header: "OpenGl_GlCore11Fwd.hxx".}
proc glBlendFunc*(this: var OpenGlGlCore11Fwd; sfactor: GLenum; dfactor: GLenum) {.
    importcpp: "glBlendFunc", header: "OpenGl_GlCore11Fwd.hxx".}
proc glCullFace*(this: var OpenGlGlCore11Fwd; theMode: GLenum) {.
    importcpp: "glCullFace", header: "OpenGl_GlCore11Fwd.hxx".}
proc glFrontFace*(this: var OpenGlGlCore11Fwd; theMode: GLenum) {.
    importcpp: "glFrontFace", header: "OpenGl_GlCore11Fwd.hxx".}
proc glLineWidth*(this: var OpenGlGlCore11Fwd; theWidth: GLfloat) {.
    importcpp: "glLineWidth", header: "OpenGl_GlCore11Fwd.hxx".}
proc glPolygonOffset*(this: var OpenGlGlCore11Fwd; theFactor: GLfloat;
                     theUnits: GLfloat) {.importcpp: "glPolygonOffset",
                                        header: "OpenGl_GlCore11Fwd.hxx".}
proc glScissor*(this: var OpenGlGlCore11Fwd; theX: GLint; theY: GLint;
               theWidth: GLsizei; theHeight: GLsizei) {.importcpp: "glScissor",
    header: "OpenGl_GlCore11Fwd.hxx".}
proc glEnable*(this: var OpenGlGlCore11Fwd; theCap: GLenum) {.importcpp: "glEnable",
    header: "OpenGl_GlCore11Fwd.hxx".}
proc glDisable*(this: var OpenGlGlCore11Fwd; theCap: GLenum) {.importcpp: "glDisable",
    header: "OpenGl_GlCore11Fwd.hxx".}
proc glIsEnabled*(this: var OpenGlGlCore11Fwd; theCap: GLenum): GLboolean {.
    importcpp: "glIsEnabled", header: "OpenGl_GlCore11Fwd.hxx".}
proc glGetBooleanv*(this: var OpenGlGlCore11Fwd; theParamName: GLenum;
                   theValues: ptr GLboolean) {.importcpp: "glGetBooleanv",
    header: "OpenGl_GlCore11Fwd.hxx".}
proc glGetFloatv*(this: var OpenGlGlCore11Fwd; theParamName: GLenum;
                 theValues: ptr GLfloat) {.importcpp: "glGetFloatv",
                                        header: "OpenGl_GlCore11Fwd.hxx".}
proc glGetIntegerv*(this: var OpenGlGlCore11Fwd; theParamName: GLenum;
                   theValues: ptr GLint) {.importcpp: "glGetIntegerv",
                                        header: "OpenGl_GlCore11Fwd.hxx".}
proc glGetError*(this: var OpenGlGlCore11Fwd): GLenum {.importcpp: "glGetError",
    header: "OpenGl_GlCore11Fwd.hxx".}
proc glGetString*(this: var OpenGlGlCore11Fwd; theName: GLenum): ptr GLubyte {.
    importcpp: "glGetString", header: "OpenGl_GlCore11Fwd.hxx".}
proc glFinish*(this: var OpenGlGlCore11Fwd) {.importcpp: "glFinish",
    header: "OpenGl_GlCore11Fwd.hxx".}
proc glFlush*(this: var OpenGlGlCore11Fwd) {.importcpp: "glFlush",
    header: "OpenGl_GlCore11Fwd.hxx".}
proc glHint*(this: var OpenGlGlCore11Fwd; theTarget: GLenum; theMode: GLenum) {.
