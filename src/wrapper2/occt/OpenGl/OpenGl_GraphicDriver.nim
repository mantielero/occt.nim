...
proc constructOpenGlGraphicDriver*(theDisp: Handle[AspectDisplayConnection];
    theToInitialize: StandardBoolean = standardTrue): OpenGlGraphicDriver {.
...
proc releaseContext*(this: var OpenGlGraphicDriver) {.importcpp: "ReleaseContext",
    header: "OpenGl_GraphicDriver.hxx".}
proc initContext*(this: var OpenGlGraphicDriver): StandardBoolean {.
...
proc inquireLimit*(this: OpenGlGraphicDriver; theType: Graphic3dTypeOfLimit): StandardInteger {.
...
proc setBuffersNoSwap*(this: var OpenGlGraphicDriver; theIsNoSwap: StandardBoolean) {.
    importcpp: "SetBuffersNoSwap", header: "OpenGl_GraphicDriver.hxx".}
proc enableVBO*(this: var OpenGlGraphicDriver; theToTurnOn: StandardBoolean) {.
