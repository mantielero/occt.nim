...
import
  OpenGl_Vec, ../NCollection/NCollection_Vector, ../Standard/Standard_Dump

## ! Software implementation for OpenGL matrix stack.

type
  OpenGl_MatrixState*[T] {.importcpp: "OpenGl_MatrixState<\'0>",
                          header: "OpenGl_MatrixState.hxx", bycopy.} = object ## !
                                                                         ## Constructs matrix state object.
    OpenGl* {.importc: "OpenGl".}: typename
    OpenGl* {.importc: "OpenGl".}: typename
    myStackHead* {.importc: "myStackHead".}: Standard_Integer ## !< Index of stack head


proc constructOpenGl_MatrixState*[T](): OpenGl_MatrixState[T] {.constructor,
    importcpp: "OpenGl_MatrixState<\'*0>(@)", header: "OpenGl_MatrixState.hxx".}
proc Push*[T](this: var OpenGl_MatrixState[T]) {.importcpp: "Push",
    header: "OpenGl_MatrixState.hxx".}
proc Pop*[T](this: var OpenGl_MatrixState[T]) {.importcpp: "Pop",
    header: "OpenGl_MatrixState.hxx".}
