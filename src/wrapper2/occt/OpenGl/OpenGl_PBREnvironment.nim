...
proc bake*(this: var OpenGlPBREnvironment; theCtx: Handle[OpenGlContext];
          theEnvMap: Handle[OpenGlTexture];
          theZIsInverted: StandardBoolean = standardFalse;
          theIsTopDown: StandardBoolean = standardTrue;
          theDiffMapNbSamples: StandardSize = 1024;
...
proc isComplete*(this: OpenGlPBREnvironment): StandardBoolean {.noSideEffect,
