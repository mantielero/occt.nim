...
proc isRaytracedGroup*(theGroup: ptr OpenGlGroup): StandardBoolean {.
...
proc isRaytracedElement*(theNode: ptr OpenGlElementNode): StandardBoolean {.
    importcpp: "OpenGl_Raytrace::IsRaytracedElement(@)",
    header: "OpenGl_SceneGeometry.hxx".}
## ! Checks to see if the element contains ray-trace geometry.

proc isRaytracedElement*(theElement: ptr OpenGlElement): StandardBoolean {.
    importcpp: "OpenGl_Raytrace::IsRaytracedElement(@)",
    header: "OpenGl_SceneGeometry.hxx".}
...
proc materialIndex*(this: OpenGlTriangleSet): StandardInteger {.noSideEffect,
    importcpp: "MaterialIndex", header: "OpenGl_SceneGeometry.hxx".}
proc setMaterialIndex*(this: var OpenGlTriangleSet; theMatID: StandardInteger) {.
...
proc center*(this: OpenGlTriangleSet; theIndex: StandardInteger;
            theAxis: StandardInteger): StandardShortReal {.noSideEffect,
...
proc clear*(this: var OpenGlRaytraceGeometry) {.importcpp: "Clear",
    header: "OpenGl_SceneGeometry.hxx".}
proc processAcceleration*(this: var OpenGlRaytraceGeometry): StandardBoolean {.
    importcpp: "ProcessAcceleration", header: "OpenGl_SceneGeometry.hxx".}
proc accelerationOffset*(this: var OpenGlRaytraceGeometry;
                        theNodeIdx: StandardInteger): StandardInteger {.
    importcpp: "AccelerationOffset", header: "OpenGl_SceneGeometry.hxx".}
proc verticesOffset*(this: var OpenGlRaytraceGeometry; theNodeIdx: StandardInteger): StandardInteger {.
    importcpp: "VerticesOffset", header: "OpenGl_SceneGeometry.hxx".}
proc elementsOffset*(this: var OpenGlRaytraceGeometry; theNodeIdx: StandardInteger): StandardInteger {.
    importcpp: "ElementsOffset", header: "OpenGl_SceneGeometry.hxx".}
proc triangleSet*(this: var OpenGlRaytraceGeometry; theNodeIdx: StandardInteger): ptr OpenGlTriangleSet {.
...
proc hasTextures*(this: OpenGlRaytraceGeometry): StandardBoolean {.noSideEffect,
    importcpp: "HasTextures", header: "OpenGl_SceneGeometry.hxx".}
proc addTexture*(this: var OpenGlRaytraceGeometry; theTexture: Handle[OpenGlTexture]): StandardInteger {.
    importcpp: "AddTexture", header: "OpenGl_SceneGeometry.hxx".}
proc updateTextureHandles*(this: var OpenGlRaytraceGeometry;
                          theContext: Handle[OpenGlContext]): StandardBoolean {.
...
proc topLevelTreeDepth*(this: OpenGlRaytraceGeometry): StandardInteger {.
    noSideEffect, importcpp: "TopLevelTreeDepth",
    header: "OpenGl_SceneGeometry.hxx".}
proc botLevelTreeDepth*(this: OpenGlRaytraceGeometry): StandardInteger {.
