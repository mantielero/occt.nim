...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "Poly_CoherentLink.hxx", bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "Poly_CoherentLink.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "Poly_CoherentLink.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "Poly_CoherentLink.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "Poly_CoherentLink.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "Poly_CoherentLink.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
...
var itInterval* {.importcpp: "it_interval", header: "Poly_CoherentLink.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "Poly_CoherentLink.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "Poly_CoherentLink.hxx".}: array[13,
...
type
  PolyCoherentLink* {.importcpp: "timex::itimerspec::timespec::__locale_struct::Poly_CoherentLink",
                     header: "Poly_CoherentLink.hxx", bycopy.} = object


proc constructPolyCoherentLink*(): PolyCoherentLink {.constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::Poly_CoherentLink(@)",
    header: "Poly_CoherentLink.hxx".}
proc constructPolyCoherentLink*(iNode0: StandardInteger; iNode1: StandardInteger): PolyCoherentLink {.
    constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::Poly_CoherentLink(@)",
    header: "Poly_CoherentLink.hxx".}
proc constructPolyCoherentLink*(theTri: PolyCoherentTriangle;
                               iSide: StandardInteger): PolyCoherentLink {.
    constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::Poly_CoherentLink(@)",
    header: "Poly_CoherentLink.hxx".}
proc node*(this: PolyCoherentLink; ind: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "Node", header: "Poly_CoherentLink.hxx".}
proc oppositeNode*(this: PolyCoherentLink; ind: StandardInteger): StandardInteger {.
...
proc isEmpty*(this: PolyCoherentLink): StandardBoolean {.noSideEffect,
