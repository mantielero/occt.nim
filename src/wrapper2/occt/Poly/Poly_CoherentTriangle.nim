...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "Poly_CoherentTriangle.hxx", bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "Poly_CoherentTriangle.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "Poly_CoherentTriangle.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "Poly_CoherentTriangle.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "Poly_CoherentTriangle.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "Poly_CoherentTriangle.hxx",
             bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
...
var itInterval* {.importcpp: "it_interval", header: "Poly_CoherentTriangle.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "Poly_CoherentTriangle.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "Poly_CoherentTriangle.hxx".}: array[
...
type
  PolyCoherentTriangle* {.importcpp: "timex::itimerspec::timespec::__locale_struct::Poly_CoherentTriangle",
                         header: "Poly_CoherentTriangle.hxx", bycopy.} = object


proc constructPolyCoherentTriangle*(): PolyCoherentTriangle {.constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::Poly_CoherentTriangle(@)",
    header: "Poly_CoherentTriangle.hxx".}
proc constructPolyCoherentTriangle*(iNode0: StandardInteger;
                                   iNode1: StandardInteger;
                                   iNode2: StandardInteger): PolyCoherentTriangle {.
    constructor, importcpp: "timex::itimerspec::timespec::__locale_struct::Poly_CoherentTriangle(@)",
    header: "Poly_CoherentTriangle.hxx".}
proc node*(this: PolyCoherentTriangle; ind: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "Node", header: "Poly_CoherentTriangle.hxx".}
proc isEmpty*(this: PolyCoherentTriangle): StandardBoolean {.noSideEffect,
    importcpp: "IsEmpty", header: "Poly_CoherentTriangle.hxx".}
proc setConnection*(this: var PolyCoherentTriangle; iConn: StandardInteger;
                   theTr: var PolyCoherentTriangle): StandardBoolean {.
    importcpp: "SetConnection", header: "Poly_CoherentTriangle.hxx".}
proc setConnection*(this: var PolyCoherentTriangle; theTri: var PolyCoherentTriangle): StandardBoolean {.
    importcpp: "SetConnection", header: "Poly_CoherentTriangle.hxx".}
proc removeConnection*(this: var PolyCoherentTriangle; iConn: StandardInteger) {.
    importcpp: "RemoveConnection", header: "Poly_CoherentTriangle.hxx".}
proc removeConnection*(this: var PolyCoherentTriangle;
                      theTri: var PolyCoherentTriangle): StandardBoolean {.
    importcpp: "RemoveConnection", header: "Poly_CoherentTriangle.hxx".}
proc nConnections*(this: PolyCoherentTriangle): StandardInteger {.noSideEffect,
    importcpp: "NConnections", header: "Poly_CoherentTriangle.hxx".}
proc getConnectedNode*(this: PolyCoherentTriangle; iConn: StandardInteger): StandardInteger {.
    noSideEffect, importcpp: "GetConnectedNode",
    header: "Poly_CoherentTriangle.hxx".}
proc getConnectedTri*(this: PolyCoherentTriangle; iConn: StandardInteger): ptr PolyCoherentTriangle {.
    noSideEffect, importcpp: "GetConnectedTri", header: "Poly_CoherentTriangle.hxx".}
proc getLink*(this: PolyCoherentTriangle; iLink: StandardInteger): ptr PolyCoherentLink {.
    noSideEffect, importcpp: "GetLink", header: "Poly_CoherentTriangle.hxx".}
proc findConnection*(this: PolyCoherentTriangle; a2: PolyCoherentTriangle): StandardInteger {.
