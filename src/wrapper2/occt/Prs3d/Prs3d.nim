...
proc matchSegment*(x: StandardReal; y: StandardReal; z: StandardReal;
                  aDistance: StandardReal; p1: GpPnt; p2: GpPnt;
...
proc getDeflection*(theBndMin: Graphic3dVec3d; theBndMax: Graphic3dVec3d;
                   theDeviationCoefficient: StandardReal): StandardReal {.
    importcpp: "Prs3d::GetDeflection(@)", header: "Prs3d.hxx".}
proc getDeflection*(theBndBox: BndBox; theDeviationCoefficient: StandardReal;
                   theMaximalChordialDeviation: StandardReal): StandardReal {.
    importcpp: "Prs3d::GetDeflection(@)", header: "Prs3d.hxx".}
...
proc addFreeEdges*(theSegments: var TColgpSequenceOfPnt;
                  thePolyTri: Handle[PolyTriangulation]; theLocation: GpTrsf) {.
