...
proc drawShaded*(theAxis: GpAx1; theTubeRadius: StandardReal;
                theAxisLength: StandardReal; theConeRadius: StandardReal;
                theConeLength: StandardReal; theNbFacettes: StandardInteger): Handle[
    Graphic3dArrayOfTriangles] {.importcpp: "Prs3d_Arrow::DrawShaded(@)",
                                header: "Prs3d_Arrow.hxx".}
proc drawSegments*(theLocation: GpPnt; theDir: GpDir; theAngle: StandardReal;
                  theLength: StandardReal; theNbSegments: StandardInteger): Handle[
    Graphic3dArrayOfSegments] {.importcpp: "Prs3d_Arrow::DrawSegments(@)",
                               header: "Prs3d_Arrow.hxx".}
proc draw*(theGroup: Handle[Graphic3dGroup]; theLocation: GpPnt; theDirection: GpDir;
          theAngle: StandardReal; theLength: StandardReal) {.
