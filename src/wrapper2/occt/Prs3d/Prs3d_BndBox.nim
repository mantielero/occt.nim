...
proc add*(thePresentation: Handle[Prs3dPresentation]; theBndBox: BndBox;
         theDrawer: Handle[Prs3dDrawer]) {.importcpp: "Prs3d_BndBox::Add(@)",
    header: "Prs3d_BndBox.hxx".}
proc add*(thePresentation: Handle[Prs3dPresentation]; theBndBox: BndOBB;
         theDrawer: Handle[Prs3dDrawer]) {.importcpp: "Prs3d_BndBox::Add(@)",
    header: "Prs3d_BndBox.hxx".}
proc fillSegments*(theBox: BndOBB): Handle[Graphic3dArrayOfSegments] {.
    importcpp: "Prs3d_BndBox::FillSegments(@)", header: "Prs3d_BndBox.hxx".}
proc fillSegments*(theBox: BndBox): Handle[Graphic3dArrayOfSegments] {.
    importcpp: "Prs3d_BndBox::FillSegments(@)", header: "Prs3d_BndBox.hxx".}
...
proc fillSegments*(theSegments: Handle[Graphic3dArrayOfSegments]; theBox: BndBox) {.
    importcpp: "Prs3d_BndBox::FillSegments(@)", header: "Prs3d_BndBox.hxx".}
proc fillSegments*(theSegments: Handle[Graphic3dArrayOfSegments]; theBox: ptr GpPnt) {.
    importcpp: "Prs3d_BndBox::fillSegments(@)", header: "Prs3d_BndBox.hxx".}
