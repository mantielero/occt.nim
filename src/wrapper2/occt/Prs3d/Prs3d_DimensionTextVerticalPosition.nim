...
type
  Prs3d_DimensionTextVerticalPosition* {.size: sizeof(cint), importcpp: "Prs3d_DimensionTextVerticalPosition", header: "Prs3d_DimensionTextVerticalPosition.hxx".} = enum
    Prs3d_DTVP_Above, Prs3d_DTVP_Below, Prs3d_DTVP_Center
