...
proc constructPrs3dIsoAspect*(theColor: QuantityColor; theType: AspectTypeOfLine;
                             theWidth: StandardReal; theNumber: StandardInteger): Prs3dIsoAspect {.
    constructor, importcpp: "Prs3d_IsoAspect(@)", header: "Prs3d_IsoAspect.hxx".}
proc setNumber*(this: var Prs3dIsoAspect; theNumber: StandardInteger) {.
    importcpp: "SetNumber", header: "Prs3d_IsoAspect.hxx".}
proc number*(this: Prs3dIsoAspect): StandardInteger {.noSideEffect,
