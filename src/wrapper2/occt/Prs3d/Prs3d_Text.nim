...
proc draw*(theGroup: Handle[Graphic3dGroup]; theAspect: Handle[Prs3dTextAspect];
          theText: TCollectionExtendedString; theAttachmentPoint: GpPnt): Handle[
    Graphic3dText] {.importcpp: "Prs3d_Text::Draw(@)", header: "Prs3d_Text.hxx".}
proc draw*(theGroup: Handle[Graphic3dGroup]; theAspect: Handle[Prs3dTextAspect];
          theText: TCollectionExtendedString; theOrientation: GpAx2;
          theHasOwnAnchor: StandardBoolean = standardTrue): Handle[Graphic3dText] {.
