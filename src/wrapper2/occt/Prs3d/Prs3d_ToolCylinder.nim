...
proc create*(theBottomRad: StandardReal; theTopRad: StandardReal;
            theHeight: StandardReal; theNbSlices: StandardInteger;
...
proc constructPrs3dToolCylinder*(theBottomRad: StandardReal;
                                theTopRad: StandardReal; theHeight: StandardReal;
                                theNbSlices: StandardInteger;
                                theNbStacks: StandardInteger): Prs3dToolCylinder {.
