...
proc create*(theInnerRadius: StandardReal; theOuterRadius: StandardReal;
...
proc constructPrs3dToolDisk*(theInnerRadius: StandardReal;
                            theOuterRadius: StandardReal;
                            theNbSlices: StandardInteger;
                            theNbStacks: StandardInteger): Prs3dToolDisk {.
    constructor, importcpp: "Prs3d_ToolDisk(@)", header: "Prs3d_ToolDisk.hxx".}
proc setAngleRange*(this: var Prs3dToolDisk; theStartAngle: StandardReal;
                   theEndAngle: StandardReal) {.importcpp: "SetAngleRange",
