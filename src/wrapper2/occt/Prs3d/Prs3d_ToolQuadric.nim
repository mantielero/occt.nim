...
proc trianglesNb*(theSlicesNb: StandardInteger; theStacksNb: StandardInteger): StandardInteger {.
    importcpp: "Prs3d_ToolQuadric::TrianglesNb(@)",
    header: "Prs3d_ToolQuadric.hxx".}
proc verticesNb*(theSlicesNb: StandardInteger; theStacksNb: StandardInteger;
                theIsIndexed: StandardBoolean = standardTrue): StandardInteger {.
    importcpp: "Prs3d_ToolQuadric::VerticesNb(@)", header: "Prs3d_ToolQuadric.hxx".}
proc createTriangulation*(this: Prs3dToolQuadric; theTrsf: GpTrsf): Handle[
    Graphic3dArrayOfTriangles] {.noSideEffect, importcpp: "CreateTriangulation",
                                header: "Prs3d_ToolQuadric.hxx".}
proc createPolyTriangulation*(this: Prs3dToolQuadric; theTrsf: GpTrsf): Handle[
    PolyTriangulation] {.noSideEffect, importcpp: "CreatePolyTriangulation",
                        header: "Prs3d_ToolQuadric.hxx".}
proc fillArray*(this: Prs3dToolQuadric;
               theArray: var Handle[Graphic3dArrayOfTriangles]; theTrsf: GpTrsf) {.
