...
proc constructPrsDimChamf3dDimension*(aFShape: TopoDS_Shape; aVal: StandardReal;
...
proc constructPrsDimChamf3dDimension*(aFShape: TopoDS_Shape; aVal: StandardReal;
                                     ...
                                     anArrowSize: StandardReal = 0.0): PrsDimChamf3dDimension {.
    constructor, importcpp: "PrsDim_Chamf3dDimension(@)",
    header: "PrsDim_Chamf3dDimension.hxx".}
proc kindOfDimension*(this: PrsDimChamf3dDimension): PrsDimKindOfDimension {.
    noSideEffect, importcpp: "KindOfDimension",
    header: "PrsDim_Chamf3dDimension.hxx".}
proc isMovable*(this: PrsDimChamf3dDimension): StandardBoolean {.noSideEffect,
