...
proc display*(this: var PrsMgrPresentationManager;
             ...
             theMode: StandardInteger = 0) {.importcpp: "Display",
    header: "PrsMgr_PresentationManager.hxx".}
proc erase*(this: var PrsMgrPresentationManager;
           thePrsObject: Handle[PrsMgrPresentableObject];
           theMode: StandardInteger = 0) {.importcpp: "Erase",
                                       header: "PrsMgr_PresentationManager.hxx".}
...
proc setVisibility*(this: var PrsMgrPresentationManager;
                   thePrsObject: Handle[PrsMgrPresentableObject];
                   theMode: StandardInteger; theValue: StandardBoolean) {.
...
proc displayPriority*(this: PrsMgrPresentationManager;
                     thePrsObject: Handle[PrsMgrPresentableObject];
                     theMode: StandardInteger): StandardInteger {.noSideEffect,
...
proc update*(this: PrsMgrPresentationManager;
            thePrsObject: Handle[PrsMgrPresentableObject];
            theMode: StandardInteger = 0) {.noSideEffect, importcpp: "Update", header: "PrsMgr_PresentationManager.hxx".}
...
proc redrawImmediate*(this: var PrsMgrPresentationManager;
    ...
    header: "PrsMgr_PresentationManager.hxx".}
proc isImmediateModeOn*(this: PrsMgrPresentationManager): StandardBoolean {.
...
proc connect*(this: var PrsMgrPresentationManager;
             thePrsObject: Handle[PrsMgrPresentableObject];
             theOtherObject: Handle[PrsMgrPresentableObject];
             theMode: StandardInteger = 0; theOtherMode: StandardInteger = 0) {.
    importcpp: "Connect", header: "PrsMgr_PresentationManager.hxx".}
proc transform*(this: var PrsMgrPresentationManager;
               thePrsObject: Handle[PrsMgrPresentableObject];
               theTransformation: Handle[TopLocDatum3D];
               theMode: StandardInteger = 0) {.importcpp: "Transform",
    header: "PrsMgr_PresentationManager.hxx".}
...
proc presentation*(this: PrsMgrPresentationManager;
                  thePrsObject: Handle[PrsMgrPresentableObject];
                  theMode: StandardInteger = 0;
                  theToCreate: StandardBoolean = standardFalse;
