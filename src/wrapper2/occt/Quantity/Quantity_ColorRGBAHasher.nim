...
proc hashCode*(theColor: QuantityColorRGBA; theUpperBound: StandardInteger): StandardInteger {.
    importcpp: "Quantity_ColorRGBAHasher::HashCode(@)",
    header: "Quantity_ColorRGBAHasher.hxx".}
proc isEqual*(theColor1: QuantityColorRGBA; theColor2: QuantityColorRGBA): StandardBoolean {.
