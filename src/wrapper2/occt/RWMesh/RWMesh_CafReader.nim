...
proc toFillIncompleteDocument*(this: RWMeshCafReader): StandardBoolean {.
    noSideEffect, importcpp: "ToFillIncompleteDocument",
    header: "RWMesh_CafReader.hxx".}
proc setFillIncompleteDocument*(this: var RWMeshCafReader;
                               theToFillIncomplete: StandardBoolean) {.
    importcpp: "SetFillIncompleteDocument", header: "RWMesh_CafReader.hxx".}
proc memoryLimitMiB*(this: RWMeshCafReader): StandardInteger {.noSideEffect,
    importcpp: "MemoryLimitMiB", header: "RWMesh_CafReader.hxx".}
proc setMemoryLimitMiB*(this: var RWMeshCafReader; theLimitMiB: StandardInteger) {.
...
proc systemLengthUnit*(this: RWMeshCafReader): StandardReal {.noSideEffect,
    importcpp: "SystemLengthUnit", header: "RWMesh_CafReader.hxx".}
proc setSystemLengthUnit*(this: var RWMeshCafReader; theUnits: StandardReal) {.
    importcpp: "SetSystemLengthUnit", header: "RWMesh_CafReader.hxx".}
proc hasSystemCoordinateSystem*(this: RWMeshCafReader): StandardBoolean {.
    noSideEffect, importcpp: "HasSystemCoordinateSystem",
    header: "RWMesh_CafReader.hxx".}
proc systemCoordinateSystem*(this: RWMeshCafReader): GpAx3 {.noSideEffect,
    importcpp: "SystemCoordinateSystem", header: "RWMesh_CafReader.hxx".}
proc setSystemCoordinateSystem*(this: var RWMeshCafReader; theCS: GpAx3) {.
...
proc setSystemCoordinateSystem*(this: var RWMeshCafReader;
    ...
    importcpp: "SetSystemCoordinateSystem", header: "RWMesh_CafReader.hxx".}
proc fileLengthUnit*(this: RWMeshCafReader): StandardReal {.noSideEffect,
    importcpp: "FileLengthUnit", header: "RWMesh_CafReader.hxx".}
proc setFileLengthUnit*(this: var RWMeshCafReader; theUnits: StandardReal) {.
    importcpp: "SetFileLengthUnit", header: "RWMesh_CafReader.hxx".}
proc hasFileCoordinateSystem*(this: RWMeshCafReader): StandardBoolean {.
    noSideEffect, importcpp: "HasFileCoordinateSystem",
    header: "RWMesh_CafReader.hxx".}
proc fileCoordinateSystem*(this: RWMeshCafReader): GpAx3 {.noSideEffect,
    importcpp: "FileCoordinateSystem", header: "RWMesh_CafReader.hxx".}
proc setFileCoordinateSystem*(this: var RWMeshCafReader; theCS: GpAx3) {.
...
proc perform*(this: var RWMeshCafReader; theFile: TCollectionAsciiString;
    ...
    header: "RWMesh_CafReader.hxx".}
proc extraStatus*(this: RWMeshCafReader): StandardInteger {.noSideEffect,
