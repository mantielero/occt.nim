...
type
  RWStepAP214RWAutoDesignGroupAssignment* {.
      importcpp: "RWStepAP214_RWAutoDesignGroupAssignment",
      header: "RWStepAP214_RWAutoDesignGroupAssignment.hxx", bycopy.} = object


proc constructRWStepAP214RWAutoDesignGroupAssignment*(): RWStepAP214RWAutoDesignGroupAssignment {.
    constructor, importcpp: "RWStepAP214_RWAutoDesignGroupAssignment(@)",
    header: "RWStepAP214_RWAutoDesignGroupAssignment.hxx".}
proc readStep*(this: RWStepAP214RWAutoDesignGroupAssignment;
              data: Handle[StepDataStepReaderData]; num: StandardInteger;
              ach: var Handle[InterfaceCheck];
              ent: Handle[StepAP214AutoDesignGroupAssignment]) {.noSideEffect,
    importcpp: "ReadStep", header: "RWStepAP214_RWAutoDesignGroupAssignment.hxx".}
proc writeStep*(this: RWStepAP214RWAutoDesignGroupAssignment;
               sw: var StepDataStepWriter;
               ent: Handle[StepAP214AutoDesignGroupAssignment]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepAP214_RWAutoDesignGroupAssignment.hxx".}
proc share*(this: RWStepAP214RWAutoDesignGroupAssignment;
           ent: Handle[StepAP214AutoDesignGroupAssignment];
