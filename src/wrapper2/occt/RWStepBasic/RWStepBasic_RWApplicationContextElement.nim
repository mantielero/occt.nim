...
proc constructRWStepBasic_RWApplicationContextElement*(): RWStepBasic_RWApplicationContextElement {.
    constructor, importcpp: "RWStepBasic_RWApplicationContextElement(@)",
    header: "RWStepBasic_RWApplicationContextElement.hxx".}
proc ReadStep*(this: RWStepBasic_RWApplicationContextElement;
              data: handle[StepData_StepReaderData]; num: Standard_Integer;
              ach: var handle[Interface_Check];
              ent: handle[StepBasic_ApplicationContextElement]) {.noSideEffect,
    importcpp: "ReadStep", header: "RWStepBasic_RWApplicationContextElement.hxx".}
proc WriteStep*(this: RWStepBasic_RWApplicationContextElement;
               SW: var StepData_StepWriter;
               ent: handle[StepBasic_ApplicationContextElement]) {.noSideEffect,
    importcpp: "WriteStep", header: "RWStepBasic_RWApplicationContextElement.hxx".}
proc Share*(this: RWStepBasic_RWApplicationContextElement;
           ent: handle[StepBasic_ApplicationContextElement];
