...
proc constructRWStepBasic_RWProductDefinitionRelationship*(): RWStepBasic_RWProductDefinitionRelationship {.
    constructor, importcpp: "RWStepBasic_RWProductDefinitionRelationship(@)",
    header: "RWStepBasic_RWProductDefinitionRelationship.hxx".}
proc ReadStep*(this: RWStepBasic_RWProductDefinitionRelationship;
              data: handle[StepData_StepReaderData]; num: Standard_Integer;
              ach: var handle[Interface_Check];
              ent: handle[StepBasic_ProductDefinitionRelationship]) {.
    noSideEffect, importcpp: "ReadStep",
    header: "RWStepBasic_RWProductDefinitionRelationship.hxx".}
proc WriteStep*(this: RWStepBasic_RWProductDefinitionRelationship;
               SW: var StepData_StepWriter;
               ent: handle[StepBasic_ProductDefinitionRelationship]) {.
    noSideEffect, importcpp: "WriteStep",
    header: "RWStepBasic_RWProductDefinitionRelationship.hxx".}
proc Share*(this: RWStepBasic_RWProductDefinitionRelationship;
           ent: handle[StepBasic_ProductDefinitionRelationship];
