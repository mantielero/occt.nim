...
proc constructRWStepFEA_RWParametricCurve3dElementCoordinateDirection*(): RWStepFEA_RWParametricCurve3dElementCoordinateDirection {.
    constructor,
    importcpp: "RWStepFEA_RWParametricCurve3dElementCoordinateDirection(@)",
    header: "RWStepFEA_RWParametricCurve3dElementCoordinateDirection.hxx".}
proc readStep*(this: RWStepFEA_RWParametricCurve3dElementCoordinateDirection;
    ...
    header: "RWStepFEA_RWParametricCurve3dElementCoordinateDirection.hxx".}
proc writeStep*(this: RWStepFEA_RWParametricCurve3dElementCoordinateDirection;
               sw: var StepDataStepWriter;
               ent: Handle[StepFEA_ParametricCurve3dElementCoordinateDirection]) {.
    noSideEffect, importcpp: "WriteStep",
    header: "RWStepFEA_RWParametricCurve3dElementCoordinateDirection.hxx".}
proc share*(this: RWStepFEA_RWParametricCurve3dElementCoordinateDirection;
           ent: Handle[StepFEA_ParametricCurve3dElementCoordinateDirection];
