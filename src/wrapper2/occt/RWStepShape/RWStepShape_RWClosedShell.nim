...
type
  RWStepShapeRWClosedShell* {.importcpp: "RWStepShape_RWClosedShell",
                             header: "RWStepShape_RWClosedShell.hxx", bycopy.} = object


proc constructRWStepShapeRWClosedShell*(): RWStepShapeRWClosedShell {.constructor,
...
proc writeStep*(this: RWStepShapeRWClosedShell; sw: var StepDataStepWriter;
               ent: Handle[StepShapeClosedShell]) {.noSideEffect,
