...
type
  RWStepShapeRWGeometricSet* {.importcpp: "RWStepShape_RWGeometricSet",
                              header: "RWStepShape_RWGeometricSet.hxx", bycopy.} = object


proc constructRWStepShapeRWGeometricSet*(): RWStepShapeRWGeometricSet {.
...
proc writeStep*(this: RWStepShapeRWGeometricSet; sw: var StepDataStepWriter;
               ent: Handle[StepShapeGeometricSet]) {.noSideEffect,
