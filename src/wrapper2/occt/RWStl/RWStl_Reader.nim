...
proc read*(this: var RWStlReader; theFile: cstring; theProgress: MessageProgressRange): StandardBoolean {.
    importcpp: "Read", header: "RWStl_Reader.hxx".}
proc isAscii*(this: var RWStlReader; theStream: var StandardIStream;
             isSeekgAvailable: bool): StandardBoolean {.importcpp: "IsAscii",
    header: "RWStl_Reader.hxx".}
...
proc addNode*(this: var RWStlReader; thePnt: GpXYZ): StandardInteger {.
    importcpp: "AddNode", header: "RWStl_Reader.hxx".}
proc addTriangle*(this: var RWStlReader; theN1: StandardInteger;
                 theN2: StandardInteger; theN3: StandardInteger) {.
