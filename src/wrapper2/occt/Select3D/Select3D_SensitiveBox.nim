...
proc constructSelect3D_SensitiveBox*(theOwnerId: Handle[SelectMgrEntityOwner];
    ...
    header: "Select3D_SensitiveBox.hxx".}
proc constructSelect3D_SensitiveBox*(theOwnerId: Handle[SelectMgrEntityOwner];
                                    theXMin: StandardReal; theYMin: StandardReal;
                                    theZMin: StandardReal; theXMax: StandardReal;
                                    theYMax: StandardReal; theZMax: StandardReal): Select3D_SensitiveBox {.
    constructor, importcpp: "Select3D_SensitiveBox(@)",
    header: "Select3D_SensitiveBox.hxx".}
proc nbSubElements*(this: Select3D_SensitiveBox): StandardInteger {.noSideEffect,
...
proc box*(this: Select3D_SensitiveBox): BndBox {.noSideEffect, importcpp: "Box",
    header: "Select3D_SensitiveBox.hxx".}
proc centerOfGeometry*(this: Select3D_SensitiveBox): GpPnt {.noSideEffect,
...
proc toBuildBVH*(this: Select3D_SensitiveBox): StandardBoolean {.noSideEffect,
