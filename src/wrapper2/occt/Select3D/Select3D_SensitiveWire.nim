...
proc add*(this: var Select3D_SensitiveWire;
    ...
    header: "Select3D_SensitiveWire.hxx".}
proc nbSubElements*(this: Select3D_SensitiveWire): StandardInteger {.noSideEffect,
...
proc centerOfGeometry*(this: Select3D_SensitiveWire): GpPnt {.noSideEffect,
    importcpp: "CenterOfGeometry", header: "Select3D_SensitiveWire.hxx".}
proc size*(this: Select3D_SensitiveWire): StandardInteger {.noSideEffect,
    importcpp: "Size", header: "Select3D_SensitiveWire.hxx".}
proc box*(this: Select3D_SensitiveWire; theIdx: StandardInteger): Select3D_BndBox3d {.
    noSideEffect, importcpp: "Box", header: "Select3D_SensitiveWire.hxx".}
proc center*(this: Select3D_SensitiveWire; theIdx: StandardInteger;
            theAxis: StandardInteger): StandardReal {.noSideEffect,
    importcpp: "Center", header: "Select3D_SensitiveWire.hxx".}
proc swap*(this: var Select3D_SensitiveWire; theIdx1: StandardInteger;
