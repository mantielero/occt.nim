...
proc init*(this: var SelectMgrSelectableObjectSetIterator;
    ...
    header: "SelectMgr_SelectableObjectSet.hxx".}
proc more*(this: var SelectMgrSelectableObjectSetIterator): StandardBoolean {.
...
proc updateBVH*(this: var SelectMgrSelectableObjectSet;
               ...
               theViewState: Graphic3dWorldViewProjState;
               theViewportWidth: StandardInteger;
               theViewportHeight: StandardInteger) {.importcpp: "UpdateBVH",
    header: "SelectMgr_SelectableObjectSet.hxx".}
...
proc contains*(this: SelectMgrSelectableObjectSet;
    ...
    header: "SelectMgr_SelectableObjectSet.hxx".}
proc isEmpty*(this: SelectMgrSelectableObjectSet): StandardBoolean {.noSideEffect,
    importcpp: "IsEmpty", header: "SelectMgr_SelectableObjectSet.hxx".}
proc isEmpty*(this: SelectMgrSelectableObjectSet;
             theSubset: SelectMgrSelectableObjectSetBVHSubset): StandardBoolean {.
...
proc getObjectById*(this: SelectMgrSelectableObjectSet;
                   ...
                   theIndex: StandardInteger): Handle[SelectMgrSelectableObject] {.
...
proc bvh*(this: SelectMgrSelectableObjectSet;
    ...
    BVH_Tree[StandardReal, 3]] {.noSideEffect, importcpp: "BVH",
                               header: "SelectMgr_SelectableObjectSet.hxx".}
