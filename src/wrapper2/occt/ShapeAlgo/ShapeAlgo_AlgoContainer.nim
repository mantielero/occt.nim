...
proc connectNextWire*(this: ShapeAlgoAlgoContainer; saw: Handle[ShapeAnalysisWire];
                     nextsewd: Handle[ShapeExtendWireData]; maxtol: StandardReal;
                     distmin: var StandardReal; revsewd: var StandardBoolean;
                     revnextsewd: var StandardBoolean): StandardBoolean {.
...
proc c0BSplineToSequenceOfC1BSplineCurve*(this: ShapeAlgoAlgoContainer;
    ...
    noSideEffect, importcpp: "C0BSplineToSequenceOfC1BSplineCurve",
    header: "ShapeAlgo_AlgoContainer.hxx".}
proc c0ShapeToC1Shape*(this: ShapeAlgoAlgoContainer; shape: TopoDS_Shape;
                      tol: StandardReal): TopoDS_Shape {.noSideEffect,
    importcpp: "C0ShapeToC1Shape", header: "ShapeAlgo_AlgoContainer.hxx".}
proc convertSurfaceToBSpline*(this: ShapeAlgoAlgoContainer;
                             surf: Handle[GeomSurface]; uf: StandardReal;
                             ul: StandardReal; vf: StandardReal; vl: StandardReal): Handle[
    GeomBSplineSurface] {.noSideEffect, importcpp: "ConvertSurfaceToBSpline",
                         header: "ShapeAlgo_AlgoContainer.hxx".}
proc homoWires*(this: ShapeAlgoAlgoContainer; wireIn1: TopoDS_Wire;
               wireIn2: TopoDS_Wire; wireOut1: var TopoDS_Wire;
               wireOut2: var TopoDS_Wire; byParam: StandardBoolean): StandardBoolean {.
...
proc convertToPeriodic*(this: ShapeAlgoAlgoContainer; surf: Handle[GeomSurface]): Handle[
    GeomSurface] {.noSideEffect, importcpp: "ConvertToPeriodic",
                  header: "ShapeAlgo_AlgoContainer.hxx".}
proc getFaceUVBounds*(this: ShapeAlgoAlgoContainer; f: TopoDS_Face;
                     umin: var StandardReal; umax: var StandardReal;
