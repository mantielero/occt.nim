...
proc copyRanges*(this: ShapeBuildEdge; toedge: TopoDS_Edge; fromedge: TopoDS_Edge;
                alpha: StandardReal = 0; beta: StandardReal = 1) {.noSideEffect,
    importcpp: "CopyRanges", header: "ShapeBuild_Edge.hxx".}
proc setRange3d*(this: ShapeBuildEdge; edge: TopoDS_Edge; first: StandardReal;
                last: StandardReal) {.noSideEffect, importcpp: "SetRange3d",
...
proc copy*(this: ShapeBuildEdge; edge: TopoDS_Edge;
          sharepcurves: StandardBoolean = standardTrue): TopoDS_Edge {.noSideEffect,
    importcpp: "Copy", header: "ShapeBuild_Edge.hxx".}
...
proc reassignPCurve*(this: ShapeBuildEdge; edge: TopoDS_Edge; old: TopoDS_Face;
                    sub: TopoDS_Face): StandardBoolean {.noSideEffect,
    importcpp: "ReassignPCurve", header: "ShapeBuild_Edge.hxx".}
proc transformPCurve*(this: ShapeBuildEdge; pcurve: Handle[Geom2dCurve];
                     trans: GpTrsf2d; uFact: StandardReal; aFirst: var StandardReal;
                     aLast: var StandardReal): Handle[Geom2dCurve] {.noSideEffect,
...
proc buildCurve3d*(this: ShapeBuildEdge; edge: TopoDS_Edge): StandardBoolean {.
...
proc makeEdge*(this: ShapeBuildEdge; edge: var TopoDS_Edge; curve: Handle[GeomCurve];
              L: TopLocLocation) {.noSideEffect, importcpp: "MakeEdge",
                                 header: "ShapeBuild_Edge.hxx".}
proc makeEdge*(this: ShapeBuildEdge; edge: var TopoDS_Edge; curve: Handle[GeomCurve];
              L: TopLocLocation; p1: StandardReal; p2: StandardReal) {.noSideEffect,
    importcpp: "MakeEdge", header: "ShapeBuild_Edge.hxx".}
proc makeEdge*(this: ShapeBuildEdge; edge: var TopoDS_Edge;
              pcurve: Handle[Geom2dCurve]; face: TopoDS_Face) {.noSideEffect,
    importcpp: "MakeEdge", header: "ShapeBuild_Edge.hxx".}
proc makeEdge*(this: ShapeBuildEdge; edge: var TopoDS_Edge;
              pcurve: Handle[Geom2dCurve]; face: TopoDS_Face; p1: StandardReal;
              p2: StandardReal) {.noSideEffect, importcpp: "MakeEdge",
                                header: "ShapeBuild_Edge.hxx".}
proc makeEdge*(this: ShapeBuildEdge; edge: var TopoDS_Edge;
