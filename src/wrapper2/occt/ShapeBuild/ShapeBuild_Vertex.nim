...
proc combineVertex*(this: ShapeBuildVertex; v1: TopoDS_Vertex; v2: TopoDS_Vertex;
                   tolFactor: StandardReal = 1.0001): TopoDS_Vertex {.noSideEffect,
    importcpp: "CombineVertex", header: "ShapeBuild_Vertex.hxx".}
proc combineVertex*(this: ShapeBuildVertex; pnt1: GpPnt; pnt2: GpPnt;
                   tol1: StandardReal; tol2: StandardReal;
                   tolFactor: StandardReal = 1.0001): TopoDS_Vertex {.noSideEffect,
    importcpp: "CombineVertex", header: "ShapeBuild_Vertex.hxx".}
