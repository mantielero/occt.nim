...
proc isLinear*(thePoles: TColgpArray1OfPnt2d; theTolerance: StandardReal;
              theDeviation: var StandardReal): StandardBoolean {.
    importcpp: "ShapeCustom_Curve2d::IsLinear(@)",
    header: "ShapeCustom_Curve2d.hxx".}
proc convertToLine2d*(theCurve: Handle[Geom2dCurve]; theFirstIn: StandardReal;
                     theLastIn: StandardReal; theTolerance: StandardReal;
                     theNewFirst: var StandardReal; theNewLast: var StandardReal;
                     theDeviation: var StandardReal): Handle[Geom2dLine] {.
    importcpp: "ShapeCustom_Curve2d::ConvertToLine2d(@)",
    header: "ShapeCustom_Curve2d.hxx".}
proc simplifyBSpline2d*(theBSpline2d: var Handle[Geom2dBSplineCurve];
                       theTolerance: StandardReal): StandardBoolean {.
