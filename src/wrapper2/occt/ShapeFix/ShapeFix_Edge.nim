...
proc fixRemovePCurve*(this: var ShapeFixEdge; edge: TopoDS_Edge; face: TopoDS_Face): StandardBoolean {.
...
proc fixRemovePCurve*(this: var ShapeFixEdge; edge: TopoDS_Edge;
    ...
    importcpp: "FixRemovePCurve", header: "ShapeFix_Edge.hxx".}
proc fixRemoveCurve3d*(this: var ShapeFixEdge; edge: TopoDS_Edge): StandardBoolean {.
...
proc fixAddPCurve*(this: var ShapeFixEdge; edge: TopoDS_Edge; face: TopoDS_Face;
                  isSeam: StandardBoolean; prec: StandardReal = 0.0): StandardBoolean {.
...
proc fixAddPCurve*(this: var ShapeFixEdge; edge: TopoDS_Edge;
    ...
    importcpp: "FixAddPCurve", header: "ShapeFix_Edge.hxx".}
proc fixAddPCurve*(this: var ShapeFixEdge; edge: TopoDS_Edge; face: TopoDS_Face;
                  isSeam: StandardBoolean; surfana: Handle[ShapeAnalysisSurface];
...
proc fixAddPCurve*(this: var ShapeFixEdge; edge: TopoDS_Edge;
                  ...
                  prec: StandardReal = 0.0): StandardBoolean {.
    importcpp: "FixAddPCurve", header: "ShapeFix_Edge.hxx".}
proc fixAddCurve3d*(this: var ShapeFixEdge; edge: TopoDS_Edge): StandardBoolean {.
    importcpp: "FixAddCurve3d", header: "ShapeFix_Edge.hxx".}
proc fixVertexTolerance*(this: var ShapeFixEdge; edge: TopoDS_Edge; face: TopoDS_Face): StandardBoolean {.
    importcpp: "FixVertexTolerance", header: "ShapeFix_Edge.hxx".}
proc fixVertexTolerance*(this: var ShapeFixEdge; edge: TopoDS_Edge): StandardBoolean {.
    importcpp: "FixVertexTolerance", header: "ShapeFix_Edge.hxx".}
proc fixReversed2d*(this: var ShapeFixEdge; edge: TopoDS_Edge; face: TopoDS_Face): StandardBoolean {.
...
proc fixSameParameter*(this: var ShapeFixEdge; edge: TopoDS_Edge; face: TopoDS_Face;
                      tolerance: StandardReal = 0.0): StandardBoolean {.
    importcpp: "FixSameParameter", header: "ShapeFix_Edge.hxx".}
proc status*(this: ShapeFixEdge; status: ShapeExtendStatus): StandardBoolean {.
