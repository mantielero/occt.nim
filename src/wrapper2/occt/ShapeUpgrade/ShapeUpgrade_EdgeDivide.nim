...
proc compute*(this: var ShapeUpgradeEdgeDivide; e: TopoDS_Edge): StandardBoolean {.
    importcpp: "Compute", header: "ShapeUpgrade_EdgeDivide.hxx".}
proc hasCurve2d*(this: ShapeUpgradeEdgeDivide): StandardBoolean {.noSideEffect,
    importcpp: "HasCurve2d", header: "ShapeUpgrade_EdgeDivide.hxx".}
proc hasCurve3d*(this: ShapeUpgradeEdgeDivide): StandardBoolean {.noSideEffect,
