...
type
  MaxAlignT* {.importcpp: "max_align_t", header: "Standard_ExtString.hxx", bycopy.} = object
...
type
  ...
  SocklenT* = cuint
  SigAtomicT* = cint
  Timeval* {.importcpp: "timeval", header: "Standard_ExtString.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
    tvUsec* {.importc: "tv_usec".}: SusecondsT

  Timex* {.importcpp: "timex::timex", header: "Standard_ExtString.hxx", bycopy.} = object
...
var time* {.importcpp: "time", header: "Standard_ExtString.hxx".}: Timextimeval
...
type
  TimeT* = TimeT
  Tm* {.importcpp: "timex::tm", header: "Standard_ExtString.hxx", bycopy.} = object
  ...
  Timespec* {.importcpp: "timex::timespec", header: "Standard_ExtString.hxx", bycopy.} = object
    tvSec* {.importc: "tv_sec".}: TimeT
  ...
  Itimerspec* {.importcpp: "timex::itimerspec::timespec::itimerspec",
               header: "Standard_ExtString.hxx", bycopy.} = object


var itInterval* {.importcpp: "it_interval", header: "Standard_ExtString.hxx".}: Itimerspectimespec

var itValue* {.importcpp: "it_value", header: "Standard_ExtString.hxx".}: Itimerspectimespec
...
var locales* {.importcpp: "__locales", header: "Standard_ExtString.hxx".}: array[13,
