...
type
  XmlXCAFDrivers* {.importcpp: "XmlXCAFDrivers", header: "XmlXCAFDrivers.hxx", bycopy.} = object ##
                                                                                         ## !
                                                                                         ## Depending
                                                                                         ## from
                                                                                         ## the
                                                                                         ...
                                                                                         ##
                                                                                         ## !
                                                                                         ## 47b0b826-d931-11d1-b5da-00a0c9064368
                                                                                         ## Transient-Persistent
                                                                                         ##
                                                                                         ## !
                                                                                         ## 47b0b827-d931-11d1-b5da-00a0c9064368
                                                                                         ...
                                                                                         ##
                                                                                         ## !
                                                                                         ## ed8793f8-3142-11d4-b9b5-0060b0ee281b
                                                                                         ## Transient-Persistent
                                                                                         ##
                                                                                         ## !
                                                                                         ...
                                                                                         ##
                                                                                         ## !
                                                                                         ## ed8793fa-3142-11d4-b9b5-0060b0ee281b
                                                                                         ## XCAFSchema
