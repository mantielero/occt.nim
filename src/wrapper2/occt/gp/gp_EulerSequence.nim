...
type
  gp_EulerSequence* {.size: sizeof(cint), importcpp: "gp_EulerSequence",
    ...
    gp_EulerAngles,           ## ! Yaw Pitch Roll (or nautical) angles, alias to Intrinsic_ZYX
    gp_YawPitchRoll,          ##  Tait-Bryan angles (using three different axes)
    ...
    gp_Intrinsic_YZX, gp_Intrinsic_YXZ, gp_Intrinsic_ZXY, gp_Intrinsic_ZYX, ##  Proper Euler angles (using two different axes, first and third the same)
    gp_Extrinsic_XYX, gp_Extrinsic_XZX, gp_Extrinsic_YZY, gp_Extrinsic_YXY,
    gp_Extrinsic_ZYZ, gp_Extrinsic_ZXZ, gp_Intrinsic_XYX, gp_Intrinsic_XZX,
