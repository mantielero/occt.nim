# 1 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx"
# 1 "<interno>"
# 1 "<línea-de-órdenes>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<línea-de-órdenes>" 2
# 1 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx"
# 18 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx"
# 1 "/usr/include/opencascade/Standard_Macro.hxx" 1
# 19 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx" 2
...
# 20 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx" 2
...
# 21 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx" 2
...
class AdvApp2Var_SysBase {
 public:
  ...
  static int macinit_(int *,
          int *);

  int mcrdelt_(integer *iunit,
          integer *isize,
          void *t,
          intptr_t *iofset,
          integer *iercod);

  static int mcrfill_(integer *size,
          void *tin,
          void *tout);

  int mcrrqst_(integer *iunit,
          integer *isize,
          void *t,
          intptr_t *iofset,
          integer *iercod);
  ...
  static int do__fio();
  static int do__lio ();
  int macrai4_(integer *nbelem,
          integer *maxelm,
          integer *itablo,
          intptr_t *iofset,
          integer *iercod);
  int macrar8_(integer *nbelem,
          integer *maxelm,
          doublereal *xtablo,
          intptr_t *iofset,
          integer *iercod);
  int macrdi4_(integer *nbelem,
          integer *maxelm,
          integer *itablo,
          intptr_t *iofset,
          integer *iercod);

  int macrdr8_(integer *nbelem,
          integer *maxelm,
          doublereal *xtablo,
          intptr_t *iofset,
          integer *iercod);
  static int maermsg_(const char *cnompg,
          integer *icoder,
          ftnlen cnompg_len);
  static int maitbr8_(integer *itaill,
          doublereal *xtab,
          doublereal *xval);
  static int maovsr8_(integer *ivalcs);
  static int mgenmsg_(const char *nomprg,
          ftnlen nomprg_len);

  static int mgsomsg_(const char *nomprg,
          ftnlen nomprg_len);
  static void miraz_(integer *taille,
         void *adt);
  static int msifill_(integer *nbintg,
          integer *ivecin,
          integer *ivecou);
  static int msrfill_(integer *nbreel,
          doublereal *vecent,
          doublereal * vecsor);
  static int mswrdbg_(const char *ctexte,
          ftnlen ctexte_len);
  static void mvriraz_(integer *taille,
           void*adt);

private:
  int macrchk_();
  int mcrlist_(integer *ier) const;
# 109 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx"
...
# 125 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx"
  struct mitem {
    unsigned char prot;
    unsigned char unit;
    integer reqsize;
...
# 153 "/usr/include/opencascade/AdvApp2Var_SysBase.hxx"
  struct {
